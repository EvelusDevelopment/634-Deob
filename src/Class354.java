...
final class Class354
{
	...
	((Class338) class338).aShortArray4194[i]
	    = (short) (ElementLoaderNode.anInt1202
	...
	int i_5_ = (!((TextureDefinition) class12).aBoolean199
		    ? ((DirectxToolkit) aHa_Sub2_4355).anInt7712 : 64);
	Class258_Sub3 class258_sub3;
	if (((TextureDefinition) class12).aBoolean218 && aHa_Sub2_4355.isBloomSupported()) {
	    float[] fs = aD4359.method1(i_5_, 0.7F, false, -30824, i_5_, i);
	    class258_sub3
		= new Class258_Sub3(aHa_Sub2_4355, 3553, 34842, i_5_, i_5_,
				    (((TextureDefinition) class12).aByte205
				     ^ 0xffffffff) != -1,
				    fs, 6408);
	} else {
	    int[] is;
	    if ((((TextureDefinition) class12).anInt200 ^ 0xffffffff) == -3
		|| !Class251.method1915((byte) 4,
					((TextureDefinition) class12).aByte213))
		...
		= new Class258_Sub3(aHa_Sub2_4355, 3553, 6408, i_5_, i_5_,
				    ((TextureDefinition) class12).aByte205 != 0, is, 0,
				    0, false);
	}
	class258_sub3.method1965(((TextureDefinition) class12).aBoolean215,
				 ((TextureDefinition) class12).aBoolean217, 10243);
	if (i_4_ != 256)
	    method3466(22);
    ...
    Class354(DirectxToolkit var_ha_Sub2, d var_d) {
	try {
