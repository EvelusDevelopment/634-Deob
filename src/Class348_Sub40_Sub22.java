...
final class Class348_Sub40_Sub22 extends Class348_Sub40
{
    ...
    static IncomingPacket aClass114_9285 = new IncomingPacket(104, 1);
    ...
    static OutgoingPacket aClass351_9304 = new OutgoingPacket(20, -1);
	...
	for (int i_2_ = 0; i_2_ < anInt9301; i_2_++) {
		...
		int i_3_ = anInt9300;
		int i_4_ = ((Model.method1097((byte) 90, 4096, random)
			     - 2048) * anInt9305
			    >> -1633784916);
		...
		if ((i_5_ ^ 0xffffffff) < -1) {
		    int i_6_ = anInt9291;
		    int i_7_ = ((Model.method1097((byte) 117, 4096, random)
				 - 2048) * anInt9302
				>> -1511824500);
		...
		anIntArrayArray9286[i_2_][i_5_]
		    = (anInt9284 <= 0 ? 4096
		       : (-Model.method1097((byte) 124, anInt9284, random)
			  + 4096));
	    }
		...
		while_186_:
			...
			while_184_:
				...
				do {
				    ...
				    anInt9301 = class348_sub49.getUByte();
				    return;
				} while (false);
				anInt9302
			    ...
			    anInt9305 = class348_sub49.getShort();
			    return;
			} while (false);
			anInt9288 = class348_sub49.getShort();
			return;
		    } while (false);
		    anInt9293 = class348_sub49.getShort();
		    return;
		} while (false);
		anInt9294 = class348_sub49.getShort();
		return;
	    } while (false);
	    anInt9284 = class348_sub49.getShort();
	} while (false);
    }
	...
	if (i_23_ != Class348_Sub15.anInt6769) {
		...
		MouseEventNode.aClass361Array7108[i_24_]
