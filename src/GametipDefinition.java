/* GametipDefinition - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */
import java.util.zip.CRC32;

final class GametipDefinition
{
    ...
    static final void method2178(Class318_Sub1 class318_sub1, int i,
				 AnimationDefinition class17, int i_0_) {
	try {
	    anInt3694++;
	    if (Message.anInt2021 < 50
		&& (class17 != null
		    && ((AnimationDefinition) class17).anIntArrayArray264 != null
		    && ((i ^ 0xffffffff)
			> (((AnimationDefinition) class17).anIntArrayArray264.length
			   ^ 0xffffffff))
		    && ((AnimationDefinition) class17).anIntArrayArray264[i] != null)) {
		int i_1_ = ((AnimationDefinition) class17).anIntArrayArray264[i][0];
		int i_2_ = i_1_ >> 572505608;
		int i_3_ = (i_1_ & 0xf1) >> 1350926597;
		if (i_0_ > -13)
		    anInt3695 = 0;
		if ((((AnimationDefinition) class17).anIntArrayArray264[i].length
		     ^ 0xffffffff)
		    < -2) {
		    int i_4_ = (int) ((double) (((AnimationDefinition) class17)
						.anIntArrayArray264[i]).length
				      * Math.random());
		    if (i_4_ > 0)
			i_2_ = ((AnimationDefinition) class17).anIntArrayArray264[i][i_4_];
		}
		int i_5_ = i_1_ & 0x1f;
		int i_6_ = 256;
		if (((AnimationDefinition) class17).anIntArray236 != null
		    && ((AnimationDefinition) class17).anIntArray265 != null)
		    i_6_ = ((int) (Math.random()
				   * (double) (-(((AnimationDefinition) class17)
						 .anIntArray236[i])
					       + (((AnimationDefinition) class17)
						  .anIntArray265[i])))
			    + ((AnimationDefinition) class17).anIntArray236[i]);
		int i_7_ = (((AnimationDefinition) class17).anIntArray253 == null ? 255
			    : ((AnimationDefinition) class17).anIntArray253[i]);
		if (i_5_ == 0) {
		    if (Class132.localPlayer
			== class318_sub1) {
			if (!((AnimationDefinition) class17).aBoolean268)
			...
			= new Class10((((AnimationDefinition) class17).aBoolean268
				       ? (byte) 2 : (byte) 1),
    ...
    public GametipDefinition() {
	/* empty */
    }
    
    private final Interface12 method2182(boolean bool, Class223 class223, ByteBuffer buffer) {
	try {
	    anInt3692++;
		...
		return Class303.method2287(buffer, (byte) -112);
	    if (class223 == Class28.aClass223_4997)
		return Class337.method2660((byte) 26, buffer);
	    if (bool != true)
		method2180((byte) -104);
	    if (class223 == Class348_Sub40_Sub21.aClass223_9274)
		return Class288_Sub1.method2189(buffer, 86);
	    if (class223 == Class313.aClass223_3934)
		return Class5.method179(16533, buffer);
	    if (Class185.aClass223_2489 == class223)
		return Class348_Sub46.method3322(0, buffer);
	    if (class223 == Class174.aClass223_2307)
		return Class50_Sub4.method472(-27794, buffer);
	    if (Class149.aClass223_2045 == class223)
		return Class328_Sub2.method2612(buffer, true);
	    if (Class187.aClass223_2507 == class223)
		return Class285_Sub1.method2128(-1730, buffer);
	    return null;
	} catch (RuntimeException runtimeexception) {
	    throw Class348_Sub17.method2929(runtimeexception,
					    ("vp.F(" + bool + ','
    ...
    final void initialize(ByteBuffer buffer, int i) {
	((GametipDefinition) this).activeTime = buffer.getTri();
	anInt3693++;
	((GametipDefinition) this).anInt3687 = buffer.getShort();
	((GametipDefinition) this).anInterface12Array3688 = new Interface12[buffer.getUByte()];
	Class223[] class223s = Class19.method285(-99);
	int i_27_ = 0;
	if (i != 21890)
	    method2180((byte) 25);
	for (/**/; ((GametipDefinition) this).anInterface12Array3688.length > i_27_;
	     i_27_++)
	    ((GametipDefinition) this).anInterface12Array3688[i_27_]
		= method2182(true,
			     class223s[(buffer.getUByte
					())],
			     buffer);
    }
