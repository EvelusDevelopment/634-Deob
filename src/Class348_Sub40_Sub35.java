...
final class Class348_Sub40_Sub35 extends Class348_Sub40
{
    ...
    static ConnectionMode demoConnectionNode;
	...
	if (((Class191) ((Class348_Sub40) this).aClass191_7032).aBoolean2570) {
	    int i_5_ = OndemandWorker.anInt3201 * anInt9448 >> -856871732;
		...
		if ((i_13_ ^ 0xffffffff) < -256)
		    i_13_ = 255;
		int i_14_ = (Widget.aByteArray821[i_12_ + (i_13_ * (1 + i_13_)
							    >> 1034972801)]
			     & 0xff);
    ...
    final void method3049(ByteBuffer class348_sub49, int i, int i_18_) {
	int i_19_ = i;
    while_210_:
	do {
	    do {
		if ((i_19_ ^ 0xffffffff) != -1) {
		    ...
		    anInt9448 = class348_sub49.getShort();
		    break while_210_;
		}
		anInt9447 = class348_sub49.getShort();
		break while_210_;
	    } while (false);
	    anInt9445 = class348_sub49.getShort();
	} while (false);
	anInt9442++;
	if (i_18_ != 31015)
	    demoConnectionNode = null;
