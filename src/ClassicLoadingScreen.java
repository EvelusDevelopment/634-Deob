/* ClassicLoadingScreen - Decompiled by JODE
...
final class ClassicLoadingScreen implements LoadingScreen
{
    ...
    static OutgoingPacket aClass351_5057 = new OutgoingPacket(10, -1);
	...
	try {
	    ...
	    anInt5038++;
	    Field field = var_class.getDeclaredField(string);
	    Object object = field.get(Class93.loaderApplet);
	...
	if (i < 23)
	    anImage5030 = null;
	if (aBoolean5020)
	    return (-i_2_ + Class321.windowWidth) / 2;
	return 0;
    }
	...
	if (aBoolean5022)
	    ...
	    if (graphics != null) {
		try {
		    int i_5_ = ObjectDefinition.loadingHandler.method2320((byte) 103);
		    String string = ObjectDefinition.loadingHandler.getLoadingMsg(-9324);
		    if (Class342.anImage4249 == null)
			Class342.anImage4249
			    = (Class305.canvas.createImage
			       (Class321.windowWidth,
				Class348_Sub42_Sub8_Sub2.windowHeight));
		    Graphics graphics_6_ = Class342.anImage4249.getGraphics();
		    graphics_6_.clearRect(0, 0, Class321.windowWidth,
					  Class348_Sub42_Sub8_Sub2.windowHeight);
			...
			Image image
			    = Class305.canvas.createImage(i_31_,
							       (-i_22_
								+ (anInt5036
								   + -i_20_)));
	...
	anInt5028++;
	if (aBoolean5045)
	    return (-i + Class348_Sub42_Sub8_Sub2.windowHeight) / 2;
	if (i_40_ != -6277)
	    anImage5026 = null;
	return 0;
    }
	...
	anInt5031++;
	Class199.drawLoadingBar(ObjectDefinition.loadingHandler.method2320((byte) 78), Class135.aColorArray1928[Class222.anInt2884], ObjectDefinition.loadingHandler.getLoadingMsg(-9324), (Class348_Sub40_Sub8.aColorArray9163[Class222.anInt2884]), (byte) -100, Class50_Sub3.aColorArray5242[Class222.anInt2884]);
    }
    
    public ClassicLoadingScreen() {
	/* empty */
    }
}
