...
final class Class62
{
    ...
    static final synchronized long getCurrentTimeMillis() {
	anInt1113++;
	long l = System.currentTimeMillis();
	if (l < Class101_Sub1.lastTime)
	    Class318_Sub1_Sub1.aLong8728 += Class101_Sub1.lastTime - l;
	Class101_Sub1.lastTime = l;
