...
final class Class158 implements Interface12
{
    ...
    static HashTable aClass356_4934 = new HashTable(8);
    int anInt4935;
    int anInt4936;
    int anInt4937;
	...
	if (i < 11)
	    aClass299_4938 = null;
	return (new Class221[]
		{ Class5_Sub1.aClass221_8344, Class104.aClass221_1620,
		  Class223.aClass221_2893 });
    }
    ...
    Class158(String string, Class221 class221, Class341 class341, int i,
    ...
    /*synthetic*/ static Class method1250(String string) {
	try {
