...
{
    private Cache aClass60_2479 = new Cache(64);
    private IndexLoader aClass45_2480;
    static int anInt2481;
    static int anInt2482;
    static IncomingPacket aClass114_2483;
	...
	synchronized (aClass45_2480) {
	    is = aClass45_2480.loadArchiveChild(-1860, 31, i_1_);
	}
	class253 = new Class253();
	int i_2_ = 50 / ((i - -63) / 56);
	if (is != null)
	    class253.method1921((byte) -69, new ByteBuffer(is));
	synchronized (aClass60_2479) {
	...
	boolean bool
	    = (Message.aClass357ArrayArrayArray2029[0][i_5_][i_6_] != null
	       && ((Class357) (Message.aClass357ArrayArrayArray2029[0][i_5_]
			       [i_6_])).aClass357_4400 != null);
	for (int i_7_ = i; i_7_ >= 0; i_7_--) {
	    if (Message.aClass357ArrayArrayArray2029[i_7_][i_5_][i_6_]
		== null) {
		Class357 class357
		    = (Message.aClass357ArrayArrayArray2029[i_7_][i_5_][i_6_]
		       = new Class357(i_7_));
		if (bool)
    ...
    static {
	aClass114_2483 = new IncomingPacket(47, 6);
