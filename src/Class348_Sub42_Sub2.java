...
final class Class348_Sub42_Sub2 extends SubNode implements Interface9
{
    static int anInt8561;
    private int anInt8562 = -1;
    private int anInt8563 = -1;
    private DirectxToolkit aHa_Sub2_8564;
    int anInt8565;
    ...
    static final void method3171(AbstractToolkit var_ha, int i, int i_0_, int i_1_,
	...
	Class348_Sub40_Sub5.aBoolean9121
	    = (Npc.anInt10503 > 1
	       && Class9.aHa171.supportsMultipleCores());
	...
	if (bool) {
	    ...
	    GraphicsFetcher.aClass357ArrayArrayArray9082
	...
	IndexTable.aClass318_Sub1Array3737 = new Class318_Sub1[5000];
	...
	if (Class348_Sub40_Sub5.aBoolean9121) {
	    ...
	    GfxLoader.aClass315Array3982 = new Class315[i_7_];
	    for (int i_8_ = 0; i_8_ < i_7_; i_8_++)
		GfxLoader.aClass315Array3982[i_8_]
	...
	AnimationDefinition.anIntArray256 = new int[Class75_Sub1.anInt5652 - 1];
    ...
    Class348_Sub42_Sub2(DirectxToolkit var_ha_Sub2, int i, int i_11_, int i_12_) {
	try {
    ...
    Class348_Sub42_Sub2(DirectxToolkit var_ha_Sub2, int i, int i_13_, int i_14_,
			int i_15_) {
	try {
