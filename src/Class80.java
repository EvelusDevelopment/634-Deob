...
final class Class80
{
	...
	if (i_1_ == 2)
	    return sinetable[i & 0x7fff] * i_0_ >> 14;
	if (i_1_ == 3)
	    return ((i & 0x7fff) * i_0_ >> 14) - i_0_;
	if (i_1_ == 4)
	    return anIntArray1416[i / 2607 & 0x7fff] * i_0_;
	return 0;
    }
    
    final void method807(ByteBuffer class348_sub49) {
	...
	for (int i_2_ = 0; i_2_ < 10; i_2_++) {
	    int i_3_ = class348_sub49.getSmartA();
	    if (i_3_ == 0)
		break;
	    anIntArray1410[i_2_] = i_3_;
	    anIntArray1411[i_2_] = class348_sub49.method3362((byte) 77);
	    anIntArray1428[i_2_] = class348_sub49.getSmartA();
	}
	anInt1427 = class348_sub49.getSmartA();
	anInt1422 = class348_sub49.getSmartA();
	((Class80) this).anInt1421 = class348_sub49.getShort();
	((Class80) this).anInt1407 = class348_sub49.getShort();
	...
	if (((Class349) aClass349_1419).anIntArray4299[0] > 0
		...
		for (/**/; i_32_ < i_33_; i_32_++) {
		    int i_34_ = (int) (((long) anIntArray1409[i_32_ + i_30_]
					* (long) Class349.anInt4303)
				       >> 16);
		    for (int i_35_ = 0; i_35_ < i_30_; i_35_++)
			i_34_ += (int) (((long) (anIntArray1409
						 [i_32_ + i_30_ - 1 - i_35_])
					 * (long) (Class349.anIntArrayArray4301
						   [0][i_35_]))
					>> 16);
		    for (int i_36_ = 0; i_36_ < i_32_; i_36_++)
			i_34_
			    -= (int) (((long) anIntArray1409[i_32_ - 1 - i_36_]
				       * (long) (Class349.anIntArrayArray4301
						 [1][i_36_]))
				      >> 16);
		...
		for (;;) {
		    ...
		    for (/**/; i_32_ < i_33_; i_32_++) {
			int i_37_
			    = (int) (((long) anIntArray1409[i_32_ + i_30_]
				      * (long) Class349.anInt4303)
				     >> 16);
			for (int i_38_ = 0; i_38_ < i_30_; i_38_++)
			    i_37_
				+= (int) (((long) (anIntArray1409
						   [i_32_ + i_30_ - 1 - i_38_])
					   * (long) (Class349
						     .anIntArrayArray4301[0]
						     [i_38_]))
					  >> 16);
			for (int i_39_ = 0; i_39_ < i_31_; i_39_++)
			    i_37_ -= (int) (((long) (anIntArray1409
						     [i_32_ - 1 - i_39_])
					     * (long) (Class349
						       .anIntArrayArray4301[1]
						       [i_39_]))
					    >> 16);
			...
			break;
		    i_30_
			= aClass349_1419.method3451(0,
						    (float) i_29_ / 65536.0F);
		    i_31_
			= aClass349_1419.method3451(1,
						    (float) i_29_ / 65536.0F);
		    i_33_ += 128;
		}
		for (/**/; i_32_ < i; i_32_++) {
			...
			i_40_
			    -= (int) (((long) anIntArray1409[i_32_ - 1 - i_42_]
				       * (long) (Class349.anIntArrayArray4301
						 [1][i_42_]))
				      >> 16);
	...
	for (int i_43_ = 0; i_43_ < i; i_43_++) {
	    if (anIntArray1409[i_43_] < -32768)
		anIntArray1409[i_43_] = -32768;
	    if (anIntArray1409[i_43_] > 32767)
		anIntArray1409[i_43_] = 32767;
	}
	return anIntArray1409;
    }
	...
	for (int i = 0; i < 32768; i++)
	    sinetable[i] = (int) (Math.sin((double) i / 5215.1903) * 16384.0);
