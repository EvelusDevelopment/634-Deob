...
abstract class Class299
{
	...
	while (i_11_ > i_9_) {
		...
		GameBuffer.anIntArray9757[i_13_] = i_9_;
		i_13_--;
		...
		if (i_10_ <= i_11_) {
		    int[] is_19_ = AnimationDefinition.anIntArrayArray255[i_11_ + i_6_];
		    int[] is_20_ = AnimationDefinition.anIntArrayArray255[i_6_ + -i_11_];
		    int i_21_ = i_3_ - -i_9_;
		    int i_22_ = -i_9_ + i_3_;
		    Class135_Sub2.method1156(-27, i_21_, is_19_, i_22_, i_8_);
		    Class135_Sub2.method1156(-27, i_21_, is_20_, i_22_, i_8_);
		} else {
		    int[] is_23_ = AnimationDefinition.anIntArrayArray255[i_6_ - -i_11_];
		    int[] is_24_ = AnimationDefinition.anIntArrayArray255[-i_11_ + i_6_];
		    int i_25_ = GameBuffer.anIntArray9757[i_11_];
		    int i_26_ = i_9_ + i_3_;
		    int i_27_ = i_3_ - i_9_;
	    ...
	    int[] is_30_ = AnimationDefinition.anIntArrayArray255[i_6_ + i_9_];
	    int[] is_31_ = AnimationDefinition.anIntArrayArray255[-i_9_ + i_6_];
	    int i_32_ = i_3_ - -i_11_;
	    int i_33_ = i_3_ - i_11_;
	    if (i_10_ > i_9_) {
		int i_34_
		    = ((i_13_ ^ 0xffffffff) <= (i_9_ ^ 0xffffffff) ? i_13_
		       : GameBuffer.anIntArray9757[i_9_]);
