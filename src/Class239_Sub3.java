...
final class Class239_Sub3 extends Class239
{
    ...
    static final void method1728(int i, int i_2_, int i_3_, boolean bool,
				 int i_4_) {
	anInt5860++;
	if (Class320.method2547(i_3_, (byte) 84))
	    Class367_Sub1.method3534(false, i_2_, i_4_, bool, i,
				     (Class348_Sub40_Sub33
				      .aClass46ArrayArray9427[i_3_]));
    }
    ...
    Class239_Sub3(int i, Class348_Sub51 class348_sub51) {
    ...
    static final void method1730(int i, int i_5_, int i_6_, int i_7_, int i_8_,
				 int i_9_, int i_10_, int i_11_) {
	if (i_10_ != -128)
	    method1730(-6, -95, 101, -81, 56, 14, -29, -19);
	anInt5868++;
	int i_12_ = -i_9_ + i_5_;
	int i_13_ = i_9_ + i_6_;
	for (int i_14_ = i_6_; i_14_ < i_13_; i_14_++)
	    Class135_Sub2.method1156(-27, i_7_,
				     AnimationDefinition.anIntArrayArray255[i_14_], i_11_,
				     i);
	int i_15_ = i_7_ + -i_9_;
	int i_16_ = i_9_ + i_11_;
	for (int i_17_ = i_5_; i_12_ < i_17_; i_17_--)
	    Class135_Sub2.method1156(i_10_ + 101, i_7_,
				     AnimationDefinition.anIntArrayArray255[i_17_], i_11_,
				     i);
	for (int i_18_ = i_13_; (i_12_ ^ 0xffffffff) <= (i_18_ ^ 0xffffffff);
	     i_18_++) {
	...
	if (bool)
	    Class282.anInt3655 = 1;
	if (!bool)
	    Class325.method2599((byte) 109,
				BitmapTable.aClass348_Sub42_Sub12_3963, i_20_,
				i_19_);
	else
	    Class138.aClass348_Sub42_Sub12_1946
		= BitmapTable.aClass348_Sub42_Sub12_3963;
	if (i != 1)
	    createGameFont(-88, null, (byte) -126, false);
    }
	...
	anInt5870++;
	if (i != -78)
	    method1732((byte) 80, -38);
	WidgetVariable class348_sub42_sub15
	    = Class318_Sub9_Sub1.method2516(i_23_, (byte) 105, 11);
	...
	if (i_24_ == i)
	    return 3;
	if (Cache.method576(i_24_, i ^ 0x56))
	    return 2;
	return 1;
    }
    
    static final GameFont createGameFont(int i, AbstractToolkit var_ha, byte i_25_,
				     boolean bool) {
	try {
	    anInt5859++;
	    if ((i ^ 0xffffffff) == 0)
		...
		for (int i_26_ = 0;
		     i_26_ < Class348_Sub1.anIntArray6547.length; i_26_++) {
		    if ((i ^ 0xffffffff)
			== (Class348_Sub1.anIntArray6547[i_26_] ^ 0xffffffff))
			return Class199.aClass352Array2636[i_26_];
		}
	    }
	    GameFont class352
		= (GameFont) Class332.aClass60_4139.method583((long) i, -92);
	    if (class352 != null) {
		if (bool && ((GameFont) class352).bitmapFont == null) {
		    BitmapFont class143
			= Class239_Sub10.createBitmapFont((byte) -76, i,
						    s.fontIndexLoader);
		    if (class143 == null)
			return null;
		    ((GameFont) class352).bitmapFont = class143;
		}
		return class352;
	    }
	    int i_27_ = -118 / ((-33 - i_25_) / 44);
	    Sprite[] class207s
		= Sprite.method1523(Class39.spriteIndexLoader, i);
	    if (class207s == null)
		return null;
	    BitmapFont class143
		= Class239_Sub10.createBitmapFont((byte) -39, i, s.fontIndexLoader);
	    if (class143 == null)
		return null;
	    if (!bool)
		class352 = new GameFont(var_ha.createFontRasterizer(class143, class207s,
							  true));
	    else
		class352 = new GameFont(var_ha.createFontRasterizer(class143, class207s,
							  true),
	...
	if (bool != false)
	    anInt5871 = -86;
	anInt5858++;
	return Cache.method576(((Class239) this).anInt3138, 29);
    }
}
