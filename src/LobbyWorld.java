/* LobbyWorld - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

final class LobbyWorld extends AbstractLobbyWorld
{
    int anInt5786;
    String activity;
    int anInt5788 = -1;
    ...
    final LobbyRegionInfo getInfo() {
	anInt5789++;
	return MouseMovementListener.lobbyRegionInfo[((AbstractLobbyWorld) this).location];
    }
