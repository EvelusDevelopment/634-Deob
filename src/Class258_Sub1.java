...
final class Class258_Sub1 extends Class258
{
    ...
    static BitmapFont p11fullBitmapFont;
	...
	if (i != -3022)
	    method1960(112, -107, -46, -98, null, null, null, null, null, null,
		       -114, (byte) 75, -105, 62, true, false, 110, -31, true);
	anInt8528 = -1;
    }
    
    Class258_Sub1(DirectxToolkit var_ha_Sub2, int i, int i_7_, int i_8_, int i_9_,
		  byte[] is, int i_10_) {
    ...
    static final void method1960
	(int i, int i_12_, int i_13_, int i_14_, byte[][][] is, int[] is_15_,
	 int[] is_16_, int[] is_17_, int[] is_18_, int[] is_19_, int i_20_,
	...
	Class37.anInt492
	    = Class239_Sub25.anInt6111 - Class318_Sub1_Sub4_Sub1.anInt10084;
	if (Class37.anInt492 < 0) {
	    NativeRaster.anInt8412 = -Class37.anInt492;
	    Class37.anInt492 = 0;
	} else
	    NativeRaster.anInt8412 = 0;
	Class348_Sub34.anInt6974
	    = Class285_Sub2.anInt8502 - Class318_Sub1_Sub4_Sub1.anInt10084;
	if (Class348_Sub34.anInt6974 < 0) {
	    Class240.anInt4686 = -Class348_Sub34.anInt6974;
	    Class348_Sub34.anInt6974 = 0;
	} else
	    Class240.anInt4686 = 0;
	Class27.anInt387
	    = Class239_Sub25.anInt6111 + Class318_Sub1_Sub4_Sub1.anInt10084;
	if (Class27.anInt387 > Class318_Sub7.anInt6451)
	    Class27.anInt387 = Class318_Sub7.anInt6451;
	Class59_Sub1.anInt5293
	    = Class285_Sub2.anInt8502 + Class318_Sub1_Sub4_Sub1.anInt10084;
	if (Class59_Sub1.anInt5293 > Class348_Sub41.anInt7054)
	...
	if (Class348_Sub40_Sub17.aBoolean9242) {
	    for (int i_29_ = 0;
		 i_29_ < (Class318_Sub1_Sub4_Sub1.anInt10084
		...
		for (int i_32_ = 0;
		     ...
		     i_32_++) {
		    if (i_32_ > 1)
			Class171.anIntArray2272[i_32_ - 2] = i_30_;
		    i_30_ = i_31_;
		    int i_33_ = (Class239_Sub25.anInt6111
				 - Class318_Sub1_Sub4_Sub1.anInt10084 + i_29_);
		    int i_34_ = (Class285_Sub2.anInt8502
				 - Class318_Sub1_Sub4_Sub1.anInt10084 + i_32_);
		    if (i_33_ >= 0 && i_34_ >= 0
			&& i_33_ < Class318_Sub7.anInt6451
			&& i_34_ < Class348_Sub41.anInt7054) {
			int i_35_ = i_33_ << Class362.anInt4459;
			int i_36_ = i_34_ << Class362.anInt4459;
			int i_37_
			    = (Class348_Sub1_Sub1.aSArray8801
				   [Class348_Sub1_Sub1.aSArray8801.length - 1]
				   .method3982((byte) -86, i_34_, i_33_)
			       - (1000 << Class362.anInt4459 - 7));
			int i_38_
			    = (Class332.aSArray4142 != null
			       ? (Class332.aSArray4142[0]
				      .method3982((byte) -86, i_34_, i_33_)
				  + Class270.anInt3465)
			       : (Class348_Sub1_Sub1.aSArray8801[0]
				      .method3982((byte) -86, i_34_, i_33_)
				  + Class270.anInt3465));
			i_31_ = (i_25_ >= 0
				 ? Class9.aHa171.r(i_35_, i_37_, i_36_, i_35_,
						   i_38_, i_36_, i_25_)
				 : Class9.aHa171.JA(i_35_, i_37_, i_36_, i_35_,
						    i_38_, i_36_));
			Class348_Sub8.aBooleanArrayArray6656[i_29_][i_32_]
			    = i_31_ == 0;
		    } else {
			i_31_ = -1;
			Class348_Sub8.aBooleanArrayArray6656[i_29_][i_32_]
		    ...
		    if (i_29_ > 0 && i_32_ > 0) {
			int i_39_ = (Class171.anIntArray2272[i_32_ - 1]
				     & Class171.anIntArray2272[i_32_] & i_30_
				     & i_31_);
			Class99.aBooleanArrayArray1572[i_29_ - 1][i_32_ - 1]
			    = i_39_ == 0;
		    }
		}
		Class171.anIntArray2272[(Class318_Sub1_Sub4_Sub1.anInt10084
		...
		Main.anIntArray5176 = is_19_;
		Class348_Sub42_Sub14.method3241(i_20_, (byte) 39,
						Class9.aHa171);
	    }
	} else {
	    if (Class369_Sub3.aBooleanArrayArray8596 == null)
		Class369_Sub3.aBooleanArrayArray8596
		    = (new boolean
		       [Class318_Sub7.anInt6451 + Class318_Sub7.anInt6451 + 1]
		       [(Class348_Sub41.anInt7054 + Class318_Sub7.anInt6451
			 + 1)]);
	    for (int i_40_ = 0;
		 i_40_ < Class369_Sub3.aBooleanArrayArray8596.length;
		 i_40_++) {
		for (int i_41_ = 0;
		     i_41_ < Class369_Sub3.aBooleanArrayArray8596[0].length;
		     i_41_++)
	...
	if (!((Class76) Class71.aClass76_1208).aBoolean1283) {
	    ...
	    for (Class318_Sub4 class318_sub4
		 ...
		 class318_sub4 != null;
		 class318_sub4
		     = (Class318_Sub4) class243.method1878((byte) 125)) {
	...
	if (Class348_Sub40_Sub5.aBoolean9121) {
	    ColorNode.anIntArray4906 = Class9.aHa171.Y();
	    Class9.aHa171.getDimensions(Class348_Sub40_Sub10.anIntArray9183);
	    int i_43_ = ((Class348_Sub40_Sub10.anIntArray9183[2]
			  - Class348_Sub40_Sub10.anIntArray9183[0])
			 / Class75_Sub1.anInt5652);
	    for (int i_44_ = 0; i_44_ < Class75_Sub1.anInt5652 - 1; i_44_++)
		AnimationDefinition.anIntArray256[i_44_]
		    = i_43_ * (i_44_ + 1) + Class345.anIntArray4271[i_44_];
	    for (int i_45_ = 0;
		 i_45_ < Class348_Sub40_Sub34.aClass293Array9432.length;
		 i_45_++)
	...
	if (GraphicsFetcher.aClass357ArrayArrayArray9082 != null) {
	    ...
	    FloatBuffer.method3398(true, is, i_20_, i_21_, i_25_,
					   i_26_, bool_27_);
	    if (Class348_Sub40_Sub5.aBoolean9121)
		Class304.method2290();
	    Class9.aHa171.pa();
	...
	FloatBuffer.method3398(false, is, i_20_, i_21_, i_25_, i_26_,
				       bool_27_);
	if (Class348_Sub40_Sub5.aBoolean9121) {
	    for (int i_46_ = 0; i_46_ < Class189.anInt2524; i_46_++)
		Class5_Sub2.aBooleanArrayArrayArray8361[i_46_]
		    = Class115.aBooleanArrayArrayArray1751[i_46_];
	    Class285_Sub1.method2131(0);
	    for (int i_47_ = 0;
		 i_47_ < Class348_Sub40_Sub34.aClass293Array9432.length;
		 i_47_++)
	...
	if (Class348_Sub40_Sub5.aBoolean9121) {
		...
		Class115.aBooleanArrayArrayArray1751[i_48_]
		    = Class5_Sub2.aBooleanArrayArrayArray8361[i_48_];
	    if (Npc.anInt10503 == 2) {
		if (VarbitDefinition.aLongArray2013[0] < VarbitDefinition.aLongArray2013[1]) {
		    if (AnimationDefinition.anIntArray256[0] + Class345.anIntArray4271[0]
			> Class348_Sub40_Sub10.anIntArray9183[0])
			Class345.anIntArray4271[0]++;
		} else if ((VarbitDefinition.aLongArray2013[0]
			    > VarbitDefinition.aLongArray2013[1])
			   && ((AnimationDefinition.anIntArray256[0]
				+ Class345.anIntArray4271[0])
			       < Class348_Sub40_Sub10.anIntArray9183[2]))
		    Class345.anIntArray4271[0]--;
	    }
	}
	if (!Class348_Sub40_Sub17.aBoolean9242) {
    ...
    Class258_Sub1(DirectxToolkit var_ha_Sub2, int i, int i_49_, int i_50_,
		  int i_51_) {
