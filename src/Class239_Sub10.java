...
final class Class239_Sub10 extends Class239
{
    ...
    static OutgoingPacket aClass351_5938 = new OutgoingPacket(0, 0);
	...
	anInt5935++;
	BufferedPacket.method3324(Class348_Sub8.currentToolkit, (byte) 105,
				  (long) Class367_Sub11.logicCycle);
	if (i != 85)
	    anInt5943 = -99;
	if (r.anInt9721 != -1)
	...
	Class58.anInt1064 = Class367_Sub11.logicCycle;
	if (r.anInt9721 != -1) {
	    Class348_Sub38.anInt7008 = 0;
	    Class88.method842(false);
	}
	Class348_Sub8.currentToolkit.la();
	Class348_Sub42_Sub20.method3281((byte) 77, Class348_Sub8.currentToolkit);
	int i_7_ = FileIndexWorker.method1053(3112);
	if ((i_7_ ^ 0xffffffff) == 0)
	    i_7_ = Class362.anInt4458;
	if (i_7_ == -1)
	    i_7_ = OndemandFileRequest.anInt10447;
    ...
    static final BitmapFont createBitmapFont(byte i, int i_16_, IndexLoader class45) {
	anInt5944++;
	if (i >= -24)
	    return null;
