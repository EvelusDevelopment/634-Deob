...
final class FileIndex
{
    ...
    private BufferedFile bufferedFile = null;
    static int anInt1934;
    static int anInt1935;
    static int anInt1936;
    static int anInt1937;
    private BufferedFile aClass78_1938 = null;
    private int anInt1939 = 65000;
    
    final boolean writeArchive(int i, int i_0_, byte[] dest, int i_1_) {
	if (i_1_ != -7305)
	    return true;
	anInt1935++;
	synchronized (bufferedFile) {
	    if ((i ^ 0xffffffff) > -1 || (anInt1939 ^ 0xffffffff) > (i ^ 0xffffffff))
		throw new IllegalArgumentException();
	    boolean bool = writeArchive(dest, i_0_, i, true);
	    if (!bool)
		bool = writeArchive(dest, i_0_, i, false);
	    return bool;
	}
    }
    
    final byte[] getArchive(byte i, int i_2_) {
	anInt1937++;
	synchronized (bufferedFile) {
	    try {
		if ((aClass78_1938.method787() ^ 0xffffffffffffffffL)
		    > ((long) (6 * i_2_ - -6) ^ 0xffffffffffffffffL))
		    return null;
		aClass78_1938.method789((long) (6 * i_2_), (byte) -106);
		...
		if ((i_3_ ^ 0xffffffff) > -1
		    ...
		    return null;
		if (i_4_ <= 0
		    || (long) i_4_ > bufferedFile.method787() / 520L)
		    return null;
		...
		while ((i_5_ ^ 0xffffffff) > (i_3_ ^ 0xffffffff)) {
			...
			return null;
		    bufferedFile.method789((long) (i_4_ * 520), (byte) -103);
		    int i_7_ = -i_5_ + i_3_;
		    if (i_7_ > 512)
			i_7_ = 512;
		    bufferedFile.method788(0, Class239.aByteArray3144,
					    8 + i_7_, i ^ 0x414f);
		    int i_8_
    ...
    private final boolean writeArchive(byte[] is, int i_13_, int i_14_,
				     boolean bool) {
	anInt1936++;
	synchronized (bufferedFile) {
	    try {
		int i_15_;
		if (bool) {
		    if (aClass78_1938.method787()
			< (long) (i_13_ * 6 - -6))
			return false;
		    aClass78_1938.method789((long) (i_13_ * 6), (byte) 70);
		    aClass78_1938.method788(0, Class239.aByteArray3144, 6,
					    -16717);
		    ...
		    i_15_ = (int) ((519L + bufferedFile.method787()) / 520L);
		    if ((i_15_ ^ 0xffffffff) == -1)
			i_15_ = 1;
		}
		...
		aClass78_1938.method789((long) (i_13_ * 6), (byte) 111);
		...
		while (i_16_ < i_14_) {
		    int i_18_ = 0;
		    if (bool) {
			bufferedFile.method789((long) (520 * i_15_),
						(byte) -116);
			try {
			    bufferedFile.method788(0, Class239.aByteArray3144,
						    8, -16717);
		    ...
		    if (i_18_ == 0) {
			bool = false;
			i_18_ = (int) ((bufferedFile.method787() - -519L)
				       / 520L);
			if ((i_18_ ^ 0xffffffff) == -1)
			    i_18_++;
		    ...
		    bufferedFile.method789((long) (520 * i_15_), (byte) -121);
		    bufferedFile.method783(0, 8, true,
					    Class239.aByteArray3144);
		    int i_22_ = -i_16_ + i_14_;
		    if (i_22_ > 512)
			i_22_ = 512;
		    bufferedFile.method783(i_16_, i_22_, true, is);
		    i_17_++;
		    i_16_ += i_22_;
		    i_15_ = i_18_;
		}
	...
	anInt1931++;
	if ((i_24_ & 0x800 ^ 0xffffffff) == -1)
	    return false;
	return true;
    }
    
    FileIndex(int i, BufferedFile class78, BufferedFile class78_26_, int i_27_) {
	try {
	    anInt1932 = i;
	    bufferedFile = class78;
