...
public final class Direct3dToolkit extends NativeToolkit
{
	...
	final void method3928(int i) {
		...
		(((Direct3dToolkit) this).aFloat8180 * ((Direct3dToolkit) this).aFloat8093,
				((Direct3dToolkit) this).aFloat8093 * ((Direct3dToolkit) this).aFloat8087,
				((Direct3dToolkit) this).aFloat8168 * ((Direct3dToolkit) this).aFloat8093,
				(float) i);
		aBoolean9801 = false;
	}
	...
	final void method3829(Class70 class70, int i, byte i_0_, boolean bool) {
		if (i_0_ == 80) {
			...
			if (bool)
				i_1_ |= 0x10;
			((Direct3dToolkit) this).anIDirect3DDevice9810.SetTextureStageState
			(((Direct3dToolkit) this).anInt8175, i_3_,
	...
	final int[] na(int i, int i_4_, int i_5_, int i_6_) {
		...
		= ((Direct3dToolkit) this).anIDirect3DDevice9810.c(0);
		IDirect3DSurface idirect3dsurface_7_
		= ((Direct3dToolkit) this).anIDirect3DDevice9810.a(i_5_, i_6_, 21, 0, 0,
				true);
		if (ue.a((((Direct3dToolkit) this).anIDirect3DDevice9810.StretchRect
				(idirect3dsurface, i, i_4_, i_5_, i_6_, idirect3dsurface_7_,
						0, 0, i_5_, i_6_, 0)),
						false)
						&& ue.a(idirect3dsurface_7_.LockRect(0, 0, i_5_, i_6_, 16,
								(((Direct3dToolkit) this)
										.aPixelBuffer9803)),
										false)) {
			is = new int[i_6_ * i_5_];
			int i_8_ = ((Direct3dToolkit) this).aPixelBuffer9803.getRowPitch();
			if ((4 * i_5_ ^ 0xffffffff) != (i_8_ ^ 0xffffffff)) {
				for (int i_9_ = 0; (i_9_ ^ 0xffffffff) > (i_6_ ^ 0xffffffff);
				i_9_++)
					((Direct3dToolkit) this).aPixelBuffer9803.b(is, i_9_ * i_5_,
							i_9_ * i_8_, i_5_);
			} else
				((Direct3dToolkit) this).aPixelBuffer9803.b(is, 0, 0, i_5_ * i_6_);
	...
	final void method3862(int i, Class130 class130) {
		...
		((Direct3dToolkit) this).anIDirect3DDevice9810.SetVertexDeclaration
	...
	final void method3954(int i, Class310_Sub2 class310_sub2) {
		...
		if (aBooleanArray9786[((Direct3dToolkit) this).anInt8175]
		                      == !((Class310_Sub2) class310_sub2).aBoolean6334) {
			((Direct3dToolkit) this).anIDirect3DDevice9810.SetSamplerState
			(((Direct3dToolkit) this).anInt8175, 1,
					!((Class310_Sub2) class310_sub2).aBoolean6334 ? 3 : 1);
			aBooleanArray9786[((Direct3dToolkit) this).anInt8175]
			                  = ((Class310_Sub2) class310_sub2).aBoolean6334;
		}
		if (i == 13700) {
			if (!aBooleanArray9806[((Direct3dToolkit) this).anInt8175]
			                       == ((Class310_Sub2) class310_sub2).aBoolean6335) {
				((Direct3dToolkit) this).anIDirect3DDevice9810.SetSamplerState
				(((Direct3dToolkit) this).anInt8175, 2,
						!((Class310_Sub2) class310_sub2).aBoolean6335 ? 3 : 1);
				aBooleanArray9806[((Direct3dToolkit) this).anInt8175]
				                  = ((Class310_Sub2) class310_sub2).aBoolean6335;
			}
		}
	}
	...
	final void method3841(byte i) {
		((Direct3dToolkit) this).anIDirect3DDevice9810.a(14, ((((Direct3dToolkit) this)
				.aBoolean8124)
				&& (((Direct3dToolkit) this)
						.aBoolean8118)));
		if (i != -116)
	...
	final void method3827(byte i) {
		if (i > -30)
			aClass53_9787 = null;
		((Direct3dToolkit) this).anIDirect3DDevice9810.a
		(28,
				(((Direct3dToolkit) this).aBoolean8148 && ((Direct3dToolkit) this).aBoolean8123
						&& ((Direct3dToolkit) this).anInt8091 >= 0));
	}

	final void method3901(byte i) {
		if (!((Direct3dToolkit) this).aBoolean8069)
			((Direct3dToolkit) this).aClass101_Sub2_8074.method918(aFloatArray9797,
					0);
		else {
		...
		if (i < -18)
			((Direct3dToolkit) this).anIDirect3DDevice9810
			.SetTransform(256, aFloatArray9797);
	}

	final void method3926(byte i, boolean bool) {
		if (i < 34)
			((Direct3dToolkit) this).aBoolean9798 = false;
		((Direct3dToolkit) this).anIDirect3DDevice9810.a(161, bool);
	}
	...
	final void method3924(boolean bool, boolean bool_12_, int i,
		...
		if (bool_13_)
			i_16_ |= 0x10;
		((Direct3dToolkit) this).anIDirect3DDevice9810.SetTextureStageState
		(((Direct3dToolkit) this).anInt8175, i_15_,
				i_16_ | method3961(class70, 2));
	}

	final void method3892(int i) {
		aD3DLIGHT9789.SetDirection(-((Direct3dToolkit) this).aFloatArray8170[0],
				-((Direct3dToolkit) this).aFloatArray8170[1],
				-((Direct3dToolkit) this).aFloatArray8170[2]);
		aD3DLIGHT9796.SetDirection(-((Direct3dToolkit) this).aFloatArray8102[i],
				-((Direct3dToolkit) this).aFloatArray8102[1],
				-((Direct3dToolkit) this).aFloatArray8102[2]);
		aBoolean9801 = false;
	}
	...
	final void method3910(byte i, int i_18_) {
		if (i != -26)
			((Direct3dToolkit) this).aD3DCAPS9791 = null;
		((Direct3dToolkit) this).anIDirect3DDevice9810
		.SetTextureStageState(((Direct3dToolkit) this).anInt8175, 11, i_18_);
	}

	static final AbstractToolkit createToolkit(Canvas canvas, d var_d, IndexLoader class45,
			Integer integer) {
		Direct3dToolkit class378 = null;
		Direct3dToolkit class378_19_;
		try {
			int i = 0;
			int i_20_ = 1;
			hb var_hb = new hb();
			...
			class378
			= new Direct3dToolkit(i, i_20_, canvas, var_hb, idirect3d,
	...
	final void method3956(byte i, Class310 class310) {
		((Direct3dToolkit) this).anIDirect3DDevice9810.SetTexture
		(((Direct3dToolkit) this).anInt8175, class310.method2314(17723));
		if (i <= -53) {
			if (aClass209Array9795[((Direct3dToolkit) this).anInt8175]
			                       == ((Class310) class310).aClass209_3894) {
				if (aBooleanArray9804[((Direct3dToolkit) this).anInt8175]
				                      == !((Class310) class310).aBoolean3892) {
					((Direct3dToolkit) this).anIDirect3DDevice9810.SetSamplerState
					(((Direct3dToolkit) this).anInt8175, 7,
							(((Class310) class310).aBoolean3892
									? method3952(((Class310) class310).aClass209_3894,
											(byte) 86)
											: 0));
					aBooleanArray9804[((Direct3dToolkit) this).anInt8175]
					                  = ((Class310) class310).aBoolean3892;
				}
			} else {
				int i_22_ = method3952(((Class310) class310).aClass209_3894,
						(byte) 82);
				((Direct3dToolkit) this).anIDirect3DDevice9810
				.SetSamplerState(((Direct3dToolkit) this).anInt8175, 6, i_22_);
				((Direct3dToolkit) this).anIDirect3DDevice9810
				.SetSamplerState(((Direct3dToolkit) this).anInt8175, 5, i_22_);
				aClass209Array9795[((Direct3dToolkit) this).anInt8175]
				                   = ((Class310) class310).aClass209_3894;
				if (aBooleanArray9804[((Direct3dToolkit) this).anInt8175]
				                      != ((Class310) class310).aBoolean3892) {
					((Direct3dToolkit) this).anIDirect3DDevice9810.SetSamplerState
			...
			if (!aBooleanArray9784[((Direct3dToolkit) this).anInt8175]) {
				aBooleanArray9784[((Direct3dToolkit) this).anInt8175] = true;
				method3935(-123);
				method3920(10);
			}
		}
	...
	final void method3813(boolean bool) {
		((Direct3dToolkit) this).anIDirect3DDevice9810
		.SetTransform(3, ((Direct3dToolkit) this).aFloatArray8135);
		if (bool != true)
			method3963(-7, null);
	}
	...
	final void method3938(Class21 class21, int i,
		...
		((Direct3dToolkit) this).anIDirect3DDevice9810.SetIndices
		(((Class142) (Class142) interface5_impl2)
				.anIDirect3DIndexBuffer8517);
		((Direct3dToolkit) this).anIDirect3DDevice9810.DrawIndexedPrimitive
	...
	final void method3888(int i) {
		if (i != 6259)
			method3882((byte) -77);
		((Direct3dToolkit) this).anIDirect3DDevice9810.SetScissorRect
		(((Direct3dToolkit) this).anInt8181 - -((Direct3dToolkit) this).anInt8106,
				((Direct3dToolkit) this).anInt8109 - -((Direct3dToolkit) this).anInt8165,
				((Direct3dToolkit) this).anInt8183, ((Direct3dToolkit) this).anInt8096);
	}
	...
	final void method3842(boolean bool) {
		float f = (!((Direct3dToolkit) this).aBoolean8110 ? 0.0F
				: ((Direct3dToolkit) this).aFloat8174);
		float f_30_ = (!((Direct3dToolkit) this).aBoolean8110 ? 0.0F
				: -((Direct3dToolkit) this).aFloat8186);
		aD3DLIGHT9789.SetDiffuse(f * ((Direct3dToolkit) this).aFloat8180,
				((Direct3dToolkit) this).aFloat8087 * f,
				f * ((Direct3dToolkit) this).aFloat8168, 0.0F);
		if (bool == true) {
			aD3DLIGHT9796.SetDiffuse(((Direct3dToolkit) this).aFloat8180 * f_30_,
					((Direct3dToolkit) this).aFloat8087 * f_30_,
					((Direct3dToolkit) this).aFloat8168 * f_30_,
					0.0F);
			aBoolean9801 = false;
		}
	}
	...
	static final int method3958(int i, Class68 class68, Class304 class304) {
		if (class68 == Class68.aClass68_1183) {
			if (MouseEventNode.aClass304_7103 != class304) {
	...
	final void method3633() {
		...
		= ((Direct3dToolkit) this).anIDirect3DDevice9810.b();
	...
	final void method3945(int i) {
		((Direct3dToolkit) this).anIDirect3DDevice9810
		.SetRenderState(60, ((Direct3dToolkit) this).anInt8119);
		if (i > -107)
			((Direct3dToolkit) this).aBoolean9802 = false;
	}
	...
	final void method3823(byte i) {
		...
		int i_35_;
		for (i_35_ = 0;
		(i_35_ ^ 0xffffffff) > (((Direct3dToolkit) this).anInt8151 ^ 0xffffffff);
		i_35_++) {
			Class348_Sub1 class348_sub1
			= ((Direct3dToolkit) this).aClass348_Sub1Array8132[i_35_];
			int i_36_ = i_35_ - -2;
			...
			((Direct3dToolkit) this).anIDirect3DDevice9810.SetLight(i_36_,
					aD3DLIGHT9808);
			((Direct3dToolkit) this).anIDirect3DDevice9810.LightEnable(i_36_, true);
		}
		for (/**/;
		(((Direct3dToolkit) this).anInt8122 ^ 0xffffffff) < (i_35_ ^ 0xffffffff);
		i_35_++)
			((Direct3dToolkit) this).anIDirect3DDevice9810.LightEnable(i_35_ - -2,
					false);
	...
	final void method3819(byte i) {
		if (aBooleanArray9784[((Direct3dToolkit) this).anInt8175]) {
			aBooleanArray9784[((Direct3dToolkit) this).anInt8175] = false;
			((Direct3dToolkit) this).anIDirect3DDevice9810
			.SetTexture(((Direct3dToolkit) this).anInt8175, null);
			method3935(-110);
			method3920(10);
		}
		if (i >= -19)
	...
	private Direct3dToolkit(int i, int i_38_, Canvas canvas, hb var_hb,
		...
		try {
			((Direct3dToolkit) this).aHb9788 = var_hb;
			aD3DPRESENT_PARAMETERS9800 = d3dpresent_parameters;
			anInt9807 = i_38_;
			anIDirect3D9793 = idirect3d;
			anInt9799 = i;
			aClass53_9787 = class53;
			((Direct3dToolkit) this).anIDirect3DDevice9810 = idirect3ddevice;
			((Direct3dToolkit) this).aD3DCAPS9791 = d3dcaps;
			aD3DLIGHT9789 = new D3DLIGHT(((Direct3dToolkit) this).aHb9788);
			aD3DLIGHT9796 = new D3DLIGHT(((Direct3dToolkit) this).aHb9788);
			aD3DLIGHT9808 = new D3DLIGHT(((Direct3dToolkit) this).aHb9788);
			((Direct3dToolkit) this).aPixelBuffer9803
			= new PixelBuffer(((Direct3dToolkit) this).aHb9788);
			((Direct3dToolkit) this).aGeometryBuffer9811
			= new GeometryBuffer(((Direct3dToolkit) this).aHb9788);
			new GeometryBuffer(((Direct3dToolkit) this).aHb9788);
			((Direct3dToolkit) this).aBoolean8101
			= (0x800 & ((Direct3dToolkit) this).aD3DCAPS9791.TextureCaps
					^ 0xffffffff) != -1;
			((Direct3dToolkit) this).aBoolean9798
			= (0x4000 & ((Direct3dToolkit) this).aD3DCAPS9791.TextureCaps) != 0;
			((Direct3dToolkit) this).aBoolean9792
			= -1 == (0x2 & ((Direct3dToolkit) this).aD3DCAPS9791.TextureCaps
					^ 0xffffffff);
			((Direct3dToolkit) this).aBoolean9802
			= (((Direct3dToolkit) this).aD3DCAPS9791.TextureCaps & 0x10000
					^ 0xffffffff) != -1;
			((Direct3dToolkit) this).anInt8138
			= (((Direct3dToolkit) this).aD3DCAPS9791.MaxActiveLights <= 0 ? 8
					: ((Direct3dToolkit) this).aD3DCAPS9791.MaxActiveLights);
			((Direct3dToolkit) this).aBoolean8159
			= (((Direct3dToolkit) this).aD3DCAPS9791.TextureCaps & 0x2000) != 0;
			((Direct3dToolkit) this).anInt8090
			= ((Direct3dToolkit) this).aD3DCAPS9791.MaxSimultaneousTextures;
			((Direct3dToolkit) this).aBoolean8182
			= ((((Direct3dToolkit) this).anInt8117 ^ 0xffffffff) < -1
					|| ((anIDirect3D9793.CheckDeviceMultiSampleType
							(anInt9799, anInt9807,
									aD3DPRESENT_PARAMETERS9800.BackBufferFormat, true, 2))
									== 0));
			aBooleanArray9806 = new boolean[((Direct3dToolkit) this).anInt8090];
			aBooleanArray9804 = new boolean[((Direct3dToolkit) this).anInt8090];
			aBooleanArray9784 = new boolean[((Direct3dToolkit) this).anInt8090];
			aClass209Array9795 = new Class209[((Direct3dToolkit) this).anInt8090];
			anIntArray9805 = new int[((Direct3dToolkit) this).anInt8090];
			aBooleanArray9786 = new boolean[((Direct3dToolkit) this).anInt8090];
			((Direct3dToolkit) this).anIDirect3DDevice9810.BeginScene();
	...
	final void method3898(int i) {
		...
		if (((Direct3dToolkit) this).aClass196_8184.method1450(-32))
			((Direct3dToolkit) this).aClass101_Sub2_8083.method918(aFloatArray9797,
					0);
		else {
			aFloatArray9797[1] = 0.0F;
			aFloatArray9797[7] = 0.0F;
		...
		((Direct3dToolkit) this).anIDirect3DDevice9810.SetTransform(2,
				aFloatArray9797);
	}

	final void method3652() {
		((Direct3dToolkit) this).aHb9788.a((byte) 13);
		super.method3652();
	}
	...
	final void drawScreenOverlay(int i) {
		((Direct3dToolkit) this).anIDirect3DDevice9810.Clear(1, i, 0.0F, 0);
	}
	...
	final void method3851(int i) {
		((Direct3dToolkit) this).aFloat8115
		= (float) (((Direct3dToolkit) this).anInt8154
				+ -((Direct3dToolkit) this).anInt8105);
		((Direct3dToolkit) this).aFloat8173 = ((float) -((Direct3dToolkit) this).anInt8091
				+ ((Direct3dToolkit) this).aFloat8115);
		if (((Direct3dToolkit) this).aFloat8173 < (float) ((Direct3dToolkit) this).anInt8095)
			((Direct3dToolkit) this).aFloat8173 = (float) ((Direct3dToolkit) this).anInt8095;
		((Direct3dToolkit) this).anIDirect3DDevice9810
		.a(36, ((Direct3dToolkit) this).aFloat8173);
		if (i != 25644)
			aD3DLIGHT9796 = null;
		((Direct3dToolkit) this).anIDirect3DDevice9810
		.a(37, ((Direct3dToolkit) this).aFloat8115);
		((Direct3dToolkit) this).anIDirect3DDevice9810
		.SetRenderState(34, ((Direct3dToolkit) this).anInt8144);
	}
	...
	final void method3884(byte i) {
		if (!aBoolean9801) {
			((Direct3dToolkit) this).anIDirect3DDevice9810.LightEnable(0, false);
			((Direct3dToolkit) this).anIDirect3DDevice9810.LightEnable(1, false);
			((Direct3dToolkit) this).anIDirect3DDevice9810.SetLight(0, aD3DLIGHT9789);
			((Direct3dToolkit) this).anIDirect3DDevice9810.SetLight(1, aD3DLIGHT9796);
			((Direct3dToolkit) this).anIDirect3DDevice9810.LightEnable(0, true);
			((Direct3dToolkit) this).anIDirect3DDevice9810.LightEnable(1, true);
			aBoolean9801 = true;
		}
		if (i != 101)
			anIntArray9805 = null;
	...
	final void method3937(byte i) {
		if (i != -33)
			method3962(-41, null);
		((Direct3dToolkit) this).anIDirect3DDevice9810.SetViewport
		(((Direct3dToolkit) this).anInt8181, ((Direct3dToolkit) this).anInt8109,
				((Direct3dToolkit) this).anInt7931, ((Direct3dToolkit) this).anInt7962, 0.0F,
				1.0F);
	}
	...
	final void method3959(int i, Class310_Sub3 class310_sub3) {
		...
		if (!aBooleanArray9786[((Direct3dToolkit) this).anInt8175]) {
			((Direct3dToolkit) this).anIDirect3DDevice9810
			.SetSamplerState(((Direct3dToolkit) this).anInt8175, 1, 1);
			aBooleanArray9786[((Direct3dToolkit) this).anInt8175] = true;
		}
		if (!aBooleanArray9806[((Direct3dToolkit) this).anInt8175]) {
			((Direct3dToolkit) this).anIDirect3DDevice9810
			.SetSamplerState(((Direct3dToolkit) this).anInt8175, 2, 1);
			aBooleanArray9806[((Direct3dToolkit) this).anInt8175] = true;
		}
	...
	final void method3947(int i) {
		if (i == 4)
			((Direct3dToolkit) this).anIDirect3DDevice9810
			.a(27, ((Direct3dToolkit) this).aBoolean8116);
	}

	final void method3859(int i) {
		((Direct3dToolkit) this).anIDirect3DDevice9810
		.a(7, ((Direct3dToolkit) this).aBoolean8164);
		if (i != 3)
			method3882((byte) 51);
	}
	...
	final synchronized void method3646(int i) {
		((Direct3dToolkit) this).aHb9788.b((byte) -82);
		super.method3646(i);
	}
	...
	private final boolean method3960(boolean bool) {
		int i = ((Direct3dToolkit) this).anIDirect3DDevice9810.TestCooperativeLevel();
		if (bool)
			method3880(null, null, (byte) -68);
		if (i == 0 || -2005530519 == i) {
			Class53 class53 = (Class53) ((Direct3dToolkit) this).anObject7919;
			method3922(false);
			...
			if (method3964(aD3DPRESENT_PARAMETERS9800, 0, anInt9799,
					...
					((Direct3dToolkit) this).anInt8117)) {
				int i_53_ = ((Direct3dToolkit) this).anIDirect3DDevice9810
				.Reset(aD3DPRESENT_PARAMETERS9800);
				if (ue.a(i_53_, false)) {
					class53.method497(((Direct3dToolkit) this)
	...
	final void method3920(int i) {
		int i_54_ = (aBooleanArray9784[((Direct3dToolkit) this).anInt8175]
		                               ? method3955(24, (((Direct3dToolkit) this).aClass229Array8086
		                            		   [((Direct3dToolkit) this).anInt8175]))
		                            		   : 1);
		if (i != 10)
			getAmountPolygons();
		((Direct3dToolkit) this).anIDirect3DDevice9810
		.SetTextureStageState(((Direct3dToolkit) this).anInt8175, 1, i_54_);
	}
	...
	final void method3939(byte i) {
		((Direct3dToolkit) this).anIDirect3DDevice9810
		.a(15, ((Direct3dToolkit) this).aBoolean8141);
		if (i != 100)
			anIntArray9805 = null;
	}
	...
	final void method3921(int i) {
		((Direct3dToolkit) this).anIDirect3DDevice9810
		.a(174, ((Direct3dToolkit) this).aBoolean8209);
		if (i != 1)
			method3858(true);
	}
				...
				do {
					if (-4 != (i_65_ ^ 0xffffffff)) {
						...
						return new Class367_Sub5(this,
								((Direct3dToolkit) this).aClass45_8039);
					return new Class367_Sub6(this, ((Direct3dToolkit) this).aClass45_8039,
							((Direct3dToolkit) this).aClass269_7937);
				} while (false);
				return new Class367_Sub7(this, ((Direct3dToolkit) this).aClass45_8039,
						((Direct3dToolkit) this).aClass269_7937);
			} while (false);
	...
	final void method3871(Class113 class113, int i) {
		...
		if (Class31.aClass113_430 == class113)
			...
			i_68_ = 196608;
		((Direct3dToolkit) this).anIDirect3DDevice9810.SetTextureStageState
		(((Direct3dToolkit) this).anInt8175, 11,
				((Direct3dToolkit) this).anInt8175 | i_68_);
	}
	...
	final void method3882(byte i) {
		for (int i_70_ = 0; i_70_ < ((Direct3dToolkit) this).anInt8090; i_70_++) {
			((Direct3dToolkit) this).anIDirect3DDevice9810.SetSamplerState(i_70_, 7,
					0);
			((Direct3dToolkit) this).anIDirect3DDevice9810.SetSamplerState(i_70_, 6,
					2);
			((Direct3dToolkit) this).anIDirect3DDevice9810.SetSamplerState(i_70_, 5,
					2);
			((Direct3dToolkit) this).anIDirect3DDevice9810.SetSamplerState(i_70_, 1,
					1);
			((Direct3dToolkit) this).anIDirect3DDevice9810.SetSamplerState(i_70_, 2,
					1);
		...
		((Direct3dToolkit) this).anIDirect3DDevice9810.SetTextureStageState(0, 6, 1);
		((Direct3dToolkit) this).anIDirect3DDevice9810.SetRenderState(9, 2);
		((Direct3dToolkit) this).anIDirect3DDevice9810.SetRenderState(23, 4);
		((Direct3dToolkit) this).anIDirect3DDevice9810.SetRenderState(25, 5);
		if (i <= 45)
			method3861(109, (byte) -95, -59, null, null);
		((Direct3dToolkit) this).anIDirect3DDevice9810.SetRenderState(24, 0);
		((Direct3dToolkit) this).anIDirect3DDevice9810.SetRenderState(22, 2);
		((Direct3dToolkit) this).anIDirect3DDevice9810.SetRenderState(147, 1);
		((Direct3dToolkit) this).anIDirect3DDevice9810.SetRenderState(145, 1);
		((Direct3dToolkit) this).anIDirect3DDevice9810.a(38, 0.95F);
		((Direct3dToolkit) this).anIDirect3DDevice9810.SetRenderState(140, 3);
	...
	final void method3935(int i) {
		if (i <= -99) {
			int i_71_ = (aBooleanArray9784[((Direct3dToolkit) this).anInt8175]
			                               ? method3955(50, (((Direct3dToolkit) this).aClass229Array8092
			                            		   [((Direct3dToolkit) this).anInt8175]))
			                            		   : 1);
			((Direct3dToolkit) this).anIDirect3DDevice9810
			.SetTextureStageState(((Direct3dToolkit) this).anInt8175, 4, i_71_);
		}
	}

	final void method3940(int i) {
		if (anIDirect3DVertexShader9794 == null
				&& ((((Direct3dToolkit) this).aClass251Array8113
						[((Direct3dToolkit) this).anInt8175])
						!= Class348_Sub42_Sub18.aClass251_9685)) {
			if (Class239_Sub18.aClass251_6030
					== (((Direct3dToolkit) this).aClass251Array8113
							[((Direct3dToolkit) this).anInt8175]))
				((Direct3dToolkit) this).anIDirect3DDevice9810.SetTransform
				(((Direct3dToolkit) this).anInt8175 + 16,
						((Direct3dToolkit) this).aClass101_Sub2Array8131
						[((Direct3dToolkit) this).anInt8175]
						 .method928(aFloatArray9797, i ^ 0x0));
			else
				((Direct3dToolkit) this).anIDirect3DDevice9810.SetTransform
				(16 - -((Direct3dToolkit) this).anInt8175,
						((Direct3dToolkit) this).aClass101_Sub2Array8131
						[((Direct3dToolkit) this).anInt8175]
						 .method918(aFloatArray9797, i ^ 0x1));
			int i_72_ = method3963(594, (((Direct3dToolkit) this).aClass251Array8113
					[((Direct3dToolkit) this).anInt8175]));
			if ((i_72_ ^ 0xffffffff)
					!= (anIntArray9805[((Direct3dToolkit) this).anInt8175]
					                   ^ 0xffffffff)) {
				((Direct3dToolkit) this).anIDirect3DDevice9810.SetTextureStageState
				(((Direct3dToolkit) this).anInt8175, 24, i_72_);
				anIntArray9805[((Direct3dToolkit) this).anInt8175] = i_72_;
			}
		} else {
			((Direct3dToolkit) this).anIDirect3DDevice9810
			.SetTextureStageState(((Direct3dToolkit) this).anInt8175, 24, 0);
			anIntArray9805[((Direct3dToolkit) this).anInt8175] = 0;
		}
		if (i != 1)
			aBoolean9801 = true;
	}
	...
	final void method3844(int i, Canvas canvas, Object object) {
		if (canvas == ((Direct3dToolkit) this).aCanvas7925) {
			Dimension dimension = canvas.getSize();
			if (-1 > (dimension.width ^ 0xffffffff) && 0 < dimension.height) {
				((Direct3dToolkit) this).anIDirect3DDevice9810.EndScene();
				method3960(false);
				((Direct3dToolkit) this).anIDirect3DDevice9810.BeginScene();
			}
		}
	...
	final void method3883(int i) {
		...
		((Direct3dToolkit) this).anIDirect3DDevice9810.a(137, ((((Direct3dToolkit) this)
				.aBoolean8145)
				&& !(((Direct3dToolkit) this)
						.aBoolean8149)));
	}
	...
	final void method3950(int i) {
		if (i != 0)
			anIntArray9809 = null;
		if (Class348_Sub4.aClass173_6602 != ((Direct3dToolkit) this).aClass173_8163) {
			if (((Direct3dToolkit) this).aClass173_8163 == ElementLoaderNode.aClass173_1201) {
				((Direct3dToolkit) this).anIDirect3DDevice9810.SetRenderState(19, 2);
				((Direct3dToolkit) this).anIDirect3DDevice9810.SetRenderState(20, 2);
			} else if (Class273.aClass173_5169
					== ((Direct3dToolkit) this).aClass173_8163) {
				((Direct3dToolkit) this).anIDirect3DDevice9810.SetRenderState(19, 9);
				((Direct3dToolkit) this).anIDirect3DDevice9810.SetRenderState(20, 2);
			}
		} else {
			((Direct3dToolkit) this).anIDirect3DDevice9810.SetRenderState(19, 5);
			((Direct3dToolkit) this).anIDirect3DDevice9810.SetRenderState(20, 6);
		}
	}
	...
	final void method3925(int i, Interface5_Impl1 interface5_impl1,
		...
		((Direct3dToolkit) this).anIDirect3DDevice9810.SetStreamSource
	...
	final void ya() {
		method3946(-32, true);
		((Direct3dToolkit) this).anIDirect3DDevice9810.Clear(2, 0, 1.0F, 0);
	}
}
