...
final class Class258_Sub2 extends Class258
{
    ...
    static String[] globalScriptStrVars;
	...
	if (i_3_ != -1)
	    globalScriptStrVars = null;
	anInt8536 = i;
	anInt8535 = i_1_;
    }
    
    Class258_Sub2(DirectxToolkit var_ha_Sub2, int i, int i_4_) {
    ...
    Class258_Sub2(DirectxToolkit var_ha_Sub2, int i, int i_6_, boolean bool,
		  byte[][] is, int i_7_) {
    ...
    Class258_Sub2(DirectxToolkit var_ha_Sub2, int i, int i_9_, boolean bool,
		  int[][] is) {
