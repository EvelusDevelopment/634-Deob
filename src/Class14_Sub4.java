...
final class Class14_Sub4 extends Class14 implements Interface18_Impl3
{
    ...
    static GameMode aClass230_8638 = new GameMode("stellardawn", 1);
    ...
    Class14_Sub4(OpenGlToolkit class377, int i, int i_3_, int[] is, int i_4_,
		 int i_5_) {
    ...
    Class14_Sub4(OpenGlToolkit class377, Class304 class304, int i, int i_6_,
    ...
    Class14_Sub4(OpenGlToolkit class377, Class304 class304, Class68 class68, int i,
		 int i_10_) {
	...
	Class135_Sub2.method1156(i_13_ + 621, i_12_ + i_15_,
				 AnimationDefinition.anIntArrayArray255[i], i_12_ + -i_15_,
				 i_14_);
	while ((i_17_ ^ 0xffffffff) < (i_16_ ^ 0xffffffff)) {
		...
		int[] is = AnimationDefinition.anIntArrayArray255[i - -i_17_];
		int[] is_20_ = AnimationDefinition.anIntArrayArray255[i + -i_17_];
	    ...
	    int[] is = AnimationDefinition.anIntArrayArray255[i_16_ + i];
	    int[] is_25_ = AnimationDefinition.anIntArrayArray255[-i_16_ + i];
    ...
    Class14_Sub4(OpenGlToolkit class377, Class304 class304, int i, int i_33_,
