    ...
    implements Interface10
{
    ...
    static IncomingPacket aClass114_10149 = new IncomingPacket(23, 6);
    ...
    static IncomingPacket aClass114_10168;
    ...
    Class318_Sub1_Sub5_Sub2(AbstractToolkit var_ha, ObjectDefinition class51, int i, int i_5_,
	...
	try {
		...
		= new Class235(var_ha, class51, i_11_, i_12_,
			       ...
			       bool, i_13_);
	    aBoolean10153 = ((ObjectDefinition) class51).anInt874 != 0 && !bool;
    ...
    final boolean method2391(AbstractToolkit var_ha, int i, int i_14_, int i_15_) {
	anInt10152++;
	AnimatableToolkit class64 = ((Class318_Sub1_Sub5_Sub2) this).aClass235_10155
    ...
    static final Class337 method2493(DirectxToolkit var_ha_Sub2, int i,
				     Class242[] class242s) {
	try {
	    anInt10167++;
	    for (int i_16_ = 0;
    ...
    static {
	aClass114_10168 = new IncomingPacket(2, 6);
    }
}
