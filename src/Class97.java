...
final class Class97
{
    ...
    private NativeToolkit aHa_Sub3_1561;
    ...
    static final void method873(int i, int i_6_, AbstractToolkit var_ha, int i_7_) {
	Cache.aHa1098 = var_ha;
	Deque.aClass190ArrayArray3335 = new Class190[i][i_7_];
	if (i_6_ == 21719) {
	    anInt1549++;
	    if (Class81.anIntArray1432 != null)
		Class348_Sub42_Sub10.aClass299_9571
		    = GameMode.method1636(Class81.anIntArray1432[4],
	    ...
	    GameText.aClass190_3547 = new Class190();
    ...
    Class97(NativeToolkit var_ha_Sub3, Class330 class330, s_Sub3 var_s_Sub3, int i,
