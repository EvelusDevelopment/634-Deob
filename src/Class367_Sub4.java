...
final class Class367_Sub4 extends Class367
{
    ...
    static OutgoingPacket aClass351_7318 = new OutgoingPacket(21, 2);
    static int anInt7319 = 104;
    static boolean aBoolean7320 = false;
    static int anInt7321;
    static int anInt7322;
    static IncomingPacket aClass114_7323 = new IncomingPacket(105, -2);
    static IncomingPacket aClass114_7324 = new IncomingPacket(96, 8);
    static Queue aClass107_7325 = new Queue();
    
    Class367_Sub4(NativeToolkit var_ha_Sub3) {
	super(var_ha_Sub3);
	if (((NativeToolkit) var_ha_Sub3).aBoolean8101) {
	    aBoolean7311
		= (((NativeToolkit) var_ha_Sub3).anInt8090 ^ 0xffffffff) > -4;
	...
	if (anInterface18_Impl2Array7315 != null && bool) {
		...
		((Class367) this).aHa_Sub3_4479.method3850
		    ((byte) -61, (((NativeToolkit) ((Class367) this).aHa_Sub3_4479)
				  .anInterface18_8147));
	    }
	...
	while ((i_18_ ^ 0xffffffff) != (i_17_ ^ 0xffffffff)) {
	    ...
	    int i_22_ = 0xffff & ToolkitException.anIntArray110[i_18_];
	    int i_23_ = ((0xff5347 & ToolkitException.anIntArray110[i_18_])
			 >> -782063056);
	    i_18_ = i_18_ + 1 & 0xfff;
		...
		if ((AnimatableToolkit.anIntArray1127[i_15_] ^ 0xffffffff)
		    >= (i_37_ ^ 0xffffffff)) {
		    if ((i_37_ ^ 0xffffffff)
			< (LoadingStage.anIntArray1045[i_15_] ^ 0xffffffff))
			LoadingStage.anIntArray1045[i_15_] = i_37_;
		} else
		    AnimatableToolkit.anIntArray1127[i_15_] = i_37_;
	    }
	    if (!bool_24_) {
		if (i_19_ >= 1
	...
	if (Class327.anIntArray4097[i_15_] != -1000000) {
	    ...
	    LoadingStage.anIntArray1045[i_15_] += 512;
	    AnimatableToolkit.anIntArray1127[i_15_] -= 512;
	}
	return true;
    }
	...
	anInt7309++;
	if (i == -89) {
	    OutgoingPacket.consoleActive = false;
	    Class354.method3466(i + 6);
	}
    }
    
    static final int method3544(ByteBuffer class348_sub49, int i,
				String string) {
	try {
	    anInt7321++;
	    int i_38_ = ((ByteBuffer) class348_sub49).position;
		...
		+= (AnimatableToolkit.huffman.method2227
		    (is.length, 0, ((ByteBuffer) class348_sub49).position,
		     is, 103,
		     ((ByteBuffer) class348_sub49).payload));
	    return ((ByteBuffer) class348_sub49).position + -i_38_;
