...
final class Class367_Sub7 extends Class367
{
    ...
    private Direct3dToolkit aClass378_7346;
	...
	if (aBoolean7344) {
		...
		= ((Direct3dToolkit) aClass378_7346).anIDirect3DDevice9810;
	    int i_2_ = 1 << (i_0_ & 0x3);
	    ...
	    idirect3ddevice.a(14,
			      (float) (((NativeToolkit) (((Class367_Sub7) this)
	...
	if (aBoolean7344) {
	    IDirect3DDevice idirect3ddevice
		= ((Direct3dToolkit) aClass378_7346).anIDirect3DDevice9810;
	    if (((NativeToolkit) ((Class367_Sub7) this).aHa_Sub3_4479).anInt8091
		<= 0)
		idirect3ddevice.a(16, 0.0F, 0.0F, 0.0F, 0.0F);
	    else {
		float f = (((NativeToolkit) ((Class367_Sub7) this).aHa_Sub3_4479)
			   .aFloat8115);
		float f_6_ = (((NativeToolkit) ((Class367_Sub7) this).aHa_Sub3_4479)
			      .aFloat8173);
    ...
    Class367_Sub7(Direct3dToolkit class378, IndexLoader class45, Class269 class269) {
	super(class378);
	aClass269_7348 = class269;
	aClass378_7346 = class378;
	if (null == class45
	    || !((NativeToolkit) ((Class367_Sub7) this).aHa_Sub3_4479).aBoolean8101
	    || !((NativeToolkit) ((Class367_Sub7) this).aHa_Sub3_4479).aBoolean8159
	    || ((((Direct3dToolkit) aClass378_7346).aD3DCAPS9791.VertexShaderVersion
		 & 0xffff)
		^ 0xffffffff) > -258) {
	    anIDirect3DVertexShader7345 = null;
	    aBoolean7347 = false;
		...
		= (((Direct3dToolkit) aClass378_7346).anIDirect3DDevice9810.b
		   (class45.getArchiveChild("dx", "environment_mapped_water_v")));
	    anIDirect3DPixelShader7343
		= (((Direct3dToolkit) aClass378_7346).anIDirect3DDevice9810.a
	...
	if (i == 15192) {
		...
		idirect3ddevice.b
		    (1,
		     -(((NativeToolkit) ((Class367_Sub7) this).aHa_Sub3_4479)
		       .aFloatArray8170[0]),
		     -(((NativeToolkit) ((Class367_Sub7) this).aHa_Sub3_4479)
		       .aFloatArray8170[1]),
		     -(((NativeToolkit) ((Class367_Sub7) this).aHa_Sub3_4479)
		     ...
		     0.0F);
		idirect3ddevice.b(2,
				  ((NativeToolkit) (((Class367_Sub7) this)
	...
	if (!bool) {
		...
		Class101_Sub2 class101_sub2_7_
		    = aClass378_7346.method3948(-22036);
		idirect3ddevice
		    .a(0, class101_sub2_7_.method924(11, aFloatArray7342));
		idirect3ddevice.a(4,
				  class101_sub2.method930(0, aFloatArray7342));
	    }
	}
    }
}
