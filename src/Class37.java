...
final class Class37
{
	...
	if (is.length == 100
		...
		Class133.aByteArrayArray1918[Class348_Sub40_Sub21.anInt9280++]
		    = is;
	    else if (is.length == 30000 && AbstractImageFetcher.anInt6913 < 50)
		Class285_Sub2.aByteArrayArray8505[AbstractImageFetcher.anInt6913++]
		    = is;
	...
	if (i_9_ != -1)
	    method359(-88, -45);
	if (i == 30000 && (AbstractImageFetcher.anInt6913 ^ 0xffffffff) < -1) {
	    byte[] is = (Class285_Sub2.aByteArrayArray8505
			 [--AbstractImageFetcher.anInt6913]);
	    Class285_Sub2.aByteArrayArray8505[AbstractImageFetcher.anInt6913] = null;
	    return is;
	}
