...
final class TextureDefinition
{
	...
	if ((i ^ 0xffffffff) > (i_2_ ^ 0xffffffff))
	    Class135_Sub2.method1156(-27, i_2_,
				     AnimationDefinition.anIntArrayArray255[i_1_], i,
				     i_0_);
	else
	    Class135_Sub2.method1156(-27, i, AnimationDefinition.anIntArrayArray255[i_1_],
				     i_2_, i_0_);
	anInt214++;
	if (i_3_ >= 20) {
	    /* empty */
	...
	AnimationDefinition.anIntArrayArray255 = is;
	anInt210++;
	if (i != -40)
