...
abstract class Class239
{
    ...
    static IncomingPacket aClass114_3135 = new IncomingPacket(108, 5);
    ...
    static IncomingPacket aClass114_3143;
    static byte[] aByteArray3144 = new byte[520];
    static IncomingPacket aClass114_3145;
    static IndexLoader indexLoader27;
    ...
    static final void method1711(int i, IndexLoader class45, int i_0_,
				 IndexLoader class45_1_) {
	try {
	    Class135_Sub2.skinIndexLoader = class45_1_;
	    anInt3140++;
	    if (i != 7)
		indexLoader27 = null;
	    Class138.skeleIndexLoader = class45;
	...
	Class239_Sub3.method1728(Class348_Sub42_Sub8_Sub2.windowHeight, -1,
				 r.anInt9721, bool, Class321.windowWidth);
	if (i == 520)
	    anInt3137++;
    }
    ...
    static {
	aClass114_3143 = new IncomingPacket(7, 3);
    }
}
