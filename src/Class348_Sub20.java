...
final class Class348_Sub20 extends Node
{
    ...
    private DirectxToolkit aHa_Sub2_6831;
    float aFloat6832;
    int anInt6833;
	...
	aNativeHeapBuffer6840
	    = ((DirectxToolkit) aHa_Sub2_6831).aNativeHeap7730.a(4 * i_3_, true);
	anInt6834++;
	if (i != 2147483647)
	    aHa_Sub2_6831 = null;
	...
	if ((((Class348_Sub51) BitmapTable.aClass348_Sub51_3959)
	     ...
	     ^ 0xffffffff) != -1
	    && i_5_ != 0 && Message.anInt2021 < 50 && i_4_ != -1)
	...
	FloatBuffer class348_sub49_sub1
	    = ((DirectxToolkit) aHa_Sub2_6831).aClass348_Sub49_Sub1_7798;
	((ByteBuffer) class348_sub49_sub1).position = 0;
	if (((DirectxToolkit) aHa_Sub2_6831).aBoolean7775) {
		...
		if ((i_13_ ^ 0xffffffff) != -1 && is_12_ != null) {
			...
			if ((i_13_ & 1 << i_14_++) == 0)
			    ...
			    class348_sub49_sub1.putShort((is_12_[i_15_++]
							    & 0xffff));
			    i_9_++;
			    class348_sub49_sub1.putShort((is_12_[i_15_++]
							    & 0xffff));
			    i_9_++;
			    i_9_++;
			    class348_sub49_sub1.putShort((0xffff
							    & (is_12_
							       [i_15_++])));
			}
		    }
	...
	if (i_9_ > 0) {
		...
		(((ByteBuffer) class348_sub49_sub1).payload, 5123,
		 64, ((ByteBuffer) class348_sub49_sub1).position);
	    ...
	    aHa_Sub2_6831.method3746(((0x7 & ((s_Sub2) aS_Sub2_6839).anInt8235)
				     ...
				     ((((s_Sub2) aS_Sub2_6839).anInt8235 & 0x8)
				      != 0),
				     112);
	    if (((DirectxToolkit) aHa_Sub2_6831).aBoolean7846)
	...
	if (i == 97) {
		...
		TextureDefinition class12
		    = ((AbstractToolkit) aHa_Sub2_6831).aD4579
			  .getTexture(((Class348_Sub20) this).anInt6841, -6662);
		int i_25_ = 0xff & ((TextureDefinition) class12).aByte201;
		if ((i_25_ ^ 0xffffffff) != -1
		    && (((TextureDefinition) class12).aByte213 ^ 0xffffffff) != -5) {
		    int i_26_;
		...
		int i_29_ = 0xff & ((TextureDefinition) class12).aByte216;
