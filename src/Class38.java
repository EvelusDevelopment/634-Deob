...
final class Class38
{
    ...
    private final void method361(int i, ByteBuffer class348_sub49,
				 int i_2_) {
	if (i != -6617)
	    method363(95);
	anInt497++;
	if (i_2_ == 1)
	    ((Class38) this).anInt501 = class348_sub49.getShort();
	else if (i_2_ == 2)
	    ...
	    ((Class38) this).anInt498 = class348_sub49.getUByte();
	else if ((i_2_ ^ 0xffffffff) == -6)
	    ((Class38) this).anInt504 = class348_sub49.getShort();
	else if ((i_2_ ^ 0xffffffff) == -7)
	    ((Class38) this).anInt503 = class348_sub49.getTri();
    }
	...
	if (Class168.consoleAlpha < 102)
	    Class168.consoleAlpha += 6;
	anInt512++;
	if ((Class121.anInt1794 ^ 0xffffffff) != 0
		...
		if (!Class50_Sub1.aStringArray5223[i_4_].startsWith("pause")) {
		    ...
		    GameApplet.addConsoleMessage("Pausing for " + i_5_ + " seconds...");
		    Class121.anInt1794 = 1 + i_4_;
		    Class299_Sub1_Sub1.aLong8694 = (long) (1000 * i_5_) + Class62.getCurrentTimeMillis();
		    return;
		}
	    }
	...
	if (i >= 124) {
		...
		if ((i_7_ ^ 0xffffffff) != -81) {
			...
			if (Class348_Sub40_Sub27.systemClipboard != null) {
				...
				if ((Class286_Sub1.consoleMessages[i_9_]
				     != null)
				    && Class286_Sub1.consoleMessages[i_9_]
					   .length() > 0)
				    string += (Class286_Sub1.consoleMessages
					       [i_9_]) + '\n';
			    }
			    Class348_Sub40_Sub27.systemClipboard.setContents
		    ...
		    } else if (Class348_Sub40_Sub27.systemClipboard != null) {
    ...
    final void method364(ByteBuffer class348_sub49, byte i) {
	anInt511++;
	if (i >= 22) {
	    for (;;) {
		int i_10_ = class348_sub49.getUByte();
