...
{
    static AbstractToolkit currentToolkit;
	...
	if (class318_sub1_sub3_sub3 instanceof Player) {
		...
		= (Player) class318_sub1_sub3_sub3;
    ...
    static final LocationMode getConnectionWhere(byte i, int i_5_) {
	anInt6659++;
	if (i > -35)
	    aBooleanArrayArray6656 = null;
	LocationMode[] class364s = Class348_Sub40_Sub28.method3122((byte) 91);
	for (int i_6_ = 0;
	     (i_6_ ^ 0xffffffff) > (class364s.length ^ 0xffffffff); i_6_++) {
	    LocationMode class364 = class364s[i_6_];
	    if (((LocationMode) class364).anInt4466 == i_5_)
		return class364;
	}
	return null;
    }
