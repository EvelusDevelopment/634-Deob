...
final class Class322
{
	...
	if (class348_sub13 == null)
	    return -1;
	if ((i_0_ ^ 0xffffffff) > -1 || (((Class348_Sub13) class348_sub13).anIntArray6757.length ^ 0xffffffff) >= (i_0_ ^ 0xffffffff))
	    return -1;
	...
	if ((((Class318_Sub1_Sub3_Sub3) class318_sub1_sub3_sub3).anInt10239
	    ...
	    Class239_Sub26.method1834(class318_sub1_sub3_sub3, (byte) -16);
		  ...
		  ^ 0xffffffff)
		 <= (Class367_Sub11.logicCycle ^ 0xffffffff))
	    LobbyWorld.method1041(-1, class318_sub1_sub3_sub3);
	else {
	...
	Class348_Sub42_Sub9_Sub1.method3208(class318_sub1_sub3_sub3, i_3_,
					    -98);
	GameMode.method1635(-69, class318_sub1_sub3_sub3);
    }
	...
	if (anInt4020 != anInt4024) {
		...
		if ((anInt4025 ^ 0xffffffff) <= (anInt4020 ^ 0xffffffff)) {
			...
			= (Class348_Sub24) aClass262_4021.getLast(-126);
		    class348_sub24
	    ...
	    aClass262_4021.addToBack(class348_sub24, -110);
	    return (anIntArrayArrayArray4029
	...
	anIntArrayArrayArray4029 = null;
	aClass262_4021.removeAll(99);
	aClass262_4021 = null;
    }
    
    Class322(int i, int i_9_, int i_10_) {
	anInt4022 = -1;
	aClass262_4021 = new Deque();
	((Class322) this).aBoolean4035 = false;
	anInt4020 = i;
	anInt4024 = i_9_;
    ...
    static {
	aClass114_4027 = new IncomingPacket(90, 10);
