...
{
    private Direct3dToolkit aClass378_8515;
	...
	if (anInt8521 < anInt8516) {
		...
		= (((Direct3dToolkit) aClass378_8515).anIDirect3DDevice9810.a
		   (anInt8516, i_1_,
	...
	if (!aBoolean8520
	    && ue.a((((Class142) this).anIDirect3DIndexBuffer8517.Lock
		     (0, anInt8521, !bool ? 0 : 8192,
		      ((Direct3dToolkit) aClass378_8515).aGeometryBuffer9811)),
		    false)) {
	    aBoolean8520 = true;
	    return ((Direct3dToolkit) aClass378_8515).aGeometryBuffer9811;
	}
	return null;
    }
    ...
    Class142(Direct3dToolkit class378, Class68 class68, boolean bool) {
