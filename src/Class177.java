...
final class Class177 implements Interface1
{
    ...
    private ColorNode aClass52_4671;
    
    public final void draw(byte i, boolean bool) {
	if (bool)
	    Class348_Sub8.currentToolkit.drawQuad(0, 0, Class321.windowWidth, Class348_Sub42_Sub8_Sub2.windowHeight, ((ColorNode) aClass52_4671).color, 0);
	anInt4668++;
	if (i != -49)
	    anInt4666 = -20;
    }
	...
	if (i_2_ != -98)
	    method1354((byte) 69);
	i_0_ = (i_0_ * ((Class348_Sub51) BitmapTable.aClass348_Sub51_3959)
			   .aClass239_Sub26_7260.method1838(-32350)
		>> -2091864696);
	if (i_0_ != 0 && i != -1) {
	    if (!Class74.aBoolean1236 && (RequiredElement.anInt3428 ^ 0xffffffff) != 0
    ...
    static final Class318_Sub1_Sub3 method1353(int i, int i_4_, int i_5_,
					       Class var_class) {
	Class357 class357
	    = Message.aClass357ArrayArrayArray2029[i][i_4_][i_5_];
	if (class357 == null)
	    return null;
