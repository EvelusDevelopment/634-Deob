...
final class Class367_Sub9 extends Class367
{
    ...
    static IncomingPacket aClass114_7367 = new IncomingPacket(37, 7);
    static int anInt7368;
    private Class89 aClass89_7369;
    static int anInt7370;
    static IndexLoader aClass45_7371;
    ...
    Class367_Sub9(OpenGlToolkit class377, IndexLoader class45, Class269 class269) {
	super(class377);
	try {
	    aClass269_7375 = class269;
	    if (class45 != null && ((OpenGlToolkit) class377).aBoolean9921
		&& ((OpenGlToolkit) class377).aBoolean9922) {
		Class39 class39
		    = (Class328.method2608
		       (class377,
	...
	if (aBoolean7376 && interface18_impl2 != null) {
	    ...
	    OpenGL.glUniform3fARB(OpenGL.glGetUniformLocationARB(l, "sunDir"),
				  -(((NativeToolkit) ((Class367) this).aHa_Sub3_4479)
				    .aFloatArray8170[0]),
				  -(((NativeToolkit) ((Class367) this).aHa_Sub3_4479)
				    .aFloatArray8170[1]),
				  -(((NativeToolkit) ((Class367) this).aHa_Sub3_4479)
		...
		(OpenGL.glGetUniformLocationARB(l, "sunColour"),
		 ((NativeToolkit) ((Class367) this).aHa_Sub3_4479).aFloat8180,
		 ((NativeToolkit) ((Class367) this).aHa_Sub3_4479).aFloat8087,
		 ((NativeToolkit) ((Class367) this).aHa_Sub3_4479).aFloat8168, 1.0F);
	    OpenGL.glUniform1fARB
		(OpenGL.glGetUniformLocationARB(l, "sunExponent"),
		 928.0F * Math.abs(((NativeToolkit) ((Class367) this).aHa_Sub3_4479)
