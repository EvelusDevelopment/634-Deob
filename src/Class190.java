...
final class Class190
{
    ...
    int anInt2538;
    static OutgoingPacket aClass351_2539 = new OutgoingPacket(26, 7);
    int anInt2540;
	...
	Class318_Sub1_Sub5_Sub2.anIntArray10172[0]
	    = (Class140.anInt1962 * Class318_Sub1_Sub5_Sub2.anIntArray10172[0]
	       / i_3_) + ElementLoaderNode.anInt1202;
    ...
    final void method1423(int i, ByteBuffer class348_sub49) {
	anInt2553++;
	((Class190) this).aFloat2545
	    = (float) (class348_sub49.getUByte() * 8) / 255.0F;
	((Class190) this).aFloat2542
	    = (float) (8 * class348_sub49.getUByte()) / 255.0F;
	((Class190) this).aFloat2551
	    = (float) (i * class348_sub49.getUByte()) / 255.0F;
    }
    ...
    static final boolean method1425(byte i, Class42 class42,
				    ...
				    AbstractToolkit var_ha, int i_6_) {
	try {
	    anInt2537++;
	    int i_7_ = 2147483647;
	    int i_8_ = -2147483648;
		...
		class323
		    = Class239_Sub15.method1782(((Class42) class42).anInt576,
						10144);
		if (class323 != null) {
		    i_15_ = (Class258_Sub1.p11fullBitmapFont.method1188
	...
	if ((((Class348_Sub51) BitmapTable.aClass348_Sub51_3959)
		...
		((Class190) this).aFloat2547
		    = (float) class348_sub49.getShort() / 256.0F;
	    else
		((Class190) this).aFloat2547 = 1.1523438F;
	...
	if ((i & 0x40 ^ 0xffffffff) != -1)
	    ((Class190) this).anInt2546 = class348_sub49.getShort();
	else
	    ((Class190) this).anInt2546 = 0;
	if ((0x80 & i) != 0) {
	    int i_27_ = class348_sub49.getShort();
	    int i_28_ = class348_sub49.getShort();
	    int i_29_ = class348_sub49.getShort();
	    int i_30_ = class348_sub49.getShort();
	    int i_31_ = class348_sub49.getShort();
	    int i_32_ = class348_sub49.getShort();
	    ((Class190) this).aClass299_2541
		= GameMode.method1636(i_31_, i_30_, i_27_, i_32_, i_28_, -1,
				      i_29_);
	} else
	    ((Class190) this).aClass299_2541
