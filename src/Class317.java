...
final class Class317
{
	...
	byte[] is = method2371();
	return new Class348_Sub19_Sub1(22050, is, 22050 * anInt3967 / 1000,
				       22050 * anInt3968 / 1000);
    }
    ...
    private Class317(ByteBuffer class348_sub49) {
	...
	anInt3967 = class348_sub49.getShort();
	anInt3968 = class348_sub49.getShort();
    }
	...
	byte[] is = class45.loadArchiveChild(-1860, i, i_11_);
	if (is == null)
	    return null;
