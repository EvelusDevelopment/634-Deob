...
final class Class199
{
    ...
    static GameFont[] aClass352Array2636;
    static int anInt2637;
    
    static final void drawLoadingBar(int i, Color color, String string, Color color_0_, byte i_1_, Color color_2_) {
	try {
	    anInt2627++;
	    try {
		Graphics graphics = Class305.canvas.getGraphics();
		if (OutgoingPacket.aFont4329 == null)
		    OutgoingPacket.aFont4329 = new Font("Helvetica", 1, 13);
		if (color == null)
		...
		try {
			...
			Class342.anImage4249 = (Class305.canvas.createImage(Class321.windowWidth, Class348_Sub42_Sub8_Sub2.windowHeight));
		    Graphics graphics_3_ = Class342.anImage4249.getGraphics();
		    graphics_3_.setColor(Color.black);
		    graphics_3_.fillRect(0, 0, Class321.windowWidth, Class348_Sub42_Sub8_Sub2.windowHeight);
		    int i_4_ = -152 + Class321.windowWidth / 2;
		    int i_5_ = -18 + Class348_Sub42_Sub8_Sub2.windowHeight / 2;
		    ...
		    graphics_3_.fillRect(3 * i + (i_4_ - -2), 2 + i_5_,
					 300 - i * 3, 30);
		    graphics_3_.setFont(OutgoingPacket.aFont4329);
		    graphics_3_.setColor(color_2_);
		    if (i_1_ > -42)
			anIntArray2631 = null;
		    graphics_3_.drawString(string, (i_4_ + (304 - string.length() * 6) / 2), i_5_ + 22);
		    if (FileRequest.overheadCenterLoadingText != null) {
			graphics_3_.setFont(OutgoingPacket.aFont4329);
			graphics_3_.setColor(color_2_);
			graphics_3_.drawString(FileRequest.overheadCenterLoadingText, (Class321.windowWidth / 2
			      - (FileRequest.overheadCenterLoadingText.length() * 6
				 / 2)),
			     -26 + Class348_Sub42_Sub8_Sub2.windowHeight / 2);
		    }
		    graphics.drawImage(Class342.anImage4249, 0, 0, null);
		} catch (Exception exception) {
		    graphics.setColor(Color.black);
		    graphics.fillRect(0, 0, Class321.windowWidth,
				      Class348_Sub42_Sub8_Sub2.windowHeight);
		    int i_6_ = -152 + Class321.windowWidth / 2;
		    int i_7_ = Class348_Sub42_Sub8_Sub2.windowHeight / 2 + -18;
		    ...
		    graphics.fillRect(3 * i + 2 + i_6_, 2 + i_7_,
				      -(i * 3) + 300, 30);
		    graphics.setFont(OutgoingPacket.aFont4329);
		    graphics.setColor(color_2_);
		    if (FileRequest.overheadCenterLoadingText != null) {
			graphics.setFont(OutgoingPacket.aFont4329);
			graphics.setColor(color_2_);
			graphics.drawString
			    (FileRequest.overheadCenterLoadingText,
			     (Class321.windowWidth / 2
			      + -(6 * FileRequest.overheadCenterLoadingText.length()
				  / 2)),
			     Class348_Sub42_Sub8_Sub2.windowHeight / 2 - 26);
		    }
