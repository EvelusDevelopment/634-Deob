...
final class Class175
{
    ...
    private HashTable aClass356_2312;
    static int anInt2313;
    static int anInt2314;
    static OutgoingPacket aClass351_2315;
    private Queue aClass107_2316 = new Queue();
    ...
    static ArchiveFetcher aClass340_2327;
	...
	for (Class348_Sub42_Sub9 class348_sub42_sub9
		 = (Class348_Sub42_Sub9) aClass356_2312.get(l);
		...
		if (object == null) {
			...
			Class348_Sub42_Sub9_Sub1 class348_sub42_sub9_sub1
				...
				(((Class348_Sub42_Sub9) class348_sub42_sub9)
				 .anInt9556)));
			aClass356_2312.putNode((((Node)
						    class348_sub42_sub9)
						   .nodeKey),
						  class348_sub42_sub9_sub1);
			aClass107_2316.add(class348_sub42_sub9_sub1);
			((SubNode) class348_sub42_sub9_sub1).subnodeKey
			    = 0L;
			class348_sub42_sub9.removeNode();
			class348_sub42_sub9.removeSubnode();
		    } else {
			aClass107_2316.add(class348_sub42_sub9);
			((SubNode) class348_sub42_sub9).subnodeKey = 0L;
		    }
		    return object;
		}
	    }
	...
	try {
		...
		while (anInt2311 < 0) {
		    Class348_Sub42_Sub9 class348_sub42_sub9
			= (Class348_Sub42_Sub9) aClass107_2316.removeFirst();
		    method1342(class348_sub42_sub9, (byte) 60);
		}
		Class348_Sub42_Sub9_Sub1 class348_sub42_sub9_sub1
		    = new Class348_Sub42_Sub9_Sub1(interface14, object, i_0_);
		aClass356_2312.putNode(interface14.method52((byte) 120),
					  class348_sub42_sub9_sub1);
		aClass107_2316.add(class348_sub42_sub9_sub1);
		((SubNode) class348_sub42_sub9_sub1).subnodeKey = 0L;
	    }
    ...
    static final void method1343(int i, Widget class46, int i_1_, int i_2_) {
	Class32.anInt451 = i;
	InterfaceScript.aClass46_6990 = class46;
	...
	aClass107_2316.removeAll();
	anInt2325++;
	aClass356_2312.removeAll(0);
	int i_3_ = 18 % ((i - -89) / 35);
	anInt2311 = anInt2324;
    }
	...
	aClass356_2312 = new HashTable(i_22_);
    }
    
    static {
	aClass351_2315 = new OutgoingPacket(18, 3);
    }
}
