...
final class Class332
{
	...
	if (i < i_0_) {
		...
		AnimationDefinition.anIntArrayArray255[i_4_][i_2_] = i_3_;
	} else {
	    for (int i_5_ = i_0_; i > i_5_; i_5_++)
		AnimationDefinition.anIntArrayArray255[i_5_][i_2_] = i_3_;
	}
    }
