...
final class Class122
{
    ...
    static final void method1085(int i, int i_0_, byte i_1_, int i_2_,
				 int i_3_) {
	anInt1805++;
	...
	if (i_1_ < -57) {
	    ((WidgetVariable) class348_sub42_sub15).anInt9650 = i;
	    ((WidgetVariable) class348_sub42_sub15).anInt9651 = i_2_;
	}
    }
	...
	anInt1804++;
	int i_10_
	    = -Class70.cosineTable[8192 * i_8_ / i_7_] + 65536 >> -67609151;
	if (i_6_ != 22)
	    return -73;
	return ((i_10_ * i >> 1589488528)
		+ (i_9_ * (65536 + -i_10_) >> 450835216));
    }
    ...
    static final void method1090(byte[][] is, int i,
	...
	try {
		...
		for (int i_14_ = 0; i_14_ < i_13_; i_14_++) {
			...
			class237_sub1.method1695(is_15_,
						 (MouseEventNode
						  .aClass361Array7108),
						 i_17_, Class348_Sub8.currentToolkit,
						 i_16_, i ^ 0x1054f);
		    }
		}
	    }
