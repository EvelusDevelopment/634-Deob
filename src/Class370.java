...
final class Class370
{
	...
	for (i_19_ = (int) Math.pow((double) i, 1.0 / (double) i_18_) + 1;
	     ByteBuffer.method3331(i_18_, (byte) 64, i_19_) > i; i_19_--) {
	    /* empty */
	}
	return i_19_;
    }
	...
	int i;
	for (i = 0; anIntArray4519[i] >= 0;
	     i = (Class348_Sub10.method2788() != 0 ? anIntArray4519[i]
		  : i + 1)) {
	    /* empty */
	}
	...
	if (bool) {
		...
		int i_21_
		    = Class348_Sub10
			  .method2789(Class299.method2253(anInt4518 - i, 126));
	    ...
	    for (int i = 0; i < anInt4518; i++) {
		if (bool_23_ && Class348_Sub10.method2788() == 0)
		    anIntArray4516[i] = 0;
		else
		    anIntArray4516[i] = Class348_Sub10.method2789(5) + 1;
	    }
	}
	method3579();
	...
	if (i > 0) {
	    ...
	    float f_24_
		= Class348_Sub10.method2786(Class348_Sub10.method2789(32));
