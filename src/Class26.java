...
{
    static int anInt373;
    private HashTable aClass356_374 = new HashTable(256);
    static int anInt375;
    static int anInt376;
    private IndexLoader aClass45_377;
    static int anInt378;
    private IndexLoader aClass45_379;
    static int anInt380;
    private HashTable aClass356_381 = new HashTable(256);
    static LocationMode aClass364_382 = new LocationMode("WTQA", 2);
    static int anInt383;
    ...
    Class26(IndexLoader class45, IndexLoader class45_9_) {
	try {
