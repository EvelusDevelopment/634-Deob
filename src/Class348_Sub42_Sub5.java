...
final class Class348_Sub42_Sub5 extends SubNode
{
    ...
    static OutgoingPacket aClass351_9533;
    static KeyboardEvent[] anInterface6Array9534 = new KeyboardEvent[128];
    
    final int[] method3183(d var_d, int i, int i_0_, boolean bool, double d,
			   IndexLoader class45, byte i_1_) {
	try {
	    anInt9522++;
	    ...
	    int i_3_ = 0;
	    for (int i_4_ = 0; (i_4_ ^ 0xffffffff) > (i_0_ ^ 0xffffffff);
		 i_4_++) {
		int[] is_5_;
		int[] is_6_;
		int[] is_7_;
		if (((Class348_Sub40) aClass348_Sub40_9521).aBoolean7045) {
		    ...
		    int[][] is_9_
			= aClass348_Sub40_9521.method3047(i_4_, -1564599039);
		    is_5_ = is_9_[2];
		    is_6_ = is_9_[1];
		    is_7_ = is_9_[0];
		}
		...
		if (((Class348_Sub40) aClass348_Sub40_9527).aBoolean7045)
		    ...
		    is_10_ = (aClass348_Sub40_9527.method3047
			      (i_4_, -1564599039)[0]);
		for (int i_11_ = i - 1; (i_11_ ^ 0xffffffff) <= -1; i_11_--) {
		    ...
		    is[i_3_++]
			= (i_14_ + (i_15_ << 881050840)
			   + ((i_12_ << 521342256) + (i_13_ << 1696622760)));
		    if (bool)
			i_3_ += -1 + i;
		}
	    }
	    for (int i_16_ = 0; ((aClass348_Sub40Array9520.length ^ 0xffffffff)
    ...
    final boolean method3184(d var_d, IndexLoader class45, int i) {
	try {
	    anInt9529++;
	    if ((Class101_Sub2.anInt5713 ^ 0xffffffff) > -1) {
		for (int i_17_ = 0;
		     ((i_17_ ^ 0xffffffff)
		...
		for (int i_18_ = 0; ((anIntArray9524.length ^ 0xffffffff)
				     < (i_18_ ^ 0xffffffff)); i_18_++) {
		    if (!class45.isLoaded(Class101_Sub2.anInt5713,
					   anIntArray9524[i_18_]))
			return false;
		}
	    }
	    int i_19_ = 0;
	    ...
	    for (/**/;
		 (anIntArray9523.length ^ 0xffffffff) < (i_19_ ^ 0xffffffff);
		 i_19_++) {
		if (!var_d.method4(-7953, anIntArray9523[i_19_]))
		    return false;
	    }
	    return true;
	} catch (RuntimeException runtimeexception) {
    ...
    final int[] method3185(int i, d var_d, int i_21_, boolean bool, double d,
			   boolean bool_22_, IndexLoader class45, int i_23_) {
	try {
	    Class286_Sub5.aD6247 = var_d;
	    Node.aClass45_4286 = class45;
	    anInt9526++;
	    for (int i_24_ = 0; aClass348_Sub40Array9520.length > i_24_;
		 i_24_++)
		...
		if (((Class348_Sub40) aClass348_Sub40_9521).aBoolean7045) {
		    ...
		    int[][] is_34_
			= aClass348_Sub40_9521.method3047(i_29_, -1564599039);
		    is_30_ = is_34_[1];
		    is_31_ = is_34_[0];
		    is_32_ = is_34_[2];
		}
	    ...
	    for (int i_40_ = i_21_;
		 ((i_40_ ^ 0xffffffff)
		  > (aClass348_Sub40Array9520.length ^ 0xffffffff));
		 i_40_++)
    ...
    final float[] method3186(int i, d var_d, boolean bool, int i_41_,
			     IndexLoader class45, int i_42_) {
	try {
	    anInt9525++;
	    Node.aClass45_4286 = class45;
	    Class286_Sub5.aD6247 = var_d;
	    if (i_42_ >= -1)
		method3183(null, -60, 98, false, -0.11623531533038078, null,
			   (byte) -72);
	    for (int i_43_ = 0; aClass348_Sub40Array9520.length > i_43_;
		 i_43_++)
		...
		if (((Class348_Sub40) aClass348_Sub40_9528).aBoolean7045)
		    ...
		    is_51_ = (aClass348_Sub40_9528.method3047
			      (i_45_, -1564599039)[0]);
		if (bool)
		    i_44_ = i_45_ << 1696393858;
		for (int i_52_ = i + -1; (i_52_ ^ 0xffffffff) <= -1; i_52_--) {
		    float f = (float) is_50_[i_52_] / 4096.0F;
		    float f_53_
			= ((31.0F * (float) is_51_[i_52_] / 4096.0F + 1.0F)
			   / 4096.0F);
		    if (!(f < 0.0F)) {
			if (f > 1.0F)
			    f = 1.0F;
    ...
    Class348_Sub42_Sub5(ByteBuffer class348_sub49) {
	...
	for (int i_58_ = 0; (i ^ 0xffffffff) < (i_58_ ^ 0xffffffff); i_58_++) {
		...
		= Class348_Sub37.method3031(125, class348_sub49);
	    if ((class348_sub40.method3037(-121) ^ 0xffffffff) <= -1)
		i_56_++;
		...
		is[i_58_][i_60_] = class348_sub49.getUByte();
	...
	for (int i_61_ = 0; i > i_61_; i_61_++) {
	    ...
	    if (i_64_ > 0)
		anIntArray9524[i_56_++] = i_64_;
	    if (i_65_ > 0)
		anIntArray9523[i_57_++] = i_65_;
	    is[i_61_] = null;
	}
	aClass348_Sub40_9521
	    = aClass348_Sub40Array9520[class348_sub49.getUByte()];
	aClass348_Sub40_9527
	    = aClass348_Sub40Array9520[class348_sub49.getUByte()];
	aClass348_Sub40_9528
	    = aClass348_Sub40Array9520[class348_sub49.getUByte()];
    ...
    static {
	aClass351_9533 = new OutgoingPacket(57, 3);
    }
}
