...
{
    static HashTable aClass356_2959 = new HashTable(512);
    private Cache aClass60_2960 = new Cache(64);
    private IndexLoader aClass45_2961;
    static int anInt2962;
    static int anInt2963;
    static int anInt2964 = 64;
    private IndexLoader aClass45_2965;
	...
	if ((i_0_ ^ 0xffffffff) > -32769)
	    is = aClass45_2961.loadArchiveChild(-1860, 0, i_0_);
	else
	    is = aClass45_2965.loadArchiveChild(-1860, 0, 0x7fff & i_0_);
	...
	if (i == 1) {
	    ...
	    Class348_Sub8.currentToolkit.f(i_2_, i_1_);
	}
    }
    
    Class226(int i, IndexLoader class45, IndexLoader class45_3_) {
	do {
	    try {
