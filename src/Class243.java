...
final class Class243
{
    ...
    static OutgoingPacket aClass351_3165 = new OutgoingPacket(60, 8);
    ...
    static final void method1877(AbstractToolkit var_ha, int i) {
	anInt3164++;
	if (i >= -20)
	    method1877(null, -112);
	...
	Class189.anInt2524 = Message.aClass357ArrayArrayArray2029.length;
    }
