...
final class Class361
{
    ...
    static IncomingPacket aClass114_4433 = new IncomingPacket(22, 0);
	...
	((Class361) this).anIntArrayArray4438[i][i_4_]
	    = Class273.method2057((((Class361) this).anIntArrayArray4438[i]
				  ...
				  i_3_);
	if (i_5_ != -6496)
	    method3494(20, -107, -63, 115);
	anInt4448++;
    }
    
    final boolean method3495(int i, int i_6_, int i_7_, int i_8_, int i_9_,
    ...
    final boolean method3497(int i, int i_18_, int i_19_, int i_20_, int i_21_,
			     int i_22_, int i_23_, int i_24_, int i_25_,
			     int i_26_) {
	if (i != -28388)
	    method3504(-75, -117, 49, -113, 42, -115, 105, -59);
	anInt4449++;
    ...
    static final void method3498(int i, AbstractToolkit var_ha, int i_39_, int i_40_,
				 boolean bool, int i_41_) {
	do {
	    try {
		anInt4442++;
		var_ha.setDimensions(i_39_, i_41_, i_40_ + i_39_, i_41_ + i);
		var_ha.method3675(i_40_, (byte) -125, i_39_, i_41_, i,
				  -16777216);
		if (Node.anInt4290 >= 100) {
		    float f = ((float) Class75.anInt1267
			       / (float) Class75.anInt1259);
		    int i_42_ = i_40_;
		    int i_43_ = i;
		    if (!(f < 1.0F))
			i_42_ = (int) ((float) i / f);
		    else
			i_43_ = (int) ((float) i_40_ * f);
		    i_41_ += (-i_43_ + i) / 2;
		    i_39_ += (i_40_ + -i_42_) / 2;
		    if (Class67.aClass105_4643 == null
			|| i_40_ != Class67.aClass105_4643.getWidth()
			|| ((i ^ 0xffffffff)
			    != (Class67.aClass105_4643.getHeight()
				^ 0xffffffff))) {
			Class75.method751(Class75.anInt1266,
					  ...
					  (Class75.anInt1266
					   - -Class75.anInt1259),
					  Class75.anInt1263, i_39_, i_41_,
					  i_42_ + i_39_, i_43_ + i_41_);
			Class75.method748(var_ha);
			Class67.aClass105_4643
			    = var_ha.createRaster(i_39_, i_41_, i_42_, i_43_,
						false);
		    }
		    ...
		    int i_46_ = i_39_ - -(i_42_ * GfxDefinition.anInt4509
					  / Class75.anInt1259);
		    if (bool != true)
			method3498(44, null, -27, -91, true, -26);
		    int i_47_
			= (-i_45_ + i_41_
			   - (-i_43_ + (i_43_ * Class59_Sub1_Sub2.anInt8665
					/ Class75.anInt1267)));
		    int i_48_ = -1996554240;
		    if (Class14_Sub4.aClass230_8638
			== Class348_Sub42_Sub8_Sub2.gameType)
			i_48_ = -1996488705;
		    var_ha.drawQuad(i_46_, i_47_, i_44_, i_45_, i_48_, 1);
		    var_ha.method3628(i_46_, i_47_, i_44_, i_45_, i_48_, 0);
		    if (Class367_Sub9.anInt7379 <= 0)
			break;
		    int i_49_;
		    if (Class164.anInt2173 <= 50)
			i_49_ = Class164.anInt2173 * 5;
		    else
			i_49_ = -(5 * Class164.anInt2173) + 500;
		    for (Class348_Sub21 class348_sub21
			     = ((Class348_Sub21)
				Class75.aClass262_1254.getFirst(4));
			 class348_sub21 != null;
			 class348_sub21
			     = (Class348_Sub21) Class75.aClass262_1254
			...
			if (Cache.method589(class42, -4)) {
				...
				int i_51_
					...
					* i_43_ / Class75.anInt1267)
				       + i_41_);
				var_ha.method3675(4, (byte) -125, i_50_ - 2,
						  -2 + i_51_, 4,
						  (i_49_ << -96926312
						   | 0xffff00));
	...
	anInt4439++;
	String string
	    = ("tele " + i_62_ + "," + (i_63_ >> -219309274) + ","
	       + (i >> 621781894) + "," + (0x3f & i_63_) + "," + (0x3f & i));
	System.out.println(string);
	if (i_61_ != 2)
	    method3502(-25, -23, 24, 63);
	StringVarScriptSettingLoader.method812(string, true, false, (byte) -79);
    }
    
    final boolean method3503(int i, byte i_64_, int i_65_, int i_66_,
			     int i_67_, int i_68_, int i_69_, int i_70_,
			     int i_71_) {
	anInt4436++;
	if (i_66_ > 1) {
	    if (Class239_Sub28.method1842(i_68_, i_65_, -1, i_66_, i, i_70_,
					  i_71_, i_66_, i_67_))
		return true;
	    return method3497(-28388, i_71_, i_69_, i_66_, i_67_, i, i_66_,
			      i_70_, i_65_, i_68_);
	}
	...
	aClass114_4433 = null;
	if (i != 2)
	    aFloat4455 = 0.7198636F;
    }
    
    final void method3509(int i, boolean bool, boolean bool_99_, int i_100_,
    ...
    final void method3510(int i, int i_109_, int i_110_, int i_111_,
