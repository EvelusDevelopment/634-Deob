...
final class Class280
{
    ...
    private int[] anIntArray3627 = new int[64];
    static int anInt3628;
    static int anInt3629;
    private Interface5_Impl1 anInterface5_Impl1_3630;
    private int[] anIntArray3631;
    private Class318_Sub9_Sub2[][] aClass318_Sub9_Sub2ArrayArray3632;
    static int anInt3633;
    static int anInt3634;
    private Interface5_Impl2 anInterface5_Impl2_3635;
    private int[] anIntArray3636;
    private Class130 aClass130_3637;
    private Interface5_Impl1 anInterface5_Impl1_3638;
    static int anInt3639;
    static int anInt3640;
    static IncomingPacket aClass114_3641 = new IncomingPacket(79, 3);
    private Class318_Sub9_Sub2[][] aClass318_Sub9_Sub2ArrayArray3642;
    static int anInt3643 = 0;
    
    private final void method2098(NativeToolkit var_ha_Sub3, int i, int i_0_) {
	anInt3629++;
	Class59_Sub1.aFloat5299 = ((NativeToolkit) var_ha_Sub3).aFloat8093;
	int i_1_ = 75 % ((2 - i) / 34);
    ...
    private final void method2099(int i, NativeToolkit var_ha_Sub3) {
	anInt3628++;
	var_ha_Sub3.method3946(i + -26358, true);
	var_ha_Sub3.method3865(true, 54);
	if (i != 26326)
	    anIntArray3631 = null;
	if (Class59_Sub1.aFloat5299 != ((NativeToolkit) var_ha_Sub3).aFloat8093)
	    var_ha_Sub3.xa(Class59_Sub1.aFloat5299);
    }
    
    final void method2100(byte i, NativeToolkit var_ha_Sub3) {
	anInterface5_Impl1_3638.method20(786336, (byte) 123, 24);
	int i_2_ = -125 / ((i - 65) / 49);
	anInt3625++;
    }
    
    final void method2101(NativeToolkit var_ha_Sub3, Class98 class98, int i,
			  int i_3_) {
	try {
	    anInt3633++;
	    if (((NativeToolkit) var_ha_Sub3).aClass101_Sub2_8080 != null) {
		if ((i ^ 0xffffffff) <= -1)
		    method2098(var_ha_Sub3, -121, i);
		else
		    method2103((byte) -33, var_ha_Sub3);
		float f = (((Class101_Sub2)
			    ((NativeToolkit) var_ha_Sub3).aClass101_Sub2_8080)
			   .aFloat5736);
		float f_4_ = (((Class101_Sub2)
			       ((NativeToolkit) var_ha_Sub3).aClass101_Sub2_8080)
			      .aFloat5691);
		float f_5_ = (((Class101_Sub2)
			       ((NativeToolkit) var_ha_Sub3).aClass101_Sub2_8080)
			      .aFloat5716);
		float f_6_ = (((Class101_Sub2)
			       ((NativeToolkit) var_ha_Sub3).aClass101_Sub2_8080)
			      .aFloat5724);
		try {
		    int i_7_ = 0;
			...
			if (bool && (Class59_Sub1.aFloat5299
				     != ((NativeToolkit) var_ha_Sub3).aFloat8093))
			    var_ha_Sub3.xa(Class59_Sub1.aFloat5299);
			else if (((NativeToolkit) var_ha_Sub3).aFloat8093 != 1.0F)
			    var_ha_Sub3.xa(1.0F);
    ...
    private final void method2102(boolean bool, NativeToolkit var_ha_Sub3, int i) {
	anInt3640++;
	if (bool != false)
	    method2098(null, 21, -85);
	int i_20_ = 0;
	Class101_Sub2 class101_sub2 = var_ha_Sub3.method3948(-22036);
	float f = ((Class101_Sub2) class101_sub2).aFloat5711;
	float f_21_ = ((Class101_Sub2) class101_sub2).aFloat5700;
	float f_22_ = ((Class101_Sub2) class101_sub2).aFloat5704;
	float f_23_ = ((Class101_Sub2) class101_sub2).aFloat5708;
	float f_24_ = ((Class101_Sub2) class101_sub2).aFloat5722;
	float f_25_ = ((Class101_Sub2) class101_sub2).aFloat5732;
	float f_26_ = f_23_ + f;
	...
	if (buffer != null) {
		...
		for (int i_35_ = -1 + i; i_35_ >= 0; i_35_--) {
			...
			for (int i_37_ = i_36_ + -1; i_37_ >= 0; i_37_--) {
			    ...
			    if (((NativeToolkit) var_ha_Sub3).anInt8178 == 0)
			    ...
			    if ((((NativeToolkit) var_ha_Sub3).anInt8178
				 ^ 0xffffffff)
				!= -1)
				stream.a(i_39_, i_40_, i_41_, i_42_);
			    else
    ...
    private final void method2103(byte i, NativeToolkit var_ha_Sub3) {
	if (i != -33)
    ...
    Class280(NativeToolkit var_ha_Sub3) {
	anInt3626 = 0;
