...
final class Class231
{
    ...
    static final void method1642(byte i, AbstractToolkit var_ha) {
	anInt2997++;
	int i_3_ = 0;
	int i_4_ = 0;
	...
	int i_5_ = -10660793;
	Class318_Sub7.method2509(Class63.anInt1117,
				 Class348_Sub42_Sub5.anInt9532 - -i_4_, var_ha,
				 Class135_Sub1.anInt4717 - -i_3_, i_5_, true,
				 Class237_Sub1.anInt5819, -16777216);
	if (i > 98) {
	    Deque.b12fullFontRasterizer.drawString1
		(GameText.aClass274_3507.getLanguageText(Class348_Sub33.gameLanguage),
		 i_5_, i_4_ + (Class348_Sub42_Sub5.anInt9532 - -14),
		 i_3_ + (Class135_Sub1.anInt4717 + 3), -1, -125);
	    int i_6_ = Class258_Sub4.mouseMovementListener.method3597(true) - -i_3_;
	    int i_7_
		= i_4_ + Class258_Sub4.mouseMovementListener.method3594((byte) 127);
		...
		for (Class348_Sub42_Sub13 class348_sub42_sub13
			...
			Class318_Sub1_Sub3_Sub3.method2431
			    (-1, i_9_, class348_sub42_sub13, i_6_,
			     ...
			     Class135_Sub1.anInt4717 - -i_3_,
			     Class237_Sub1.anInt5819);
		}
		if (Class242.aClass348_Sub42_Sub13_3152 != null) {
		    Class318_Sub7.method2509(Class348_Sub1_Sub1.anInt8806,
					     AbstractMouseListener.anInt4534, var_ha,
					     Class50_Sub3.anInt5252, i_5_,
					     true, Class177.anInt4669,
					     -16777216);
		    i_8_ = 0;
		    Deque.b12fullFontRasterizer.drawString1
			(((Class348_Sub42_Sub13)
			  Class242.aClass348_Sub42_Sub13_3152).aString9617,
			 i_5_, AbstractMouseListener.anInt4534 - -14,
			 3 + Class50_Sub3.anInt5252, -1, -126);
		    for (Class348_Sub42_Sub12 class348_sub42_sub12
			     = ((Class348_Sub42_Sub12)
				((Class348_Sub42_Sub13)
				 Class242.aClass348_Sub42_Sub13_3152)
				    .aClass107_9621.getFirst());
			 ...
			 class348_sub42_sub12
				...
				((Class348_Sub42_Sub13)
				 Class242.aClass348_Sub42_Sub13_3152)
				    .aClass107_9621.next())) {
			int i_10_ = 31 + (AbstractMouseListener.anInt4534 + i_8_ * 16);
			i_8_++;
			Class318_Sub2.method2494(AbstractMouseListener.anInt4534, -256,
						 i_10_, var_ha,
						 class348_sub42_sub12,
						 Class348_Sub1_Sub1.anInt8806,
						 i_7_, -1, (byte) 125,
						 Class177.anInt4669,
						 Class50_Sub3.anInt5252, i_6_);
		    }
		    Class332.method2642(Class348_Sub1_Sub1.anInt8806,
					AbstractMouseListener.anInt4534, true,
		...
		for (Class348_Sub42_Sub12 class348_sub42_sub12
			 ...
			 = (Class348_Sub42_Sub12) Class348_Sub40_Sub4
						      ...
						      .nextForward((byte) 55)) {
		    int i_12_
			= 31 + (i_4_ + Class348_Sub42_Sub5.anInt9532
				- -((-i_11_ + -1 + FileArchiveTracker.anInt4776) * 16));
		    Class318_Sub2.method2494
			(i_4_ + Class348_Sub42_Sub5.anInt9532, -256, i_12_,
			 var_ha, class348_sub42_sub12, Class63.anInt1117, i_7_,
			 -1, (byte) 124, Class237_Sub1.anInt5819,
			 Class135_Sub1.anInt4717 - -i_3_, i_6_);
		    i_11_++;
		}
	    }
	    Class332.method2642(Class63.anInt1117,
				Class348_Sub42_Sub5.anInt9532 - -i_4_, true,
				Class135_Sub1.anInt4717 + i_3_,
				Class237_Sub1.anInt5819);
	}
    }
