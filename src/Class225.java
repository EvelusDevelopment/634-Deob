...
final class Class225
{
    ...
    static int amountWorlds;
    static Class243 aClass243_2957;
    int anInt2958;
    
    final Class101[] method1618(AbstractToolkit var_ha, int i) {
	anInt2952++;
	if (aClass101Array2925 != null
	    && (anInt2942 ^ 0xffffffff) == (((AbstractToolkit) var_ha).id
					    ^ 0xffffffff))
    ...
    final void method1620(ByteBuffer class348_sub49, int i) {
	for (;;) {
    ...
    private final void method1622(ByteBuffer class348_sub49, int i,
				  int i_12_) {
	anInt2903++;
	if (i_12_ != 1) {
							...
							if ((i_12_
								...
								if ((i_12_
									...
									if ((i_12_
										...
										((Class225) this).anInt2927 = class348_sub49.getShort();
									    else if (i_12_ != 48) {
										if ((i_12_ ^ 0xffffffff) == -50)
										    ((Class225) this).anInt2911 = class348_sub49.getShort();
										else if ((i_12_ ^ 0xffffffff) == -51)
										    ((Class225) this).anInt2934 = class348_sub49.getShort();
											...
											for (int i_16_ = 0; i_16_ < i_15_; i_16_++) {
											    ((Class225) this).anIntArray2915[i_16_] = class348_sub49.getShort();
											...
											((Class225) this).anInt2912 = class348_sub49.getUByte() << -1300429466;
											((Class225) this).anInt2943 = class348_sub49.getUByte() << -59678202;
										    } else if (i_12_ == 55) {
											if (((Class225) this).anIntArray2907 == null)
											    ((Class225) this).anIntArray2907 = new int[12];
											int i_18_ = class348_sub49.getUByte();
											((Class225) this).anIntArray2907[i_18_] = class348_sub49.getShort();
										    } else if (i_12_ == 56) {
										    ...
										    ((Class225) this).anInt2953 = class348_sub49.getShort();
									    } else
										((Class225) this).anInt2905 = class348_sub49.getShort();
									} else
									    ((Class225)
									     this).anInt2908
										= class348_sub49.getShort();
		...
		= class348_sub49.getShort();
	    ((Class225) this).anInt2951 = class348_sub49.getShort();
