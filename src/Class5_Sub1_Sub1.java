...
final class Class5_Sub1_Sub1 extends Class5_Sub1
{
    ...
    static Sprite[] aClass207Array9929;
    static int anInt9930;
    static Deque aClass262_9931 = new Deque();
    ...
    Class5_Sub1_Sub1(IndexLoader class45, IndexLoader class45_0_,
		     Class369_Sub3_Sub1 class369_sub3_sub1) {
	super(class45, class45_0_, (Class369_Sub3) class369_sub3_sub1);
    }
	...
	if (i_2_ <= 21)
	    aClass207Array9929 = null;
	anInt9928++;
	int i_5_ = ((Class5_Sub1) this).aClass105_8350.method966();
	int i_6_ = (((Class369_Sub3_Sub1) (Class369_Sub3_Sub1)
		     ((Class5) this).aClass369_4635).anInt10177
