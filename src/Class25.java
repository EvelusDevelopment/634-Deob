...
final class Class25
{
    private Cache aClass60_360 = new Cache(16);
    static int anInt361;
    static int anInt362;
    static int anInt363;
    static OutgoingPacket aClass351_364 = new OutgoingPacket(12, 3);
    static int anInt365;
    private IndexLoader aClass45_366;
    static RasterToolkit[] aClass105Array367;
	...
	synchronized (aClass45_366) {
	    is = aClass45_366.loadArchiveChild(-1860, 30, i);
	}
	if (i_2_ < 6)
	    aClass60_360 = null;
	class38 = new Class38();
	if (is != null)
	    class38.method364(new ByteBuffer(is), (byte) 54);
	synchronized (aClass60_360) {
    ...
    Class25(GameMode class230, int i, IndexLoader class45) {
	try {
	    aClass45_366 = class45;
	    aClass45_366.method407(30);
