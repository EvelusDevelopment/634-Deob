...
final class Class348_Sub16_Sub2 extends Class348_Sub16
{
    ...
    private Deque aClass262_8861 = new Deque();
	...
	if (i != -23076)
	    method2817(null, 71, 78);
	anInt8872++;
	return (Class348_Sub42_Sub4) aClass262_8861.getFirst(i + 23080);
    }
	...
	if (class348_sub42_sub4 != null) {
	    class348_sub42_sub4.removeNode();
	    anInt8888--;
	    anInt8883 = 0;
	    Class348_Sub40_Sub10.aClass308_9180.method2305(class348_sub42_sub4
							       .method3182(90),
							   class348_sub42_sub4,
							   -1);
	}
	...
	if (i != 1)
	    aDouble8869 = -2.8743710633758983;
	aBoolean8886 = bool;
	anInt8878++;
    }
	...
	anInt8876++;
	Class221 class221
	    = Class158.method1248(15)[class348_sub49.getUByte()];
	if (i > -113)
	    aDouble8869 = -1.5911312034627048;
	Class341 class341
	...
	return new Class369(class221, class341, i_7_, i_8_, i_9_, i_10_, i_11_,
			    i_12_, i_13_);
    }
	...
	if (i != -21987)
	    method2818();
	Class348_Sub42_Sub4 class348_sub42_sub4
	    = (Class348_Sub42_Sub4) aClass262_8861.getFirst(4);
	if (class348_sub42_sub4 == null)
	    return -1.0;
