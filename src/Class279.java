...
class Class279
{
	...
	if (!aBoolean3610) {
		...
		if (i != -6858)
		    anInt3616 = 114;
		for (/**/; aLong3602 + 5000L < l; l = Class62.getCurrentTimeMillis()) {
	...
	aLong3602 = Class62.getCurrentTimeMillis();
    }
	...
	try {
	    ...
	    method2091();
	    aLong3614 = 2000L + Class62.getCurrentTimeMillis();
	}
    }
	...
	if (((bool
	     ...
	     ^ 0xffffffff) != -1
	    && i != 0 && (Message.anInt2021 ^ 0xffffffff) > -51
	    && (i_24_ ^ 0xffffffff) != 0)
