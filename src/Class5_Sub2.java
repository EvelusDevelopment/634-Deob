...
final class Class5_Sub2 extends Class5
{
    ...
    static IncomingPacket aClass114_8365 = new IncomingPacket(30, -1);
    
    static final void method191(boolean bool, int i, int i_0_) {
	if (Class282.anInt3655 != 1) {
	    if (Class282.anInt3655 == 2) {
		if (!Class59_Sub1.aBoolean5300)
		    Class304.method2291((byte) -127, i, i_0_);
		else
		    Class304.method2291((byte) -122,
					i + s_Sub3.method4008((byte) -128),
					Class16.method260(!bool) + i_0_);
	    }
	} else
	    Class325.method2599((byte) 101,
				Class138.aClass348_Sub42_Sub12_1946, i_0_, i);
	anInt8354++;
    ...
    static final byte[] method194(int i, int i_3_, int i_4_, float f, int i_5_,
				  float f_6_, float f_7_, float f_8_,
				  float f_9_, Class186 class186, int i_10_) {
	anInt8353++;
	if (i_3_ != -1922)
	    aClass273_8356 = null;
	byte[] is = new byte[i * i_5_ * i_10_];
	Class253.method1919(i, f_8_, is, f_6_, 0, f_9_, class186, f_7_, i_4_,
			    (byte) 119, i_10_, f, i_5_);
	return is;
    }
	...
	ObjectDefinition class51
	    = Class348_Sub40_Sub12.objectLoader.getObject(0, i_11_);
	if (i == 11)
	    i = 10;
	if (bool != false)
	    return false;
    ...
    Class5_Sub2(IndexLoader class45, IndexLoader class45_12_,
    ...
    static final void method196(boolean bool, int i, int i_13_, int i_14_,
				int i_15_) {
	if (bool != true)
	    method192(null, -119, 63, 12);
	if (Class132.anInt1910 <= i_15_ && Class38.anInt513 >= i_15_) {
	    i_14_ = Whirlpool.method831(Class113.anInt1745, i_14_,
				      Class369.anInt4960, 71);
	    i = Whirlpool.method831(Class113.anInt1745, i, Class369.anInt4960,
				  -87);
	    TextureDefinition.method223(i, i_13_, i_15_, i_14_, (byte) 39);
	}
	anInt8357++;
    }
	...
	int i_21_ = (this.method183(116)
		     * ((Class369) ((Class5) this).aClass369_4635).anInt4971
		     / 10000);
	Class348_Sub8.currentToolkit.drawQuad(i_19_, 2 + i_18_, i_21_,
    ...
    static final void method198(Widget class46, boolean bool, int i,
				int i_22_) {
	SocketConnection.anInt5832 = i;
