...
final class Class239_Sub23 extends Class239
{
	...
	if (bool == false) {
	    if (((Class239) this).aClass348_Sub51_3136.method3425(-68))
	...
	if (i < 85)
	    return false;
	anInt6078++;
	if (!((Class239) this).aClass348_Sub51_3136.method3425(-108))
	    return true;
	return false;
    }
    ...
    static final BitmapFont method1819(int i, int i_1_, int i_2_,
				     IndexLoader class45) {
	anInt6081++;
	byte[] is = class45.loadArchiveChild(-1860, i, i_1_);
	if (i_2_ >= -31)
