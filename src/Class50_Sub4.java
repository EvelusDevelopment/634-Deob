...
final class Class50_Sub4 extends Class50
{
    ...
    static final Class158 method472(int i, ByteBuffer class348_sub49) {
	anInt5263++;
	String string = class348_sub49.getJStr();
	Class221 class221
	    = Class158.method1248(127)[class348_sub49.getUByte()];
	if (i != -27794)
	    return null;
	Class341 class341
	    = Class62.method596(i + 47794)[class348_sub49.getUByte()];
	...
	int i_21_ = class348_sub49.getShort();
	int i_22_ = class348_sub49.getDWord();
	int i_23_ = class348_sub49.getDWord();
	int i_24_ = class348_sub49.getDWord();
	return new Class158(string, class221, class341, i_15_, i_16_, i_17_,
			    i_18_, i_19_, i_20_, i_21_, i_22_, i_23_, i_24_);
    }
    
    static final int method473(byte i, int i_25_, LobbyWorld class110_sub1,
