...
final class FloatBuffer extends ByteBuffer
{
    static int anInt9741;
    static int anInt9742;
    static OutgoingPacket aClass351_9743 = new OutgoingPacket(84, -1);
    ...
    static OutgoingPacket aClass351_9749;
	...
	if ((i_2_ & 0x2) == 0) {
	    for (Class318_Sub1 class318_sub1
		     = Node.aClass318_Sub1Array4293[i_4_];
		 class318_sub1 != null;
		 class318_sub1
		...
		if (!Class348_Sub9.method2778(class318_sub1, bool, is, i,
		    ...
		    if (((Class318_Sub1) class318_sub1).anInt6389 != -1)
	...
	if ((i_2_ & 0x1) == 0) {
		...
		if (!Class348_Sub9.method2778(class318_sub1, bool, is, i,
		    ...
		    s_Sub2.method4001(class318_sub1);
		    if (((Class318_Sub1) class318_sub1).anInt6389 != -1)
			IndexTable.aClass318_Sub1Array3737
		...
		for (int i_5_ = 0; i_5_ < Class86.anInt1477; i_5_++) {
			...
			s_Sub2.method4001(Class24.aClass318_Sub1_Sub3Array357
					  [i_5_]);
			if ((((Class318_Sub1)
			      Class24.aClass318_Sub1_Sub3Array357[i_5_])
			     .anInt6389)
			    != -1) {
	...
	if ((i_2_ & 0x2) == 0) {
		...
		if (i_7_ >= i && is != null) {
			...
			for (int i_10_ = NativeRaster.anInt8412; i_10_ < i_8_;
			     i_10_++) {
			    int i_11_ = (i_10_ + Class37.anInt492
					 - NativeRaster.anInt8412);
			...
			if (i_1_ >= 0)
			    ...
			    aa_Sub1.aSArray5191[i_7_].method3983(0, 0, 0, null,
								 false, i_2_);
			for (int i_15_ = 0;
			     i_15_ < Npc.anInt10503;
			     i_15_++)
			    GfxLoader.aClass315Array3982[i_15_]
			...
			if (i_1_ >= 0)
			    ...
			    aa_Sub1.aSArray5191[i_7_].method3983(0, 0, 0, null,
								 false, i_2_);
			for (int i_21_ = 0;
			     i_21_ < Npc.anInt10503;
			     i_21_++)
			    GfxLoader.aClass315Array3982[i_21_]
				.method2359(new Class318_Sub2(i_7_ + 1), -1);
		    } else if (i_1_ >= 0)
			aa_Sub1.aSArray5191[i_7_].method3984
			    (Class239_Sub25.anInt6111, Class285_Sub2.anInt8502,
	...
	if (Class348_Sub42_Sub3.anInt9504 > 0) {
	    Class67.method718(IndexTable.aClass318_Sub1Array3737, 0,
			      Class348_Sub42_Sub3.anInt9504 - 1);
	    for (int i_22_ = 0; i_22_ < Class348_Sub42_Sub3.anInt9504; i_22_++)
		Class13.method227(IndexTable.aClass318_Sub1Array3737[i_22_],
				  true, bool_3_);
	}
    }
    ...
    static {
	anInt9750 = 0;
	aClass351_9749 = new OutgoingPacket(45, 7);
    }
}
