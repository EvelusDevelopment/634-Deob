...
final class Class239_Sub2 extends Class239
{
    ...
    static RasterToolkit[] aClass105Array5857;
	...
	for (/**/; AbtractArchiveLoader.aFloat3938 >= 16384.0F;
	     AbtractArchiveLoader.aFloat3938 -= 16384.0F) {
	    /* empty */
	}
	for (/**/; AbtractArchiveLoader.aFloat3938 < 0.0F;
	     AbtractArchiveLoader.aFloat3938 += 16384.0F) {
	    /* empty */
	}
