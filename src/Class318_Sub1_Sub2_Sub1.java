...
final class Class318_Sub1_Sub2_Sub1 extends Class318_Sub1_Sub2
{
	...
	int i_0_ = ((ItemDefinition) class213).anInt2784;
	if ((((Class318_Sub1_Sub2_Sub1) this).anInt10189 ^ 0xffffffff) != 0) {
	    ItemDefinition class213_1_
		= (ToolkitException.itemLoader.getItemDefinition
		   (74, ((Class318_Sub1_Sub2_Sub1) this).anInt10189));
	    if (((ItemDefinition) class213_1_).anInt2784 > i_0_)
		i_0_ = ((ItemDefinition) class213_1_).anInt2784;
	}
	if ((((Class318_Sub1_Sub2_Sub1) this).anInt10180 ^ 0xffffffff) != 0) {
	    ItemDefinition class213_2_
		= (ToolkitException.itemLoader.getItemDefinition
		   (-88, ((Class318_Sub1_Sub2_Sub1) this).anInt10180));
	    if (i_0_ < ((ItemDefinition) class213_2_).anInt2784)
		i_0_ = ((ItemDefinition) class213_2_).anInt2784;
	}
	return i_0_;
    }
	...
	if (class64 != null
		...
		? class64.method623(i_7_, i, class101, true,
				    ((ItemDefinition) class213).anInt2784,
				    Class132.anInt1906)
	...
	if ((((Class318_Sub1_Sub2_Sub1) this).anInt10189 ^ 0xffffffff)
		...
		&& (Class305.aBoolean3870
		    ? class64.method623(i_7_, i, class101, true,
					((ItemDefinition) class213_9_).anInt2784,
					Class132.anInt1906)
		    : class64.method628(i_7_, i, class101, true,
					((ItemDefinition) class213_9_).anInt2784)))
		return true;
	...
	if (((Class318_Sub1_Sub2_Sub1) this).anInt10180 != -1) {
		...
		&& (!Class305.aBoolean3870
		    ? class64.method628(i_7_, i, class101, true,
					((ItemDefinition) class213_10_).anInt2784)
		    : class64.method623(i_7_, i, class101, true,
					((ItemDefinition) class213_10_).anInt2784,
					Class132.anInt1906)))
		return true;
	...
	Class318_Sub4 class318_sub4
	    = DummyOutputstream.method136(3, true, false);
	aBoolean10191 = false;
	anInt10184 = 0;
	if ((((Class318_Sub1_Sub2_Sub1) this).anInt10180 ^ 0xffffffff) != 0) {
	    AnimatableToolkit class64
