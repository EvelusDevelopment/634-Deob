...
class Class59_Sub1 extends Class59
{
	...
	if (i != Class363.aString4461.length()) {
	    GameApplet.addConsoleMessage("--> " + Class363.aString4461);
	    StringVarScriptSettingLoader.method812(Class363.aString4461, false, bool, (byte) -79);
