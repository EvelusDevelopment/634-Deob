...
final class Class18
{
    ...
    private DirectxToolkit aHa_Sub2_290;
    static int anInt291;
    private Deque aClass262_292;
    ...
    static final void method271(int i, Widget class46, byte i_0_, int i_1_) {
	anInt278++;
	aa var_aa = class46.method425(Class348_Sub8.currentToolkit, (byte) 19);
	if (var_aa != null) {
	    Class348_Sub8.currentToolkit.setDimensions(i_1_, i,
				     ((Widget) class46).anInt709 + i_1_,
				     i - -((Widget) class46).anInt789);
	    if ((IntegerVarScriptSettingLoader.anInt3306 ^ 0xffffffff) <= -4)
		Class348_Sub8.currentToolkit.A(-16777216, var_aa, i_1_, i);
	    else
		NpcDefinition.aClass105_1365.method976
		    (((float) ((Widget) class46).anInt709 / 2.0F
		      + (float) i_1_),
		     (float) i + (float) ((Widget) class46).anInt789 / 2.0F,
		     4096,
		     (0x3fff & (int) -AbtractArchiveLoader.aFloat3938) << -1614383390,
		     var_aa, i_1_, i);
	    if (i_0_ != -98)
		method271(88, null, (byte) 15, 71);
	}
    }
	...
	if (aBoolean289) {
		...
		if (aBoolean303)
		    i_2_ |= 0x100;
		OpenGL.glBlitFramebufferEXT(0, 0, anInt286, anInt275, 0, 0,
					    anInt286, anInt275, i_2_, 9728);
	    ...
	    for (Class348_Sub5 class348_sub5_6_
		     = (Class348_Sub5) aClass262_292.getFirst(4);
		 class348_sub5_6_ != null; class348_sub5_6_ = class348_sub5) {
		class348_sub5
		    = (Class348_Sub5) aClass262_292.nextForward((byte) 113);
		...
		for (int i_8_ = 0; (i_7_ ^ 0xffffffff) < (i_8_ ^ 0xffffffff);
			...
			OpenGL.glVertex2i(anInt287 - -anInt286,
					  anInt276 + anInt275);
			OpenGL.glTexCoord2f((float) anInt286,
					    (float) anInt275);
    ...
    static final void method273(Widget class46, int i) {
	anInt288++;
	if (((Widget) class46).type == 5
	    && ((Widget) class46).itemId != -1)
	    Class318_Sub1.method2383(Class348_Sub8.currentToolkit, -2, class46);
	if (i != -2835)
	    method273(null, 44);
    }
	...
	if (aClass206_284 != null) {
	    if (class348_sub5.method2751(bool)
		|| class348_sub5.method2758(85)) {
		aClass262_292.addToFront(class348_sub5, -20180);
		method281((byte) -94);
		if (method276(false)) {
	...
	if (i_12_ != -1)
	    return true;
	anInt272++;
	if (aClass206_284 == null || aClass262_292.isEnd((byte) 18))
	    return false;
	if ((i ^ 0xffffffff) != (anInt286 ^ 0xffffffff) || i_10_ != anInt275) {
	    anInt286 = i;
	    anInt275 = i_10_;
	    for (Node class348 = aClass262_292.getFirst(i_12_ ^ ~0x4);
		 ((Deque) aClass262_292).parent != class348;
	...
	if (method276(false)) {
	    ...
	    aHa_Sub2_290.method3790(98, (-((DirectxToolkit) aHa_Sub2_290).anInt7641
	...
	if (aBoolean293) {
		...
		aClass348_Sub42_Sub2_298
		    = new Class348_Sub42_Sub2(aHa_Sub2_290, 6402, anInt286,
					      anInt275,
					      (((DirectxToolkit) aHa_Sub2_290)
					       .anInt7713));
	    if (aBoolean303)
		aClass258_Sub3_300
		    = new Class258_Sub3(aHa_Sub2_290, 34037, 6402, anInt286,
					anInt275);
	    else if (aClass348_Sub42_Sub2_298 == null)
		aClass348_Sub42_Sub2_298
		    = new Class348_Sub42_Sub2(aHa_Sub2_290, 6402, anInt286,
					      anInt275);
	    aBoolean293 = false;
	...
	if (aBoolean297) {
		...
		= new Class258_Sub3(aHa_Sub2_290, 34037, anInt301, anInt286,
				    anInt275);
	    aClass258_Sub3Array295[1]
		= anInt302 > 1 ? new Class258_Sub3(aHa_Sub2_290, 34037,
						   anInt301, anInt286,
						   anInt275) : null;
	    aBoolean294 = true;
	    aBoolean299 = true;
	...
	if (aBoolean294) {
		...
		if (aBoolean303)
		    ...
		    aClass206_281.method1508(8, aClass348_Sub42_Sub2_298, 114);
		aHa_Sub2_290.method3770(-422613672, aClass206_281);
	    } else {
		aHa_Sub2_290.method3773(-1, aClass206_281);
		aClass206_281.method1500(2983, 0);
	...
	if (!aClass262_292.isEnd((byte) 18)) {
	    for (Node class348 = aClass262_292.getFirst(4);
		 ((Deque) aClass262_292).parent != class348;
		 class348 = ((Node) class348).nodeParent)
	...
	for (/**/; class348_sub5 != null;
	     class348_sub5
		 = (Class348_Sub5) aClass262_292.nextForward((byte) 67)) {
	...
	if (i_20_ != i_19_)
	    aBoolean294 = aBoolean297 = true;
    }
    
    static final void method282(int i, AbstractToolkit var_ha, int i_21_, byte i_22_,
				int i_23_, int i_24_, int i_25_, int i_26_) {
	anInt274++;
	Class21.aHa326 = var_ha;
	ObjectDefinition.aClass101_905 = Class21.aHa326.method3654();
	...
	AnimationDefinition.anInterface4_252 = null;
	ByteBuffer.anInt7207 = 1;
	Class239_Sub12.anInt5965 = i;
	Whirlpool.method828((byte) 38, i_25_, i_21_);
    }
    
    Class18(DirectxToolkit var_ha_Sub2) {
	anInt286 = 1;
	...
	if (((DirectxToolkit) aHa_Sub2_290).aBoolean7820
	    && ((DirectxToolkit) aHa_Sub2_290).aBoolean7837) {
	    aClass206_284 = aClass206_281 = new Class206(aHa_Sub2_290);
	    if (((DirectxToolkit) aHa_Sub2_290).anInt7713 > 1
		&& ((DirectxToolkit) aHa_Sub2_290).aBoolean7815
		&& ((DirectxToolkit) aHa_Sub2_290).aBoolean7807)
