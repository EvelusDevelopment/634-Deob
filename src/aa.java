...
{
    static int anInt113;
    static SignlinkRequest aClass144_114;
    static int anInt115;
	...
	if (d_7_ != d_6_) {
	    if (d_10_ < 0.5)
		d_9_ = (-d_6_ + d_7_) / (d_6_ + d_7_);
	    if (d_7_ != d) {
		if (d_4_ != d_7_) {
		    if (d_5_ == d_7_)
			d_8_ = (-d_4_ + d) / (d_7_ - d_6_) + 4.0;
		} else
		    d_8_ = 2.0 + (-d + d_5_) / (d_7_ - d_6_);
	    } else
		d_8_ = (-d_5_ + d_4_) / (-d_6_ + d_7_);
	    if (d_10_ >= 0.5)
		d_9_ = (-d_6_ + d_7_) / (-d_6_ + (-d_7_ + 2.0));
	}
	d_8_ /= 6.0;
	...
	if ((i_13_ ^ 0xffffffff) < -244)
	    ...
	    i_12_ >>= 1;
	return ((i_13_ >> 2140240129)
		+ ((i_11_ & 0xff) >> -615751774 << 779990378)
		+ (i_12_ >> 1750853765 << 698382727));
    }
}
