...
class Class258_Sub3 extends Class258
{
    ...
    Class258_Sub3(DirectxToolkit var_ha_Sub2, int i, int i_0_, int i_1_, int i_2_) {
    ...
    Class258_Sub3(DirectxToolkit var_ha_Sub2, int i, int i_6_, int i_7_, int i_8_,
		  boolean bool, float[] fs, int i_9_) {
    ...
    final void method1964(boolean bool, int i, int i_10_, int[] is, int i_11_,
			  byte i_12_, int i_13_, int i_14_, int i_15_) {
	anInt8543++;
	if (i_15_ == 0)
	    i_15_ = i_13_;
	if (bool) {
	...
	OpenGL.glTexSubImage2Di(((Class258) this).anInt4849, 0, i_14_, i_10_,
				i_13_, i, 32993,
				(((DirectxToolkit) ((Class258) this).aHa_Sub2_4851)
				 .anInt7812),
				is, i_11_);
    ...
    Class258_Sub3(DirectxToolkit var_ha_Sub2, int i, int i_21_, int i_22_, int i_23_,
    ...
    Class258_Sub3(DirectxToolkit var_ha_Sub2, int i, int i_32_, int i_33_, int i_34_,
		  boolean bool, byte[] is, int i_35_, boolean bool_36_) {
	...
	try {
		...
		Class186_Sub1.method1403(i_34_, i_33_, is, false, i_35_, i,
					 i_32_);
		this.method1955(true, (byte) -123);
	    }
    ...
    static final void method1966(int i, int i_43_, int i_44_, int i_45_,
				 byte i_46_, int i_47_, int i_48_, int i_49_,
				 int i_50_) {
	Message.aClass338Array2034[Class239_Sub26.anInt6115++]
	    = new Class338(i_47_, i_49_, i_50_, i, i, i_50_, i_45_, i_43_,
			   i_43_, i_45_, i_44_, i_44_, i_48_, i_48_);
	anInt8548++;
	if (i_46_ != 0)
	    method1968();
    }
	...
	anInt8544++;
	int i_57_ = (((DirectxToolkit) ((Class258) this).aHa_Sub2_4851).anInt7641
		     + (-i_52_ - i_51_));
    ...
    static final RasterToolkit method1969(byte[] is, int i) {
	anInt8546++;
	if (i != -5901)
	    anInt8550 = 83;
	if (is == null)
	...
	for (;;) {
		...
		MediaTracker mediatracker
		    = new MediaTracker(NpcDefinition.aClient1367);
		...
		PixelGrabber pixelgrabber
		    = new PixelGrabber(image, 0, 0, i_58_, i_59_, is_60_, 0,
				       i_58_);
		pixelgrabber.grabPixels();
		return Class348_Sub8.currentToolkit.method3662(i_58_, is_60_,
							(byte) 94, 0, i_58_,
							i_59_);
    ...
    Class258_Sub3(DirectxToolkit var_ha_Sub2, int i, int i_77_, int i_78_, int i_79_,
		  int i_80_) {
	super(var_ha_Sub2, i, 6407, i_80_ * i_79_, false);
	anInt8545 = -1;
	((Class258_Sub3) this).anInt8547 = i_79_;
	((Class258_Sub3) this).anInt8551 = i_80_;
	int i_81_ = (((DirectxToolkit) ((Class258) this).aHa_Sub2_4851).anInt7641
		     + (-i_78_ + -i_80_));
	((Class258) this).aHa_Sub2_4851.method3771((byte) -111, this);
