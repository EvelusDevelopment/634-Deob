...
final class Class264
{
    ...
    static IncomingPacket aClass114_3368 = new IncomingPacket(112, 4);
    static int anInt3369;
    int anInt3370;
    static IncomingPacket aClass114_3371 = new IncomingPacket(63, 5);
    ...
    static final void method2017(int i, AnimationDefinition class17, int i_3_) {
	anInt3367++;
	if (Message.anInt2021 < 50
	    ...
	    int i_4_ = ((AnimationDefinition) class17).anIntArrayArray264[i][0];
	    int i_5_ = i_4_ >> 1426050504;
	    if ((((AnimationDefinition) class17).anIntArrayArray264[i].length ^ 0xffffffff)
		< -2) {
		int i_6_ = (int) (Math.random()
				  * (double) (((AnimationDefinition) class17)
					      .anIntArrayArray264[i]).length);
		if ((i_6_ ^ 0xffffffff) < -1)
		    i_5_ = ((AnimationDefinition) class17).anIntArrayArray264[i][i_6_];
	    }
		...
		if (((AnimationDefinition) class17).anIntArray236 != null
		    ...
		    i_8_ = Class299_Sub1.method2257((((AnimationDefinition) class17)
						     .anIntArray265[i]),
