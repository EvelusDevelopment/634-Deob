...
final class Class232
{
    ...
    private DirectxToolkit aHa_Sub2_3000;
	...
	if (i != -128)
	    anIntArray3014 = null;
	anInt3012++;
	WidgetVariable class348_sub42_sub15 = Class318_Sub9_Sub1.method2516(i_3_, (byte) 105, 1);
	class348_sub42_sub15.method3251(-16058);
    }
    
    Class232(DirectxToolkit var_ha_Sub2, Class104 class104, s_Sub2 var_s_Sub2, int i,
	...
	try {
		...
		ByteBuffer class348_sub49 = new ByteBuffer(i_9_ * 2);
		if (!((DirectxToolkit) aHa_Sub2_3000).aBoolean7775) {
		    for (int i_15_ = 0;
			...
			for (int i_21_ = 0; i_8_ > i_21_; i_21_++) {
				...
				for (int i_22_ = 0;
				     ((is.length ^ 0xffffffff)
				      < (i_22_ ^ 0xffffffff));
				     i_22_++)
				    class348_sub49.putShort((is[i_22_]
							       & 0xffff));
			    }
			}
		    }
		...
		anInterface8_3001
		    = (aHa_Sub2_3000.method3733
		       (5123, -39, ((ByteBuffer) class348_sub49).position,
	...
	if (((Class232) this).aBoolean3009) {
	    ...
	    byte[] is_23_ = ((DirectxToolkit) aHa_Sub2_3000).aByteArray7879;
	    if (i > 115) {
		int i_24_ = 0;
		...
		if (aClass258_Sub3_2998 != null && i_24_ == anInt3010)
			...
			aClass258_Sub3_2998.method1970
			    (0, 0, 128, false, 0, 128, 6406, -69,
			     ((DirectxToolkit) aHa_Sub2_3000).aByteArray7879, 0);
		    else {
			aClass258_Sub3_2998
			    = new Class258_Sub3(aHa_Sub2_3000, 3553, 6406, 128,
						128, false,
						(((DirectxToolkit) aHa_Sub2_3000)
						 .aByteArray7879),
						6406, false);
