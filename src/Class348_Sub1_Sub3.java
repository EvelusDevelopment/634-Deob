...
final class Class348_Sub1_Sub3 extends Class348_Sub1
{
	...
	if (i != -1)
	    method2732(-79, -120, true, 36, null, 19);
    }
    
    Class348_Sub1_Sub3(int i, int i_3_, int i_4_, int i_5_, int i_6_,
		       float f) {
	super(i, i_3_, i_4_, i_5_, i_6_, f);
    }
    
    static final void method2732(int i, int i_7_, boolean bool, int i_8_,
				 IndexLoader class45, int i_9_) {
	anInt8820++;
	if (i_8_ < 90)
	    anInt8818 = -21;
