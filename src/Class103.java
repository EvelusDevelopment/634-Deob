...
final class Class103
{
	...
	if (i_8_ > i_7_) {
		...
		= Class65.lobbyWorlds[i_13_];
	    Class65.lobbyWorlds[i_13_]
		= Class65.lobbyWorlds[i_8_];
	    Class65.lobbyWorlds[i_8_] = class110_sub1;
		...
		if (Class50_Sub4.method473((byte) -122, i_10_, class110_sub1,
					   ...
					   (Class65.lobbyWorlds
					    [i_15_]))
		    <= 0) {
		    LobbyWorld class110_sub1_16_
			= Class65.lobbyWorlds[i_15_];
		    Class65.lobbyWorlds[i_15_]
			= Class65.lobbyWorlds[i_14_];
		    Class65.lobbyWorlds[i_14_++]
			= class110_sub1_16_;
		}
	    }
	    Class65.lobbyWorlds[i_8_]
		= Class65.lobbyWorlds[i_14_];
	    Class65.lobbyWorlds[i_14_] = class110_sub1;
