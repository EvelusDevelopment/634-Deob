...
class Class75
{
    ...
    private static HashTable aClass356_1271;
    ...
    static final void method745(AbstractToolkit var_ha, Class348_Sub21 class348_sub21,
				Class42 class42) {
    ...
    private static final void method747(AbstractToolkit var_ha,
    ...
    static final void method748(AbstractToolkit var_ha) {
	...
	(AbstractToolkit var_ha, ByteBuffer class348_sub49, int i, int i_21_, int i_22_,
	...
	if ((i_25_ & 0x1) == 0) {
		...
		int i_30_ = class348_sub49.getUByte();
		int i_31_ = 0;
		int i_32_ = 0;
		if (bool) {
		    i_31_ = class348_sub49.getUByte();
		    i_32_ = class348_sub49.getUByte();
		}
		int i_33_ = 0;
		if (bool_28_)
		    i_33_ = class348_sub49.getUByte();
		if (i_29_ == 0) {
			...
			for (int i_36_ = 0; i_36_ < i_33_; i_36_++) {
			    is_34_[i_36_]
				= (short) class348_sub49.getShort();
			    is_35_[i_36_] = class348_sub49.getByte();
			}
			aClass356_1271.putNode((long) (i_22_ << 16 | i_23_),
			...
			for (int i_39_ = 0; i_39_ < i_33_; i_39_++) {
			    is_37_[i_39_]
				= (short) class348_sub49.getShort();
			    is_38_[i_39_] = class348_sub49.getByte();
			}
		    }
    ...
    static final void method752(IndexLoader class45, Class268 class268,
				Class183 class183, ObjectLoader class263,
				Class153 class153, Class141 class141,
				ConfigHandler interface17) {
	...
	if (is != null) {
		...
		aClass356_1241.putNode((long) (((Class348_Sub42_Sub14)
		...
		if (i_49_ != 0) {
			...
			if (class348_sub39 != null) {
				...
				ObjectDefinition class51
				    = (aClass263_1245.getObject
				       (0,
					(((Class348_Sub39) class348_sub39)
					 .aShortArray7024[i_50_]) & 0xffff));
				int i_51_ = ((ObjectDefinition) class51).anInt921;
				if (((ObjectDefinition) class51).anIntArray945
					...
					= class51.method480(anInterface17_1244,
							    (byte) 47);
				    if (class51 != null)
					i_51_ = ((ObjectDefinition) class51).anInt921;
				}
				if (i_51_ != -1) {
				    ...
				    ((Class348_Sub21) class348_sub21).anInt6851
					= i_48_;
				    aClass262_1254.addToFront(class348_sub21,
							      -20180);
				}
			    }
			}
			...
			ObjectDefinition class51
			    = aClass263_1245.getObject(0, i_49_ - 1);
			int i_52_ = ((ObjectDefinition) class51).anInt921;
			if (((ObjectDefinition) class51).anIntArray945 != null) {
			    class51 = class51.method480(anInterface17_1244,
							(byte) 47);
			    if (class51 != null)
				i_52_ = ((ObjectDefinition) class51).anInt921;
			}
			if (i_52_ != -1) {
			    Class348_Sub21 class348_sub21
			    ...
			    ((Class348_Sub21) class348_sub21).anInt6851
				= i_48_;
			    aClass262_1254.addToFront(class348_sub21, -20180);
			}
		    }
		}
	    }
				...
				for (int i_55_ = 0;
					...
					= (aClass263_1245.getObject
					   (0, (((Class318_Sub8) class318_sub8)
						.aShortArray6461
						[i_55_]) & 0xffff));
				    int i_56_ = ((ObjectDefinition) class51).anInt921;
				    if (((ObjectDefinition) class51).anIntArray945
					!= null) {
	...
	aClass348_Sub42_Sub14_1243
	    = (Class348_Sub42_Sub14) aClass356_1241.get((long) i);
    }
    
    private static final void method755
	(AbstractToolkit var_ha, int i, int i_57_, int i_58_, int i_59_, int i_60_,
	 int i_61_, int i_62_, short[] is, byte[] is_63_, boolean bool) {
	if (bool || i_60_ != 0 || i_61_ > 0) {
	    if (i_61_ == 0)
		var_ha.drawQuad(i, i_57_, i_58_, i_59_, i_60_, 0);
	    else {
		int i_64_ = i_62_ & 0x3f;
		if (i_64_ == 0 || i_58_ <= 1 || i_59_ <= 1) {
		    int i_65_ = anIntArray1260[i_61_];
		    if (bool || i_65_ != 0)
			var_ha.drawQuad(i, i_57_, i_58_, i_59_, i_65_, 0);
		} else {
		    int i_66_ = bool ? 0 : 1;
		    Widget.method424(anIntArray1260[i_61_], i_60_, var_ha, 0,
	...
	if (is != null) {
		...
		if (i_70_ == 0 || i_70_ == 2 || i_70_ == 3 || i_70_ == 9) {
		    ObjectDefinition class51
			= aClass263_1245.getObject(0, is[i_69_] & 0xffff);
		    if (((ObjectDefinition) class51).anInt875 == -1) {
			int i_71_ = -3355444;
			if (((ObjectDefinition) class51).anInt874 == 1)
			    i_71_ = -3407872;
			int i_72_ = is_63_[i_69_] >> 6 & 0x3;
			if (i_70_ == 0) {
			    if (i_72_ == 0)
				var_ha.drawVerticalLine(i, i_57_, i_59_, i_71_, 0);
			    else if (i_72_ == 1)
				var_ha.drawHorizontalLine(i, i_57_, i_58_, i_71_, 0);
			    else if (i_72_ == 2)
				var_ha.drawVerticalLine(i_67_, i_57_, i_59_, i_71_, 0);
			    else
				var_ha.drawHorizontalLine(i, i_68_, i_58_, i_71_, 0);
			} else if (i_70_ == 2) {
			    if (i_72_ == 0) {
				var_ha.drawVerticalLine(i, i_57_, i_59_, -1, 0);
				var_ha.drawHorizontalLine(i, i_57_, i_58_, i_71_, 0);
			    } else if (i_72_ == 1) {
				var_ha.drawVerticalLine(i_67_, i_57_, i_59_, -1, 0);
				var_ha.drawHorizontalLine(i, i_57_, i_58_, i_71_, 0);
			    } else if (i_72_ == 2) {
				var_ha.drawVerticalLine(i_67_, i_57_, i_59_, -1, 0);
				var_ha.drawHorizontalLine(i, i_68_, i_58_, i_71_, 0);
			    ...
			    if (i_72_ == 0)
				var_ha.drawHorizontalLine(i, i_57_, 1, i_71_, 0);
			    else if (i_72_ == 1)
				var_ha.drawHorizontalLine(i_67_, i_57_, 1, i_71_, 0);
			    else if (i_72_ == 2)
				var_ha.drawHorizontalLine(i_67_, i_68_, 1, i_71_, 0);
			    else
				var_ha.drawHorizontalLine(i, i_68_, 1, i_71_, 0);
			} else if (i_70_ == 9) {
			    if (i_72_ == 0 || i_72_ == 2) {
				for (int i_73_ = 0; i_73_ < i_59_; i_73_++)
				    var_ha.drawHorizontalLine(i + i_73_, i_68_ - i_73_, 1,
					     i_71_, 0);
			    } else {
				for (int i_74_ = 0; i_74_ < i_59_; i_74_++)
				    var_ha.drawHorizontalLine(i + i_74_, i_57_ + i_74_, 1,
					     i_71_, 0);
			    }
			}
		    }
	...
	for (int i_77_ = 0; i_77_ < i_76_; i_77_++)
	    is[i_77_] = class348_sub49.getUByte();
	int i_78_ = class348_sub49.getUByte();
	int[] is_79_ = new int[i_78_];
	for (int i_80_ = 0; i_80_ < i_78_; i_80_++)
	    is_79_[i_80_] = class348_sub49.getUByte();
	while (((ByteBuffer) class348_sub49).position
	       < ((ByteBuffer) class348_sub49).payload.length) {
	    if (class348_sub49.getUByte() == 0) {
		int i_81_ = class348_sub49.getUByte();
		int i_82_ = class348_sub49.getUByte();
		...
		int i_88_ = class348_sub49.getUByte();
		int i_89_ = class348_sub49.getUByte();
		int i_90_ = class348_sub49.getUByte();
	...
	return ((Class348_Sub42_Sub14)
		aClass356_1241.get((long) i));
    }
    
    static final Deque method758(AbstractToolkit var_ha) {
	int i = anInt1265 - anInt1274;
	...
	if (i_107_ >= 0
	    && ((TextureDefinition) var_d.getTexture(i_107_, -6662)).aBoolean209)
	    i_107_ = -1;
	int i_108_;
	if (((Class277) class277).anInt3569 >= 0) {
	    ...
	    i_108_ = (~0xffffff
			 ...
			 [(Class25.method303
			   (Class35.method353(96, -85,
					      (((TextureDefinition) var_d.getTexture(i_107_,
									-6662))
					       .aShort208)),
			    30)) & 0xffff]));
	    ...
	    i_108_ = ~0xffffff | (Class126.hslColorTable
	...
	aClass356_1271 = new HashTable(1024);
    ...
    private static final Deque method762(AbstractToolkit var_ha, int i, int i_115_,
					    int i_116_, int i_117_) {
	for (Class348_Sub21 class348_sub21
		 = (Class348_Sub21) aClass262_1254.getFirst(4);
	     class348_sub21 != null;
	     class348_sub21
		 = (Class348_Sub21) aClass262_1254.nextForward((byte) 74))
	    method747(var_ha, class348_sub21, i, i_115_, i_116_, i_117_);
	return aClass262_1254;
    }
    
    private static final void method763(AbstractToolkit var_ha, int i, int i_118_,
					int i_119_, int i_120_, short[] is,
					byte[] is_121_) {
	if (is != null) {
	    for (int i_122_ = 0; i_122_ < is.length; i_122_++) {
		ObjectDefinition class51
		    = aClass263_1245.getObject(0, is[i_122_] & 0xffff);
		int i_123_ = ((ObjectDefinition) class51).anInt875;
		if (i_123_ != -1) {
		    Class218 class218
			= aClass141_1242.method1173((byte) 31, i_123_);
		    RasterToolkit class105
			= class218.method1596((((ObjectDefinition) class51).aBoolean912
					       ? is_121_[i_122_] >> 6 & 0x3
					       : 0),
					      (((ObjectDefinition) class51).aBoolean925
					       ? (((ObjectDefinition) class51)
						  .aBoolean902)
					       : false),
					      125, var_ha);
			...
			if (((Class218) class218).aBoolean2854) {
			    int i_126_ = ((ObjectDefinition) class51).anInt961;
			    int i_127_ = ((ObjectDefinition) class51).anInt926;
    ...
    private static final void method765(AbstractToolkit var_ha, int i, int i_131_,
	...
	for (int i_136_ = 0; i_136_ < i_134_; i_136_++) {
		...
		if (i_140_ < 0 || i_140_ >= anInt1259) {
			...
			if (i_145_ == 0)
			    i_145_ = -16777216;
			var_ha.drawQuad(i_137_, i_142_, i_139_, i_144_, i_145_, 0);
		    }
		} else {
			...
			if (i_149_ > 0) {
				...
				if (i_152_ == 0)
				    i_152_ = -16777216;
				var_ha.drawQuad(i_137_, i_147_, i_139_, i_149_,
					  i_152_, 0);
			    } else if (i_154_ > 0) {
				if (i_154_ == 65535) {
				    Class348_Sub39 class348_sub39
    ...
    static final Queue method767(int i, int i_192_) {
	Queue class107 = new Queue();
	for (Class348_Sub42_Sub14 class348_sub42_sub14
		 = (Class348_Sub42_Sub14) aClass356_1241.method3484(0);
	     class348_sub42_sub14 != null;
	     class348_sub42_sub14
		...
		class107.add(class348_sub42_sub14);
	}
	return class107;
    }
