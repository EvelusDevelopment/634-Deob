    ...
    implements Interface10
{
    ...
    Class318_Sub1_Sub3_Sub2(AbstractToolkit var_ha, ObjectDefinition class51, int i, int i_0_,
	...
	super(i, i_0_, i_1_, i_2_, i_3_, i_4_, i_5_, i_6_, i_7_,
	      ((ObjectDefinition) class51).anInt895 == 1,
	      Class220.method1606(i_9_, -27939, i_8_));
	try {
	...
	if (i != -25675)
	    return -125;
	anInt10061++;
	return ((Class318_Sub1_Sub3_Sub2) this).aClass235_10045
		   .method1664(i ^ 0x6462);
    }
	...
	anInt10048++;
	if (i != -12031)
	    ((Class318_Sub1_Sub3_Sub2) this).aClass235_10045 = null;
    }
    
    final boolean method2391(AbstractToolkit var_ha, int i, int i_11_, int i_12_) {
	anInt10040++;
	AnimatableToolkit class64
	    = ((Class318_Sub1_Sub3_Sub2) this).aClass235_10045
		  .method1668(false, false, i_12_ + -127, 131072, var_ha);
	if (class64 == null)
	    return false;
	if (i_12_ != 0)
	    return false;
	...
	if (!Class305.aBoolean3870)
	    return class64.method628(i_11_, i, class101, false, 0);
	return class64.method623(i_11_, i, class101, false, 0,
				 Class132.anInt1906);
    }
	...
	if (i != -32228)
	    aClass30_10051 = null;
	anInt10044++;
	return (((Class235) ((Class318_Sub1_Sub3_Sub2) this).aClass235_10045)
		.anInt3052);
    }
	...
	if (i != -14218)
	    aClass30_10051 = null;
	((Class318_Sub1_Sub3_Sub2) this).aClass235_10045.method1674(-1,
								    var_ha);
    }
    
    final Class318_Sub4 method2386(int i, AbstractToolkit var_ha) {
	anInt10057++;
	AnimatableToolkit class64 = ((Class318_Sub1_Sub3_Sub2) this).aClass235_10045
	...
	if ((((Class235) ((Class318_Sub1_Sub3_Sub2) this).aClass235_10045)
	     .aClass318_Sub10_3081)
	    != null) {
	    Class98 class98
		= ((Class235) ((Class318_Sub1_Sub3_Sub2) this).aClass235_10045)
	...
	aBoolean10055
	    = class64.F() || (((Class235) (((Class318_Sub1_Sub3_Sub2) this)
					   .aClass235_10045))
			      .aClass318_Sub10_3081) != null;
	if (aClass30_10051 != null)
	...
	if (i != 836)
	    method44(-65, null);
	anInt10059++;
	((Class318_Sub1_Sub3_Sub2) this).aClass235_10045.method1667((byte) 116,
								    var_ha);
    }
	...
	if (i != -18443)
	    return true;
	anInt10043++;
	return ((Class318_Sub1_Sub3_Sub2) this).aClass235_10045.method1665(2);
    }
	...
	if (bool != true)
	    return 68;
	anInt10038++;
	return ((Class318_Sub1_Sub3_Sub2) this).aClass235_10045.method1663(80);
    }
}
