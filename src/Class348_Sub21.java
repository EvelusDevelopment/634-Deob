...
final class Class348_Sub21 extends Node
{
    int anInt6847;
	...
	anInt6856++;
	if (za_Sub1.anInt9775 != -1 && FileIndexTracker.anInt4803 != -1) {
	    int i_0_ = ((Class117.anInt1780 * (Class331.anInt4133
					       + -ModernLoadingScreen.anInt5019)
			 >> 1817537424)
			+ ModernLoadingScreen.anInt5019);
		...
		int i_14_ = 3 * (Class348_Sub43.anIntArrayArrayArray7079
				 [FileIndexTracker.anInt4803][i_11_][i_13_]);
		int i_15_ = 3 * (Class348_Sub43.anIntArrayArrayArray7079
				 [FileIndexTracker.anInt4803][i_11_ + 1][i_13_]);
		int i_16_ = (((Class348_Sub43.anIntArrayArrayArray7079
			       [FileIndexTracker.anInt4803][2 + i_11_][i_13_])
			      + (-(Class348_Sub43.anIntArrayArrayArray7079
				   [FileIndexTracker.anInt4803][3 + i_11_][i_13_])
				 + (Class348_Sub43.anIntArrayArrayArray7079
				    [FileIndexTracker.anInt4803][i_11_ - -2][i_13_])))
			     * 3);
    ...
    static int XOR(int i, int i_24_) {
	return i ^ i_24_;
    }
