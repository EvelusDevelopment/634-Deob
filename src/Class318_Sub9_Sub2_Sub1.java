...
final class Class318_Sub9_Sub2_Sub1 extends Class318_Sub9_Sub2
{
	...
	((Class318_Sub10) (((Class318_Sub7) (((Class318_Sub9_Sub2_Sub1) this)
	    ...
	    = null;
	Class239_Sub25.aClass318_Sub9_Sub2_Sub1Array6103[Main.anInt5171]
	    = this;
	Main.anInt5171 = Main.anInt5171 + 1 & 0x3ff;
    ...
    final void method2522(AbstractToolkit var_ha, long l) {
	int i
	...
	if (i_1_ > 0 || i_1_ < -262144 || i < 0 || i >= Class318_Sub7.anInt6451
		...
		class357
		    = Message.aClass357ArrayArrayArray2029[i_5_][i][i_0_];
		if (class357 == null) {
		    if (i_5_ == 0
			...
			class357
			    ...
			    = new Class357(0);
		    boolean bool
			= (((Class357) (Message.aClass357ArrayArrayArray2029
			...
			if ((Message.aClass357ArrayArrayArray2029[i_6_][i]
			     [i_0_])
			    == null) {
			    class357
				= Message.aClass357ArrayArrayArray2029
	...
	if (aShort10420 <= 0)
		...
		Node class348
			...
			((Class318_Sub10) class318_sub10).aClass262_6479)
		       .parent);
		for (Node class348_39_
			 = ((Node) class348).nodeParent;
		     class348_39_ != class348;
		     class348_39_ = ((Node) class348_39_).nodeParent) {
		...
		if (((Class181) class181).anIntArray2385 == null) {
			...
			((Class181) class181).anIntArray2385[i_63_]
			    = ((Class348_Sub35) (Class348_Sub35)
			       (Class59_Sub2_Sub2.aClass356_8679.get
