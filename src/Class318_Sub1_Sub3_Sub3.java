...
abstract class Class318_Sub1_Sub3_Sub3 extends Class318_Sub1_Sub3
{
    ...
    int anInt10244;
    int anInt10245;
    private static short[][] aShortArrayArray10246
    ...
    int anInt10322;
    AnimatableToolkit[] aClass64Array10323;
	...
	if (i != 72)
	    method2438(-88, 93, -127, 68, 7, -76, 116, (byte) 122);
	anInt10249++;
	int i_1_ = method2421((byte) 127);
	if ((i_1_ ^ 0xffffffff) != 0)
	    return Class64_Sub3.aClass261_5558.method1983(i_1_, 32);
	...
	int i_20_ = ((((Class318_Sub1_Sub3) this).aShort8750
		      + ((Class318_Sub1_Sub3) this).aShort8747)
		     >> 1919701089);
	int i_21_ = Class70.sineTable[i];
	int i_22_ = Class70.cosineTable[i];
	int i_23_ = -i_14_ / 2;
	int i_24_ = -i_16_ / 2;
	int i_25_ = i_23_ * i_22_ + i_24_ * i_21_ >> -2111512946;
	...
	int i_28_ = i_14_ / 2;
	int i_29_ = -i_16_ / 2;
	int i_30_ = i_28_ * i_22_ + i_21_ * i_29_ >> 381645678;
	...
	int i_33_ = -i_14_ / 2;
	int i_34_ = i_16_ / 2;
	int i_35_ = i_34_ * i_21_ - -(i_33_ * i_22_) >> -106654962;
	...
	((Class318_Sub1_Sub3_Sub3) this).aClass64Array10323 = new AnimatableToolkit[3];
	((Class318_Sub1_Sub3_Sub3) this).anInt10319 = 0;
	...
	(int i, int i_56_, Class348_Sub42_Sub13 class348_sub42_sub13,
	 int i_57_, int i_58_, int i_59_, int i_60_, AbstractToolkit var_ha, int i_61_,
	 int i_62_, int i_63_, int i_64_) {
	try {
	    if (i_62_ < 111)
		aShortArrayArray10246 = null;
	    if (i_63_ < i_57_ && i_57_ < i_58_ + i_63_
		&& (i_56_ - 13 ^ 0xffffffff) > (i_60_ ^ 0xffffffff)
		&& i_60_ < 3 + i_56_)
		i = i_59_;
	    anInt10212++;
	    String string
		= Class348_Sub15.method2812(-44, class348_sub42_sub13);
	    Deque.b12fullFontRasterizer.method2567(i_56_, string, (byte) 120, i, 0,
					       i_63_ - -3,
    ...
    final void method2432(AbstractToolkit var_ha, int i, Class101 class101, boolean bool,
			  AnimatableToolkit[] class64s) {
	do {
	    try {
		if (i == -15074) {
		    anInt10256++;
		    if (!bool) {
			AnimatableToolkit class64 = class64s[0];
			AnimatableToolkit class64_65_ = class64s[1];
			AnimatableToolkit class64_66_ = class64s[2];
			if (class64 != null) {
				...
				if (i_68_ != 1) {
				    ...
				    class129s_75_ = class129s_71_;
				else if (class129s_73_ != null)
				    class129s_75_ = class129s_73_;
				else
				    class129s_75_ = class129s;
				Object object_77_ = null;
				Class342[] class342s_78_;
				if ((i_70_ ^ 0xffffffff) == -2) {
				    if (class342s_72_ != null)
					class342s_78_ = class342s_72_;
				    else if (class342s_74_ == null)
					class342s_78_ = class342s;
				    else
					class342s_78_ = class342s_74_;
				} else {
				...
				((Class318_Sub1_Sub3_Sub3) this)
				    ...
				    (var_ha, (long) Class367_Sub11.logicCycle,
	...
	if (Class65.aClass357ArrayArrayArray1148 != null) {
	    for (int i = 0; i < Class65.aClass357ArrayArrayArray1148.length;
		 i++) {
		for (int i_80_ = 0; i_80_ < Class318_Sub7.anInt6451; i_80_++) {
		    for (int i_81_ = 0; i_81_ < Class348_Sub41.anInt7054;
			 i_81_++) {
			if ((Class65.aClass357ArrayArrayArray1148[i][i_80_]
			     [i_81_])
			    != null)
			    Class65.aClass357ArrayArrayArray1148[i][i_80_]
				[i_81_].method3485(true);
			Class65.aClass357ArrayArrayArray1148[i][i_80_][i_81_]
			    = null;
		    }
		}
	    }
	...
	if (GraphicsFetcher.aClass357ArrayArrayArray9082 != null) {
	    for (int i = 0;
		 i < GraphicsFetcher.aClass357ArrayArrayArray9082.length;
		 i++) {
		for (int i_82_ = 0; i_82_ < Class318_Sub7.anInt6451; i_82_++) {
		    for (int i_83_ = 0; i_83_ < Class348_Sub41.anInt7054;
			 i_83_++) {
			if ((GraphicsFetcher.aClass357ArrayArrayArray9082
			     [i][i_82_][i_83_])
			    != null)
			    GraphicsFetcher
				.aClass357ArrayArrayArray9082[i][i_82_][i_83_]
				.method3485(true);
			GraphicsFetcher.aClass357ArrayArrayArray9082[i]
			    [i_82_][i_83_]
			    = null;
		    }
		}
	...
	GraphicsFetcher.aClass357ArrayArrayArray9082 = null;
	...
	if (Class239_Sub21.aClass318_Sub1Array6066 != null) {
	    for (int i = 0; i < Class239_Sub21.aClass318_Sub1Array6066.length;
		 i++)
		Class239_Sub21.aClass318_Sub1Array6066[i] = null;
	    Class5_Sub1_Sub1.anInt9930 = 0;
	}
	if (IndexTable.aClass318_Sub1Array3737 != null) {
	    for (int i = 0; i < IndexTable.aClass318_Sub1Array3737.length; i++)
		IndexTable.aClass318_Sub1Array3737[i] = null;
	...
	if (Class239_Sub14.aClass211Array5993 != null) {
		...
		for (int i_84_ = 0; i_84_ < Class318_Sub7.anInt6451; i_84_++) {
		    for (int i_85_ = 0; i_85_ < Class348_Sub41.anInt7054;
			 i_85_++)
	...
	if (GfxLoader.aClass315Array3982 != null)
	    GfxLoader.aClass315Array3982 = null;
	Class9.aHa171 = null;
    }
	...
	if (i_88_ != -1 && i_92_ != -1) {
		...
		GfxDefinition class368 = Class348_Sub40_Sub18.gfxLoader
					.loadDefinition((byte) 109, i_88_);
		GfxDefinition class368_93_
		    = Class348_Sub40_Sub18.gfxLoader.loadDefinition((byte) 99,
								     i_92_);
		if ((((GfxDefinition) class368).anInt4503 ^ 0xffffffff) != 0
		    && ((GfxDefinition) class368_93_).anInt4503 != -1) {
		    AnimationDefinition class17
			= Class10.animationLoader
			      .method835(((GfxDefinition) class368).anInt4503, 7);
		    AnimationDefinition class17_94_
			= Class10.animationLoader.method835((((GfxDefinition)
							   class368_93_)
							  .anInt4503),
							 i_89_ ^ ~0x3c5664d6);
		    if (((AnimationDefinition) class17_94_).anInt239
			> ((AnimationDefinition) class17).anInt239)
			return;
		}
	    } else {
		GfxDefinition class368
		    = Class348_Sub40_Sub18.gfxLoader.loadDefinition((byte) 65,
								     i_88_);
		if (((GfxDefinition) class368).aBoolean4487
			...
			= Class10.animationLoader
			      .method835(((GfxDefinition) class368).anInt4503, 7);
		    int i_95_ = ((AnimationDefinition) class17).anInt248;
	...
	int i_96_ = Class367_Sub11.logicCycle;
	if (i_89_ != -1012294866)
	...
	if (bool) {
		...
		&& ((i_96_ ^ 0xffffffff)
		    == (((Class318_Sub1_Sub3_Sub3) this).anInt10211
			^ 0xffffffff))) {
		int i_97_ = (((GfxDefinition)
			      (Class348_Sub40_Sub18.gfxLoader.loadDefinition
			       ((byte) 98,
				((Class318_Sub1_Sub3_Sub3) this).anInt10291)))
			     .anInt4503);
		if (i_97_ != -1) {
		    AnimationDefinition class17 = Class10.animationLoader.method835(i_97_, 7);
		    if (class17 != null
			&& ((AnimationDefinition) class17).anIntArray237 != null
			&& !((Class318_Sub1_Sub3_Sub3) this).aBoolean10309)
			GametipDefinition.method2178(this, 0, class17,
					    i_89_ + 1012294835);
		}
	    }
	} else {
		...
		int i_98_ = (((GfxDefinition)
			      (Class348_Sub40_Sub18.gfxLoader.loadDefinition
			       ((byte) 103,
				((Class318_Sub1_Sub3_Sub3) this).anInt10269)))
			     .anInt4503);
		if (i_98_ != -1) {
		    AnimationDefinition class17 = Class10.animationLoader.method835(i_98_, 7);
		    if (class17 != null
			&& ((AnimationDefinition) class17).anIntArray237 != null
			&& !((Class318_Sub1_Sub3_Sub3) this).aBoolean10309)
			GametipDefinition.method2178(this, 0, class17, -128);
		}
	    }
	}
    }
    
    final void method2438(int i, int i_99_, int i_100_, int i_101_, int i_102_,
			  int i_103_, int i_104_, byte i_105_) {
	anInt10228++;
	boolean bool = true;
	...
	if (i_105_ > 91) {
	    ...
	    if (i_100_ >= 0) {
		Class31 class31
		    = FileArchiveTracker.aClass219_4782.method1601(46, i_100_);
		...
		if (bool)
		    aByte10222 = (byte) 0;
		for (int i_111_ = 0;
		     (Class132.anInt1905 ^ 0xffffffff) < (i_111_ ^ 0xffffffff);
		     i_111_++) {
		...
		if ((i_109_ ^ 0xffffffff) == -2
		    && (i ^ 0xffffffff) >= (i_113_ ^ 0xffffffff))
		    return;
	    }
	    if (i_108_ >= 0) {
    ...
    final void method2439(int i, AnimatableToolkit class64) {
	try {
	    anInt10205++;
	...
	aShortArrayArray10258
	    = (new short[][]
		 ...
		 { 4550, 12, 78, 8384, 14511, 9162, 5056, 939, 5025, 4760,
		   9108, 7719, 14241, 22443, 30247, -29781, -25675, -21568,
		   -17472, -12373, -8256, -3545 } });
	aShortArrayArray10204
	    = new short[][] { new short[0], new short[0], new short[0],
			      new short[0], new short[0] };
	aShortArrayArrayArray10253
	    = new short[][][] { aShortArrayArray10258, aShortArrayArray10204,
				aShortArrayArray10246 };
    }
}
