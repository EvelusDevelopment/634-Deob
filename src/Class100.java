...
final class Class100
{
    ...
    static BufferedFile[] bufferedCacheFiles = new BufferedFile[37];
    static int anInt1580;
    private DirectxToolkit aHa_Sub2_1581;
    private Class83 aClass83_1582;
    static int[] anIntArray1583 = new int[14];
    private int anInt1584 = 0;
    static HashTable aClass356_1585 = new HashTable(16);
    ...
    static final void method887(Widget class46, int i, int i_5_, int i_6_) {
	if (i_6_ == 2147483647) {
	    anInt1589++;
	    if (Class289.aClass46_3701 == null && !Class5_Sub1.aBoolean8335
		&& (class46 != null
		    && (ToolkitException.method141(class46, (byte) -79)
			!= null))) {
		Class289.aClass46_3701 = class46;
		Class331.aClass46_4130
		    = ToolkitException.method141(class46, (byte) -117);
    ...
    static final int method888(byte i, int i_7_, Widget class46) {
	anInt1580++;
	if (i != 57)
	    method886(7);
	if (!Main.method105(class46).method3301(i_7_, false)
	    && ((Widget) class46).anObjectArray741 == null)
	    return -1;
	if (((Widget) class46).anIntArray706 != null
	    && i_7_ < ((Widget) class46).anIntArray706.length)
	    return ((Widget) class46).anIntArray706[i_7_];
	return -1;
    }
    ...
    Class100(DirectxToolkit var_ha_Sub2) {
	anInt1578 = 0;
	anInt1592 = 0;
