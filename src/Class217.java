...
final class Class217
{
    ...
    private IndexLoader aClass45_2842;
    static int anInt2843;
    static Cache aClass60_2844 = new Cache(64);
    int anInt2845;
    static int anInt2846;
    static int anInt2847;
    private Cache aClass60_2848 = new Cache(64);
	...
	synchronized (aClass45_2842) {
	    is = aClass45_2842.loadArchiveChild(-1860, 16, i_1_);
	    if (i >= -17)
		aClass60_2848 = null;
	}
	class159 = new Class159();
	if (is != null)
	    class159.method1253(new ByteBuffer(is), true);
	synchronized (aClass60_2848) {
    ...
    Class217(GameMode class230, int i, IndexLoader class45) {
	try {
