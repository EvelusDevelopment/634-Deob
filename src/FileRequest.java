/* FileRequest - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

abstract class FileRequest extends SubNode
{
    static Class21 aClass21_9661;
    static int anInt9662;
    boolean boolParameter;
    volatile boolean isActive = true;
    static String overheadCenterLoadingText = null;
	...
	aClass21_9661 = null;
	overheadCenterLoadingText = null;
	if (i != 353)
	    aClass21_9661 = null;
    }
	...
	Class357 class357
	    = Message.aClass357ArrayArrayArray2029[i][i_0_][i_1_];
	if (class357 != null) {
    ...
    abstract int getPercentComplete();
