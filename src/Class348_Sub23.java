...
abstract class Class348_Sub23 extends Node
{
	...
	if ((i ^ 0xffffffff) == -1) {
	    Class348_Sub8.currentToolkit = Class104.method958(true, 0, Class348_Sub40_Sub4.textureLoader, ((Class348_Sub51) BitmapTable.aClass348_Sub51_3959).aClass239_Sub20_7248.method1808(-32350) * 2, Class305.canvas, EntryElementLoader.indexLoader31);
	    if (string != null) {
		Class348_Sub8.currentToolkit.drawScreenOverlay(0);
		BitmapFont class143 = Class239_Sub23.method1819(AnimationDefinition.p12fullArchiveId, 0, -117, Class104.indexLoader13);
		AbstractFontRasterizer class324 = (Class348_Sub8.currentToolkit.createFontRasterizer
				     (class143,
				      Sprite.loadSprites(Class21.indexLoader8,
							  AnimationDefinition.p12fullArchiveId, 0),
				      true));
	    ...
	    AbstractToolkit var_ha = null;
	    if (string != null) {
		var_ha
		    = Class104.method958(true, 0, Class348_Sub40_Sub4.textureLoader,
					 0, Class305.canvas,
					 EntryElementLoader.indexLoader31);
		var_ha.drawScreenOverlay(0);
		BitmapFont class143
		    = Class239_Sub23.method1819(AnimationDefinition.p12fullArchiveId, 0, -115,
						Class104.indexLoader13);
		AbstractFontRasterizer class324
		    = var_ha.createFontRasterizer(class143,
					Sprite.loadSprites((Class21
							     .indexLoader8),
							    AnimationDefinition.p12fullArchiveId,
							    0),
					true);
	    ...
	    try {
		Class348_Sub8.currentToolkit
		    = Class104.method958(true, i, Class348_Sub40_Sub4.textureLoader,
					 2 * ((Class348_Sub51)
		...
		if (string != null) {
		    var_ha.drawScreenOverlay(0);
		    BitmapFont class143
			= Class239_Sub23.method1819(AnimationDefinition.p12fullArchiveId, 0, -51,
						    Class104.indexLoader13);
		    AbstractFontRasterizer class324
			= (var_ha.createFontRasterizer
			   (class143,
			    Sprite.loadSprites(Class21.indexLoader8,
						AnimationDefinition.p12fullArchiveId, 0),
			    true));
		...
		if (Class348_Sub8.currentToolkit.method3693()) {
		    ...
		    za var_za;
		    if (!bool_2_)
			var_za = Class348_Sub8.currentToolkit.method3702(104857600);
		    else
			var_za = Class348_Sub8.currentToolkit.method3702(146800640);
		    Class348_Sub8.currentToolkit.method3651(var_za);
		}
	    } catch (Throwable throwable) {
	...
	Class348_Sub8.currentToolkit.method3650(10000);
	Class348_Sub8.currentToolkit.X(32);
	Class157.aClass101_2123 = Class348_Sub8.currentToolkit.method3654();
	Class50_Sub1.aClass101_5209 = Class348_Sub8.currentToolkit.method3654();
	Class290.method2196((byte) -9);
	Class348_Sub8.currentToolkit.method3630(((Class348_Sub51)
					  BitmapTable.aClass348_Sub51_3959)
					     .aClass239_Sub2_7228
					     .method1726(-32350) == 1);
