...
final class Class324_Sub5 extends AbstractFontRasterizer
{
    private DirectxToolkit aHa_Sub2_6509;
    private Class61 aClass61_6510;
    private Class258_Sub3_Sub1 aClass258_Sub3_Sub1_6511;
    private boolean aBoolean6512;
    
    Class324_Sub5(DirectxToolkit var_ha_Sub2, BitmapFont class143, Sprite[] class207s,
		  boolean bool) {
	super(var_ha_Sub2, class143);
	aHa_Sub2_6509 = var_ha_Sub2;
	int i = 0;
	for (int i_0_ = 0; i_0_ < 256; i_0_++) {
	    Sprite class207 = class207s[i_0_];
	...
	if (bool) {
		...
		Sprite class207 = class207s[i_2_];
		int i_3_ = ((Sprite) class207).indexHeight;
		int i_4_ = ((Sprite) class207).indexWidth;
		int i_5_ = i_2_ % 16 * i;
		int i_6_ = i_2_ / 16 * i;
		int i_7_ = i_6_ * i_1_ + i_5_;
		int i_8_ = 0;
		if (((Sprite) class207).alphaIndex == null) {
		    byte[] is_9_ = ((Sprite) class207).colorIndex;
		    ...
		    byte[] is_12_ = ((Sprite) class207).alphaIndex;
		...
		Sprite class207 = class207s[i_15_];
		int[] is_16_ = ((Sprite) class207).colors;
		byte[] is_17_ = ((Sprite) class207).alphaIndex;
		byte[] is_18_ = ((Sprite) class207).colorIndex;
		int i_19_ = ((Sprite) class207).indexHeight;
		int i_20_ = ((Sprite) class207).indexWidth;
	...
	for (int i_31_ = 0; i_31_ < 256; i_31_++) {
	    Sprite class207 = class207s[i_31_];
	    int i_32_ = ((Sprite) class207).indexHeight;
	    int i_33_ = ((Sprite) class207).indexWidth;
	    int i_34_ = ((Sprite) class207).heightOffset;
	    int i_35_ = ((Sprite) class207).widthOffset;
    ...
    final void drawCharacter(char c, int i, int i_42_, int i_43_, boolean bool,
    ...
    final void drawCharacter(char c, int i, int i_47_, int i_48_, boolean bool) {
	aHa_Sub2_6509.method3735(9473);
