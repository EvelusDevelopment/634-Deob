...
{
    static OutgoingPacket aClass351_5200 = new OutgoingPacket(13, 2);
    int[] anIntArray5201;
    int[] anIntArray5202;
    static int anInt5203;
    static OutgoingPacket aClass351_5204 = new OutgoingPacket(15, 8);
    static int anInt5205;
    static Class348_Sub6 aClass348_Sub6_5206 = new Class348_Sub6(0, 0);
    static IndexLoader indexLoader7;
	...
	do {
	    if (!((Signlink) Class348_Sub23_Sub1.signlink)
		 .aBoolean3794) {
		try {
		    Method method
