...
final class GameText
{
    ...
    static GameText developerConsoleGameText
	= (new GameText
    ...
    static GameText aClass274_3485
	= (new GameText
	   ("There was an error executing the command.",
	    "Es gab einen Fehler beim Ausf\u00fchren des Befehls.",
	    "Une erreur s'est produite lors de l'ex\u00e9cution de la commande.",
	    "Houve um erro quando o comando foi executado."));
    static GameText unknwnDeveloperCommandGameText
	= new GameText("Unknown developer command: ", "Unbekannter Befehl: ",
		       "Commande inconnue : ", "Comando desconhecido: ");
    static GameText aClass274_3487
	= new GameText("Cancel", "Abbrechen", "Annuler", "Cancelar");
    static GameText aClass274_3488;
    static GameText aClass274_3489;
    static GameText aClass274_3490;
    static GameText aClass274_3491;
    static GameText aClass274_3492;
    static GameText aClass274_3493;
    static GameText aClass274_3494;
    static GameText loadingPleaseWaitGameText;
    static GameText aClass274_3496;
    static GameText connectionLostGameText;
    static GameText aClass274_3498;
    static GameText checkingUpdatesGameText;
    static GameText fetchingUpdatesGameText;
    static GameText aClass274_3501;
    static GameText aClass274_3502;
    static GameText aClass274_3503;
    static GameText aClass274_3504;
    static GameText examineGameText;
    static GameText attackGameText;
    static GameText aClass274_3507;
    static GameText moreOptionsGameText;
    static GameText walkHereGameText;
    static GameText aClass274_3510;
    static GameText levelGameText;
    static GameText skillGameText;
    static GameText ratingGameText;
    static GameText pleaseWaitGameText;
    static GameText aClass274_3515;
    static GameText aClass274_3516;
    static GameText aClass274_3517;
    static GameText aClass274_3518;
    static GameText aClass274_3519;
    static GameText aClass274_3520;
    static GameText aClass274_3521;
    static GameText aClass274_3522;
    static GameText aClass274_3523;
    static GameText aClass274_3524;
    static GameText aClass274_3525;
    static GameText aClass274_3526;
    static GameText aClass274_3527;
    static GameText aClass274_3528;
    static GameText aClass274_3529;
    static GameText aClass274_3530;
    static GameText aClass274_3531;
    static GameText aClass274_3532;
    static GameText aClass274_3533;
    static GameText aClass274_3534;
    static GameText aClass274_3535;
    static GameText aClass274_3536;
    static GameText aClass274_3537;
    static GameText aClass274_3538;
    static GameText aClass274_3539;
    static GameText aClass274_3540;
    static GameText aClass274_3541;
    static GameText aClass274_3542;
    static GameText aClass274_3543;
    static GameText aClass274_3544;
    static GameText aClass274_3545;
    static GameText aClass274_3546;
    static Class190 aClass190_3547;
	...
	aClass274_3530 = null;
	aClass274_3533 = null;
	walkHereGameText = null;
	aClass274_3503 = null;
	fetchingUpdatesGameText = null;
	aClass274_3537 = null;
	aClass274_3504 = null;
	examineGameText = null;
	aClass274_3540 = null;
	pleaseWaitGameText = null;
	aClass274_3515 = null;
	aClass274_3531 = null;
	aClass274_3543 = null;
	if (i > -88)
	...
	aClass274_3522 = null;
	aClass274_3485 = null;
	developerConsoleGameText = null;
	aClass274_3488 = null;
	aClass274_3496 = null;
	connectionLostGameText = null;
	aClass274_3526 = null;
	aClass274_3538 = null;
	aClass274_3487 = null;
	aClass274_3507 = null;
	...
	aClass274_3490 = null;
	aClass274_3532 = null;
	moreOptionsGameText = null;
	aClass274_3541 = null;
	aClass274_3492 = null;
	aClass274_3517 = null;
	checkingUpdatesGameText = null;
	aClass274_3498 = null;
	aClass274_3529 = null;
	aClass274_3516 = null;
	aClass274_3502 = null;
	...
	aClass274_3494 = null;
	aClass274_3524 = null;
	unknwnDeveloperCommandGameText = null;
	aClass274_3525 = null;
	aClass274_3521 = null;
	skillGameText = null;
	aClass274_3534 = null;
	...
	attackGameText = null;
	aClass274_3527 = null;
	loadingPleaseWaitGameText = null;
	aClass274_3546 = null;
    }
	...
	Class348_Sub42_Sub14.putBufferedPacket(37, class348_sub47);
	...
	DummyOutputstream.aClass105_106 = null;
	NativeLibTracker.aClass105_4808 = null;
	AbstractLobbyWorld.aClass105_1706 = null;
    }
    
    static final void method2062(byte i) {
	if (Message.aClass338Array2034 != null) {
	    for (int i_3_ = 0;
		 (Class239_Sub26.anInt6115 ^ 0xffffffff) < (i_3_ ^ 0xffffffff);
		 i_3_++)
		Message.aClass338Array2034[i_3_] = null;
	    Message.aClass338Array2034 = null;
	}
	anInt3480++;
	if (Class318_Sub1_Sub3_Sub4.aClass338Array10330 != null) {
	    for (int i_4_ = 0; i_4_ < ElementLoaderNode.anInt1200; i_4_++)
		Class318_Sub1_Sub3_Sub4.aClass338Array10330[i_4_] = null;
	    Class318_Sub1_Sub3_Sub4.aClass338Array10330 = null;
	}
	if (ClassicLoadingScreen.aClass338Array5060 != null) {
	    for (int i_5_ = 0; i_5_ < Class348_Sub44.anInt7101; i_5_++)
		ClassicLoadingScreen.aClass338Array5060[i_5_] = null;
	    ClassicLoadingScreen.aClass338Array5060 = null;
	}
    ...
    final String getLanguageText(int i) {
	anInt3479++;
	return languageText[i];
    }
    
    static {
	new GameText("#Player", "#Spieler", "#Joueur", "#Jogador");
	aClass274_3488
	    = new GameText("Members object", "Gegenstand f\u00fcr Mitglieder",
	...
	aClass274_3489
	    = new GameText("Discard", "Ablegen", "Jeter", "Descartar");
	aClass274_3490 = new GameText("Take", "Nehmen", "Prendre", "Pegar");
	aClass274_3491
	    = new GameText("Drop", "Fallen lassen", "Poser", "Largar");
	new GameText("Ok", "Okay", "OK", "Ok");
	new GameText("Select", "Ausw\u00e4hlen", "S\u00e9lectionner",
		     "Selecionar");
	aClass274_3492
	    = new GameText("Continue", "Weiter", "Continuer", "Continuar");
	new GameText("Invalid player name.",
		     "Unzul\u00e4ssiger Charaktername!",
		     "Nom de joueur incorrect.",
		     "Nome de jogador inv\u00e1lido.");
	new GameText("You can't report yourself!",
	...
	new GameText(null, "Dieses System darf nicht missbraucht werden!",
		     null, null);
	new GameText
	...
	new GameText("Invalid name", "Unzul\u00e4ssiger Name!",
	...
	new GameText("You can't reach that.", "Da kommst du nicht hin.",
	...
	aClass274_3493
		...
		"Votre liste d'amis est pleine (200 noms maximum pour la version gratuite et 200 pour les abonn\u00e9s).",
		"Sua lista de amigos est\u00e1 cheia. O limite \u00e9 200 para usu\u00e1rios n\u00e3o pagantes, e 200 para membros."));
	aClass274_3494
	    = (new GameText
	       (null,
		"Mitglieder k\u00f6nnen 200 Freunde hinzuf\u00fcgen, freie Spieler nur 200.",
		null, null));
	new GameText
	...
	new GameText(null, "der Spieler ist momentan nicht verf\u00fcgbar.",
		     null, null);
	new GameText
	...
	new GameText(null, "Spieler nicht auf deiner Freunde-Liste.", null,
		     null);
	new GameText
	...
	new GameText(null, "indem du dich ins Spiel einloggst.", null, null);
	new GameText
	...
	new GameText("clan_chat", "clanchat", "conversation_clan",
		     "clan_chat");
	new GameText
	    ("You are not currently in a clan channel.",
	...
	new GameText("Attempting to join channel...",
	...
	new GameText
	    ("Now talking in clan channel of player: ",
	...
	new GameText
	    ("You do not have a high enough rank to join this clan channel.",
	...
	new GameText("You have left the channel.",
	...
	new GameText("Your clan channel has now been disabled!",
		     ...
		     "Votre canal de clan est d\u00e9sactiv\u00e9.",
	...
	new GameText("This mute will remain for a further ",
	...
	loadingPleaseWaitGameText
	    = new GameText("Loading - please wait.",
			   "Ladevorgang - bitte warte.",
			   "Chargement en cours. Veuillez patienter.",
			   "Carregando. Aguarde.");
	aClass274_3496 = new GameText("Profiling...", "Profiling...",
				      "Profilage...", "Profiling...");
	connectionLostGameText
	    = new GameText("Connection lost.", "Verbindung abgebrochen.",
	...
	checkingUpdatesGameText
	    = new GameText("Checking for updates - ", "Suche nach Updates - ",
			   "V\u00e9rification des mises \u00e0 jour - ",
			   "Verificando atualiza\u00e7\u00f5es - ");
	fetchingUpdatesGameText = new GameText("Fetching Updates - ", "Lade Update - ",
				      "Chargement des MAJ - ",
	...
	new GameText("Loaded sprites", "Sprites geladen.",
	...
	new GameText("Loading interfaces - ",
	...
	aClass274_3501
	    = new GameText("Loading...", "Lade...", "Chargement en cours...",
			   "Carregando...");
	new GameText
	...
	aClass274_3502
	    = new GameText(" has logged in.", " loggt sich ein.",
			   " s'est connect\u00e9.", " entrou no jogo.");
	aClass274_3503
	    = new GameText(" has logged out.", " loggt sich aus.",
			   " s'est d\u00e9connect\u00e9.", " saiu do jogo.");
	aClass274_3504
	    = new GameText("Unable to find ",
			   "Spieler kann nicht gefunden werden: ",
			   "Impossible de trouver ",
			   "N\u00e3o \u00e9 poss\u00edvel encontrar ");
	new GameText("Use", "Benutzen", "Utiliser", "Usar");
	examineGameText
	    = new GameText("Examine", "Untersuchen", "Examiner", "Examinar");
	attackGameText
	    = new GameText("Attack", "Angreifen", "Attaquer", "Atacar");
	aClass274_3507
	    = new GameText("Choose Option", "W\u00e4hl eine Option",
			   "Choisir une option", "Selecionar op\u00e7\u00e3o");
	moreOptionsGameText
	    = new GameText(" more options", " weitere Optionen",
			   " autres options", " mais op\u00e7\u00f5es");
	walkHereGameText = new GameText("Walk here", "Hierhin gehen",
				      "Atteindre", "Caminhar para c\u00e1");
	aClass274_3510 = new GameText("Face here", "Hierhin drehen",
				      "Regarder dans cette direction",
				      "Virar para c\u00e1");
	levelGameText
	    = new GameText("level: ", "Stufe: ", "niveau ", "n\u00edvel: ");
	skillGameText = new GameText("skill: ", "Fertigkeit: ",
				      "comp\u00e9tence ", "habilidade: ");
	ratingGameText
	    = new GameText("rating: ", "Kampfstufe: ", "classement ",
			   "qualifica\u00e7\u00e3o: ");
	pleaseWaitGameText = new GameText("Please wait...", "Bitte warte...",
	...
	new GameText
	    ("Close",
	     ...
	     "Fermez l'interface que vous avez ouverte avant d'utiliser le bouton \u00ab Signaler un abus \u00bb.",
	     "Feche a interface aberta antes de usar o recurso \"Denunciar abuso\".");
	aClass274_3515 = new GameText(" ", ": ", " ", " ");
	aClass274_3516 = new GameText("M", "M", "M", "M");
	aClass274_3517 = new GameText("M", "M", "M", "M");
	aClass274_3518 = new GameText("K", "T", "K", "K");
	aClass274_3519 = new GameText("K", "T", "K", "K");
	new GameText("From", "Von:", "De", "De");
	aClass274_3520 = new GameText("Self", "Mich", "Moi", "Eu");
	aClass274_3521
	    = new GameText(" is already on your friends list.",
	...
	aClass274_3523
	    = new GameText(" is already on your ignore list.",
	...
	new GameText
	    ("Changes will take effect on your clan in the next 60 seconds.",
	     "Die \u00c4nderungen am Chatraum werden innerhalb von 60 Sekunden g\u00fcltig.",
	...
	aClass274_3526
	    = new GameText("Please remove ", "Bitte entferne ",
			   "Veuillez commencer par supprimer ", "Remova ");
	aClass274_3527 = new GameText(" from your ignore list first.",
	...
	aClass274_3528
	    = new GameText("Please remove ", "Bitte entferne ",
			   "Veuillez commencer par supprimer ", "Remova ");
	aClass274_3529 = new GameText(" from your friends list first.",
				      " zuerst von deiner Freunde-Liste!",
				      " de votre liste d'amis.",
				      " da sua lista de amigos primeiro.");
	aClass274_3530
	    = new GameText("yellow:", "gelb:", "jaune:", "amarelo:");
	aClass274_3531 = new GameText("red:", "rot:", "rouge:", "vermelho:");
	aClass274_3532
	    = new GameText("green:", "gr\u00fcn:", "vert:", "verde:");
	aClass274_3533
	    = new GameText("cyan:", "blaugr\u00fcn:", "cyan:", "cyan:");
	aClass274_3534 = new GameText("purple:", "lila:", "violet:", "roxo:");
	aClass274_3535 = new GameText("white:", "weiss:", "blanc:", "branco:");
	aClass274_3536
	    = new GameText("flash1:", "blinken1:", "clignotant1:", "flash1:");
	aClass274_3537
	    = new GameText("flash2:", "blinken2:", "clignotant2:", "flash2:");
	aClass274_3538
	    = new GameText("flash3:", "blinken3:", "clignotant3:", "brilho3:");
	aClass274_3539
	    = new GameText("glow1:", "leuchten1:", "brillant1:", "brilho1:");
	aClass274_3540
	    = new GameText("glow2:", "leuchten2:", "brillant2:", "brilho2:");
	aClass274_3541
	    = new GameText("glow3:", "leuchten3:", "brillant3:", "brilho3:");
	aClass274_3542
	    = new GameText("wave:", "welle:", "ondulation:", "onda:");
	aClass274_3543
	    = new GameText("wave2:", "welle2:", "ondulation2:", "onda2:");
	aClass274_3544 = new GameText("shake:", "sch\u00fctteln:",
				      "tremblement:", "tremor:");
	aClass274_3545 = new GameText("scroll:", "scrollen:",
				      "d\u00e9roulement:", "rolagem:");
	aClass274_3546 = new GameText("slide:", "gleiten:", "glissement:",
				      "deslizamento:");
    }
}
