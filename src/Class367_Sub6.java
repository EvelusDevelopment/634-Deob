...
final class Class367_Sub6 extends Class367
{
    ...
    private Direct3dToolkit aClass378_7340;
	...
	((Class367_Sub6) this).aHa_Sub3_4479.method3874
	    (Class348_Sub23_Sub2.aClass229_9011, 127, OndemandWorker.aClass229_3196);
	if (i != -103)
	    method3524(55);
    }
	...
	IDirect3DDevice idirect3ddevice
	    = ((Direct3dToolkit) aClass378_7340).anIDirect3DDevice9810;
	if (((Class269) aClass269_7339).aBoolean3458) {
	    float f
		= ((float) ((((NativeToolkit) ((Class367_Sub6) this).aHa_Sub3_4479)
			     .anInt8146)
			    % 4000)
		   / 4000.0F);
	    ...
	    int i_3_ = 16 * ((((NativeToolkit) ((Class367_Sub6) this).aHa_Sub3_4479)
			      .anInt8146)
			     % 4000) / 4000;
	    ((Class367_Sub6) this).aHa_Sub3_4479.method3850
    ...
    Class367_Sub6(Direct3dToolkit class378, IndexLoader class45, Class269 class269) {
	super(class378);
	aClass269_7339 = class269;
	aClass378_7340 = class378;
	if (null == class45 || !aClass269_7339.method2039(123)
	    || (257
		> (((Direct3dToolkit) aClass378_7340).aD3DCAPS9791.VertexShaderVersion
		   & 0xffff)))
	...
	if (anIDirect3DVertexShader7341 != null) {
	    IDirect3DDevice idirect3ddevice
		= ((Direct3dToolkit) aClass378_7340).anIDirect3DDevice9810;
	    if (((NativeToolkit) ((Class367_Sub6) this).aHa_Sub3_4479).anInt8091
		<= 0)
		idirect3ddevice.a(10, 0.0F, 0.0F, 0.0F, 0.0F);
	    else {
		float f = (((NativeToolkit) ((Class367_Sub6) this).aHa_Sub3_4479)
			   .aFloat8115);
		float f_4_ = (((NativeToolkit) ((Class367_Sub6) this).aHa_Sub3_4479)
			      .aFloat8173);
		...
		(-28186,
		 ((NativeToolkit) ((Class367_Sub6) this).aHa_Sub3_4479).anInt8144);
	}
    }
