...
final class Class305
{
    ...
    private RasterToolkit aClass105_3867;
    static int anInt3868;
    static Canvas canvas;
    static boolean aBoolean3870 = false;
    private Class72 aClass72_3871;
    
    final boolean method2292(int i, AbstractToolkit var_ha, int i_0_) {
    ...
    final void method2293(int i, AbstractToolkit var_ha, byte i_6_, int i_7_, int i_8_,
			  int i_9_, int i_10_, int i_11_, int i_12_,
			  int i_13_) {
	i_10_ = 0x3fff & i + i_10_;
	anInt3860++;
	if ((anInt3858 ^ 0xffffffff) != 0 && (anInt3863 ^ 0xffffffff) != -1) {
	    TextureDefinition class12 = Class101_Sub1.aD5684.getTexture(anInt3858, -6662);
	    if (aClass105_3867 == null
		&& Class101_Sub1.aD5684.method4(-7953, anInt3858)) {
		int[] is = ((((TextureDefinition) class12).anInt200 ^ 0xffffffff) == -3
		...
		var_ha.drawQuad(i_7_, i_9_, i_8_, i_13_, i_12_, 0);
	    if (aClass105_3867 != null) {
		int i_14_ = ((TextureDefinition) class12).anInt200 == 2 ? 1 : 0;
	...
	if (i < -46) {
		...
		Class318_Sub2.messages[i_22_] = null;
	    za_Sub1.anInt9774 = 0;
	}
    }
