...
final class Class108
{
    ...
    static LocationMode aClass364_1657 = new LocationMode("WTWIP", 3);
    ...
    static RasterToolkit aClass105_1664;
    
    static final float method1012(float f, float f_0_, float f_1_, float f_2_,
				  int i, float f_3_, byte i_4_, float f_5_) {
	anInt1659++;
	float f_6_ = 0.0F;
	...
	while (f_6_ < 1.1F) {
		...
		int i_19_
		    = Class348_Sub1_Sub1.aSArray8801[i_18_]
			  .method3986((int) f_13_, (int) f_15_, (byte) 109);
		if (f_14_ > (float) i_19_) {
		    if (i < 2)
			return f_6_;
		    return (f_6_ - 0.1F
			    + method1012(f_11_, f_13_, f_12_, f_15_, i - 1,
					 f_10_, (byte) 122, f_14_) * 0.1F);
		}
	    }
	    f_10_ = f_13_;
	    f_11_ = f_14_;
	...
	anInt1660++;
	for (Class348_Sub42_Sub6 class348_sub42_sub6
		 = (Class348_Sub42_Sub6) r_Sub2.aClass262_10492.getFirst(4);
	     class348_sub42_sub6 != null;
	     class348_sub42_sub6
		 = ((Class348_Sub42_Sub6)
		    r_Sub2.aClass262_10492.nextForward((byte) 55))) {
		...
		if (((((Class318_Sub1_Sub3_Sub4) class318_sub1_sub3_sub4)
		    ...
		    if (((Class318_Sub1_Sub3_Sub4) class318_sub1_sub3_sub4)
			.aBoolean10345)
			class348_sub42_sub6.removeNode();
		    else
	...
	anInt1658++;
	Class190 class190 = Deque.aClass190ArrayArray3335[i][i_20_];
	if (class190 != null) {
