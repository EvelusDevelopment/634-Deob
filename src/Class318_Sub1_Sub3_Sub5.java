...
final class Class318_Sub1_Sub3_Sub5 extends Class318_Sub1_Sub3
{
    ...
    private AnimationDefinition aClass17_10375;
	...
	anInt10379++;
	AnimatableToolkit class64 = method2476(0, var_ha, (byte) 127);
	if (class64 != null) {
	    if (i >= -125)
    ...
    private final void method2473(Class101 class101, AnimatableToolkit class64,
				  AbstractToolkit var_ha, int i) {
	do {
	    try {
		anInt10406++;
		...
		if ((aClass318_Sub10_10378 == null
			...
			= Class318_Sub10.method2526(Class367_Sub11.logicCycle,
						    true);
		if (aClass318_Sub10_10378 != null) {
	...
	if (!aBoolean10407 && i == 121) {
		...
		if ((anInt10387 ^ 0xffffffff) > -1) {
			...
			= ((Class348_Sub22)
			   Class282.aClass356_3654.get((long) i_10_));
	...
	anInt10397++;
	AnimatableToolkit class64 = method2476(2048, var_ha, (byte) 127);
	if (class64 == null)
	    return null;
	Class101 class101 = var_ha.method3705();
	class101.method899(anInt10396);
    ...
    final boolean method2391(AbstractToolkit var_ha, int i, int i_19_, int i_20_) {
	if (i_20_ != 0)
	    return true;
	anInt10380++;
	return false;
	...
	if (aClass17_10375 != null) {
	    ...
	    while ((anInt10403 ^ 0xffffffff)
		   < (((AnimationDefinition) aClass17_10375).anIntArray267[anInt10365]
		      ^ 0xffffffff)) {
		anInt10403
		    -= ((AnimationDefinition) aClass17_10375).anIntArray267[anInt10365];
		anInt10365++;
		if ((((AnimationDefinition) aClass17_10375).anIntArray237.length
		     ^ 0xffffffff)
		    >= (anInt10365 ^ 0xffffffff)) {
		    anInt10365 -= ((AnimationDefinition) aClass17_10375).anInt238;
		    if ((anInt10365 ^ 0xffffffff) > -1
			|| anInt10365 >= (((AnimationDefinition) aClass17_10375)
		...
		if (((AnimationDefinition) aClass17_10375).anIntArray237.length
		    <= anInt10369) {
		    anInt10369 -= ((AnimationDefinition) aClass17_10375).anInt238;
		    if (anInt10369 < 0
			|| (((AnimationDefinition) aClass17_10375).anIntArray237.length
	...
	anInt10387 = i_31_;
	int i_35_ = (((GfxDefinition) Class348_Sub40_Sub18.gfxLoader
				     .loadDefinition((byte) 72, anInt10391))
		     .anInt4503);
	if (i_35_ != -1)
	    aClass17_10375 = Class10.animationLoader.method835(i_35_, 7);
	else
	    aClass17_10375 = null;
    }
    ...
    private final AnimatableToolkit method2476(int i, AbstractToolkit var_ha, byte i_36_) {
	anInt10377++;
	GfxDefinition class368
	    = Class348_Sub40_Sub18.gfxLoader.loadDefinition((byte) 75,
							     anInt10391);
	if (i_36_ < 126)
	    aClass318_Sub10_10378 = null;
	return class368.method3562(anInt10365, var_ha, anInt10403, i,
				   anInt10369, Class10.animationLoader,
				   (byte) 121);
    }
	...
	try {
		...
		Class318_Sub2.messages[i_44_] = Class318_Sub2.messages[i_44_ - 1];
	    if (message == null)
		message = new Message(type, i_42_, string_39_, string, string_43_, string_40_, i_38_, string_37_);
	    else
		message.setValues(type, i_42_, string_43_, string,
				    string_40_, -18691, i_38_, string_39_,
				    string_37_);
	    Class318_Sub2.messages[0] = message;
	    Class348_Sub42_Sub3.anInt9501 = LoadingHandler.anInt3918;
	} catch (RuntimeException runtimeexception) {
	    throw Class348_Sub17.method2929
		      (runtimeexception,
		       ("to.K(" + (string != null ? "{...}" : "null") + ','
			+ (string_37_ != null ? "{...}" : "null")
			+ ',' + i_38_ + ','
			+ (string_39_ != null ? "{...}" : "null") + ','
			+ (string_40_ != null ? "{...}" : "null") + ',' + type
			+ ',' + i_42_ + ','
