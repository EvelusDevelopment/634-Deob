...
final class Class348_Sub40_Sub16 extends Class348_Sub40
{
    ...
    static IncomingPacket aClass114_9225;
	...
	do {
		...
		anInt9226 = class348_sub49.getUByte();
		break;
	    }
	...
	anInt9228++;
	if (Class76.aClass364_1279 != Class8.modeWhere && i == 9) {
	    try {
		Class224.method1617((byte) 125, NpcDefinition.aClient1367,
				    "tbrefresh");
    ...
    static {
	aClass114_9225 = new IncomingPacket(28, -2);
    }
}
