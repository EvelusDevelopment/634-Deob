    ...
    implements Interface10
{
    ...
    private AnimatableToolkit aClass64_10124;
    static Deque aClass262_10125 = new Deque();
    ...
    static OutgoingPacket aClass351_10134 = new OutgoingPacket(62, 3);
    ...
    private final AnimatableToolkit method2488(int i, int i_0_, AbstractToolkit var_ha) {
	if (i_0_ != 0)
	    return null;
	anInt10126++;
	...
	Class318_Sub4 class318_sub4
	    = DummyOutputstream.method136(i, aBoolean10130, false);
    ...
    final boolean method2391(AbstractToolkit var_ha, int i, int i_2_, int i_3_) {
	anInt10119++;
	AnimatableToolkit class64 = method2488(131072, i_3_, var_ha);
	if (class64 != null) {
	    Class101 class101 = var_ha.method3705();
	    class101.method894(((Class318_Sub1) this).anInt6377,
			       ((Class318_Sub1) this).anInt6382,
	...
	ObjectDefinition class51 = Class348_Sub40_Sub12.objectLoader
			      .getObject(0, 0xffff & aShort10129);
	s var_s;
	s var_s_6_;
	if (!aBoolean10138) {
    ...
    Class318_Sub1_Sub5_Sub1(AbstractToolkit var_ha, ObjectDefinition class51, int i, int i_7_,
			    int i_8_, int i_9_, int i_10_, boolean bool,
			    int i_11_, int i_12_, int i_13_, int i_14_) {
	super(i_8_, i_9_, i_10_, i, i_7_, i_11_, i_12_);
	do {
	    try {
		aBoolean10130 = ((ObjectDefinition) class51).anInt874 != 0 && !bool;
		aByte10145 = (byte) i_13_;
		aShort10129 = (short) ((ObjectDefinition) class51).anInt941;
