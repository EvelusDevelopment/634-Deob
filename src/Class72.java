...
final class Class72
{
    ...
    private static final void method732(AbstractToolkit var_ha) {
    ...
    final boolean method736(AbstractToolkit var_ha, Class72 class72_31_) {
	if (aClass105_1221 == null && !method730(var_ha, class72_31_))
	    return false;
	return true;
    }
    
    final void method737(AbstractToolkit var_ha, int i, int i_32_, int i_33_, int i_34_,
			 int i_35_, int i_36_) {
	if (aClass105_1221 != null) {
    ...
    private static final void method738(AbstractToolkit var_ha) {
	if (aClass64_1227 == null) {
	    Model class124 = new Model(580, 1104, 1);
	    ...
	    for (int i = 0; i <= 24; i++) {
		int i_41_ = i * 8192 / 24;
		int i_42_ = Class70.sineTable[i_41_];
		int i_43_ = Class70.cosineTable[i_41_];
		for (int i_44_ = 1; i_44_ < 24; i_44_++) {
		    int i_45_ = i_44_ * 8192 / 24;
		    int i_46_ = Class70.cosineTable[i_45_] >> 7;
		    int i_47_ = Class70.sineTable[i_45_] * i_42_ >> 21;
		    int i_48_ = Class70.sineTable[i_45_] * i_43_ >> 21;
	    ...
	    ((Model) class124).anInt1821 = ((Model) class124).vertices;
	    ((Model) class124).anIntArray1824 = null;
	    ((Model) class124).vgroups = null;
