...
final class j extends RasterToolkit implements ModelToolkit
{
    long nativeid;
    
    private final native void R(long l, boolean bool);
    
    private final native void P(long l, int i, int i_0_, int i_1_, int i_2_,
    ...
    private final native void UA(long l, float f, float f_17_, float f_18_,
				 float f_19_, float f_20_, float f_21_, int i,
				 long l_22_, int i_23_, int i_24_);
    ...
    private final native void EA(SafeToolkit var_oa, int i, int i_28_);
    
    final void method985(int i, int i_29_, int i_30_, int i_31_) {
	A(((j) this).nativeid, i, i_29_, i_30_, i_31_);
    }
    
    private final native void ma(SafeToolkit var_oa, int[] is, byte[] is_32_,
				 byte[] is_33_, int i, int i_34_, int i_35_,
				 int i_36_);
    ...
    private final native void W(long l, int i, int i_46_, int i_47_, int i_48_,
				int i_49_);
    ...
    j(SafeToolkit var_oa, int i, int i_57_) {
	EA(var_oa, i, i_57_);
    }
    
    private final native void b(long l, float f, float f_58_, float f_59_,
				float f_60_, float f_61_, float f_62_, int i,
				int i_63_, int i_64_, int i_65_);
    
    j(SafeToolkit var_oa, int[] is, int i, int i_66_, int i_67_, int i_68_,
      boolean bool) {
	ua(var_oa, is, i, i_66_, i_67_, i_68_, bool);
    }
    
    private final native void A(long l, int i, int i_69_, int i_70_,
				int i_71_);
    
    private final native void V(long l, int i, int i_72_, long l_73_,
				int i_74_, int i_75_);
    
    j(SafeToolkit var_oa, int[] is, byte[] is_76_, byte[] is_77_, int i, int i_78_,
      int i_79_, int i_80_) {
    ...
    private final native void YA(long l, int i, int i_83_, int i_84_,
				 int i_85_, int i_86_, int i_87_);
    
    j(SafeToolkit var_oa, int i, int i_88_, int i_89_, int i_90_, boolean bool) {
    ...
    private final native void ua(SafeToolkit var_oa, int[] is, int i, int i_91_,
				 int i_92_, int i_93_, boolean bool);
    ...
    private final native void h(SafeToolkit var_oa, int i, int i_99_, int i_100_,
				int i_101_, boolean bool);
