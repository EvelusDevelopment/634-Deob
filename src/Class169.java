...
final class Class169 implements Runnable
{
    ...
    private Deque aClass262_2258 = new Deque();
    private Thread aThread2259 = new Thread(this);
    static RasterToolkit[] aClass105Array2260;
	...
	for (;;) {
		...
		Node class348;
		for (class348 = aClass262_2258.removeFirst(8); class348 == null;
		     class348 = aClass262_2258.removeFirst(8)) {
		    try {
			aClass262_2258.wait();
	...
	if (i != 1000)
	    method1303((byte) 95);
	synchronized (aClass262_2258) {
	    aClass262_2258.addToFront(class348, -20180);
