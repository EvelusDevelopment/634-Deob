...
abstract class Class348_Sub40 extends Node
{
    ...
    static HashTable aClass356_7041 = new HashTable(32);
    static Class279 aClass279_7042;
    static int anInt7043;
    static int anInt7044;
    boolean aBoolean7045;
    
    static final Class50_Sub2 method3036(ByteBuffer class348_sub49,
					 int i) {
	anInt7026++;
	if (i > -4)
	    return null;
	...
	Class348_Sub40_Sub18.gfxLoader.method2541(119, i_0_);
	Class367_Sub1.method3535(i_0_, i ^ 0xffffffff);
	Class269.method2040(i_0_, true);
	ElementLoaderNode.method720(i_0_, i + 1227);
	...
	int i_21_ = i_18_ << -1280290975;
	int i_22_ = i_17_ << 1895430721;
	int i_23_ = i_20_ << 633706337;
	int i_24_ = i_19_ << -1479120479;
	int i_25_ = i_8_ << 316289;
	int i_26_ = i_16_ << -1564599039;
	int i_27_ = i_21_ + i_17_ * (-i_25_ + 1);
	int i_28_ = i_18_ + -(i_22_ * (-1 + i_25_));
	int i_29_ = (1 - i_26_) * i_19_ + i_23_;
	int i_30_ = i_20_ + -(i_24_ * (-1 + i_26_));
	int i_31_ = i_17_ << 316850146;
	int i_32_ = i_18_ << -1891053982;
	int i_33_ = i_19_ << -1278286910;
	int i_34_ = i_20_ << 984523842;
	int i_35_ = 3 * i_21_;
	...
	if ((Class132.anInt1910 ^ 0xffffffff) >= (i_6_ ^ 0xffffffff)
	    ...
	    int[] is = AnimationDefinition.anIntArrayArray255[i_6_];
	    int i_43_ = Whirlpool.method831(Class113.anInt1745, i_5_ + -i,
					  Class369.anInt4960, 77);
	    int i_44_ = Whirlpool.method831(Class113.anInt1745, i + i_5_,
					  Class369.anInt4960, -68);
	    int i_45_ = Whirlpool.method831(Class113.anInt1745, i_5_ + -i_15_,
					  Class369.anInt4960, i_7_ + -115);
	    int i_46_ = Whirlpool.method831(Class113.anInt1745, i_5_ + i_15_,
	...
	while ((i_13_ ^ 0xffffffff) < -1) {
		...
		int i_49_ = Whirlpool.method831(Class113.anInt1745, i_12_ + i_5_,
					      Class369.anInt4960, 36);
		int i_50_
		    = Whirlpool.method831(Class113.anInt1745, -i_12_ + i_5_,
					Class369.anInt4960, 97);
		if (!bool) {
		    ...
		    int i_51_
			= Whirlpool.method831(Class113.anInt1745, i_5_ - -i_14_,
					    Class369.anInt4960, i_7_ ^ ~0x5c);
		    int i_52_
			= Whirlpool.method831(Class113.anInt1745, -i_14_ + i_5_,
					    Class369.anInt4960, 32);
		    if ((i_47_ ^ 0xffffffff)
			<= (Class132.anInt1910 ^ 0xffffffff)) {
			int[] is = AnimationDefinition.anIntArrayArray255[i_47_];
			...
			int[] is = AnimationDefinition.anIntArrayArray255[i_48_];
    ...
    void method3049(ByteBuffer class348_sub49, int i, int i_60_) {
	anInt7028++;
	if (i_60_ != 31015)
	    method3038(-16);
    }
