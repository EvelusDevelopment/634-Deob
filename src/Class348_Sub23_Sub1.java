...
final class Class348_Sub23_Sub1 extends Class348_Sub23
{
    ...
    static final Class30 method2967(int i, AnimatableToolkit class64, int i_0_, int i_1_,
				    int i_2_) {
	anInt8991++;
	if (i_2_ != 2)
	...
	anInt9004++;
	if (((Signlink) signlink).allowsFileOperations) {
	    Class3.currentConnection = new ConnectionMode();
	    ((ConnectionMode) Class3.currentConnection).portOffset = i;
	    ((ConnectionMode) Class3.currentConnection).address = string;
	    if (Class8.modeWhere != Class55_Sub1.aClass364_5271) {
		((ConnectionMode) Class3.currentConnection).anInt2138
		    = 50000 + ((ConnectionMode) Class3.currentConnection).portOffset;
		((ConnectionMode) Class3.currentConnection).anInt2148
		    = 40000 + ((ConnectionMode) Class3.currentConnection).portOffset;
	    }
	    if (i < Class65.lobbyWorlds.length
		&& Class65.lobbyWorlds[i] != null)
		Class251.anInt3234
		    = (((AbstractLobbyWorld) Class65.lobbyWorlds[i])
		       .settings);
	    return true;
	}
	String string_4_ = "";
	...
	String string_6_
	    = ("http://" + string + string_4_ + "/l="
	       + Class348_Sub33.gameLanguage + "/a=" + SocketWorker.anInt2670
	       + string_5_ + "/j" + (!Class289.aBoolean3697 ? "0" : "1") + ",o"
	       + (Class348_Sub37.aBoolean6997 ? "1" : "0") + ",a2");
	try {
	    NpcDefinition.aClient1367.getAppletContext()
