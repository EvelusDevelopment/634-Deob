...
final class Class189
{
    ...
    int anInt2525;
    int anInt2526;
    static IncomingPacket aClass114_2527 = new IncomingPacket(98, -2);
    static int anInt2528;
    static NpcLoader npcLoader;
    int anInt2530;
    ...
    private final void initialize(int i, int i_0_,
				  ByteBuffer class348_sub49, byte i_1_) {
	anInt2532++;
	if ((i ^ 0xffffffff) == -2) {
	    ((Class189) this).anInt2525 = class348_sub49.getShort();
		...
		= 1 + class348_sub49.getShort();
	    ((Class189) this).anInt2530
		= class348_sub49.getShort() - -1;
	}
    }
    
    final void initialize(int i, ByteBuffer buffer, byte i_2_) {
	anInt2528++;
	...
	for (;;) {
		...
		break;
	    initialize(opcode, i, buffer, (byte) 94);
	}
    }
    
    static final boolean method1420
	(int i, int i_5_, int i_6_, int i_7_, int i_8_, int i_9_, int i_10_,
	 int i_11_, int i_12_, Class361 class361, int i_13_, int i_14_) {
	anInt2521++;
	int i_15_ = i_10_;
	int i_16_ = i_7_;
	int i_17_ = 64;
	...
	if (i_6_ >= -65)
	    method1420(115, 22, 74, 19, 100, -62, 111, 76, 26, null, -41, -28);
	...
	while_48_:
		...
		while_46_:
			...
			do {
			    ...
			    if (class361.method3497(-28388, i_9_, i_11_, i_12_,
						    i_8_, i_15_, i_12_, i_16_,
						    i_14_, i)) {
				Class348_Sub40_Sub30.anInt9388 = i_15_;
				Class115.anInt1753 = i_16_;
				return true;
			...
			if (class361.method3503(i_15_, (byte) -98, i_14_,
						i_12_, i_8_, i, i_11_, i_16_,
						i_9_)) {
			    Class348_Sub40_Sub30.anInt9388 = i_15_;
			    Class115.anInt1753 = i_16_;
			    return true;
		    ...
		    if (class361.method3495(i_9_, i_16_, i_12_, i_5_, i_15_,
					    i_14_, i_13_, -71)) {
			Class348_Sub40_Sub30.anInt9388 = i_15_;
			Class115.anInt1753 = i_16_;
			return true;
		...
		if (class361.method3504(i_14_, i_16_, i_9_, i_15_, i_13_, 1,
					i_5_, i_12_)) {
		    Class115.anInt1753 = i_16_;
		    Class348_Sub40_Sub30.anInt9388 = i_15_;
		    return true;
	...
	while_49_:
	    do {
		if (i_17_ > 0 && r.anIntArrayArray9723[-1 + i_17_][i_18_] == 0
		    && (is[-1 + i_23_][i_24_] & 0x43a40000) == 0
	...
	while_50_:
		...
		if (i_17_ < -i_12_ + 128
		    ...
		    && (is[i_23_ + i_12_][i_24_] & 0x60e40000) == 0
	...
	while_52_:
		...
		if (i_18_ < -i_12_ + 128
			...
			if ((0x7e240000 & is[i_23_ + i_29_][i_12_ + i_24_])
			    != 0)
			    break while_52_;
		    }
		    Class367_Sub11.anIntArray7397[i_21_] = i_15_;
	...
	while_53_:
		...
		if (i_17_ > 0 && (i_18_ ^ 0xffffffff) < -1
		    ...
		    Class223.anIntArrayArray2900[i_17_ + -1][-1 + i_18_]
			= i_25_;
		}
	    } while (false);
	while_54_:
		...
		if ((i_17_ ^ 0xffffffff) > (128 - i_12_ ^ 0xffffffff)
		    ...
		    i_21_ = 0xfff & i_21_ - -1;
		    Class223.anIntArrayArray2900[1 + i_17_][-1 + i_18_]
			= i_25_;
		}
	    } while (false);
	while_55_:
		...
		if (i_17_ > 0 && i_18_ < -i_12_ + 128
		    ...
		    i_21_ = i_21_ - -1 & 0xfff;
		    Class223.anIntArrayArray2900[-1 + i_17_][i_18_ - -1]
			= i_25_;
		}
	    } while (false);
