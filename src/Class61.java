...
final class Class61
{
	...
	for (int i_4_ = 0;
		...
		&& ((((Class348_Sub13) class348_sub13).anIntArray6757[i_4_]
		     ^ 0xffffffff)
		    > (((ItemLoader) ToolkitException.itemLoader).anInt3271
		       ^ 0xffffffff))) {
		ItemDefinition class213 = (ToolkitException.itemLoader.getItemDefinition
    ...
    Class61(DirectxToolkit var_ha_Sub2, int i) {
