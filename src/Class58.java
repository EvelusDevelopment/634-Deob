...
final class Class58
{
	...
	anInt1062++;
	int i_13_ = Whirlpool.method831(Class38.anInt513, i_11_,
				      Class132.anInt1910, 111);
	int i_14_ = Whirlpool.method831(Class38.anInt513, i_7_,
				      Class132.anInt1910, -104);
	if (i_12_ >= -62)
	    method535(80, -63, -10, 41, -65, 39, (byte) -89);
	int i_15_ = Whirlpool.method831(Class113.anInt1745, i,
				      Class369.anInt4960, -79);
	int i_16_ = Whirlpool.method831(Class113.anInt1745, i_9_,
				      Class369.anInt4960, 92);
	int i_17_ = Whirlpool.method831(Class38.anInt513, i_11_ + i_8_,
				      Class132.anInt1910, 32);
	int i_18_ = Whirlpool.method831(Class38.anInt513, -i_8_ + i_7_,
				      Class132.anInt1910, 41);
	for (int i_19_ = i_13_; (i_19_ ^ 0xffffffff) > (i_17_ ^ 0xffffffff);
	     i_19_++)
	    Class135_Sub2.method1156(-27, i_16_,
				     AnimationDefinition.anIntArrayArray255[i_19_], i_15_,
				     i_10_);
	for (int i_20_ = i_14_; i_18_ < i_20_; i_20_--)
	    Class135_Sub2.method1156(-27, i_16_,
				     AnimationDefinition.anIntArrayArray255[i_20_], i_15_,
				     i_10_);
	int i_21_ = Whirlpool.method831(Class113.anInt1745, i_8_ + i,
				      Class369.anInt4960, 121);
	int i_22_ = Whirlpool.method831(Class113.anInt1745, -i_8_ + i_9_,
				      Class369.anInt4960, -101);
	for (int i_23_ = i_17_; (i_18_ ^ 0xffffffff) <= (i_23_ ^ 0xffffffff);
	     i_23_++) {
	    int[] is = AnimationDefinition.anIntArrayArray255[i_23_];
