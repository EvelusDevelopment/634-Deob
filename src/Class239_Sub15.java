...
final class Class239_Sub15 extends Class239
{
    ...
    static IncomingPacket aClass114_5997 = new IncomingPacket(115, 11);
	...
	if (bool != false)
	    method1783(115, -122, -59, 41, -49, 92);
	anInt5999++;
	if (((Class239) this).aClass348_Sub51_3136.method3428((byte) -84)
		.method1458(-23688)
	    < 96)
	...
	if (i != 3)
	    method1784(99);
	if (((Class239) this).aClass348_Sub51_3136.method3428((byte) -85)
		.method1458(-23688)
	    < 96)
	    return 3;
	return 1;
	...
	Class126.method1114(((Class239) this).anInt3138, -122);
    }
    
    static final void method1783(int i, int i_2_, int i_3_, int i_4_, int i_5_,
				 int i_6_) {
	anInt5998++;
	int i_7_ = -i_3_ + i_4_;
	int i_8_ = i_5_ + -i;
	if ((i_8_ ^ 0xffffffff) != i_2_) {
		...
		TextureDefinition.method223(i_5_, i_6_, i_3_, i, (byte) 47);
		return;
	    }
	} else {
	    if (i_7_ != 0)
	...
	if (!bool) {
		...
		i_16_ += i_15_;
		AnimationDefinition.anIntArrayArray255[i_13_][i_18_] = i_6_;
		...
		AnimationDefinition.anIntArrayArray255[i_19_][i_13_] = i_6_;
		i_16_ += i_15_;
		if (i_16_ > 0) {
		    i_13_ += i_17_;
		    i_16_ -= i_14_;
	...
	if (i != 20014)
	    method1782(-76, -103);
	if ((((Class239) this).aClass348_Sub51_3136.method3428((byte) -105)
		 .method1458(-23688)
	     ^ 0xffffffff)
	    > -97)
	    return 0;
	...
	Class126.method1114(((Class239) this).anInt3138, -120);
    }
	...
	if (i < 85)
	    method1784(-69);
	anInt6001++;
	if (((Class239) this).aClass348_Sub51_3136.method3428((byte) -104)
		.method1458(-23688)
	    < 96)
	    return false;
	return true;
	...
	WidgetVariable class348_sub42_sub15
	    = Class318_Sub9_Sub1.method2516(i, (byte) 105, i_22_);
