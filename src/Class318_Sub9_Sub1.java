...
final class Class318_Sub9_Sub1 extends Class318_Sub9
{
    ...
    short aShort8786;
    int anInt8787 = (int) (Class62.getCurrentTimeMillis() / 1000L);
	...
	if (Class228.aClass57Array2974 == null) {
	    ...
	    int i_1_ = 0;
	    int i_2_ = ((Class348_Sub51) BitmapTable.aClass348_Sub51_3959)
    ...
    static final WidgetVariable method2516(int id, byte i_7_, int i_8_) {
	anInt8788++;
	WidgetVariable class348_sub42_sub15
	    = ((WidgetVariable)
	       Class100.aClass356_1585.get(((long) i_8_ << 32 | (long) id)));
	if (class348_sub42_sub15 == null) {
	    class348_sub42_sub15 = new WidgetVariable(i_8_, id);
	    Class100.aClass356_1585.putNode((((Node)
