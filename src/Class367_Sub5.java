...
final class Class367_Sub5 extends Class367
{
    ...
    private Direct3dToolkit aClass378_7328;
    private boolean aBoolean7329;
    ...
    private static float[] aFloatArray7337 = new float[16];
    
    Class367_Sub5(Direct3dToolkit class378, IndexLoader class45) {
	super(class378);
	aClass378_7328 = class378;
	if (null == class45
	    || -258 < ((((Direct3dToolkit) aClass378_7328).aD3DCAPS9791
			.VertexShaderVersion) & 0xffff
		       ^ 0xffffffff))
	    aBoolean7329 = false;
	else {
	    anIDirect3DVertexShader7332
		= ((Direct3dToolkit) aClass378_7328).anIDirect3DDevice9810
		...
		& null != anIDirect3DVertexShader7335) {
		anInterface18_Impl3_7331
		    = (((Class367_Sub5) this).aHa_Sub3_4479.method3839
		       (1, 2, -15137, false, new int[] { 0, -1 }));
	...
	Class101_Sub2 class101_sub2
	    = ((Class367_Sub5) this).aHa_Sub3_4479.method3887((byte) 61);
	...
	class101_sub2.method919(0.0F, aFloatArray7327, -1.0F, 0.0F,
				(float) i_0_, (byte) -120);
	...
	if (i != 87)
	    method3527(55, null, -69);
	((Class367_Sub5) this).aHa_Sub3_4479.method3897(1, -4382);
	((Class367_Sub5) this).aHa_Sub3_4479.method3850((byte) 82, null);
	((Class367_Sub5) this).aHa_Sub3_4479.method3874
	    (Class167.aClass229_2207, i + 25, Class167.aClass229_2207);
	((Class367_Sub5) this).aHa_Sub3_4479
	...
	((Class367_Sub5) this).aHa_Sub3_4479.method3897(0, i ^ ~0x114a);
	if (aBoolean7326) {
	    ((Class367_Sub5) this).aHa_Sub3_4479
		.method3849((byte) 47, 0, Class342.aClass70_4247);
	    ((Class367_Sub5) this).aHa_Sub3_4479
	...
	if (i != 12)
	    method3521(false, (byte) -54);
	if (null != anIDirect3DVertexShader7333) {
	    IDirect3DDevice idirect3ddevice
		= ((Direct3dToolkit) aClass378_7328).anIDirect3DDevice9810;
	    Class101_Sub2 class101_sub2
		= aClass378_7328.method3948(i + -22048);
	...
	if (i == -14775) {
		...
		IDirect3DDevice idirect3ddevice
		    = ((Direct3dToolkit) aClass378_7328).anIDirect3DDevice9810;
		idirect3ddevice.a(4, ((Class367_Sub5) this).aHa_Sub3_4479
					 .method3835(aFloatArray7337, -101));
	    }
	}
    }
	...
	if (interface18 == null) {
	    if (!aBoolean7326) {
		((Class367_Sub5) this).aHa_Sub3_4479.method3850
		    ((byte) -43,
		     (((NativeToolkit) ((Class367_Sub5) this).aHa_Sub3_4479)
		      .anInterface18_8147));
		((Class367_Sub5) this).aHa_Sub3_4479.method3923(true, 1);
		((Class367_Sub5) this).aHa_Sub3_4479.method3849
		    ((byte) 47, 0, Class318_Sub1_Sub2.aClass70_8737);
		((Class367_Sub5) this).aHa_Sub3_4479
	    ...
	    ((Class367_Sub5) this).aHa_Sub3_4479.method3850((byte) -103,
							    interface18);
	    ((Class367_Sub5) this).aHa_Sub3_4479.method3923(true, i);
	}
	if (i_3_ != -16776)
	    anIDirect3DVertexShader7332 = null;
    }
    
    final void method3522(int i) {
	if (i != -16252)
	    method3521(true, (byte) -11);
	if (null != anIDirect3DVertexShader7333) {
	    IDirect3DDevice idirect3ddevice
		= ((Direct3dToolkit) aClass378_7328).anIDirect3DDevice9810;
	    int i_4_ = ((Class367_Sub5) this).aHa_Sub3_4479.XA();
	    int i_5_ = ((Class367_Sub5) this).aHa_Sub3_4479.i();
	    float f = -(0.125F * (float) (i_4_ + -i_5_)) + (float) i_4_;
	    float f_6_ = (float) i_4_ - (float) (-i_5_ + i_4_) * 0.25F;
	    idirect3ddevice.a(10, f_6_, 1.0F / (-f_6_ + f), f,
			      1.0F / (-f + (float) i_4_));
	    idirect3ddevice.a
		(11,
		 1.0F / (float) ((Class367_Sub5) this).aHa_Sub3_4479
				    .method3833((byte) -58),
		 (float) ((Class367_Sub5) this).aHa_Sub3_4479
			     .method3826((byte) -70) / 255.0F,
		 ((NativeToolkit) ((Class367_Sub5) this).aHa_Sub3_4479).aFloat8115,
		 1.0F / (-(((NativeToolkit) ((Class367_Sub5) this).aHa_Sub3_4479)
			   .aFloat8173)
			 + (((NativeToolkit) ((Class367_Sub5) this).aHa_Sub3_4479)
			    .aFloat8115)));
	    ((Class367_Sub5) this).aHa_Sub3_4479.method3894
		(-28186,
		 ((Class367_Sub5) this).aHa_Sub3_4479.method3863(-103));
	}
    }
	...
	((Class367_Sub5) this).aHa_Sub3_4479.method3897(1, -4382);
	((Class367_Sub5) this).aHa_Sub3_4479
	    .method3850((byte) 95, anInterface18_Impl3_7331);
	if (i != 15192)
	    method3520((byte) -41);
	((Class367_Sub5) this).aHa_Sub3_4479.method3874
	    (Class328_Sub3.aClass229_6519, 105, OndemandWorker.aClass229_3196);
	((Class367_Sub5) this).aHa_Sub3_4479
	...
	((Class367_Sub5) this).aHa_Sub3_4479
	    .method3885(0, true, Class318_Sub1_Sub2.aClass70_8737);
	((Class367_Sub5) this).aHa_Sub3_4479.method3897(0, -4382);
	method3528(106);
    }
		...
		class101_sub2.method923
		    ((((NativeToolkit) ((Class367_Sub5) this).aHa_Sub3_4479)
		     ...
		     (((NativeToolkit) ((Class367_Sub5) this).aHa_Sub3_4479)
		      .aFloatArray8170[2]),
		     aFloatArray7327);
		idirect3ddevice.SetVertexShaderConstantF(15, aFloatArray7327,
							 1);
		class101_sub2.method923
		    ((((NativeToolkit) ((Class367_Sub5) this).aHa_Sub3_4479)
		      .aFloatArray8102[0]),
		     ...
		     (((NativeToolkit) ((Class367_Sub5) this).aHa_Sub3_4479)
		      .aFloatArray8102[2]),
		     aFloatArray7327);
		idirect3ddevice.SetVertexShaderConstantF(17, aFloatArray7327,
							 1);
	    }
	}
    }
	...
	if (null != anIDirect3DVertexShader7333) {
		...
		= ((Direct3dToolkit) aClass378_7328).anIDirect3DDevice9810;
	    Class101_Sub2 class101_sub2
		= ((Class367_Sub5) this).aHa_Sub3_4479.method3848(5);
	    idirect3ddevice.SetVertexShaderConstantF
		(8, class101_sub2.method915(aFloatArray7337, i + -10424), 2);
	}
    }
}
