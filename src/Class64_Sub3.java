...
final class Class64_Sub3 extends AnimatableToolkit
{
    ...
    private DirectxToolkit aHa_Sub2_5598;
    ...
    final void FA(int i) {
	anInt5650++;
	int i_0_ = Class70.sineTable[i];
	int i_1_ = Class70.cosineTable[i];
	for (int i_2_ = 0; (anInt5557 ^ 0xffffffff) < (i_2_ ^ 0xffffffff);
	     i_2_++) {
	    int i_3_
	...
	if (aClass123_5605 != null)
	    ((Class123) aClass123_5605).anInterface2_1811 = null;
	aBoolean5527 = false;
    }
	...
	if (i == 1) {
	    class64_sub3_6_ = ((DirectxToolkit) aHa_Sub2_5598).aClass64_Sub3_7864;
	    class64_sub3_5_ = ((DirectxToolkit) aHa_Sub2_5598).aClass64_Sub3_7780;
	} else if ((i ^ 0xffffffff) == -3) {
	    class64_sub3_5_ = ((DirectxToolkit) aHa_Sub2_5598).aClass64_Sub3_7802;
	    class64_sub3_6_ = ((DirectxToolkit) aHa_Sub2_5598).aClass64_Sub3_7838;
	} else if (i != 3) {
	    if (i == 4) {
		class64_sub3_6_ = ((DirectxToolkit) aHa_Sub2_5598).aClass64_Sub3_7834;
		class64_sub3_5_ = ((DirectxToolkit) aHa_Sub2_5598).aClass64_Sub3_7844;
	    } else if (i == 5) {
		class64_sub3_6_ = ((DirectxToolkit) aHa_Sub2_5598).aClass64_Sub3_7840;
		class64_sub3_5_ = ((DirectxToolkit) aHa_Sub2_5598).aClass64_Sub3_7785;
	    } else
		class64_sub3_6_ = class64_sub3_5_
		    = new Class64_Sub3(aHa_Sub2_5598);
	} else {
	    class64_sub3_6_ = ((DirectxToolkit) aHa_Sub2_5598).aClass64_Sub3_7803;
	    class64_sub3_5_ = ((DirectxToolkit) aHa_Sub2_5598).aClass64_Sub3_7821;
	}
	...
	anInt5619++;
	if ((anInt5537 ^ 0xffffffff) != -1 && i > 125) {
	    if (aByte5581 != 0)
		method688(5, true);
	    method688(5, false);
	    if (aClass270_5575 != null) {
		if (((Class270) aClass270_5575).anInterface8_3463 == null)
	...
	if (6 * anInt5537 > (((ByteBuffer) (((DirectxToolkit) aHa_Sub2_5598)
						.aClass348_Sub49_Sub1_7798))
			     .payload).length)
	    ((DirectxToolkit) aHa_Sub2_5598).aClass348_Sub49_Sub1_7798
		= new FloatBuffer(6 * (anInt5537 - -100));
	else
	    ((ByteBuffer)
	     ((DirectxToolkit) aHa_Sub2_5598).aClass348_Sub49_Sub1_7798).position
		= 0;
	anInt5630++;
	if (i != 27)
	    WA();
	FloatBuffer class348_sub49_sub1
	    = ((DirectxToolkit) aHa_Sub2_5598).aClass348_Sub49_Sub1_7798;
	if (((DirectxToolkit) aHa_Sub2_5598).aBoolean7775) {
    ...
    private final boolean method679(int i, int i_16_, int i_17_, int i_18_,
				    ...
				    int i_23_) {
	anInt5651++;
	if (i_20_ > i && i < i_18_ && (i ^ 0xffffffff) > (i_23_ ^ 0xffffffff))
	    return false;
	if (i > i_20_ && i_18_ < i && (i_23_ ^ 0xffffffff) > (i ^ 0xffffffff))
	    return false;
	if ((i_19_ ^ 0xffffffff) < (i_22_ ^ 0xffffffff) && i_16_ > i_22_
	    && (i_22_ ^ 0xffffffff) > (i_17_ ^ 0xffffffff))
	    return false;
	int i_24_ = -65 / ((i_21_ - 57) / 62);
	if (i_19_ < i_22_ && i_22_ > i_16_
	    && (i_22_ ^ 0xffffffff) < (i_17_ ^ 0xffffffff))
	    return false;
	return true;
    }
    ...
    final void VA(int i) {
	anInt5561++;
	int i_25_ = Class70.sineTable[i];
	int i_26_ = Class70.cosineTable[i];
	...
	if ((i_31_ ^ 0xffffffff) != 0) {
		...
		= ((AbstractToolkit) aHa_Sub2_5598).aD4579.getTexture(i_31_ & 0xffff, -6662);
	    int i_34_ = 0xff & ((TextureDefinition) class12).aByte201;
	    if (i_34_ != 0) {
		int i_35_;
		if (i_29_ >= 0) {
		    if (i_29_ > 127)
	    ...
	    int i_38_ = 0xff & ((TextureDefinition) class12).aByte216;
	...
	if (aShortArray5601 == null)
	    return true;
	for (int i = 0;
	     (aShortArray5601.length ^ 0xffffffff) < (i ^ 0xffffffff); i++) {
	    if (aShortArray5601[i] != -1
		&& !((AbstractToolkit) aHa_Sub2_5598).aD4579.method4(-7953,
							aShortArray5601[i]))
		return false;
	}
	return true;
    ...
    final void method613(AnimatableToolkit class64, int i, int i_42_, int i_43_,
			 boolean bool) {
	try {
	    anInt5589++;
	    Class64_Sub3 class64_sub3_44_ = (Class64_Sub3) class64;
	    if ((anInt5632 ^ 0xffffffff) != -1
		&& (class64_sub3_44_.anInt5632 ^ 0xffffffff) != -1) {
		...
		if (aClass139_5572 != null) {
		    is_55_ = ((Class139) aClass139_5572).aShortArray1954;
		    is_54_ = ((Class139) aClass139_5572).aByteArray1948;
		    is_53_ = ((Class139) aClass139_5572).aShortArray1951;
		    is_52_ = ((Class139) aClass139_5572).aShortArray1953;
		} else {
		    is_52_ = null;
		    is_53_ = null;
		    is_54_ = null;
		...
		if (class64_sub3_44_.aClass139_5572 != null) {
		    is_59_ = (((Class139) class64_sub3_44_.aClass139_5572)
			      .aShortArray1953);
		    is_56_ = (((Class139) class64_sub3_44_.aClass139_5572)
			      .aByteArray1948);
		    is_58_ = (((Class139) class64_sub3_44_.aClass139_5572)
			      .aShortArray1954);
		    is_57_ = (((Class139) class64_sub3_44_.aClass139_5572)
			      .aShortArray1951);
		} else {
		    is_56_ = null;
		    is_57_ = null;
		...
		for (int i_68_ = 0;
		     (anInt5557 ^ 0xffffffff) < (i_68_ ^ 0xffffffff);
		     i_68_++) {
			...
			if (i_70_ >= i_64_ && i_70_ <= i_65_) {
				...
				for (int i_75_ = i_73_;
				    ...
				    if (i_72_ == -1 || (aByteArray5594[i_72_]
							^ 0xffffffff) != -1)
					break;
				}
				if (i_72_ != -1) {
					...
					if (is[i_76_] == i_70_
						...
						if (aClass123_5563 == null
						    && aClass123_5610 != null)
						    ((Class123) aClass123_5610)
							.anInterface2_1811
							= null;
						if (aClass123_5563 != null)
						    ((Class123) aClass123_5563)
							.anInterface2_1811
							= null;
						if ((class64_sub3_44_
						     .aClass123_5563) == null
	...
	if (aClass118Array5621 != null) {
		...
		= ((DirectxToolkit) aHa_Sub2_5598).aClass101_Sub3_7729;
	    aHa_Sub2_5598.method3788(-18516);
	    aHa_Sub2_5598.C(!aBoolean5595);
	    aHa_Sub2_5598.method3728(false, 35);
	    aHa_Sub2_5598.method3794(((DirectxToolkit) aHa_Sub2_5598).aClass123_7849,
				     null, -26411,
				     ((DirectxToolkit) aHa_Sub2_5598).aClass123_7833,
				     null);
	    for (int i = 0; (anInt5536 ^ 0xffffffff) < (i ^ 0xffffffff); i++) {
		Class118 class118 = aClass118Array5621[i];
		Class48 class48 = aClass48Array5596[i];
		if (!((Class118) class118).aBoolean1791
		    || !aHa_Sub2_5598.isBloomSupported()) {
		    float f
			= ((float) ((anIntArray5543
				     [((Class118) class118).anInt1782])
				    + ((anIntArray5543
					[((Class118) class118).anInt1788])
				       + (anIntArray5543
					  [((Class118) class118).anInt1781])))
			   * 0.3333333F);
		    float f_90_
		    ...
		    float f_93_ = (Class156.aFloat2111
				   + (Class215.aFloat2836 * f_91_
					 ...
					 + AbtractArchiveLoader.aFloat3943 * f)));
		    float f_94_ = (f * Class318_Sub9_Sub1.aFloat8784
				   + f_90_ * Class320.aFloat3994
				   + f_91_ * Class286_Sub8.aFloat6304
				   + BufferedRasterizer.aFloat4720);
		    float f_95_
			= ((float) (1.0
				    / Math.sqrt((double) (f_94_ * f_94_
							  + (f_93_ * f_93_
							     + (f_92_
								* f_92_)))))
			   * (float) ((Class118) class118).anInt1784);
		    class101_sub3.method939
			(-f_94_ + f_94_ * f_95_,
			 (((Class118) class118).aShort1785
			  * ((Class48) class48).anInt856) >> -647544441,
			 (-(f_92_ * f_95_)
			  + (f_92_ + (float) ((Class48) class48).anInt854)),
			 (((Class118) class118).aShort1790
			  * ((Class48) class48).anInt857) >> -1444250169,
			 ((Class48) class48).anInt853, 90,
			 (f_95_ * f_93_
			  + (-f_93_ + (float) ((Class48) class48).anInt847)));
		    aHa_Sub2_5598.method3766((byte) 55, class101_sub3);
		    int i_96_ = ((Class48) class48).anInt858;
		    OpenGL.glColor4ub((byte) (i_96_ >> -1284244496),
				      (byte) (i_96_ >> -349426456),
				      (byte) i_96_,
				      (byte) (i_96_ >> -184573064));
		    aHa_Sub2_5598.method3757(((Class118) class118).aShort1787,
					     -77);
		    aHa_Sub2_5598.method3753(((Class118) class118).aByte1789,
					     1);
	...
	try {
		...
		= ((DirectxToolkit) aHa_Sub2_5598).aClass101_Sub3_7760;
	    float f = (((Class101_Sub3) class101_sub3_112_).aFloat5747
		       + ((((Class101_Sub3) class101_sub3).aFloat5751
			   * ((Class101_Sub3) class101_sub3_112_).aFloat5781)
			  + ((((Class101_Sub3) class101_sub3_112_).aFloat5770
			      * ((Class101_Sub3) class101_sub3).aFloat5747)
			     + (((Class101_Sub3) class101_sub3).aFloat5772
				* (((Class101_Sub3) class101_sub3_112_)
				   .aFloat5750)))));
	    float f_113_
		= (((Class101_Sub3) class101_sub3_112_).aFloat5772
		   + ((((Class101_Sub3) class101_sub3).aFloat5751
		       * ((Class101_Sub3) class101_sub3_112_).aFloat5762)
		      + ((((Class101_Sub3) class101_sub3).aFloat5747
			  * ((Class101_Sub3) class101_sub3_112_).aFloat5761)
			 + (((Class101_Sub3) class101_sub3).aFloat5772
			    * (((Class101_Sub3) class101_sub3_112_)
			       .aFloat5769)))));
	    Class299_Sub1_Sub1.aFloat8696
		= ((((Class101_Sub3) class101_sub3_112_).aFloat5781
		    * ((Class101_Sub3) class101_sub3).aFloat5754)
		   + ((((Class101_Sub3) class101_sub3).aFloat5769
		       * ((Class101_Sub3) class101_sub3_112_).aFloat5750)
		      + (((Class101_Sub3) class101_sub3_112_).aFloat5770
			 * ((Class101_Sub3) class101_sub3).aFloat5750)));
	    Class215.aFloat2836
		= ((((Class101_Sub3) class101_sub3).aFloat5781
		    * ((Class101_Sub3) class101_sub3_112_).aFloat5761)
		   + (((Class101_Sub3) class101_sub3_112_).aFloat5769
		      * ((Class101_Sub3) class101_sub3).aFloat5762)
		   + (((Class101_Sub3) class101_sub3_112_).aFloat5762
		      * ((Class101_Sub3) class101_sub3).aFloat5784));
	    Class318_Sub9_Sub1.aFloat8784
		= ((((Class101_Sub3) class101_sub3_112_).aFloat5754
		    * ((Class101_Sub3) class101_sub3).aFloat5761)
		   + (((Class101_Sub3) class101_sub3).aFloat5770
		      * ((Class101_Sub3) class101_sub3_112_).aFloat5756)
		   + (((Class101_Sub3) class101_sub3).aFloat5756
		      * ((Class101_Sub3) class101_sub3_112_).aFloat5784));
		...
		= ((((Class101_Sub3) class101_sub3_112_).aFloat5756
		   ...
		   + (((Class101_Sub3) class101_sub3).aFloat5751
		      * ((Class101_Sub3) class101_sub3_112_).aFloat5784)
		   + ((Class101_Sub3) class101_sub3_112_).aFloat5751);
	    Class252.aFloat3242
		= ((((Class101_Sub3) class101_sub3_112_).aFloat5761
		    * ((Class101_Sub3) class101_sub3).aFloat5750)
		   + (((Class101_Sub3) class101_sub3_112_).aFloat5769
		   ...
		   + (((Class101_Sub3) class101_sub3_112_).aFloat5762
		      * ((Class101_Sub3) class101_sub3).aFloat5754));
	    AbtractArchiveLoader.aFloat3943
		= ((((Class101_Sub3) class101_sub3).aFloat5756
		    * ((Class101_Sub3) class101_sub3_112_).aFloat5762)
		   + ((((Class101_Sub3) class101_sub3).aFloat5761
		       * ((Class101_Sub3) class101_sub3_112_).aFloat5769)
	    ...
	    int i_120_ = ((DirectxToolkit) aHa_Sub2_5598).anInt7771;
	    int i_121_ = ((DirectxToolkit) aHa_Sub2_5598).anInt7794;
	    if (!aBoolean5527)
		method692((byte) -123);
		...
		float f_138_ = (Class286_Sub8.aFloat6304 * f_135_
				...
				+ f_114_);
		float f_139_ = f_113_ + (AbtractArchiveLoader.aFloat3943 * f_137_
		...
		if ((float) ((DirectxToolkit) aHa_Sub2_5598).anInt7826 <= f_138_) {
		    if ((i_108_ ^ 0xffffffff) < -1)
			f_138_ = (float) i_108_;
		    float f_141_
			= (f_140_ * (float) i_120_ / f_138_
			   + (float) ((DirectxToolkit) aHa_Sub2_5598).anInt7853);
		    if (f_141_ < f_116_)
			f_116_ = f_141_;
		    if (f_141_ > f_117_)
			f_117_ = f_141_;
			...
			= (f_139_ * (float) i_121_ / f_138_
			   + (float) ((DirectxToolkit) aHa_Sub2_5598).anInt7810);
		    if (f_142_ > f_119_)
			f_119_ = f_142_;
		    bool_115_ = true;
		    if (f_142_ < f_118_)
		...
		if (bool)
		    return true;
		if ((((DirectxToolkit) aHa_Sub2_5598).anIntArray7880.length
		     ^ 0xffffffff)
		    > (anInt5529 ^ 0xffffffff)) {
		    ((DirectxToolkit) aHa_Sub2_5598).anIntArray7883
			= new int[anInt5529];
		    ((DirectxToolkit) aHa_Sub2_5598).anIntArray7880
			= new int[anInt5529];
		}
		int[] is = ((DirectxToolkit) aHa_Sub2_5598).anIntArray7880;
		int[] is_143_ = ((DirectxToolkit) aHa_Sub2_5598).anIntArray7883;
		for (int i_144_ = 0;
		     (anInt5557 ^ 0xffffffff) < (i_144_ ^ 0xffffffff);
		     i_144_++) {
		    ...
		    float f_150_ = f_113_ + (Class252.aFloat3242 * f_147_
					     + f_145_ * AbtractArchiveLoader.aFloat3943
					     + f_146_ * Class215.aFloat2836);
		    if (!(f_148_
			  >= (float) ((DirectxToolkit) aHa_Sub2_5598).anInt7826)) {
			int i_151_ = anIntArray5528[i_144_];
			int i_152_ = anIntArray5528[1 + i_144_];
			for (int i_153_ = i_151_;
			     (i_153_ ^ 0xffffffff) > (i_152_ ^ 0xffffffff);
			     i_153_++) {
			...
			if (i_108_ > 0)
			    f_148_ = (float) i_108_;
			int i_155_
			    = (int) ((float) (((DirectxToolkit) aHa_Sub2_5598)
					      .anInt7853)
			...
			for (int i_159_ = i_157_;
			     (i_158_ ^ 0xffffffff) < (i_159_ ^ 0xffffffff);
			     i_159_++) {
			    int i_160_ = -1 + aShortArray5649[i_159_];
			    if ((i_160_ ^ 0xffffffff) == 0)
				break;
			    is[i_160_] = i_155_;
		...
		for (int i_161_ = 0; i_161_ < anInt5632; i_161_++) {
		    if ((is[aShortArray5592[i_161_]] ^ 0xffffffff) != 999998
	...
	try {
	    anInt5562++;
	    if ((anInt5529 ^ 0xffffffff) == -1)
		return null;
	    if (!aBoolean5527)
		method692((byte) -123);
	    int i;
	    int i_165_;
	    if ((((DirectxToolkit) aHa_Sub2_5598).anInt7772 ^ 0xffffffff) < -1) {
		i = (-(aShort5629 * ((DirectxToolkit) aHa_Sub2_5598).anInt7772
		       >> 2019324136) + aShort5540
		     >> ((DirectxToolkit) aHa_Sub2_5598).anInt7731);
		i_165_ = ((aShort5586
			   + -(aShort5591 * ((DirectxToolkit) aHa_Sub2_5598).anInt7772
			       >> 343653448))
			  >> ((DirectxToolkit) aHa_Sub2_5598).anInt7731);
	    } else {
		i = (-(aShort5591 * ((DirectxToolkit) aHa_Sub2_5598).anInt7772
		       >> 1513519656) + aShort5540
		     >> ((DirectxToolkit) aHa_Sub2_5598).anInt7731);
		i_165_ = ((aShort5586
			   + -(((DirectxToolkit) aHa_Sub2_5598).anInt7772 * aShort5629
			       >> 627247144))
			  >> ((DirectxToolkit) aHa_Sub2_5598).anInt7731);
	    }
	    int i_166_;
	    int i_167_;
	    if (((DirectxToolkit) aHa_Sub2_5598).anInt7777 > 0) {
		i_166_ = (-(((DirectxToolkit) aHa_Sub2_5598).anInt7777 * aShort5629
			    >> 1276490888) + aShort5617
			  >> ((DirectxToolkit) aHa_Sub2_5598).anInt7731);
		i_167_ = ((aShort5646
			   - (aShort5591 * ((DirectxToolkit) aHa_Sub2_5598).anInt7777
			      >> 1713748072))
			  >> ((DirectxToolkit) aHa_Sub2_5598).anInt7731);
	    } else {
		i_166_ = (-(((DirectxToolkit) aHa_Sub2_5598).anInt7777 * aShort5591
			    >> -1440833304) + aShort5617
			  >> ((DirectxToolkit) aHa_Sub2_5598).anInt7731);
		i_167_ = (-(((DirectxToolkit) aHa_Sub2_5598).anInt7777 * aShort5629
	...
	if (anInt5529 > 0 && anInt5537 > 0) {
	    method688(5, false);
	    if ((aByte5581 & 0x10) == 0
		&& ((Class270) aClass270_5575).anInterface8_3463 == null)
    ...
    final void k(int i) {
	anInt5622++;
	int i_171_ = Class70.sineTable[i];
	int i_172_ = Class70.cosineTable[i];
	for (int i_173_ = 0; (anInt5557 ^ 0xffffffff) < (i_173_ ^ 0xffffffff);
	     i_173_++) {
	...
	if (aClass123_5563 == null && aClass123_5610 != null)
	    ((Class123) aClass123_5610).anInterface2_1811 = null;
	if (aClass123_5563 != null)
	    ((Class123) aClass123_5563).anInterface2_1811 = null;
	if (aClass123_5605 != null)
	    ((Class123) aClass123_5605).anInterface2_1811 = null;
	aBoolean5527 = false;
    }
	...
	try {
	    if ((anInt5529 ^ 0xffffffff)
		< (((DirectxToolkit) aHa_Sub2_5598).anIntArray7880.length
		   ^ 0xffffffff)) {
		((DirectxToolkit) aHa_Sub2_5598).anIntArray7883 = new int[anInt5529];
		((DirectxToolkit) aHa_Sub2_5598).anIntArray7880 = new int[anInt5529];
	    }
	    anInt5530++;
	    int[] is = ((DirectxToolkit) aHa_Sub2_5598).anIntArray7880;
	    if (i < 91)
		method619();
	    int[] is_177_ = ((DirectxToolkit) aHa_Sub2_5598).anIntArray7883;
	    for (int i_178_ = 0;
		 (i_178_ ^ 0xffffffff) > (anInt5557 ^ 0xffffffff); i_178_++) {
		int i_179_ = ((-((((DirectxToolkit) aHa_Sub2_5598).anInt7772
				  * anIntArray5593[i_178_])
				 >> 1278542952) + anIntArray5543[i_178_]
			       >> ((DirectxToolkit) aHa_Sub2_5598).anInt7731)
			      - ((r_Sub2) var_r_Sub2).anInt10489);
		int i_180_ = (((anIntArray5644[i_178_]
				+ -((((DirectxToolkit) aHa_Sub2_5598).anInt7777
				     * anIntArray5593[i_178_])
				    >> 1797551784))
			       >> ((DirectxToolkit) aHa_Sub2_5598).anInt7731)
			      + -((r_Sub2) var_r_Sub2).anInt10484);
		...
		if (aByteArray5542 == null
		    || (aByteArray5542[i_185_] ^ 0xffffffff) >= -129) {
	...
	if (aClass118Array5621 != null) {
	    for (int i_203_ = 0;
		 (anInt5536 ^ 0xffffffff) < (i_203_ ^ 0xffffffff); i_203_++) {
		Class118 class118 = aClass118Array5621[i_203_];
		Class48 class48 = aClass48Array5596[i_203_];
		((Class48) class48).anInt858
		    = ((0xffffff
			& (Class10.anIntArray179
			   [0xffff & (aShortArray5580
				      [((Class118) class118).anInt1783])]))
		       | ((Class48) class48).anInt858 & ~0xffffff);
	    }
	}
    ...
    final void a(int i) {
	anInt5538++;
	int i_207_ = Class70.sineTable[i];
	int i_208_ = Class70.cosineTable[i];
    ...
    private final AnimatableToolkit createCopy
	...
	try {
		...
		if (bool_217_) {
			...
			|| ((anInt5642 ^ 0xffffffff)
			    < (class64_sub3_213_.anIntArray5644.length
			       ^ 0xffffffff)))
		    ...
		    class64_sub3_211_.anIntArray5644 = anIntArray5644;
		for (int i_219_ = 0;
		     (i_219_ ^ 0xffffffff) > (anInt5642 ^ 0xffffffff);
		     i_219_++) {
		    if (bool_215_)
		...
		if (!AnimatableToolkit.method616(i_212_ + 2, i, anInt5556))
		...
		((Class123) class64_sub3_211_.aClass123_5605).anInterface2_1811
		    = ((Class123) aClass123_5605).anInterface2_1811;
		((Class123) class64_sub3_211_.aClass123_5605).aByte1812
		    = ((Class123) aClass123_5605).aByte1812;
	    }
	    if (Class122.method1087(12644, anInt5556, i)) {
		if (class64_sub3_213_.aShortArray5580 != null
		    && ((anInt5632 ^ 0xffffffff)
			>= (class64_sub3_213_.aShortArray5580.length
			    ^ 0xffffffff)))
	    ...
	    if (!NpcLoader.method2075(i, -128, anInt5556))
		class64_sub3_211_.aByteArray5542 = aByteArray5542;
	    else {
		if (class64_sub3_213_.aByteArray5542 == null
		    || ((anInt5632 ^ 0xffffffff)
			< (class64_sub3_213_.aByteArray5542.length
			   ^ 0xffffffff)))
		...
		((Class123) class64_sub3_211_.aClass123_5610).anInterface2_1811
		    = ((Class123) aClass123_5610).anInterface2_1811;
		((Class123) class64_sub3_211_.aClass123_5610).aByte1812
		    = ((Class123) aClass123_5610).aByte1812;
	    } else if (VarbitDefinition.method1193(anInt5556, i, true))
		...
		if (aClass139_5572 == null) {
		    ...
		    if (((Class139) class139).aShortArray1954 == null
			|| (anInt5529
			    > ((Class139) class139).aShortArray1954.length)) {
			int i_224_ = anInt5529;
			((Class139) class139).aShortArray1951
			    = new short[i_224_];
			((Class139) class139).aShortArray1953
			    = new short[i_224_];
			((Class139) class139).aShortArray1954
			    = new short[i_224_];
			((Class139) class139).aByteArray1948
			    = new byte[i_224_];
		    }
			...
			((Class139) class139).aShortArray1954[i_225_]
			    = (((Class139) aClass139_5572).aShortArray1954
			       [i_225_]);
			((Class139) class139).aShortArray1951[i_225_]
			    = (((Class139) aClass139_5572).aShortArray1951
			       [i_225_]);
			((Class139) class139).aShortArray1953[i_225_]
			    = (((Class139) aClass139_5572).aShortArray1953
			       [i_225_]);
			((Class139) class139).aByteArray1948[i_225_]
			    = (((Class139) aClass139_5572).aByteArray1948
			       [i_225_]);
		    }
		}
		class64_sub3_211_.aByteArray5594 = aByteArray5594;
	    }
	    if (BufferedPacket.method3325(i, anInt5556, true)) {
		if (bool_214_)
		    class64_sub3_211_.aByte5581 |= 0x4;
		class64_sub3_211_.aClass123_5563
		    = class64_sub3_213_.aClass123_5563;
		((Class123) class64_sub3_211_.aClass123_5563).anInterface2_1811
		    = ((Class123) aClass123_5563).anInterface2_1811;
		((Class123) class64_sub3_211_.aClass123_5563).aByte1812
		    = ((Class123) aClass123_5563).aByte1812;
		...
		if (class64_sub3_213_.aFloatArray5552 != null
		    && ((anInt5632 ^ 0xffffffff)
			>= (class64_sub3_213_.aFloatArray5552.length
			    ^ 0xffffffff))) {
	    ...
	    if (SocketWorker.method1475((byte) -96, anInt5556, i)) {
		class64_sub3_211_.aClass123_5620
		    = class64_sub3_213_.aClass123_5620;
		if (bool_214_)
		    class64_sub3_211_.aByte5581 |= 0x8;
		((Class123) class64_sub3_211_.aClass123_5620).anInterface2_1811
		    = ((Class123) aClass123_5620).anInterface2_1811;
		((Class123) class64_sub3_211_.aClass123_5620).aByte1812
		    = ((Class123) aClass123_5620).aByte1812;
	    } else if (FileIndex.method1163(anInt5556, (byte) -60, i))
		class64_sub3_211_.aClass123_5620 = aClass123_5620;
	    else
		class64_sub3_211_.aClass123_5620 = null;
	    if (!ArchiveLoader.method2352(-19, anInt5556, i)) {
		...
		if (class64_sub3_213_.aShortArray5592 != null
		    && ((class64_sub3_213_.aShortArray5592.length ^ 0xffffffff)
			<= (anInt5632 ^ 0xffffffff))) {
		...
		for (int i_229_ = 0;
		     (i_229_ ^ 0xffffffff) > (anInt5632 ^ 0xffffffff);
		     i_229_++) {
	    ...
	    if (ElementLoaderNode.method723(i, anInt5556, (byte) -70)) {
		if (bool_214_)
		    class64_sub3_211_.aByte5581 |= 0x10;
		class64_sub3_211_.aClass270_5575
		    = class64_sub3_213_.aClass270_5575;
		((Class270) class64_sub3_211_.aClass270_5575).anInterface8_3463
		    = ((Class270) aClass270_5575).anInterface8_3463;
	    ...
	    if (!GameMode.method1637(anInt5556, 32768, i))
		class64_sub3_211_.aShortArray5601 = aShortArray5601;
	    else {
		...
		if (class64_sub3_213_.aClass48Array5596 != null
		    && ((anInt5536 ^ 0xffffffff)
			>= (class64_sub3_213_.aClass48Array5596.length
			    ^ 0xffffffff))) {
	    ...
	    if (!aBoolean5527)
		class64_sub3_211_.aBoolean5527 = false;
	    else {
	    ...
	    class64_sub3_211_.vertexGroups = vertexGroups;
    ...
    final void wa() {
	for (int i = 0; (anInt5642 ^ 0xffffffff) < (i ^ 0xffffffff); i++) {
	...
	try {
		...
		if (!aBoolean5527)
		    method692((byte) -123);
		Class320.aFloat3994
		    = ((((Class101_Sub3) class101_sub3_236_).aFloat5750
			* ((Class101_Sub3) class101_sub3).aFloat5756)
		       + (((Class101_Sub3) class101_sub3).aFloat5754
			  * ((Class101_Sub3) class101_sub3_236_).aFloat5769)
		       + (((Class101_Sub3) class101_sub3).aFloat5784
			  * ((Class101_Sub3) class101_sub3_236_).aFloat5754));
		BufferedRasterizer.aFloat4720
		    = ((((Class101_Sub3) class101_sub3_236_).aFloat5751
			* ((Class101_Sub3) class101_sub3).aFloat5784)
		       + ((((Class101_Sub3) class101_sub3).aFloat5756
			   * ((Class101_Sub3) class101_sub3_236_).aFloat5747)
			  + (((Class101_Sub3) class101_sub3_236_).aFloat5772
			     * ((Class101_Sub3) class101_sub3).aFloat5754))
		       + ((Class101_Sub3) class101_sub3).aFloat5751);
		float f = (BufferedRasterizer.aFloat4720
		...
		if (!(f_239_ >= ((DirectxToolkit) aHa_Sub2_5598).aFloat7875)
		    && !((float) ((DirectxToolkit) aHa_Sub2_5598).anInt7826
			 >= f_238_)) {
		    Class299_Sub1_Sub1.aFloat8696
			= ((((Class101_Sub3) class101_sub3).aFloat5781
			   ...
			   + ((((Class101_Sub3) class101_sub3_236_).aFloat5769
			       * ((Class101_Sub3) class101_sub3).aFloat5750)
			      + ((((Class101_Sub3) class101_sub3_236_)
				  .aFloat5750)
				 * (((Class101_Sub3) class101_sub3)
				    .aFloat5770))));
		    Class190.aFloat2555
		    ...
		    float f_243_;
		    if (!(f_240_ > f_241_)) {
			f_243_ = ((float) ((DirectxToolkit) aHa_Sub2_5598).anInt7771
				  * ((float) -aShort5634 + f_240_));
			f_242_ = ((float) ((DirectxToolkit) aHa_Sub2_5598).anInt7771
		    ...
		    if (!(((DirectxToolkit) aHa_Sub2_5598).aFloat7835
			  <= f_243_ / (float) i)
			&& !(f_242_ / (float) i
			     <= ((DirectxToolkit) aHa_Sub2_5598).aFloat7872)) {
			Class252.aFloat3242
			    = ((((Class101_Sub3) class101_sub3).aFloat5769
				* (((Class101_Sub3) class101_sub3_236_)
				   .aFloat5769))
			...
			if (f_245_ < f_244_) {
			    f_247_ = (((float) -aShort5634 + f_245_)
				      * (float) (((DirectxToolkit) aHa_Sub2_5598)
						 .anInt7794));
			    f_246_
				= ((float) ((DirectxToolkit) aHa_Sub2_5598).anInt7794
			...
			if (!(f_247_ / (float) i
			      >= ((DirectxToolkit) aHa_Sub2_5598).aFloat7830)
			    && !(((DirectxToolkit) aHa_Sub2_5598).aFloat7836
				 >= f_246_ / (float) i)) {
				...
				int i_251_ = (int) (Class156.aFloat2111
						    ...
						    + (Class215.aFloat2836
						       * (float) i_249_));
				int i_252_ = (int) (BufferedRasterizer.aFloat4720
						    + ((float) i_248_
						       * (Class318_Sub9_Sub1
							  .aFloat8784))
						    + (Class320.aFloat3994
				...
				((Class318_Sub3) class318_sub3).anInt6405
				    = (((DirectxToolkit) aHa_Sub2_5598).anInt7853
				       - -(i_250_ * (((DirectxToolkit) aHa_Sub2_5598)
						     .anInt7771) / i));
				((Class318_Sub3) class318_sub3).anInt6402
				    = ((i_251_
					* ((DirectxToolkit) aHa_Sub2_5598).anInt7794
					/ i)
				       + ((DirectxToolkit) aHa_Sub2_5598).anInt7810);
				...
				((Class318_Sub3) class318_sub3).anInt6406
				    = (((DirectxToolkit) aHa_Sub2_5598).anInt7853
				       + (i_253_
					  * ((DirectxToolkit) aHa_Sub2_5598).anInt7771
					  / i));
				if ((((DirectxToolkit) aHa_Sub2_5598).anInt7826
				     ^ 0xffffffff) >= (i_252_ ^ 0xffffffff)
				    || i_255_ >= (((DirectxToolkit) aHa_Sub2_5598)
						  .anInt7826)) {
	...
	do {
		...
		if ((i != 1 && (i ^ 0xffffffff) != -3 && (i ^ 0xffffffff) != -4
		     && i != 5)
		    || (i_261_ >= 0
			&& (((s) var_s).anInt4587
			    > (((s) var_s).anInt4592 + i_262_
			       >> ((s) var_s).anInt4588))
			&& (i_263_ ^ 0xffffffff) <= -1
			&& (((s) var_s).anInt4590
			    > (i_264_ - -((s) var_s).anInt4592
			       >> ((s) var_s).anInt4588)))) {
		    if ((i ^ 0xffffffff) != -5 && i != 5) {
			i_261_ >>= ((s) var_s).anInt4588;
			i_262_ = (i_262_ - -((s) var_s).anInt4592 - 1
				  >> ((s) var_s).anInt4588);
			i_263_ >>= ((s) var_s).anInt4588;
			i_264_ = (i_264_ + ((s) var_s).anInt4592 + -1
				  >> ((s) var_s).anInt4588);
			if ((var_s.method3982((byte) -86, i_263_, i_261_)
			     ^ 0xffffffff) == (i_259_ ^ 0xffffffff)
			    && (var_s.method3982((byte) -86, i_263_, i_262_)
				^ 0xffffffff) == (i_259_ ^ 0xffffffff)
			    ...
			    break;
			       ...
			       || (i_261_ < 0
				   || ((((s) var_s_257_).anInt4587
					^ 0xffffffff)
				       >= (((i_262_
					     - -((s) var_s_257_).anInt4592)
					    >> ((s) var_s_257_).anInt4588)
					   ^ 0xffffffff))
				   || (i_263_ ^ 0xffffffff) > -1
				   || (((s) var_s_257_).anInt4590
				       <= (((s) var_s_257_).anInt4592 + i_264_
					   >> ((s) var_s_257_).anInt4588))))
			break;
		    if (i == 1) {
			...
			if (i == 3) {
				...
				|| (((i_266_ >> 96965825)
				     + (i_258_ - -((s) var_s).anInt4592))
				    >= (((s) var_s).anInt4587
					<< ((s) var_s).anInt4588))
				|| -(i_267_ >> -1445996511) + i_260_ < 0
				|| ((((i_267_ >> -295450847) + i_260_
				      + ((s) var_s).anInt4592)
				     ^ 0xffffffff)
				    <= ((((s) var_s).anInt4590
					 << ((s) var_s).anInt4588)
			...
			for (int i_280_ = 0; anInt5557 > i_280_; i_280_++) {
				...
				= ((anIntArray5593[i_280_] << -677349360)
				   / i_279_);
			    if ((i_256_ ^ 0xffffffff) < (i_281_ ^ 0xffffffff))
	...
	anInt5590++;
	d var_d = ((AbstractToolkit) aHa_Sub2_5598).aD4579;
	...
	byte i_287_ = 0;
	if ((i ^ 0xffffffff) != 0) {
	    TextureDefinition class12 = var_d.getTexture(0xffff & i, -6662);
	    i_287_ = ((TextureDefinition) class12).aByte216;
	    i_286_ = ((TextureDefinition) class12).aByte201;
	}
	byte i_288_ = 0;
	byte i_289_ = 0;
	if (i_284_ != -1) {
	    TextureDefinition class12 = var_d.getTexture(i_284_ & 0xffff, -6662);
	    if (((TextureDefinition) class12).aByte198 != 0
		|| ((TextureDefinition) class12).aByte211 != 0)
		aBoolean5638 = true;
	    i_288_ = ((TextureDefinition) class12).aByte201;
	    i_289_ = ((TextureDefinition) class12).aByte216;
	}
	if ((i_289_ ^ 0xffffffff) != (i_287_ ^ 0xffffffff)
	    | (i_288_ ^ 0xffffffff) != (i_286_ ^ 0xffffffff)) {
	    if (aClass118Array5621 != null) {
	...
	boolean bool_294_
	    = (aClass123_5620 != null
	       && ((Class123) aClass123_5620).anInterface2_1811 == null);
	if (bool) {
	...
	if (i == 5) {
		...
		if (((((ByteBuffer)
		      ...
		      .payload).length
		     ^ 0xffffffff)
		    > (anInt5529 * i_295_ ^ 0xffffffff))
		    ((DirectxToolkit) aHa_Sub2_5598).aClass348_Sub49_Sub1_7798
			= new FloatBuffer(i_295_ * (100 + anInt5529));
		else
		    ((ByteBuffer) (((DirectxToolkit) aHa_Sub2_5598)
				       .aClass348_Sub49_Sub1_7798)).position
			= 0;
		FloatBuffer class348_sub49_sub1
		    = ((DirectxToolkit) aHa_Sub2_5598).aClass348_Sub49_Sub1_7798;
		if (bool_293_) {
		    if (((DirectxToolkit) aHa_Sub2_5598).aBoolean7775) {
			for (int i_300_ = 0;
			     (i_300_ ^ 0xffffffff) > (anInt5557 ^ 0xffffffff);
			     i_300_++) {
				...
				if ((i_307_ ^ 0xffffffff) == 0)
				    break;
				((ByteBuffer) class348_sub49_sub1)
				    .position
				    = i_295_ * i_307_;
				class348_sub49_sub1.putInt(i_301_);
				class348_sub49_sub1.putInt(i_302_);
				class348_sub49_sub1.putInt(i_303_);
			    }
			}
		    } else {
		...
		if (bool_291_) {
			...
			if (aClass139_5572 != null) {
			    is_318_
				= ((Class139) aClass139_5572).aShortArray1954;
			    is = ((Class139) aClass139_5572).aShortArray1953;
			    is_317_
				= ((Class139) aClass139_5572).aShortArray1951;
			    is_316_
				= ((Class139) aClass139_5572).aByteArray1948;
			...
			float f = ((DirectxToolkit) aHa_Sub2_5598).aFloatArray7825[0];
			float f_319_
			    = ((DirectxToolkit) aHa_Sub2_5598).aFloatArray7825[1];
			float f_320_
			    = ((DirectxToolkit) aHa_Sub2_5598).aFloatArray7825[2];
			float f_321_ = ((DirectxToolkit) aHa_Sub2_5598).aFloat7768;
			float f_322_ = (((DirectxToolkit) aHa_Sub2_5598).aFloat7832
					* 768.0F / (float) aShort5645);
			float f_323_ = (((DirectxToolkit) aHa_Sub2_5598).aFloat7871
					* 768.0F / (float) aShort5645);
			for (int i_324_ = 0; anInt5632 > i_324_; i_324_++) {
			    ...
			    float f_326_
				= (((DirectxToolkit) aHa_Sub2_5598).aFloat7781
				   * (float) (i_325_ >>> 1893072216));
			    float f_327_
				= ((float) (0xff & i_325_ >> -934101304)
				   * ((DirectxToolkit) aHa_Sub2_5598).aFloat7823);
			    float f_328_
				= ((float) ((0xff88e4 & i_325_) >> 1887530576)
				   * ((DirectxToolkit) aHa_Sub2_5598).aFloat7816);
			    int i_329_ = aShortArray5592[i_324_];
			    short i_330_ = (short) is_316_[i_329_];
			    float f_331_;
			    if ((i_330_ ^ 0xffffffff) != -1)
			    ...
			    if ((i_333_ ^ 0xffffffff) <= -1) {
				if ((i_333_ ^ 0xffffffff) < -256)
				    i_333_ = 255;
			    } else
				i_333_ = 0;
				...
				i_335_ = 255;
			    class348_sub49_sub1.putByte(i_333_);
			    class348_sub49_sub1.putByte(i_334_);
			    class348_sub49_sub1.putByte(i_335_);
			    class348_sub49_sub1.putByte((255
							    + -((aByteArray5542
								 [i_324_])
								& 0xff)));
			    i_329_ = aShortArray5579[i_324_];
			    i_330_ = (short) is_316_[i_329_];
			    if (i_330_ != 0)
				f_331_
				    = (((float) is[i_329_] * f_320_
					+ (f * (float) is_318_[i_329_]
			    ...
			    if ((i_335_ ^ 0xffffffff) > -1)
				i_335_ = 0;
			    else if ((i_335_ ^ 0xffffffff) < -256)
				i_335_ = 255;
			    class348_sub49_sub1.putByte(i_333_);
			    class348_sub49_sub1.putByte(i_334_);
			    class348_sub49_sub1.putByte(i_335_);
			    class348_sub49_sub1.putByte
				(255 - (aByteArray5542[i_324_] & 0xff));
			    ...
			    class348_sub49_sub1.putByte(i_334_);
			    class348_sub49_sub1.putByte(i_335_);
			    class348_sub49_sub1.putByte((-(0xff
							      & (aByteArray5542
								 [i_324_]))
							    + 255));
			}
			...
			for (int i_336_ = 0; i_336_ < anInt5632; i_336_++) {
			    ...
			    class348_sub49_sub1.putInt(i_337_);
			    ((ByteBuffer) class348_sub49_sub1).position
		...
		if (bool_292_) {
			...
			is = ((Class139) aClass139_5572).aByteArray1948;
			is_338_ = ((Class139) aClass139_5572).aShortArray1951;
			is_339_ = ((Class139) aClass139_5572).aShortArray1953;
			is_340_ = ((Class139) aClass139_5572).aShortArray1954;
		    }
		    float f = 3.0F / (float) aShort5645;
		    ((ByteBuffer) class348_sub49_sub1).position = i_298_;
		    float f_341_
			= 3.0F / (float) (aShort5645 / 2 + aShort5645);
		    if (!((DirectxToolkit) aHa_Sub2_5598).aBoolean7775) {
			for (int i_342_ = 0;
			     (anInt5529 ^ 0xffffffff) < (i_342_ ^ 0xffffffff);
			     i_342_++) {
		...
		if (bool_294_) {
		    ((ByteBuffer) class348_sub49_sub1).position = i_299_;
		    if (((DirectxToolkit) aHa_Sub2_5598).aBoolean7775) {
			for (int i_348_ = 0;
			     (anInt5529 ^ 0xffffffff) < (i_348_ ^ 0xffffffff);
			     i_348_++) {
		...
		if (bool_293_) {
		    ((Class123) aClass123_5605).aByte1812 = i_296_;
		    ((Class123) aClass123_5605).anInterface2_1811 = interface2;
		}
		if (bool_294_) {
		    ((Class123) aClass123_5620).aByte1812 = i_299_;
		    ((Class123) aClass123_5620).anInterface2_1811 = interface2;
		}
		if (bool_291_) {
		    ((Class123) aClass123_5610).aByte1812 = i_297_;
		    ((Class123) aClass123_5610).anInterface2_1811 = interface2;
		}
		if (bool_292_) {
		    ((Class123) aClass123_5563).aByte1812 = i_298_;
		    ((Class123) aClass123_5563).anInterface2_1811 = interface2;
		}
	    }
	}
    }
	...
	try {
		...
		Class320.aFloat3994
		    = ((((Class101_Sub3) class101_sub3_350_).aFloat5754
			* ((Class101_Sub3) class101_sub3).aFloat5784)
		       + ((((Class101_Sub3) class101_sub3_350_).aFloat5750
			   * ((Class101_Sub3) class101_sub3).aFloat5756)
			  + (((Class101_Sub3) class101_sub3_350_).aFloat5769
			     * ((Class101_Sub3) class101_sub3).aFloat5754)));
		BufferedRasterizer.aFloat4720
		    = (((Class101_Sub3) class101_sub3).aFloat5751
		       + ((((Class101_Sub3) class101_sub3).aFloat5756
			   * ((Class101_Sub3) class101_sub3_350_).aFloat5747)
			  + (((Class101_Sub3) class101_sub3_350_).aFloat5772
			     * ((Class101_Sub3) class101_sub3).aFloat5754)
			  + (((Class101_Sub3) class101_sub3_350_).aFloat5751
			     * ((Class101_Sub3) class101_sub3).aFloat5784)));
		float f = (BufferedRasterizer.aFloat4720
			   + Class320.aFloat3994 * (float) aShort5591);
		...
		if (!(((DirectxToolkit) aHa_Sub2_5598).aFloat7874 <= f_352_)
		    && !((float) ((DirectxToolkit) aHa_Sub2_5598).anInt7826
			 >= f_353_)) {
		    Class299_Sub1_Sub1.aFloat8696
			= ((((Class101_Sub3) class101_sub3).aFloat5750
			   ...
			   + (((Class101_Sub3) class101_sub3_350_).aFloat5750
			      * ((Class101_Sub3) class101_sub3).aFloat5770)
			   + (((Class101_Sub3) class101_sub3).aFloat5781
			      * (((Class101_Sub3) class101_sub3_350_)
				 .aFloat5754)));
		    Class190.aFloat2555
			= (((Class101_Sub3) class101_sub3).aFloat5747
			   + ((((Class101_Sub3) class101_sub3).aFloat5781
		    ...
		    float f_357_;
		    if (!(f_354_ > f_355_)) {
			f_357_ = ((float) ((DirectxToolkit) aHa_Sub2_5598).anInt7771
				  * (f_355_ + (float) aShort5634));
			f_356_
			    = (((float) -aShort5634 + f_354_)
			       * (float) ((DirectxToolkit) aHa_Sub2_5598).anInt7771);
		    } else {
			f_356_ = ((float) ((DirectxToolkit) aHa_Sub2_5598).anInt7771
			...
			if (!(f_361_ / f_353_
				...
				int i_367_
				    = (int) ((Class318_Sub9_Sub1.aFloat8784
						...
						* (float) aShort5591)
					     + (Class286_Sub8.aFloat6304
						* (float) i_364_));
				if ((i_367_ ^ 0xffffffff)
				    <= (((DirectxToolkit) aHa_Sub2_5598).anInt7826
					^ 0xffffffff)) {
				    ((Class318_Sub3) class318_sub3).anInt6405
					= (i_365_ * (((DirectxToolkit) aHa_Sub2_5598)
						     .anInt7771) / i_367_
					   + (((DirectxToolkit) aHa_Sub2_5598)
					      .anInt7853));
				    ((Class318_Sub3) class318_sub3).anInt6402
					= (i_366_ * (((DirectxToolkit) aHa_Sub2_5598)
						     .anInt7794) / i_367_
					   + (((DirectxToolkit) aHa_Sub2_5598)
					      .anInt7810));
				} else
				...
				if (i_370_
				    >= ((DirectxToolkit) aHa_Sub2_5598).anInt7826) {
				    ((Class318_Sub3) class318_sub3).anInt6406
					= (i_368_ * (((DirectxToolkit) aHa_Sub2_5598)
						     .anInt7771) / i_370_
					   + (((DirectxToolkit) aHa_Sub2_5598)
					      .anInt7853));
				    ((Class318_Sub3) class318_sub3).anInt6404
					= (i_369_ * (((DirectxToolkit) aHa_Sub2_5598)
						     .anInt7794) / i_370_
					   + (((DirectxToolkit) aHa_Sub2_5598)
					      .anInt7810));
				} else
				...
				if (bool) {
					...
					|| ((i_370_ ^ 0xffffffff)
					    <= ((((DirectxToolkit) aHa_Sub2_5598)
						 .anInt7826)
						^ 0xffffffff))) {
					if (((((DirectxToolkit) aHa_Sub2_5598)
					      .anInt7826)
					     ^ 0xffffffff)
					    < (i_367_ ^ 0xffffffff)) {
					    int i_371_
						...
						= ((i_373_
						   ...
						   + (((DirectxToolkit) aHa_Sub2_5598)
						      .anInt7810));
					} else if (((((DirectxToolkit) aHa_Sub2_5598)
						     .anInt7826)
						    ^ 0xffffffff)
						   < (i_370_ ^ 0xffffffff)) {
					    int i_374_
	...
	if (i != -59)
	    anInt5584 = 77;
	anInt5577++;
	InterfaceScript.anInt6992 = i_377_;
	...
	Class348_Sub15 class348_sub15
	    = ((Class348_Sub15)
	       Class27.aClass356_389.get((long) i_378_));
	int i_379_ = -8 % ((i - -49) / 44);
	if (class348_sub15 != null) {
	    ((Class348_Sub15) class348_sub15).aClass55_Sub1_6768.method508(1);
	    Class303.method2285(((Class348_Sub15) class348_sub15).aBoolean6776,
				(byte) -114,
				((Class348_Sub15) class348_sub15).anInt6773);
	    class348_sub15.removeNode();
	}
    }
	...
	if (aBoolean5555) {
		...
		&& !NativeRaster.method989(anInt5648, -385, anInt5556)) {
		if (aClass123_5563 == null) {
		    if (aClass123_5610 == null
			|| (((Class123) aClass123_5610).anInterface2_1811
			    != null)) {
			...
			aBoolean5555 = true;
		} else if (((Class123) aClass123_5563).anInterface2_1811
			   == null)
		    aBoolean5555 = true;
		else {
		    aByteArray5594 = null;
		...
		&& !ElementLoaderNode.method724(anInt5648, anInt5556, 393216)) {
		if ((aClass270_5575 != null
		     && ((Class270) aClass270_5575).anInterface8_3463 == null)
		    || aClass123_5610 != null && (((Class123) aClass123_5610)
	...
	if (aClass118Array5621 != null) {
		...
		((Class48) class48).anInt858
		    = ((Class10.anIntArray179
			[(aShortArray5580[((Class118) class118).anInt1783]
			  & 0xffff)]) & 0xffffff
		       | ~0xffffff & ((Class48) class48).anInt858);
	    }
	}
	if (aClass123_5610 != null)
	    ((Class123) aClass123_5610).anInterface2_1811 = null;
	...
	do {
		...
		if (aClass129Array5640 != null) {
			...
			((Class129) class129_384_).anInt1882
			    = (int) (((Class101_Sub3) class101_sub3).aFloat5747
				     + (((float) (anIntArray5593
						  [(((Class129) class129)
						    .anInt1881)])
					 * (((Class101_Sub3) class101_sub3)
					...
					+ ((float) (anIntArray5644
					   ...
					   * (((Class101_Sub3) class101_sub3)
					      .aFloat5781))));
			((Class129) class129_384_).anInt1891
			    = (int) (((Class101_Sub3) class101_sub3).aFloat5772
				     + (((float) (anIntArray5593
						  [(((Class129) class129)
						    .anInt1881)])
					 * (((Class101_Sub3) class101_sub3)
					...
					+ ((float) (anIntArray5644
					   ...
					   * (((Class101_Sub3) class101_sub3)
					      .aFloat5762))));
			((Class129) class129_384_).anInt1889
			    = (int) (((Class101_Sub3) class101_sub3).aFloat5751
				     + (((float) (anIntArray5543
						  [(((Class129) class129)
						    .anInt1881)])
					 * (((Class101_Sub3) class101_sub3)
					...
					+ ((float) (anIntArray5644
					   ...
					   * (((Class101_Sub3) class101_sub3)
					      .aFloat5784))));
			((Class129) class129_384_).anInt1883
			    = (int) (((Class101_Sub3) class101_sub3).aFloat5747
				     + (((((Class101_Sub3) class101_sub3)
					  .aFloat5770)
					 * (float) (anIntArray5543
					...
					+ ((float) (anIntArray5644
					   ...
					   * (((Class101_Sub3) class101_sub3)
					      .aFloat5781))));
			((Class129) class129_384_).anInt1890
			    = (int) (((Class101_Sub3) class101_sub3).aFloat5772
				     + (((((Class101_Sub3) class101_sub3)
					  .aFloat5762)
					 * (float) (anIntArray5644
			...
			((Class129) class129_384_).anInt1880
			    = (int) (((Class101_Sub3) class101_sub3).aFloat5751
				     + (((((Class101_Sub3) class101_sub3)
					  .aFloat5784)
					 * (float) (anIntArray5644
			...
			((Class129) class129_384_).anInt1876
			    = (int) (((Class101_Sub3) class101_sub3).aFloat5747
				     + (((float) (anIntArray5593
						  [(((Class129) class129)
						    .anInt1892)])
					...
					+ ((((Class101_Sub3) class101_sub3)
					   ...
					   * (float) (anIntArray5644
						      [(((Class129) class129)
							.anInt1892)]))));
			((Class129) class129_384_).anInt1874
			    = (int) (((Class101_Sub3) class101_sub3).aFloat5772
				     + (((float) (anIntArray5644
						  [(((Class129) class129)
						    .anInt1892)])
					   ...
					   + ((((Class101_Sub3) class101_sub3)
					      ...
					      * (float) (anIntArray5593
							 [(((Class129)
							    class129)
							   .anInt1892)])))));
			((Class129) class129_384_).anInt1884
			    = (int) (((((Class101_Sub3) class101_sub3)
				       .aFloat5754)
				      * (float) (anIntArray5593
						 [(((Class129) class129)
						   .anInt1892)]))
		...
		for (int i = 0; aClass342Array5541.length > i; i++) {
			...
			class342_385_ = ((Class342) class342).aClass342_4248;
		    ...
		    ((Class342) class342_385_).anInt4238
			= (int) (((Class101_Sub3) class101_sub3).aFloat5747
				 + (((float) (anIntArray5644
					      [(((Class342) class342)
						.anInt4244)])
					...
					* (((Class101_Sub3) class101_sub3)
					  ...
					  * (float) (anIntArray5593
						     [(((Class342) class342)
						       .anInt4244)])))));
		    ((Class342) class342_385_).anInt4239
			= (int) (((Class101_Sub3) class101_sub3).aFloat5772
				 + (((float) (anIntArray5593
					      [(((Class342) class342)
						.anInt4244)])
				    ...
				    + ((float) (anIntArray5644
				       ...
				       * (((Class101_Sub3) class101_sub3)
					  .aFloat5762))));
		    ((Class342) class342_385_).anInt4240
			= (int) (((Class101_Sub3) class101_sub3).aFloat5751
				 + (((float) (anIntArray5644
					      [(((Class342) class342)
						.anInt4244)])
	...
	try {
		...
		for (int i_392_ = 0; i_392_ < i_390_; i_392_++) {
		    ...
		    if (i_393_ < vertexGroups.length) {
			int[] is_394_ = vertexGroups[i_393_];
			for (int i_395_ = 0;
			     ((is_394_.length ^ 0xffffffff)
			      < (i_395_ ^ 0xffffffff));
			     i_395_++) {
		...
		for (int i_397_ = 0; i_390_ > i_397_; i_397_++) {
		    ...
		    if (i_398_ < vertexGroups.length) {
			int[] is_399_ = vertexGroups[i_398_];
		...
		for (int i_402_ = 0;
		     (i_402_ ^ 0xffffffff) > (i_390_ ^ 0xffffffff); i_402_++) {
		    int i_403_ = is[i_402_];
		    if (vertexGroups.length > i_403_) {
			int[] is_404_ = vertexGroups[i_403_];
			if ((0x1 & i_389_ ^ 0xffffffff) != -1) {
				...
				if (i_386_ != 0) {
				    int i_407_
					= Class70.sineTable[i_386_];
				    int i_408_
					= Class70.cosineTable[i_386_];
				    int i_409_
					= ((16383
				...
				if (i_388_ != 0) {
				    int i_410_
					= Class70.sineTable[i_388_];
				    int i_411_
					= Class70.cosineTable[i_388_];
				    int i_412_
					= ((16383
				...
				if ((i_387_ ^ 0xffffffff) != -1) {
				    int i_413_
					= Class70.sineTable[i_387_];
				    int i_414_
					= Class70.cosineTable[i_387_];
				    int i_415_
		...
		if (bool) {
			...
			if (i_428_ < vertexGroups.length) {
			    int[] is_429_ = vertexGroups[i_428_];
		...
		for (int i_445_ = 0;
		     (i_390_ ^ 0xffffffff) < (i_445_ ^ 0xffffffff); i_445_++) {
		    int i_446_ = is[i_445_];
		    if ((vertexGroups.length ^ 0xffffffff)
			< (i_446_ ^ 0xffffffff)) {
			int[] is_447_ = vertexGroups[i_446_];
		...
		if (anIntArrayArray5553 != null) {
		    for (int i_450_ = 0;
			 (i_450_ ^ 0xffffffff) > (i_390_ ^ 0xffffffff);
			 i_450_++) {
			...
			if (anIntArrayArray5553.length > i_451_) {
				...
				int i_455_ = ((0xff & aByteArray5542[i_454_])
					      + 8 * i_386_);
				if ((i_455_ ^ 0xffffffff) > -1)
				    i_455_ = 0;
				else if ((i_455_ ^ 0xffffffff) < -256)
				    i_455_ = 255;
				aByteArray5542[i_454_] = (byte) i_455_;
			    }
			    if ((is_452_.length ^ 0xffffffff) < -1
				&& aClass123_5610 != null)
				((Class123) aClass123_5610).anInterface2_1811
				    = null;
			}
		...
		if (anIntArrayArray5553 != null) {
		    for (int i_457_ = 0;
			 (i_457_ ^ 0xffffffff) > (i_390_ ^ 0xffffffff);
			 i_457_++) {
			...
			if (i_458_ < anIntArrayArray5553.length) {
				...
				i_465_ += i_388_;
				if ((i_464_ ^ 0xffffffff) <= -1) {
				    if ((i_464_ ^ 0xffffffff) < -8)
					i_464_ = 7;
				} else
				    i_464_ = 0;
				if (i_465_ < 0)
			    ...
			    if ((is_459_.length ^ 0xffffffff) < -1
				&& aClass123_5610 != null)
				((Class123) aClass123_5610).anInterface2_1811
				    = null;
			}
		    ...
		    if (aClass118Array5621 != null) {
			for (int i_466_ = 0;
			     (i_466_ ^ 0xffffffff) > (anInt5536 ^ 0xffffffff);
			     i_466_++) {
		...
		if (anIntArrayArray5627 != null) {
		    for (int i_467_ = 0;
			 (i_390_ ^ 0xffffffff) < (i_467_ ^ 0xffffffff);
			 i_467_++) {
			int i_468_ = is[i_467_];
			if ((anIntArrayArray5627.length ^ 0xffffffff)
			    < (i_468_ ^ 0xffffffff)) {
				...
				((Class48) class48).anInt854 += i_386_;
				((Class48) class48).anInt847 += i_387_;
			    }
			}
		    }
		}
		...
		if (anIntArrayArray5627 != null) {
			...
			if (i_472_ < anIntArrayArray5627.length) {
			    ...
			    for (int i_474_ = 0;
				 ((is_473_.length ^ 0xffffffff)
				  < (i_474_ ^ 0xffffffff));
				 i_474_++) {
				Class48 class48
				    = aClass48Array5596[is_473_[i_474_]];
				((Class48) class48).anInt856
				    = (i_386_ * ((Class48) class48).anInt856
				       >> -1460665785);
				((Class48) class48).anInt857
				    = (((Class48) class48).anInt857 * i_387_
				       >> 74633895);
			    }
			}
		    }
		...
		if (anIntArrayArray5627 != null) {
			...
			if ((i_476_ ^ 0xffffffff)
			    > (anIntArrayArray5627.length ^ 0xffffffff)) {
			    int[] is_477_ = anIntArrayArray5627[i_476_];
			    for (int i_478_ = 0; is_477_.length > i_478_;
				 i_478_++) {
				Class48 class48
				    = aClass48Array5596[is_477_[i_478_]];
				((Class48) class48).anInt853
				    = (((Class48) class48).anInt853 + i_386_
				       & 0x3fff);
			    }
			}
		    }
	...
	if (i == 0) {
		...
		if (i_481_ != 0) {
		    int i_486_ = Class70.sineTable[i_481_];
		    int i_487_ = Class70.cosineTable[i_481_];
		...
		if (i_479_ != 0) {
		    int i_489_ = Class70.sineTable[i_479_];
		    int i_490_ = Class70.cosineTable[i_479_];
		...
		if (i_480_ != 0) {
		    int i_492_ = Class70.sineTable[i_480_];
		    int i_493_ = Class70.cosineTable[i_480_];
		    int i_494_
	    ...
	    for (int i_495_ = 0;
		 (anInt5557 ^ 0xffffffff) < (i_495_ ^ 0xffffffff); i_495_++) {
		...
		i_502_ += i_480_ / 4;
		i_503_ += i_481_;
		if ((i_502_ ^ 0xffffffff) <= -1) {
		    if (i_502_ > 7)
			i_502_ = 7;
		} else
		    i_502_ = 0;
		if ((i_503_ ^ 0xffffffff) <= -1) {
		    if (i_503_ > 127)
			i_503_ = 127;
		} else
		    i_503_ = 0;
	    ...
	    for (int i_505_ = 0;
		 (anInt5536 ^ 0xffffffff) < (i_505_ ^ 0xffffffff); i_505_++) {
		Class48 class48 = aClass48Array5596[i_505_];
		((Class48) class48).anInt847 += i_480_;
		((Class48) class48).anInt854 += i_479_;
	    }
	} else if ((i ^ 0xffffffff) == -11) {
	    for (int i_506_ = 0;
		 (i_506_ ^ 0xffffffff) > (anInt5536 ^ 0xffffffff); i_506_++) {
		Class48 class48 = aClass48Array5596[i_506_];
		((Class48) class48).anInt856
		    = ((Class48) class48).anInt856 * i_479_ >> -1065439225;
		((Class48) class48).anInt857
		    = i_480_ * ((Class48) class48).anInt857 >> 507326855;
	    }
	} else if ((i ^ 0xffffffff) == -10) {
	    for (int i_507_ = 0; i_507_ < anInt5536; i_507_++) {
		Class48 class48 = aClass48Array5596[i_507_];
		((Class48) class48).anInt853
		    = ((Class48) class48).anInt853 + i_479_ & 0x3fff;
	    }
	}
    }
	...
	anInt5597++;
	if (aClass139_5572 != null
	    && (0x10000 & anInt5648 ^ 0xffffffff) == -1) {
	    aShortArray5576 = ((Class139) aClass139_5572).aShortArray1953;
	    aByteArray5594 = ((Class139) aClass139_5572).aByteArray1948;
	    aShortArray5564 = ((Class139) aClass139_5572).aShortArray1954;
	    aShortArray5583 = ((Class139) aClass139_5572).aShortArray1951;
	    aClass139_5572 = null;
	}
	aBoolean5555 = true;
	method691((byte) -62);
    ...
    final void v() {
	anInt5535++;
	for (int i = 0; (i ^ 0xffffffff) > (anInt5557 ^ 0xffffffff); i++)
	    anIntArray5644[i] = -anIntArray5644[i];
	for (int i = 0; (i ^ 0xffffffff) > (anInt5529 ^ 0xffffffff); i++)
	...
	try {
		...
		int[] is = new int[3];
		for (int i_509_ = 0;
		     (anInt5557 ^ 0xffffffff) < (i_509_ ^ 0xffffffff);
		     i_509_++) {
		    if ((i & aShortArray5608[i_509_] ^ 0xffffffff) != -1) {
			if (!bool)
	...
	try {
		...
		for (int i_517_ = 0; i_515_ > i_517_; i_517_++) {
		    ...
		    if ((i_518_ ^ 0xffffffff)
			> (vertexGroups.length ^ 0xffffffff)) {
			int[] is_519_ = vertexGroups[i_518_];
			for (int i_520_ = 0; i_520_ < is_519_.length;
			     i_520_++) {
			    int i_521_ = is_519_[i_520_];
			    if (aShortArray5608 == null
				|| (i_513_ & aShortArray5608[i_521_]
				    ^ 0xffffffff) != -1) {
		...
		if (i_516_ <= 0) {
		    ...
		    OndemandFileRequest.aBoolean10450 = true;
		}
	    } else if (i == 1) {
		if (is_514_ != null) {
		...
		i_511_ <<= 4;
		for (int i_525_ = 0;
		     (i_515_ ^ 0xffffffff) < (i_525_ ^ 0xffffffff); i_525_++) {
		    int i_526_ = is[i_525_];
		    if (i_526_ < vertexGroups.length) {
			int[] is_527_ = vertexGroups[i_526_];
		...
		if (is_514_ == null) {
		    for (int i_530_ = 0;
			 (i_530_ ^ 0xffffffff) > (i_515_ ^ 0xffffffff);
			 i_530_++) {
			int i_531_ = is[i_530_];
			if (i_531_ < vertexGroups.length) {
			    int[] is_532_ = vertexGroups[i_531_];
				...
				if (aShortArray5608 == null
					...
					-= Class181.anInt2398;
				    if ((i_512_ ^ 0xffffffff) != -1) {
					int i_535_
					    = Class70.sineTable[i_512_];
					int i_536_
					    = Class70.cosineTable[i_512_];
					int i_537_
				    ...
				    if (i_510_ != 0) {
					int i_538_
					    = Class70.sineTable[i_510_];
					int i_539_
					    = Class70.cosineTable[i_510_];
					int i_540_
					    = ((-(anIntArray5644[i_534_]
						  * i_538_)
						+ (i_539_
				    ...
				    if (i_511_ != 0) {
					int i_541_
					    = Class70.sineTable[i_511_];
					int i_542_
					    = Class70.cosineTable[i_511_];
					int i_543_
			...
			for (int i_544_ = 0; i_544_ < i_515_; i_544_++) {
			    ...
			    if ((vertexGroups.length ^ 0xffffffff)
				< (i_545_ ^ 0xffffffff)) {
				int[] is_546_ = vertexGroups[i_545_];
		    ...
		    if (OndemandFileRequest.aBoolean10450) {
			int i_568_
			...
			OndemandFileRequest.aBoolean10450 = false;
		    }
		    int[] is_571_ = new int[9];
		    int i_572_ = Class70.cosineTable[i_510_];
		    int i_573_ = Class70.sineTable[i_510_];
		    int i_574_ = Class70.cosineTable[i_511_];
		    int i_575_ = Class70.sineTable[i_511_];
		    int i_576_ = Class70.cosineTable[i_512_];
		    int i_577_ = Class70.sineTable[i_512_];
			...
			for (int i_588_ = 0; i_588_ < 3; i_588_++) {
			    int i_589_ = 0;
			    for (int i_590_ = 0; (i_590_ ^ 0xffffffff) > -4;
				 i_590_++)
		    ...
		    for (int i_595_ = 0; (i_595_ ^ 0xffffffff) > -4;
			 i_595_++) {
			for (int i_596_ = 0; i_596_ < 3; i_596_++) {
			    int i_597_ = 0;
			    for (int i_598_ = 0; (i_598_ ^ 0xffffffff) > -4;
				 i_598_++)
		    ...
		    i_601_ += i_564_;
		    for (int i_602_ = 0;
			 (i_515_ ^ 0xffffffff) < (i_602_ ^ 0xffffffff);
			 i_602_++) {
			int i_603_ = is[i_602_];
			if (i_603_ < vertexGroups.length) {
			    int[] is_604_ = vertexGroups[i_603_];
			    for (int i_605_ = 0;
				 ((is_604_.length ^ 0xffffffff)
				  < (i_605_ ^ 0xffffffff));
				 i_605_++) {
				int i_606_ = is_604_[i_605_];
				if (aShortArray5608 == null
				    || (aShortArray5608[i_606_] & i_513_
					^ 0xffffffff) != -1) {
				    int i_607_
					= ((8192
					    + (is_594_[2]
		...
		if (is_514_ != null) {
		    ...
		    for (int i_633_ = 0; (i_633_ ^ 0xffffffff) > -4;
			 i_633_++) {
		    ...
		    i_639_ += i_612_;
		    for (int i_640_ = 0;
			 (i_515_ ^ 0xffffffff) < (i_640_ ^ 0xffffffff);
			 i_640_++) {
			int i_641_ = is[i_640_];
			if ((i_641_ ^ 0xffffffff)
			    > (vertexGroups.length ^ 0xffffffff)) {
			    int[] is_642_ = vertexGroups[i_641_];
			    for (int i_643_ = 0; is_642_.length > i_643_;
				 i_643_++) {
				int i_644_ = is_642_[i_643_];
				if (aShortArray5608 == null
				    || (aShortArray5608[i_644_] & i_513_
					^ 0xffffffff) != -1) {
				    int i_645_
					= ((8192
					    + (is_632_[1]
			...
			if ((vertexGroups.length ^ 0xffffffff)
			    < (i_649_ ^ 0xffffffff)) {
			    int[] is_650_ = vertexGroups[i_649_];
			    for (int i_651_ = 0;
				 ((is_650_.length ^ 0xffffffff)
				  < (i_651_ ^ 0xffffffff));
				 i_651_++) {
		...
		if (anIntArrayArray5553 != null) {
		    for (int i_653_ = 0;
			 (i_515_ ^ 0xffffffff) < (i_653_ ^ 0xffffffff);
			 i_653_++) {
			...
			if (i_654_ < anIntArrayArray5553.length) {
				...
				if (aShortArray5573 == null
				    || (aShortArray5573[i_657_] & i_513_
					^ 0xffffffff) != -1) {
				    int i_658_
					= ((aByteArray5542[i_657_] & 0xff)
					   - -(8 * i_510_));
				    if ((i_658_ ^ 0xffffffff) > -1)
					i_658_ = 0;
				    else if (i_658_ > 255)
					i_658_ = 255;
		...
		if (anIntArrayArray5553 != null) {
		    for (int i_660_ = 0;
			 (i_660_ ^ 0xffffffff) > (i_515_ ^ 0xffffffff);
			 i_660_++) {
			...
			if (anIntArrayArray5553.length > i_661_) {
			    ...
			    for (int i_663_ = 0;
				 ((i_663_ ^ 0xffffffff)
				  > (is_662_.length ^ 0xffffffff));
				 i_663_++) {
				int i_664_ = is_662_[i_663_];
				if (aShortArray5573 == null
				    || (aShortArray5573[i_664_] & i_513_
					^ 0xffffffff) != -1) {
				    int i_665_
				    ...
				    if ((i_667_ ^ 0xffffffff) > -1)
					i_667_ = 0;
				    else if (i_667_ > 7)
					i_667_ = 7;
				    i_668_ += i_512_;
				    if ((i_668_ ^ 0xffffffff) > -1)
					i_668_ = 0;
				    else if (i_668_ > 127)
					i_668_ = 127;
		    ...
		    if (aClass118Array5621 != null) {
			for (int i_669_ = 0;
			     (i_669_ ^ 0xffffffff) > (anInt5536 ^ 0xffffffff);
			     i_669_++) {
		...
		if (anIntArrayArray5627 != null) {
			...
			if (i_671_ < anIntArrayArray5627.length) {
				...
				((Class48) class48).anInt847 += i_511_;
				((Class48) class48).anInt854 += i_510_;
			    }
			}
		    }
		}
		...
		if (anIntArrayArray5627 != null) {
		    for (int i_674_ = 0;
			 (i_515_ ^ 0xffffffff) < (i_674_ ^ 0xffffffff);
			 i_674_++) {
			...
			if (i_675_ < anIntArrayArray5627.length) {
				...
				((Class48) class48).anInt857
				    = (i_511_ * ((Class48) class48).anInt857
				       >> 1471674151);
				((Class48) class48).anInt856
				    = (i_510_ * ((Class48) class48).anInt856
				       >> -1297445913);
			    }
			}
		    }
		...
		if (anIntArrayArray5627 != null) {
		    for (int i_678_ = 0;
			 (i_515_ ^ 0xffffffff) < (i_678_ ^ 0xffffffff);
			 i_678_++) {
			...
			if ((anIntArrayArray5627.length ^ 0xffffffff)
				...
				((Class48) class48).anInt853
				    = 0x3fff & (((Class48) class48).anInt853
						+ i_510_);
			    }
			}
		    }
	...
	for (int i_690_ = 0; i_690_ < anInt5557; i_690_++) {
	    ...
	    if ((i_688_ ^ 0xffffffff) > (i_694_ ^ 0xffffffff))
		i_688_ = i_694_;
	...
	aShort5634 = (short) (int) (0.99 + Math.sqrt((double) i_688_));
	aShort5559 = (short) (int) (0.99 + Math.sqrt((double) i_689_));
	aBoolean5527 = true;
    }
    ...
    Class64_Sub3(DirectxToolkit var_ha_Sub2) {
	aBoolean5527 = false;
	anInt5529 = 0;
	anInt5632 = 0;
	anInt5557 = 0;
    ...
    Class64_Sub3(DirectxToolkit var_ha_Sub2, Model class124, int i, int i_695_,
	...
	do {
		...
		anInt5648 = i;
		aHa_Sub2_5598 = var_ha_Sub2;
		if (AnimatableToolkit.method616(2, i, i_697_))
		    aClass123_5605 = new Class123(null, 5126, 3, 0);
		if (FileIndex.method1163(i_697_, (byte) 78, i))
		    aClass123_5620 = new Class123(null, 5126, 2, 0);
		if (aa_Sub3.method166((byte) 69, i_697_, i))
		    aClass123_5563 = new Class123(null, 5126, 3, 0);
		if (VarbitDefinition.method1193(i_697_, i, true))
		    aClass123_5610 = new Class123(null, 5121, 4, 0);
		if (Class156.method1238(i, i_697_, -31))
		    aClass270_5575 = new Class270();
		d var_d = ((AbstractToolkit) var_ha_Sub2).aD4579;
		anIntArray5528 = new int[((Model) class124).anInt1821 + 1];
		int[] is = new int[((Model) class124).triangles];
		for (int i_698_ = 0;
		     ((((Model) class124).triangles ^ 0xffffffff)
		      < (i_698_ ^ 0xffffffff));
		     i_698_++) {
		    if (((Model) class124).aByteArray1843 == null
			|| ((Model) class124).aByteArray1843[i_698_] != 2) {
			if (((Model) class124).aShortArray1822 != null
			    && (((Model) class124).aShortArray1822[i_698_]
				!= -1)) {
			    TextureDefinition class12
				= var_d.getTexture(((((Model) class124)
						  .aShortArray1822[i_698_])
						 & 0xffff),
						-6662);
			    if (((anInt5556 & 0x40 ^ 0xffffffff) == -1
				 || !((TextureDefinition) class12).aBoolean209)
				&& ((TextureDefinition) class12).aBoolean204)
				continue;
			}
			is[anInt5632++] = i_698_;
			anIntArray5528[(((Model) class124).aShortArray1863
					[i_698_])]++;
			anIntArray5528[(((Model) class124).aShortArray1835
					[i_698_])]++;
			anIntArray5528[(((Model) class124).aShortArray1855
					[i_698_])]++;
		    }
		}
		anInt5537 = anInt5632;
		...
		for (int i_699_ = 0; anInt5632 > i_699_; i_699_++) {
		    ...
		    int i_703_ = 0;
		    int i_704_ = 0;
		    if (((Model) class124).polygons != null) {
			boolean bool_705_ = false;
			for (int i_706_ = 0;
			     (((Model) class124).polygons.length
			      > i_706_);
			     i_706_++) {
			    ModelPolygon class162 = (((Model) class124)
						 .polygons[i_706_]);
			    if (i_700_ == ((ModelPolygon) class162).alpha) {
				Class189 class189
				...
				if (((Class189) class189).aBoolean2531)
				    bool_705_ = true;
				if (((Class189) class189).anInt2525 != -1) {
				    TextureDefinition class12_707_
					= var_d.getTexture((((Class189) class189)
							 .anInt2525),
							-6662);
				    if ((((TextureDefinition) class12_707_).anInt200
					 ^ 0xffffffff)
					== -3)
					aBoolean5595 = true;
				}
		    ...
		    int i_708_ = -1;
		    if (((Model) class124).aShortArray1822 != null) {
			i_708_ = ((Model) class124).aShortArray1822[i_700_];
			if (i_708_ != -1) {
			    class12 = var_d.getTexture(i_708_ & 0xffff, -6662);
			    if ((anInt5556 & 0x40 ^ 0xffffffff) != -1
				&& ((TextureDefinition) class12).aBoolean209) {
				i_708_ = -1;
				class12 = null;
			    } else {
				i_704_ = ((TextureDefinition) class12).aByte202;
				if ((((TextureDefinition) class12).aByte198
				     ^ 0xffffffff) != -1
				    || ((TextureDefinition) class12).aByte211 != 0)
				    aBoolean5638 = true;
				i_703_ = ((TextureDefinition) class12).aByte213;
			    }
			}
		    }
		    boolean bool_709_
			= ((((Model) class124).polyAlphas != null
			    && (((Model) class124).polyAlphas[i_700_]
				!= 0))
			   || (class12 != null
			       && ((TextureDefinition) class12).anInt200 != 0));
		    if ((bool || bool_709_)
			&& ((Model) class124).aByteArray1839 != null)
			i_701_ += (((Model) class124).aByteArray1839[i_700_]
				   << 1029512945);
		    if (bool_709_)
			i_701_ += 65536;
		...
		anIntArray5644 = ((Model) class124).vertexZ;
		anIntArray5593 = ((Model) class124).vertexY;
		anInt5642 = ((Model) class124).vertices;
		anIntArray5543 = ((Model) class124).vertexX;
		aShortArray5608 = ((Model) class124).aShortArray1842;
		anInt5557 = ((Model) class124).anInt1821;
		aClass342Array5541 = ((Model) class124).aClass342Array1866;
		Class8[] class8s = new Class8[anInt5557];
		aClass129Array5640 = ((Model) class124).aClass129Array1846;
		if (((Model) class124).polygons != null) {
		    anInt5536
			= ((Model) class124).polygons.length;
		    ...
		    for (int i_711_ = 0;
			 (i_711_ ^ 0xffffffff) > (anInt5536 ^ 0xffffffff);
			 i_711_++) {
			ModelPolygon class162
			    = ((Model) class124).polygons[i_711_];
			Class189 class189
			    = FileArchiveTracker.method742(104, (((ModelPolygon) class162)
						      .x));
			int i_712_ = -1;
			for (int i_713_ = 0;
			     (anInt5632 ^ 0xffffffff) < (i_713_ ^ 0xffffffff);
			     i_713_++) {
			    if ((is[i_713_] ^ 0xffffffff)
			...
			int i_714_
			    = ((Class10.anIntArray179
				[0xffff & (((Model) class124)
					   .triangleColors
					   [((ModelPolygon) class162).alpha])])
			       & 0xffffff);
			i_714_ = i_714_ | (255 + -((((Model) class124)
						    .polyAlphas) == null
						   ? (int) 0
						   : (((Model) class124)
						      .polyAlphas
		...
		if (((Model) class124).aShortArray1856 != null)
		...
		int i_716_ = 0;
		for (int i_717_ = 0; i_717_ < ((Model) class124).anInt1821;
		     i_717_++) {
		...
		anIntArray5528[((Model) class124).anInt1821] = i_716_;
		Class358 class358 = Class59_Sub2_Sub1.method565(255, anInt5632,
								class124, is);
		Class347[] class347s
		    = new Class347[((Model) class124).triangles];
		for (int i_719_ = 0; ((Model) class124).triangles > i_719_;
		     i_719_++) {
		    short i_720_
			= ((Model) class124).aShortArray1863[i_719_];
		    short i_721_
			= ((Model) class124).aShortArray1835[i_719_];
		    short i_722_
			= ((Model) class124).aShortArray1855[i_719_];
		    int i_723_
		    ...
		    for (i_731_ = -(i_724_ * i_726_) + i_727_ * i_723_;
			 ((i_729_ ^ 0xffffffff) < -8193
			  || (i_730_ ^ 0xffffffff) < -8193 || i_731_ > 8192
		    ...
		    int i_732_ = (int) Math.sqrt((double) (i_731_ * i_731_
							   + i_730_ * i_730_
							   + i_729_ * i_729_));
		    if ((i_732_ ^ 0xffffffff) >= -1)
			i_732_ = 1;
		    i_731_ = i_731_ * 256 / i_732_;
		    i_729_ = i_729_ * 256 / i_732_;
		    i_730_ = 256 * i_730_ / i_732_;
		    byte i_733_
			= (((Model) class124).aByteArray1843 == null
			   ? (byte) 0
			   : ((Model) class124).aByteArray1843[i_719_]);
		    if (i_733_ == 0) {
			Class8 class8 = class8s[i_720_];
			((Class8) class8).anInt162 += i_730_;
			((Class8) class8).anInt159 += i_731_;
			((Class8) class8).anInt160++;
			((Class8) class8).anInt161 += i_729_;
			...
			((Class347) class347).anInt4283 = i_731_;
			((Class347) class347).anInt4279 = i_730_;
			((Class347) class347).anInt4282 = i_729_;
		    }
		}
		for (int i_734_ = 0; anInt5632 > i_734_; i_734_++) {
		    int i_735_ = is[i_734_];
		    int i_736_ = (((Model) class124).triangleColors[i_735_]
				  & 0xffff);
		    int i_737_;
		    if (((Model) class124).aByteArray1820 != null)
			i_737_ = ((Model) class124).aByteArray1820[i_735_];
		    else
			i_737_ = -1;
		    int i_738_;
		    if (((Model) class124).polyAlphas != null)
			i_738_ = 0xff & (((Model) class124).polyAlphas
					 [i_735_]);
		    else
			i_738_ = 0;
		    short i_739_
			= (((Model) class124).aShortArray1822 == null
			   ? (short) -1
			   : ((Model) class124).aShortArray1822[i_735_]);
		    if ((i_739_ ^ 0xffffffff) != 0
			&& (0x40 & anInt5556 ^ 0xffffffff) != -1) {
			TextureDefinition class12
			    = var_d.getTexture(i_739_ & 0xffff, -6662);
			...
			if ((i_737_ ^ 0xffffffff) == 0) {
			    ...
			    i_737_ &= 0xff;
			    byte i_748_
				= ((Model) class124).aByteArray1823[i_737_];
			    if ((i_748_ ^ 0xffffffff) == -1) {
				short i_749_ = (((Model) class124)
						.aShortArray1863[i_735_]);
				short i_750_ = (((Model) class124)
						.aShortArray1835[i_735_]);
				short i_751_ = (((Model) class124)
						.aShortArray1855[i_735_]);
				short i_752_ = (((Model) class124)
						.aShortArray1829[i_737_]);
				short i_753_ = (((Model) class124)
						.aShortArray1849[i_737_]);
				short i_754_ = (((Model) class124)
						.aShortArray1825[i_737_]);
				float f_755_
				    = (float) (((Model) class124)
					       .vertexX[i_752_]);
				float f_756_
				    = (float) (((Model) class124)
					       .vertexY[i_752_]);
				...
				short i_780_ = (((Model) class124)
						.aShortArray1863[i_735_]);
				short i_781_ = (((Model) class124)
						.aShortArray1835[i_735_]);
				short i_782_ = (((Model) class124)
						.aShortArray1855[i_735_]);
				int i_783_ = (((Class358) class358)
					      .anIntArray4416[i_737_]);
				int i_784_ = (((Class358) class358)
					      .anIntArray4415[i_737_]);
				int i_785_ = (((Class358) class358)
					      .anIntArray4414[i_737_]);
				float[] fs = (((Class358) class358)
					      .aFloatArrayArray4412[i_737_]);
				byte i_786_ = (((Model) class124)
				...
				float f_787_
				    = ((float) (((Model) class124)
				       ...
				       / 256.0F);
				if (i_748_ != 1) {
				    if ((i_748_ ^ 0xffffffff) != -3) {
					if ((i_748_ ^ 0xffffffff) == -4) {
					    Class181.method1367
		    ...
		    byte i_807_;
		    if (((Model) class124).aByteArray1843 != null)
			i_807_ = ((Model) class124).aByteArray1843[i_735_];
		    else
			i_807_ = (byte) 0;
		    if (i_807_ != 0) {
			if ((i_807_ ^ 0xffffffff) == -2) {
				...
				= ((((long) (i_736_ << -1343350136)
				     ...
				     + (long) i_738_)
				    << -940119520)
				   + (long) (((((Class347) class347).anInt4282
					       > 0)
					      ? 1024 : 2048)
					     + (i_737_ << -976265246)
					     + ((((Class347) class347)
						 .anInt4279) + 256
						<< 1923798252)
					     - -(256 + (((Class347) class347)
							.anInt4283)
						 << -604250250)));
			    aShortArray5592[i_734_]
				= method683(((Class347) class347).anInt4279,
					    ((Class347) class347).anInt4283, l,
					    ((Class347) class347).anInt4282,
					    class124, 0, f, 0,
					    (((Model) class124)
					     .aShortArray1863[i_735_]),
					    f_740_);
			...
			short i_808_
			    = ((Model) class124).aShortArray1863[i_735_];
			short i_809_
			    = ((Model) class124).aShortArray1835[i_735_];
			short i_810_
			    = ((Model) class124).aShortArray1855[i_735_];
			Class8 class8 = class8s[i_808_];
			aShortArray5592[i_734_]
			    = method683(((Class8) class8).anInt162,
					((Class8) class8).anInt159, l,
					((Class8) class8).anInt161, class124,
					((Class8) class8).anInt160, f, 0,
					i_808_, f_740_);
			class8 = class8s[i_809_];
			aShortArray5579[i_734_]
			    = method683(((Class8) class8).anInt162,
					((Class8) class8).anInt159,
					(long) i_745_ + l,
					((Class8) class8).anInt161, class124,
					((Class8) class8).anInt160, f_741_, 0,
					i_809_, f_742_);
			...
			aShortArray5566[i_734_]
			    = method683(((Class8) class8).anInt162,
					...
					l + (long) i_746_,
					((Class8) class8).anInt161, class124,
					((Class8) class8).anInt160, f_743_, 0,
					i_810_, f_744_);
		    }
		    if (((Model) class124).polyAlphas != null)
			aByteArray5542[i_734_]
			    = ((Model) class124).polyAlphas[i_735_];
		    if (((Model) class124).aShortArray1856 != null)
			aShortArray5573[i_734_]
			    = ((Model) class124).aShortArray1856[i_735_];
		    aShortArray5580[i_734_]
			= ((Model) class124).triangleColors[i_735_];
		...
		for (int i_815_ = 0; anInt5537 > i_815_; i_815_++) {
		    ...
		    if ((i_812_ ^ 0xffffffff) != (i_816_ ^ 0xffffffff)) {
		...
		if (((Model) class124).vgroups != null && Class312.method2332(anInt5556, (byte) 125, i))
		    vertexGroups = class124.getVertexGroups(false, -42);
		if (((Model) class124).polygons != null
		    && Class229.method1633(false, i, anInt5556))
		    anIntArrayArray5627 = class124.getTriangleGroups();
		if (((Model) class124).anIntArray1824 == null
		    || !Class40.method371(i, 256, anInt5556))
		    break;
		int i_817_ = 0;
		int[] is_818_ = new int[256];
		for (int i_819_ = 0;
		     (i_819_ ^ 0xffffffff) > (anInt5632 ^ 0xffffffff);
		     i_819_++) {
		    int i_820_
			= ((Model) class124).anIntArray1824[is[i_819_]];
		    if ((i_820_ ^ 0xffffffff) <= -1) {
			if ((i_820_ ^ 0xffffffff) < (i_817_ ^ 0xffffffff))
			    i_817_ = i_820_;
			is_818_[i_820_]++;
		    }
		}
		...
		for (int i_822_ = 0; i_822_ < anInt5632; i_822_++) {
		    int i_823_
			= ((Model) class124).anIntArray1824[is[i_822_]];
		    if (i_823_ >= 0)
