...
final class Class239_Sub21 extends Class239
{
    ...
    static IncomingPacket aClass114_6058;
	...
	if (i < 85)
	    method1813(11, 68);
	if (((Class239) this).aClass348_Sub51_3136.method3425(-104))
	    return false;
	return true;
    }
	...
	if (i_5_ != 8 && (i_5_ ^ 0xffffffff) != -17) {
	    Class357 class357
		= Message.aClass357ArrayArrayArray2029[i_4_][i][i_2_];
	    if (class357 == null)
		class357 = new Class357(i_4_);
	    if ((i_5_ ^ 0xffffffff) != -2) {
		if ((i_5_ ^ 0xffffffff) == -3) {
		    ((Class357) class357).aShort4398 = (short) i_1_;
		    ((Class357) class357).aShort4397 = (short) i_0_;
		}
	    } else {
		((Class357) class357).aShort4401 = (short) i_0_;
		((Class357) class357).aShort4409 = (short) i_1_;
	    }
		...
		= Class348_Sub1_Sub1.aSArray8801[i_4_].method3982((byte) -86,
								  1 + i_2_, i);
	    ClassicLoadingScreen.aClass338Array5060[Class348_Sub44.anInt7101++]
    ...
    static final int method1811(int i, String string, int i_18_,
				String string_19_) {
	try {
	    anInt6060++;
	...
	while_81_:
		...
		for (;;) {
			...
			c_25_ = string_19_.charAt(i_22_++);
		    if (c_24_ != 0) {
			c_26_ = c_24_;
			boolean bool = false;
		    } else
			c_26_ = string.charAt(i_23_++);
		    c = OpenGlRaster.method990(c_25_, (byte) -39);
		    c_24_ = OpenGlRaster.method990(c_26_, (byte) -127);
		...
		return (Class113.method1056(i_18_, 30316, c_25_)
			+ -Class113.method1056(i_18_, i ^ 0x55ac, c_26_));
	    } while (false);
		...
		if ((c_30_ ^ 0xffffffff) != (c_29_ ^ 0xffffffff)
		    ...
		    if (c_30_ != c_29_)
			return (Class113.method1056(i_18_, 30316, c_29_)
				+ -Class113.method1056(i_18_, 30316, c_30_));
		}
	    }
	    if (i != 9152)
		...
		if (c_34_ != c_33_)
		    return (Class113.method1056(i_18_, 30316, c_33_)
			    - Class113.method1056(i_18_, 30316, c_34_));
	    }
	    return 0;
	...
	if (i != 3)
	    return 91;
	anInt6064++;
	if (((Class239) this).aClass348_Sub51_3136.method3425(i ^ ~0x4b))
	    return 3;
	return 1;
    }
	...
	if (((Class239) this).aClass348_Sub51_3136.method3425(-112))
	...
	if (i_38_ == 3 || i_38_ == 4 || (i_38_ ^ 0xffffffff) == -10
	    ...
	    return true;
	if (i_38_ == 2 || (i_38_ ^ 0xffffffff) == -1002)
	    return true;
	return false;
    }
	...
	aClass114_6058 = new IncomingPacket(46, -1);
    }
}
