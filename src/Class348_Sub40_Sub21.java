...
final class Class348_Sub40_Sub21 extends Class348_Sub40
{
	...
	if (((Class191) ((Class348_Sub40) this).aClass191_7032).aBoolean2570) {
		...
		i_4_ = (i_4_ ^ 0xffffffff) > 2047 ? 4096 + i_4_ : i_4_;
		...
		is[i_2_] = (method3108(i_5_, 9619, i_4_)
			    || method3105(i_7_, -7981, i_6_)) ? 4096 : 0;
	    }
	}
	return is;
    }
	...
	int i_11_
	    = Class127.anIntArray4654[(i_10_ * 255 & 0xfff2f) >> -1918018836];
	if (i_8_ != -7981)
	    anInt9266 = -52;
	...
	if (i_11_ <= i + -i_9_
	    || (-i_11_ ^ 0xffffffff) <= (-i_9_ + i ^ 0xffffffff))
	    return false;
	return true;
    }
    ...
    final void method3049(ByteBuffer class348_sub49, int i, int i_13_) {
	anInt9268++;
	if (i_13_ != 31015)
	    method3042(72, 12);
	int i_14_ = i;
	...
	while_182_:
		...
		while_180_:
			...
			do {
			    ...
			    anInt9266 = class348_sub49.getShort();
			    return;
			} while (false);
			anInt9281 = class348_sub49.getShort();
			return;
		    } while (false);
		    anInt9279 = class348_sub49.getShort();
		    return;
		} while (false);
		anInt9276 = class348_sub49.getShort();
		return;
	    } while (false);
	    anInt9277 = class348_sub49.getShort();
	} while (false);
    }
    
    static final long method3107(byte i, Interface10 interface10, int i_15_,
				 int i_16_) {
	anInt9270++;
	long l = 4194304L;
	long l_17_ = -9223372036854775808L;
	ObjectDefinition class51 = Class348_Sub40_Sub12.objectLoader
			      .getObject(0, interface10.method42(-107));
	long l_18_ = (long) (interface10.method39(-14) << -810638610
			     | (i_16_ | i_15_ << 409106119)
			     | interface10.method41(-32228) << -1876485644
			     | 0x40000000);
	if (((ObjectDefinition) class51).anInt874 == 0)
	    l_18_ |= l_17_;
	if ((((ObjectDefinition) class51).anInt895 ^ 0xffffffff) == -2)
	    l_18_ |= l;
	...
	int i_23_
	    = Class127.anIntArray4654[(0xff530 & 255 * i_22_) >> -1766956564];
	i_23_ = (i_23_ << 1313955820) / anInt9279;
	i_23_ = (i_23_ << -1206741460) / anInt9277;
	i_23_ = anInt9276 * i_23_ >> -30765876;
	if ((i_21_ - -i ^ 0xffffffff) <= (i_23_ ^ 0xffffffff)
	    || (i + i_21_ ^ 0xffffffff) >= (-i_23_ ^ 0xffffffff))
	    return false;
	return true;
    }
	...
	for (int i = 0; (i ^ 0xffffffff) > -257; i++) {
		...
		if ((0x1L & l) == 1L)
		    l = ~0x3693a86a2878f0bdL ^ l >>> 2032730177;
		else
		    l >>>= 1;
	    }
	    aLongArray9283[i] = l;
