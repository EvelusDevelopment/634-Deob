...
final class Whirlpool
{
			 ...
			 ((OpenGlRaster.method993
			   (Class348_Sub8.method2777(255L << -561803296,
						     ((long) (aByteArray1475
						      ...
						      << 1709594400)),
			    (OpenGlRaster.method993
			     (OpenGlRaster.method993((Class348_Sub8.method2777
						       (255L << -1772986896,
							((long) (aByteArray1475
								 [1 + i_1_])
							 << -295236176))),
	...
	for (int i_2_ = 0; i_2_ < 8; i_2_++)
	    aLongArray1469[i_2_]
		= OpenGlRaster.method993(aLongArray1473[i_2_],
					  (aLongArray1472[i_2_]
					   = aLongArray1474[i_2_]));
	for (int i_3_ = 1; (i_3_ ^ 0xffffffff) >= -11; i_3_++) {
	    ...
	    aLongArray1472[0]
		= OpenGlRaster.method993(aLongArray1472[0],
					  DummyInputstream2.aLongArray76[i_3_]);
	...
	for (int i_12_ = 0; i_12_ < 8; i_12_++)
		...
		= (OpenGlRaster.method993
		   (aLongArray1474[i_12_],
		    OpenGlRaster.method993(aLongArray1473[i_12_],
	...
	if (Class21.aHa326 != null) {
		...
		AnimationDefinition.anInterface4_252
	...
	int i_24_ = Class348_Sub42_Sub12.method3229();
	if (i_22_ == 102) {
	    if ((i ^ 0xffffffff) == -4 || (i_24_ ^ 0xffffffff) == -4)
		bool = true;
	    if (!Class348_Sub8.currentToolkit.method3695())
		bool = true;
