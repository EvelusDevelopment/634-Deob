...
final class Class186_Sub1 extends Class186
{
    ...
    static GametipLoader gametipLoader;
	...
	for (int i_19_ = 0; (i_19_ ^ 0xffffffff) > (i_0_ ^ 0xffffffff);
		...
		fs[i_2_++]
		    = f_3_ * (AbtractArchiveLoader.method2337
    ...
    static final Class258_Sub3_Sub1 method1401(DirectxToolkit var_ha_Sub2, int i,
	...
	if (i == 1) {
	    Class318_Sub1_Sub2.aClass60_8732.removeAll(0);
	    anInt5811++;
	}
    }
