...
final class Class348_Sub42_Sub20 extends SubNode
{
    ...
    int anInt9710;
    static Deque aClass262_9711 = new Deque();
    int anInt9712;
    ...
    static final void method3281(byte i, AbstractToolkit var_ha) {
	...
	if (((Signlink) Class348_Sub23_Sub1.signlink).allowsFileOperations
	    && ((((ConnectionMode) aa_Sub2.aClass161_5199).portOffset ^ 0xffffffff)
		!= 0))
	    Class348_Sub23_Sub1.method2972((((ConnectionMode) aa_Sub2.aClass161_5199)
					    .address),
