...
final class Class367_Sub1 extends Class367
{
	...
	if (bool == false) {
		...
		if (class46 != null && i == ((Widget) class46).anInt834) {
		    ...
		    if ((((Widget) class46).anInt747 ^ 0xffffffff)
			< ((-((Widget) class46).anInt709
			    + ((Widget) class46).anInt698)
			   ^ 0xffffffff))
			((Widget) class46).anInt747
			    = (((Widget) class46).anInt698
			       - ((Widget) class46).anInt709);
		    if (((Widget) class46).anInt747 < 0)
			((Widget) class46).anInt747 = 0;
		    if ((((Widget) class46).anInt755 ^ 0xffffffff)
			< ((((Widget) class46).anInt791
			    - ((Widget) class46).anInt789)
			   ^ 0xffffffff))
			((Widget) class46).anInt755
			    = (((Widget) class46).anInt791
			       - ((Widget) class46).anInt789);
		    if (((Widget) class46).anInt755 < 0)
			((Widget) class46).anInt755 = 0;
	...
	anInt7282++;
	Class15.aClass60_225.removeAll(i_11_);
    }
    ...
    Class367_Sub1(NativeToolkit var_ha_Sub3) {
	super(var_ha_Sub3);
    }
}
