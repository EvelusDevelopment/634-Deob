...
abstract class Class285 implements Interface5
{
	...
	if ((anInt4736 ^ 0xffffffff) == -1) {
		...
		if (anInt4747 <= (((NativeToolkit) ((Class285) this).aClass377_4759)
				  .aNativeHeapBuffer7974.b)) {
		    anInt4736 = 1;
		    return (((NativeToolkit) ((Class285) this).aClass377_4759)
	...
	if (i_3_ > anInt4739) {
	    ...
	    ((NativeToolkit) ((Class285) this).aClass377_4759).anInt8063
		+= i_3_ - anInt4747;
	    anInt4739 = i_3_;
	} else if (anInt4746 > 0) {
	    OpenGL.glBindBufferARB(anInt4755, anInt4746);
	...
	anInt4742++;
	if (i == 0) {
	    if (((OpenGlToolkit) ((Class285) this).aClass377_4759).aBoolean9920)
		OpenGL.glBindBufferARB(anInt4755, anInt4746);
	}
    }
    ...
    Class285(OpenGlToolkit class377, int i, boolean bool) {
