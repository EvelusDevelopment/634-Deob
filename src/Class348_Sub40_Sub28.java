...
final class Class348_Sub40_Sub28 extends Class348_Sub40
{
    ...
    static IndexLoader aClass45_9365;
    ...
    static final LocationMode[] method3122(byte i) {
	if (i < 86)
	    aClass45_9365 = null;
	anInt9361++;
	...
	while_203_:
		...
		do {
			...
			if ((i_1_ ^ 0xffffffff) != -1) {
			    ...
			    anInt9367 = class348_sub49.getUByte();
			    return;
			}
			anInt9362 = class348_sub49.getShort();
			return;
		    } while (false);
		    anInt9368 = class348_sub49.getUByte();
		    return;
		} while (false);
		anInt9369 = class348_sub49.getShort();
		return;
	    } while (false);
	    anInt9364 = class348_sub49.getShort();
	} while (false);
    }
	...
	if (((Class191) ((Class348_Sub40) this).aClass191_7032).aBoolean2570) {
		...
		int i_6_
		    = ((anInt9364 ^ 0xffffffff) < -1
		       ? anInt9369 + Model.method1097((byte) 92, anInt9364,
							 random) + -i_3_
		       : anInt9369);
		i_6_ = i_6_ >> -807902044 & 0xff;
		int i_7_ = Model.method1097((byte) 81,
					       Class348_Sub40_Sub6.anInt9139,
					       random);
		int i_8_
		    = Model.method1097((byte) 123, Class286_Sub2.anInt6212,
					  random);
		...
		if (i_12_ != 0 || (i_11_ ^ 0xffffffff) != -1) {
		    ...
		    int i_22_
			= 1024 - (Model.method1097((byte) 90, 4096, random)
				  >> -1276678686);
		    if (i_19_ < 0)
			i_19_ = -i_19_;
		    int i_23_
