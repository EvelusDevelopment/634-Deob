...
{
    static ByteBuffer lobbylistBuffer;
    ...
    static OutgoingPacket aClass351_8706 = new OutgoingPacket(79, 3);
    private DirectxToolkit aHa_Sub2_8707;
	...
	try {
	    anInt8703++;
	    boolean bool = true;
	    Class206 class206 = ((DirectxToolkit) aHa_Sub2_8707).aClass206_7778;
	    aHa_Sub2_8707.getDimensions(Class348_Sub6.anIntArray6635);
	    aHa_Sub2_8707.la();
	    ...
	    OpenGL.glPopAttrib();
	    aHa_Sub2_8707.setDimensions(Class348_Sub6.anIntArray6635[0],
			     Class348_Sub6.anIntArray6635[1],
			     Class348_Sub6.anIntArray6635[2],
			     Class348_Sub6.anIntArray6635[3]);
	    if (bool && !((DirectxToolkit) aHa_Sub2_8707).aBoolean7847)
    ...
    static final RasterToolkit method2263(AbstractToolkit var_ha, int i, int i_4_) {
	anInt8705++;
	Class348_Sub15 class348_sub15
	    = ((Class348_Sub15)
	       Class27.aClass356_389.get((long) i_4_));
    ...
    Class299_Sub1_Sub2(DirectxToolkit var_ha_Sub2, int i) {
