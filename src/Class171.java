...
final class Class171
{
    ...
    private DirectxToolkit aHa_Sub2_2268;
	...
	if (bool != true)
	    return 63;
	int i_1_ = -1;
	for (int i_2_ = i_0_; (i ^ 0xffffffff) < (i_2_ ^ 0xffffffff); i_2_++)
	    i_1_ = (i_1_ >>> -677827672
		    ^ Class89.anIntArray1508[(i_1_ ^ is[i_2_]) & 0xff]);
	i_1_ ^= 0xffffffff;
	return i_1_;
    }
	...
	for (int i = 0; i < Class331.anInt4135; i++) {
		...
		int i_7_ = (class348_sub1.method2724(-1) - i_4_
			    >> Class362.anInt4459);
		int i_8_ = (class348_sub1.method2717((byte) 79) - i_4_
			    >> Class362.anInt4459);
		int i_9_ = (class348_sub1.method2717((byte) 113) + i_4_
			    >> Class362.anInt4459);
		if (i_8_ < 0) {
		    i_6_ -= i_8_;
		    i_8_ = 0;
		...
		for (int i_10_ = i_8_; i_10_ <= i_9_; i_10_++) {
		    ...
		    if (i_15_ >= Class318_Sub7.anInt6451)
    ...
    static final int method1321(byte i, int i_32_, int i_33_, int i_34_,
				int i_35_, int i_36_) {
	int i_37_ = 4 / ((-51 - i) / 63);
	anInt2273++;
    ...
    Class171(DirectxToolkit var_ha_Sub2, int i, int i_45_) {
	aHa_Sub2_2268 = var_ha_Sub2;
	((Class171) this).anInt2270 = i_45_;
    }
    
    /*synthetic*/ static Class method1324(String string) {
	try {
