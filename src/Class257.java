...
final class Class257
{
    ...
    private static Deque aClass262_3297;
    ...
    static final synchronized void method1947(int i, ModelToolkit interface19) {
	if (!aBoolean3296) {
	    if (i >= anInt3298)
		interface19.w(false);
	    else {
		...
		((Class348_Sub28) class348_sub28).anInterface19_6908
		    = interface19;
		aClass262_3297.addToFront(class348_sub28, -20180);
	    }
	}
    }
