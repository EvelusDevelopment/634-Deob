...
final class Class348_Sub40_Sub14 extends Class348_Sub40
{
	...
	if (i == 0) {
	    anInt9211 = class348_sub49.getUByte();
	    anIntArrayArray9210 = new int[class348_sub49.getUByte()][2];
	...
	do {
		...
		if ((i_2_ ^ 0xffffffff) != -3) {
			...
			for (i_4_ = 1; -1 + anIntArrayArray9210.length > i_4_;
			     i_4_++) {
			    if (anIntArrayArray9210[i_4_][0] > i_3_)
				break;
			}
			...
			int i_14_ = i_8_ + -i_6_;
			int i_15_ = i_7_;
			int i_16_ = ((i_10_ * i_12_ >> 903807436) * i_11_
				     >> 1658079276);
		...
		for (i_2_ = 0; (i_2_ ^ 0xffffffff) > -258; i_2_++) {
		    ...
		    int i_23_ = ((-is[0] + i_20_ << -1964753972)
				 / (is_22_[0] - is[0]));
		    int i_24_ = (-(Class127.anIntArray4654
				   [(i_23_ & 0x1ff6) >> 1736923941]) + 4096
				 >> -136464031);
	...
	if (((Class191) ((Class348_Sub40) this).aClass191_7032).aBoolean2570) {
	    ...
	    for (int i_35_ = 0; i_35_ < Class348_Sub40_Sub6.anInt9139;
		 i_35_++) {
	...
	anIntArray9208 = new int[] { is_38_[0] - (is_39_[0] + -is_38_[0]),
				     is_38_[1] - (-is_38_[1] + is_39_[1]) };
	if (i != 73)
	    method3042(75, 39);
	anIntArray9214 = new int[] { is[0] + -is_37_[0] + is[0],
				     is[1] - (-is[1] - -is_37_[1]) };
    }
    
    final void method3044(int i) {
	if (anIntArrayArray9210 == null)
	    anIntArrayArray9210 = new int[][] { new int[2], { 4096, 4096 } };
	if (i <= 108)
	    anIntArrayArray9210 = null;
	anInt9209++;
	if (anIntArrayArray9210.length < 2)
