/* GametipLoader - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */
import java.util.Random;

final class GametipLoader
{
    private int anInt1715;
    static int anInt1716;
    static int anInt1717;
    private IndexLoader aClass45_1718;
    static int anInt1719;
    static int anInt1720 = -1;
    static int anInt1721;
    static IncomingPacket incomingPacket8 = new IncomingPacket(8, -2);
	...
	anInt1721++;
	byte[] is = aClass45_1718.loadArchiveChild(-1860, 1, i);
	if (i_0_ < 12)
	    return null;
	GametipDefinition definition = new GametipDefinition();
	definition.initialize(new ByteBuffer(is), 21890);
	return definition;
    }
	...
	int i_16_;
	if (class46_14_ != null) {
	    i_15_ = ((Widget) class46_14_).anInt789;
	    i_16_ = ((Widget) class46_14_).anInt709;
	} else {
	    i_15_ = Class348_Sub42_Sub8_Sub2.windowHeight;
	    i_16_ = Class321.windowWidth;
	}
	...
	try {
	    ...
	    ByteBuffer class348_sub49 = new ByteBuffer(aClass45_1718.loadArchiveChild(-1860, 0, 0));
		...
		if (!bool) {
			...
			int i_25_ = class348_sub49.getShort();
			if ((anInt1715 ^ 0xffffffff) == 0) {
