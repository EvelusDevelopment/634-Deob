...
{
    static IncomingPacket aClass114_3751;
	...
	(Player class318_sub1_sub3_sub3_sub2, int i) {
	anInt3752++;
	if (i != -28482)
	...
	anInt3755++;
	FileArchiveTracker.aLong4783 = 1000000000L / (long) i;
	if (i_3_ != -124)
	    method2223(-83);
    }
    ...
    static {
	aClass114_3751 = new IncomingPacket(1, 2);
	anInt3760 = -1;
	anInt3764 = 0;
    }
}
