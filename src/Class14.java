...
abstract class Class14 implements Interface18
{
	...
	int i_1_ = (((OpenGlToolkit) ((Class14) this).aClass377_5082).anIntArray9927
		    [i_0_]);
	if ((i_1_ ^ 0xffffffff) != (((Class14) this).anInt5093 ^ 0xffffffff)) {
	    ...
	    ((OpenGlToolkit) ((Class14) this).aClass377_5082).anIntArray9927[i_0_]
	...
	if (Class68.aClass68_1183 != ((Class14) this).aClass68_5088) {
		...
		if (MouseEventNode.aClass304_7103
		    != ((Class14) this).aClass304_5084) {
		    if (((Class14) this).aClass304_5084
	...
	if (bool != true)
	    createFontRasterizer(null, (byte) 106, true, 70);
    }
	...
	if (i >= -105)
	    createFontRasterizer(null, (byte) 118, true, 16);
	if (aBoolean5099)
	    return 4 * i_21_ / 3;
	return i_21_;
    }
    
    static final AbstractFontRasterizer createFontRasterizer(AbstractToolkit var_ha, byte i, boolean bool, int i_22_) {
	if (i != -53)
	    method237(true);
	anInt5094++;
	GameFont class352 = Class239_Sub3.createGameFont(i_22_, var_ha, (byte) 55, bool);
	if (class352 == null)
	    return null;
	return ((GameFont) class352).fontRasterizer;
    }
	...
	if ((i ^ 0xffffffff) != 0 && Class163.aBooleanArray2162[i]) {
	    Class229.aClass45_2978.removeChildren(i);
	...
	anInt5098++;
	((NativeToolkit) ((Class14) this).aClass377_5082).anInt8062 -= i;
	((NativeToolkit) ((Class14) this).aClass377_5082).anInt8062
	    += method231(-119);
	if (i_47_ >= -124)
	    aBoolean5099 = false;
    }
    ...
    Class14(OpenGlToolkit class377, int i, Class304 class304, Class68 class68,
