...
final class aa_Sub2 extends aa
{
    ...
    static ConnectionMode aClass161_5199;
	...
	return ObjectDefinition.loadingHandler.method2325((byte) -98);
    }
	...
	if ((-FileOnDisk.anInt3049 ^ 0xffffffff) == (i_3_ ^ 0xffffffff))
	    return false;
	if (FileOnDisk.anInt3049 == i_3_)
	    return true;
	...
	Class354.anIntArrayArrayArray4356[i][i_0_][i_2_] = -FileOnDisk.anInt3049;
	return false;
    }
	...
	if (i_9_ < 512 || i_11_ < 512
		...
		Class348_Sub8.currentToolkit.da(i_9_, i_15_, i_11_,
					 Class239_Sub21.anIntArray6062);
	    else
		Class348_Sub8.currentToolkit.HA(i_9_, i_15_, i_11_,
					 Class132.anInt1906,
					 Class239_Sub21.anIntArray6062);
	    if (Class59_Sub1.aBoolean5300)
    ...
    aa_Sub2(NativeToolkit var_ha_Sub3, int i, int i_16_, byte[] is) {
	try {
    ...
    aa_Sub2(NativeToolkit var_ha_Sub3, int i, int i_17_, int[] is) {
	try {
	    ((aa_Sub2) this).anInterface18_Impl3_5196
