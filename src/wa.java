...
final class wa implements AbstractRasterizer
{
    j aJ4732;
    xa aXa4733;
    private long aLong4734 = 0L;
    
    public final void drawi(int i, int i_0_, int i_1_, int i_2_, int i_3_,
    ...
    public final void drawf(int i, int i_22_, int i_23_, int i_24_,
    ...
    wa(SafeToolkit var_oa, j var_j, xa var_xa) {
	aLong4734 = ((SafeToolkit) var_oa).nativeid;
