...
final class Class339 implements Runnable
{
    ...
    private SignlinkRequest aClass144_4201;
    ...
    static OutgoingPacket aClass351_4207 = new OutgoingPacket(29, 3);
    ...
    static final void method2666(int i, int i_13_, Widget class46,
				 byte i_14_) {
	anInt4199++;
	if (class46 != null) {
	    if (((Widget) class46).anObjectArray714 != null) {
		InterfaceScript class348_sub36 = new InterfaceScript();
		((InterfaceScript) class348_sub36).parameters
		    = ((Widget) class46).anObjectArray714;
		((InterfaceScript) class348_sub36).parent = class46;
		ScriptExecutor.executeScript(class348_sub36);
	    }
	    Class362.anInt4458 = ((Widget) class46).anInt695;
	    Class246.anInt3176 = i;
	    Class38.anInt500 = i_13_;
	    Class301.anInt3829 = ((Widget) class46).itemId;
	    r.aBoolean9722 = true;
	    Class9.anInt169 = ((Widget) class46).anInt704;
	    FloatBuffer.anInt9747 = ((Widget) class46).anInt824;
	    if (i_14_ != 21)
		method2665(-99, (byte) -106, 10, -37, 26, -123);
	    Class149.anInt2046 = ((Widget) class46).anInt830;
	...
	if (aClass144_4201 == null) {
	    try {
		int i_15_
		    = (Class8.modeWhere == Class55_Sub1.aClass364_5271 ? 80
		       : 7000 - -(((ConnectionMode) Class135_Sub2.worldConnectionNode)
				  .portOffset));
		aClass144_4201
		    = (Class348_Sub23_Sub1.signlink.method2237
		       (new URL("http://"
				+ (((ConnectionMode) Class135_Sub2.worldConnectionNode)
				   .address)
				+ ":" + i_15_ + "/news.ws?game="
	...
	if (aClass144_4201 == null || aClass144_4201.state == 2)
	    return true;
	if (i != -21913)
	    return false;
	if ((aClass144_4201.state ^ 0xffffffff) != -2)
	    return false;
	if (aThread4206 == null) {
