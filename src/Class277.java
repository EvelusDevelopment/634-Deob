...
final class Class277
{
    ...
    static FileIndex tableFileIndex;
    int anInt3569;
    int anInt3570;
    ...
    private final void method2069(int i, ByteBuffer class348_sub49,
				  int i_1_) {
	anInt3567++;
	if (i == -1) {
	    if (i_1_ != 1) {
		...
		((Class277) this).anInt3563
		    = Class348_Sub40_Sub34
			  .method3140(-57, class348_sub49.getTri());
	}
    }
