...
{
    private DirectxToolkit aHa_Sub2_2511;
    static OutgoingPacket aClass351_2512;
    private Class337 aClass337_2513;
    static boolean doRenderProfile = false;
	...
	try {
	    ...
	    if (!method1414(35632))
		return false;
	    Class206 class206 = ((DirectxToolkit) aHa_Sub2_2511).aClass206_7778;
	    int i_3_ = 30 % ((-55 - i) / 59);
	...
	if (((DirectxToolkit) aHa_Sub2_2511).aBoolean7820
	    && ((DirectxToolkit) aHa_Sub2_2511).aBoolean7783
	    && aClass337_2513 == null) {
	    Class242 class242
		= (WidgetVariable.method3249
		   (35632, 121, aHa_Sub2_2511,
		    "uniform float rcpRelief;\nuniform vec2 sampleSize;\nuniform sampler3D heightMap;\nvoid main() {\nfloat dx = texture3D(heightMap, vec3(-sampleSize.x, 0.0, 0.0)+gl_TexCoord[0].xyz).r - texture3D(heightMap, vec3(sampleSize.x, 0.0, 0.0)+gl_TexCoord[0].xyz).r;\nfloat dy = texture3D(heightMap, vec3(0.0, -sampleSize.y, 0.0)+gl_TexCoord[0].xyz).r - texture3D(heightMap, vec3(0.0, sampleSize.y, 0.0)+gl_TexCoord[0].xyz).r;\ngl_FragColor = vec4(0.5+normalize(vec3(dx, dy, rcpRelief))*0.5, texture3D(heightMap, gl_TexCoord[0].xyz).r);\n}\n"));
	    if (class242 != null)
		aClass337_2513
		    = Class318_Sub1_Sub5_Sub2.method2493(aHa_Sub2_2511,
							 i + -35633,
							 (new Class242[]
							  { class242 }));
	}
	...
	WidgetVariable class348_sub42_sub15
	    = Class318_Sub9_Sub1.method2516(i, (byte) 105, 17);
	if (i_6_ < 106)
	    method1417(-62, null, -125);
	...
	Class348_Sub40_Sub12.objectLoader.method2010(5, i + -6);
	Class189.npcLoader.method2076(5, true);
	ToolkitException.itemLoader.method1937(5, false);
	Class10.animationLoader.method836(5, 93);
	Class348_Sub40_Sub18.gfxLoader.method2544(5, (byte) -41);
	Class229.scriptConfigLoader.method1442(5, (byte) 1);
	...
	EntryElementLoader.aClass65_4787.method697(5, 26);
	FileArchiveTracker.aClass219_4782.method1603(5, -66);
	...
	ScriptExecutor.aClass60_1174.method578(2, 5);
    }
    
    static final Class348_Sub17 method1417(int i, IndexLoader class45, int i_7_) {
	anInt2516++;
	if (i != 0)
	    doRenderProfile = true;
    ...
    Class188(DirectxToolkit var_ha_Sub2) {
	aHa_Sub2_2511 = var_ha_Sub2;
    }
    
    static {
	aClass351_2512 = new OutgoingPacket(16, 7);
    }
}
