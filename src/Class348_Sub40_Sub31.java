...
final class Class348_Sub40_Sub31 extends Class348_Sub40
{
	...
	if (((Class322) ((Class348_Sub40) this).aClass322_7033).aBoolean4035) {
	    ...
	    if (i_2_ > 0) {
		int i_4_ = i % i_2_;
		is_3_ = this.method3039((byte) -86,
					Class286_Sub2.anInt6212 * i_4_ / i_2_,
					0);
	    } else
		is_3_ = this.method3039((byte) 105, 0, 0);
	    int[] is_5_ = is_3_[0];
	    int[] is_6_ = is_3_[1];
	    int[] is_7_ = is_3_[2];
	    int[] is_8_ = is[0];
    ...
    final void method3049(ByteBuffer class348_sub49, int i, int i_14_) {
	if (i_14_ == 31015) {
	    int i_15_ = i;
	    do {
		if (i_15_ != 0) {
		    ...
		    anInt9405 = class348_sub49.getUByte();
		    break;
		}
		anInt9410 = class348_sub49.getUByte();
	    } while (false);
	    anInt9413++;
	}
    }
	...
	if (i != 50)
	    method3131((byte) -33, null);
	anInt9404++;
	return Player.aHashtable10565
		   .containsKey(string);
    }
