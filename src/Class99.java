...
final class Class99
{
    ...
    static final void method880(int i, byte[] is, byte[] is_0_, int i_1_,
	...
	try {
	    ...
	    i = -(i & 0x3);
	    if (i_2_ != 13880)
		method880(9, null, null, -128, 85, -75, 62, 85, -51);
		...
		for (int i_10_ = i; (i_10_ ^ 0xffffffff) > -1; i_10_++)
		    is[i_4_++] += is_0_[i_1_++];
		i_4_ += i_5_;
		i_1_ += i_6_;
	    }
    ...
    static final void method881(Class348_Sub42_Sub13 class348_sub42_sub13,
				int i, boolean bool, int i_11_) {
	anInt1576++;
	if (Class5_Sub1.aBoolean8335) {
		...
		if (i_12_ + i_15_ > Class321.windowWidth)
		    i_15_ = -i_12_ + Class135_Sub1.anInt4717;
		if ((i_15_ ^ 0xffffffff) > -1)
		    i_15_ = 0;
		int i_16_ = !Class71.aBoolean1211 ? 31 : 33;
		int i_17_ = 13 + i_11_ + -i_16_;
		if ((Class348_Sub42_Sub8_Sub2.windowHeight ^ 0xffffffff)
		    > (i_17_ + i_14_ ^ 0xffffffff))
		    i_17_ = Class348_Sub42_Sub8_Sub2.windowHeight - i_14_;
		...
		AbstractMouseListener.anInt4534 = i_17_;
	    }
	}
    }
	...
	anInt1573++;
	Class369_Sub2.aClass46ArrayArray8584
	    = new Widget[Class229.aClass45_2978.getAmountChildren()][];
