...
final class Class348_Sub40_Sub39 extends Class348_Sub40
{
	...
	TextureDefinition.method224((byte) -40, is);
	...
	Class8.anInt166 = 0;
	FileArchiveTracker.anInt4776 = i;
	Class348_Sub40_Sub4.aClass262_9111.removeAll(125);
	Class348_Sub42_Sub12.aClass356_9603.removeAll(0);
	Class233.aClass107_3022.removeAll();
	Class5_Sub1.aBoolean8335 = false;
    }
    
    final void method3049(ByteBuffer class348_sub49, int i, int i_6_) {
	if (i_6_ != 31015)
	    aClass70_9485 = null;
	if (i == 0) {
	    aClass50Array9481 = new Class50[class348_sub49.getUByte()];
	while_216_:
