...
final class Class104
{
    ...
    private DirectxToolkit aHa_Sub2_1616;
    byte[] aByteArray1617;
    ...
    static IndexLoader indexLoader13;
	...
	if (i_5_ > 0 && (i_4_ ^ 0xffffffff) < -1) {
	    OndemandWorker.method1895(i_3_, ((Class104) this).aByteArray1617, i_4_,
				i_2_, i_6_, i_7_,
	...
	float f = 1.0F / (float) (((DirectxToolkit) aHa_Sub2_1616).anInt7733 * 128);
	if (!bool) {
		...
		for (int i_42_ = 0;
			...
			= ((DirectxToolkit) aHa_Sub2_1616).aClass348_Sub49_Sub1_7798;
			...
			if ((-i_36_ + i_46_ ^ 0xffffffff) <= (-i_35_
				...
				if (((-i_37_ + i_48_ ^ 0xffffffff)
				    ...
				    if (is != null) {
					if (!((DirectxToolkit) aHa_Sub2_1616)
					     .aBoolean7775) {
					    for (int i_49_ = 0;
