...
final class Class348_Sub40_Sub34 extends Class348_Sub40
{
	...
	for (int i_2_ = 0; (i_2_ ^ 0xffffffff) > -5; i_2_++)
	    MouseEventNode.aClass361Array7108[i_2_].method3500(700);
	...
	if (bool)
	    ByteBuffer.setClientState(2, 12);
	else {
	    ByteBuffer.setClientState(i + -9, 3);
	    try {
    ...
    final void method3049(ByteBuffer class348_sub49, int i, int i_5_) {
	do {
	    try {
		if (i_5_ != 31015)
		    method3140(-77, 55);
		...
		if (i_6_ != 0) {
		    ...
		    anInt9438 = class348_sub49.getShort();
		    break;
		}
		aBoolean9439 = class348_sub49.getUByte() == 1;
		break;
