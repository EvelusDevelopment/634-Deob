...
final class Class367_Sub11 extends Class367
{
    ...
    static IncomingPacket incomingPacket16 = new IncomingPacket(16, 6);
	...
	class101_sub2.method919(0.0F, aFloatArray7413, -1.0F, 0.0F,
				(float) i_0_, (byte) -120);
	OpenGL.glProgramLocalParameter4fARB(34336, 1, aFloatArray7413[0],
					    aFloatArray7413[1],
					    aFloatArray7413[2],
					    aFloatArray7413[3]);
	method3522(-16252);
    ...
    static final void method3555(IndexLoader class45, int i, boolean bool, long l,
				 int i_7_, int i_8_, int i_9_) {
	try {
	    anInt7410++;
	    Class299_Sub1_Sub1.method2260(i_9_, i_8_, l, 0, bool, class45,
					  (byte) 126, i_7_);
	...
	if (bool == false) {
		...
		if (Class34.aFrame476 != null) {
			...
			if ((Class321.windowWidth ^ 0xffffffff) > -1025
			    && Class348_Sub42_Sub8_Sub2.windowHeight < 768) {
			    /* empty */
			}
		    }
			...
			if (Class59_Sub1.aBoolean5300)
			    s.method3980(120, Class305.canvas);
			else
			    Class348_Sub8.currentToolkit.method3669
				(Class305.canvas, Class321.windowWidth,
				 Class348_Sub42_Sub8_Sub2.windowHeight);
		    }
		    if (ColorNode.aFrame4904 != container)
			Class305.canvas.setLocation((Class348_Sub48
							  .anInt7129),
							 Class335.anInt4167);
		    else {
			Insets insets = ColorNode.aFrame4904.getInsets();
			Class305.canvas.setLocation
    ...
    Class367_Sub11(OpenGlToolkit class377, IndexLoader class45) {
	super(class377);
	try {
	    if (class45 != null && ((OpenGlToolkit) class377).aBoolean9923) {
		aClass193_7395
