...
final class Class135_Sub1 extends Class135 implements Interface2
{
    ...
    static IncomingPacket aClass114_4707;
    ...
    Class135_Sub1(DirectxToolkit var_ha_Sub2, int i, byte[] is, int i_2_,
		  boolean bool) {
    ...
    Class135_Sub1(DirectxToolkit var_ha_Sub2, int i, Buffer buffer, int i_3_,
		  boolean bool) {
    ...
    static final void method1153(AbstractToolkit var_ha, int i) {
	anInt4713++;
	int i_4_ = 0;
	int i_5_ = 0;
	...
	int i_11_ = i_4_ + Class258_Sub4.mouseMovementListener.method3597(true);
	if (i != 16)
	    method1154((byte) 9);
	int i_12_ = i_5_ + Class258_Sub4.mouseMovementListener.method3594((byte) 95);
	if (!Class348_Sub42_Sub6.aBoolean9535) {
	    ...
	    for (Class348_Sub42_Sub12 class348_sub42_sub12
		 ...
		 class348_sub42_sub12
		     = (Class348_Sub42_Sub12) Class348_Sub40_Sub4
						  .aClass262_9111
						  .nextForward((byte) 101)) {
		int i_14_ = (16 * (-1 + (FileArchiveTracker.anInt4776 - i_13_)) + 13
			     + (i_7_ + i_10_));
		if ((anInt4717 - -i_4_ ^ 0xffffffff) > (i_11_ ^ 0xffffffff)
			...
			.aBoolean9610))
		    var_ha.drawQuad(i_4_ + anInt4717, -12 + i_14_, Class63.anInt1117,
			      16,
		...
		if ((i_11_ ^ 0xffffffff) < (i_4_ + anInt4717 ^ 0xffffffff)
			...
			|| ((Class348_Sub42_Sub12) (Class348_Sub42_Sub12)
				...
				.aClass107_9621)).parent)
			     .subnodeParent)).aBoolean9610))
		    var_ha.drawQuad(anInt4717 + i_4_, -12 + i_16_, Class63.anInt1117,
			      16,
			      (255 + -Class348_Sub42_Sub4.anInt9511
		...
		Class299_Sub2_Sub1.method2270(Class348_Sub1_Sub1.anInt8806,
						...
						(Class242
						 .aClass348_Sub42_Sub13_3152))
					       .aString9617),
					      false, AbstractMouseListener.anInt4534,
		...
		for (Class348_Sub42_Sub12 class348_sub42_sub12
			 ...
			 = ((Class348_Sub42_Sub12)
				...
				.aClass107_9621.next())) {
		    int i_17_
			= i_15_ * 16 + (AbstractMouseListener.anInt4534 + i_10_ - -13);
			...
			&& (((Class348_Sub42_Sub12) class348_sub42_sub12)
			    .aBoolean9610))
			var_ha.drawQuad(Class50_Sub3.anInt5252, i_17_ - 12,
		...
		Class84.method826(i_10_, Class50_Sub3.anInt5252,
				  ...
				  Class177.anInt4669, 125, AbstractMouseListener.anInt4534,
				  var_ha);
	    }
	}
	...
	if (!Class348_Sub42_Sub6.aBoolean9535) {
		...
		int i_19_
		    = (i_7_ - -i_10_
		       - (-13 - (FileArchiveTracker.anInt4776 + (-1 + -i_18_)) * 16));
		i_18_++;
		...
		for (Class348_Sub42_Sub12 class348_sub42_sub12
			 ...
			 = ((Class348_Sub42_Sub12)
			    ((Class348_Sub42_Sub13)
			     Class242.aClass348_Sub42_Sub13_3152)
				.aClass107_9621.next())) {
		    int i_22_ = i_20_ * 16 + 13 + (AbstractMouseListener.anInt4534 + i_10_);
		    i_20_++;
		    Class318_Sub2.method2494(AbstractMouseListener.anInt4534,
    ...
    static {
	aClass114_4707 = new IncomingPacket(39, 8);
	anInt4718 = 0;
    }
}
