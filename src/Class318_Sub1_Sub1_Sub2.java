...
final class Class318_Sub1_Sub1_Sub2 extends Class318_Sub1_Sub1
    implements Interface10
{
    ...
    private AnimatableToolkit aClass64_9993;
	...
	do {
		...
		if (!(class318_sub1 instanceof Class318_Sub1_Sub1_Sub2))
		    break;
		Class318_Sub1_Sub1_Sub2 class318_sub1_sub1_sub2_3_
		    = (Class318_Sub1_Sub1_Sub2) class318_sub1;
		if (aClass64_9993 == null
		    || class318_sub1_sub1_sub2_3_.aClass64_9993 == null)
		    break;
		aClass64_9993.method613((class318_sub1_sub1_sub2_3_
					 .aClass64_9993),
					i_2_, i, i_0_, bool);
    ...
    private final Class2 method2401(AbstractToolkit var_ha, int i, boolean bool, int i_4_) {
	anInt9985++;
	if (i_4_ != 22)
	    method2404(null, -21, -25);
	ObjectDefinition class51 = Class348_Sub40_Sub12.objectLoader
			      .getObject(0, aShort9991 & 0xffff);
	s var_s;
	s var_s_5_;
	if (aBoolean9983) {
	...
	if (bool == true) {
	    aBoolean9989 = false;
	    if (aClass64_9993 != null)
		aClass64_9993.s(~0x10000 & aClass64_9993.ua());
	}
    }
	...
	Class318_Sub4 class318_sub4
	    = DummyOutputstream.method136(i, aBoolean9974, false);
    ...
    static final void method2403(int i, int i_7_, int i_8_, int i_9_,
	...
	for (int i_13_ = 0;
		...
		if ((Class239_Sub21.anIntArray6062[0] ^ 0xffffffff) < 0
		    ...
		    RasterToolkit class105 = (Class239_Sub9.aClass105Array5933
		    ...
		    Class338.method2663(-5590, i_14_,
					i_14_ - -class105.method966(), i_15_,
					class105.method980() + i_15_);
		}
	    }
	}
    }
    ...
    final boolean method2391(AbstractToolkit var_ha, int i, int i_16_, int i_17_) {
	if (i_17_ != 0)
	    anInt9997 = -51;
	anInt9996++;
    ...
    private final AnimatableToolkit method2404(AbstractToolkit var_ha, int i, int i_18_) {
	anInt9984++;
	int i_19_ = 65 / ((-34 - i) / 53);
	if (aClass64_9993 != null
	    && var_ha.method3667(aClass64_9993.ua(), i_18_) == 0)
    ...
    Class318_Sub1_Sub1_Sub2(AbstractToolkit var_ha, ObjectDefinition class51, int i, int i_20_,
			    int i_21_, int i_22_, int i_23_, boolean bool,
			    int i_24_, boolean bool_25_) {
	super(i_21_, i_22_, i_23_, i, i_20_, ((ObjectDefinition) class51).anInt930);
	do {
	    try {
		aBoolean9983 = bool;
		aBoolean9974
		...
		if (!aBoolean9989)
		    break;
		aClass64_9993
		    = aClass64_9993.method614((byte) 0, i_26_, false);
	    } catch (RuntimeException runtimeexception) {
		throw Class348_Sub17.method2929
			  (runtimeexception,
			   ("uo.<init>(" + (var_ha != null ? "{...}" : "null")
			    + ',' + (class51 != null ? "{...}" : "null") + ','
			    + i + ',' + i_20_ + ',' + i_21_ + ',' + i_22_ + ','
			    + i_23_ + ',' + bool + ',' + i_24_ + ',' + bool_25_
			    + ')'));
	    }
	    break;
	} while (false);
