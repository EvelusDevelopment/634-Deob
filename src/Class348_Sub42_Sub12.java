...
final class Class348_Sub42_Sub12 extends SubNode
{
    String aString9593;
    ...
    String aString9601;
    int anInt9602;
    static HashTable aClass356_9603;
    ...
    static final void method3231(int i, int i_3_, int i_4_, int i_5_, int i_6_,
				 int i_7_) {
	if (i_7_ > -123)
	    method3229();
	Class239_Sub12.anInt5973 = i_5_;
	Class121.anInt1797 = i_4_;
	GameFont.anInt4336 = i_3_;
	...
	if ((Class239_Sub12.anInt5973 ^ 0xffffffff) <= -101) {
	    ...
	    Class5.anInt4638 = (int) (-2607.5945876176133
				      * Math.atan2((double) i_11_,
						   (double) i_13_)) & 0x3fff;
	    if ((ClientScript.anInt9701 ^ 0xffffffff) > -1025)
		ClientScript.anInt9701 = 1024;
	    Class338.anInt4186 = 0;
	    if ((ClientScript.anInt9701 ^ 0xffffffff) < -3073)
    ...
    Class348_Sub42_Sub12(String string, String string_15_, int i, int i_16_,
	...
	try {
	    ...
	    throw Class348_Sub17.method2929
		      (runtimeexception,
		       ("db.<init>(" + (string != null ? "{...}" : "null")
			+ ',' + (string_15_ != null ? "{...}" : "null") + ','
			+ i + ',' + i_16_ + ',' + i_17_ + ',' + l + ',' + i_18_
			+ ',' + i_19_ + ',' + bool + ',' + bool_20_ + ','
			+ l_21_ + ',' + bool_22_ + ')'));
	}
    }
    ...
    static {
	aClass356_9603 = new HashTable(16);
