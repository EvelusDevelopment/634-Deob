/* DummyInputstream2 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */
import java.io.InputStream;

final class DummyInputstream2 extends InputStream
{
    static int anInt71;
    static int anInt72;
    static int anInt73;
    ...
    static OutgoingPacket aClass351_77;
    static int anInt78;
    static IncomingPacket aClass114_79;
	...
	for (int i_7_ = 0; (i_7_ ^ 0xffffffff) > -5; i_7_++)
	    MouseEventNode.aClass361Array7108[i_7_].method3500(700);
	if (i != -16203)
	...
	aClass351_77 = new OutgoingPacket(8, 1);
	anInt78 = 0;
	aClass114_79 = new IncomingPacket(75, 6);
    }
}
