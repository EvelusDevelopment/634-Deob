...
final class Class348_Sub40_Sub8 extends Class348_Sub40
{
	...
	= { new Color(9179409), new Color(16777215), new Color(16726277),
	    new Color(16726277) };
    int anInt9164;
    static AbstractConnection gameConnection;
	...
	aByteArray9152
	    = AbstractToolkit.method3664(((Class348_Sub40_Sub8) this).anInt9156, 95);
	anInt9148++;
	method3067((byte) -98);
	...
	if (i_64_ > 1)
	    i_66_
		= (i_64_ ^ 0xffffffff) == -3 ? i_57_ - i_55_ : -i_55_ + -i_57_;
	else
	...
	if ((i_64_ ^ 0xffffffff) >= -2)
	    i_67_
		= (i_64_ ^ 0xffffffff) == -1 ? i_62_ + i_55_ : i_55_ + -i_62_;
	else
	...
	if (i_64_ > 1)
	    i_67_
		= (i_64_ ^ 0xffffffff) == -3 ? -i_63_ + i_62_ : -i_62_ - i_63_;
	else
