...
final class Class31
{
    ...
    final RasterToolkit method324(AbstractToolkit var_ha, boolean bool) {
	anInt440++;
	if (bool != true)
	    return null;
	if (anInt429 < 0)
	...
	RasterToolkit class105
	    = (RasterToolkit) ((Class219) ((Class31) this).aClass219_438)
    ...
    final RasterToolkit method325(AbstractToolkit var_ha, int i) {
	anInt428++;
	if (anInt439 < 0)
	    return null;
	RasterToolkit class105
	...
	if (class105 == null) {
	    ...
	    class105 = (RasterToolkit) ((Class219) ((Class31) this).aClass219_438)
				      .aClass60_2862
    ...
    final RasterToolkit method327(AbstractToolkit var_ha, byte i) {
	anInt432++;
	if (anInt421 < 0)
	    return null;
	RasterToolkit class105
    ...
    private final void method329(ByteBuffer class348_sub49, int i,
				 int i_1_) {
	if (i_1_ != 1) {
	    if (i_1_ != 2) {
		if ((i_1_ ^ 0xffffffff) == -4)
		    anInt421 = class348_sub49.getShort();
		else if ((i_1_ ^ 0xffffffff) != -5) {
		    if ((i_1_ ^ 0xffffffff) == -6)
			anInt433 = class348_sub49.getShort();
		    else if (i_1_ == 6)
			anInt439 = class348_sub49.getShort();
		    else if (i_1_ != 7) {
			if ((i_1_ ^ 0xffffffff) != -9) {
			    ...
			    aString423 = class348_sub49.getJStr2(i ^ 0x34af);
		    } else
			((Class31) this).anInt424
			    = class348_sub49.method3372(13638);
		} else
		    anInt429 = class348_sub49.getShort();
	    } else
		((Class31) this).anInt444 = class348_sub49.getTri();
	} else
	    ((Class31) this).anInt435 = class348_sub49.getShort();
	if (i != -2)
	    method333(-112, 38);
	anInt437++;
    }
    
    private final void method330(AbstractToolkit var_ha, int i) {
	anInt446++;
	IndexLoader class45
	...
	if (anInt421 >= 0
	    ...
	    Sprite class207 = Sprite.loadSingleSprite(class45, anInt421);
	...
	if (anInt433 >= 0
	    ...
	    Sprite class207 = Sprite.loadSingleSprite(class45, anInt433);
	    ((Class219) ((Class31) this).aClass219_438).aClass60_2862.method582
	...
	if (anInt429 >= 0
	    ...
	    Sprite class207 = Sprite.loadSingleSprite(class45, anInt429);
	    ((Class219) ((Class31) this).aClass219_438).aClass60_2862.method582
	...
	if ((anInt439 ^ 0xffffffff) <= -1
	    ...
	    Sprite class207 = Sprite.loadSingleSprite(class45, anInt439);
	    ((Class219) ((Class31) this).aClass219_438).aClass60_2862.method582
    ...
    final RasterToolkit method331(AbstractToolkit var_ha, byte i) {
	anInt441++;
    ...
    final void method332(int i, ByteBuffer class348_sub49) {
	if (i > -119)
	    method333(119, -71);
	for (;;) {
