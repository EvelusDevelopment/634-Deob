...
{
    private Class123 aClass123_6927;
    private float[][] aFloatArrayArray6928;
    private s_Sub2 aS_Sub2_6929;
    static int anInt6930 = 0;
    static int anInt6931;
    private HashTable aClass356_6932;
    static int anInt6933;
    private int anInt6934;
    private int anInt6935;
    private ByteBuffer aClass348_Sub49_6936;
    private Class348_Sub1 aClass348_Sub1_6937;
    static int anInt6938;
    static int anInt6939;
    private int anInt6940;
    static int anInt6941;
    private int anInt6942;
    private Class123 aClass123_6943;
    private int anInt6944;
    private Interface8 anInterface8_6945;
    static Thread aThread6946;
    private float[][] aFloatArrayArray6947;
    private int anInt6948;
    private float[][] aFloatArrayArray6949;
    static IndexLoader indexLoader23;
    private DirectxToolkit aHa_Sub2_6951;
    private Interface2 anInterface2_6952;
    private FloatBuffer aClass348_Sub49_Sub1_6953;
	...
	anInt6933++;
	long l = -1L;
	int i_6_ = i_3_ - -(i_2_ << ((s) aS_Sub2_6929).anInt4588);
	int i_7_ = i + (i_5_ << ((s) aS_Sub2_6929).anInt4588);
	int i_8_ = aS_Sub2_6929.method3986(i_6_, i_7_, (byte) -17);
	if ((i_3_ & 0x7f) == 0 || (i & 0x7f ^ 0xffffffff) == -1) {
	    l = ((long) i_7_ << -1366341936 & 65535L << 692063248
		 | 0xffffL & (long) i_6_);
	    Node class348 = aClass356_6932.get(l);
	    if (class348 != null) {
		method3022((byte) -46,
			   (((Class348_Sub29) (Class348_Sub29) class348)
			    .aShort6911));
		return;
	    }
	}
	...
	if (l != -1L)
	    aClass356_6932.putNode(l, new Class348_Sub29(i_9_));
	float f;
	float f_10_;
	float f_11_;
	if (i_3_ != 0 || i != 0) {
	    if ((i_3_ ^ 0xffffffff) == (((s) aS_Sub2_6929).anInt4592
					^ 0xffffffff)
		&& (i ^ 0xffffffff) == -1) {
		f_10_ = aFloatArrayArray6928[1 + i_0_][i_1_];
		f_11_ = aFloatArrayArray6947[1 + i_0_][i_1_];
		f = aFloatArrayArray6949[1 + i_0_][i_1_];
	    } else if (i_3_ != ((s) aS_Sub2_6929).anInt4592
		       || ((s) aS_Sub2_6929).anInt4592 != i) {
		if (i_3_ != 0 || ((s) aS_Sub2_6929).anInt4592 != i) {
		    float f_12_
			= (float) i_3_ / (float) ((s) aS_Sub2_6929).anInt4592;
		    float f_13_
			= (float) i / (float) ((s) aS_Sub2_6929).anInt4592;
	...
	float f_23_ = (float) Math.sqrt((double) (f_21_ * f_21_ + f_20_ * f_20_
						  + f_22_ * f_22_));
	...
	if (!((DirectxToolkit) aHa_Sub2_6951).aBoolean7775) {
	...
	if (i_33_ > 255)
	    i_33_ = 255;
	aClass348_Sub49_Sub1_6953.putByte(i_31_);
	aClass348_Sub49_Sub1_6953.putByte(i_32_);
	aClass348_Sub49_Sub1_6953.putByte(i_33_);
	aClass348_Sub49_Sub1_6953.putByte(255);
	...
	if (class229 != Class328_Sub3.aClass229_6519) {
		...
		return 8448;
	    if (class229 == OndemandWorker.aClass229_3196)
		return 34165;
	...
	if (i == -46) {
		...
		aClass348_Sub49_6936.putShort(i_34_);
	}
    }
	...
	if (anInterface8_6945 != null && i_37_ + i_35_ >= anInt6935
	    && (i_35_ + -i_37_ ^ 0xffffffff) >= (anInt6942 ^ 0xffffffff)
	    && i_36_ + i_37_ >= anInt6948
	    && (anInt6944 ^ 0xffffffff) <= (i_36_ + -i_37_ ^ 0xffffffff)) {
	    for (int i_38_ = anInt6948;
		 (anInt6944 ^ 0xffffffff) <= (i_38_ ^ 0xffffffff); i_38_++) {
		for (int i_39_ = anInt6935; anInt6942 >= i_39_; i_39_++) {
		    int i_40_ = i_39_ - i_35_;
		    int i_41_ = -i_36_ + i_38_;
		    if (i_40_ > -i_37_ && i_37_ > i_40_
			&& (-i_37_ ^ 0xffffffff) > (i_41_ ^ 0xffffffff)
			&& (i_41_ ^ 0xffffffff) > (i_37_ ^ 0xffffffff)
    ...
    Class348_Sub32(DirectxToolkit var_ha_Sub2, s_Sub2 var_s_Sub2,
	...
	try {
	    ...
	    int i = (aClass348_Sub1_6937.method2723(-1)
		     + -(((s) var_s_Sub2).anInt4592 >> -2046904927));
	    anInt6935 = (aClass348_Sub1_6937.method2724(-1) + -i
			 >> ((s) var_s_Sub2).anInt4588);
		...
		if ((i_45_ ^ 0xffffffff) < -1
		    && i_45_ < -1 + ((s) aS_Sub2_6929).anInt4590) {
		    for (int i_46_ = 0;
			 (i_46_ ^ 0xffffffff) >= (i_42_ ^ 0xffffffff);
			 i_46_++) {
			int i_47_ = i_46_ - -anInt6935;
			if ((i_47_ ^ 0xffffffff) < -1
			    && i_47_ < ((s) aS_Sub2_6929).anInt4587 + -1) {
			    int i_48_
		...
		if (i_51_ < 0 || i_51_ >= ((s) var_s_Sub2).anInt4590)
			...
			if ((i_52_ ^ 0xffffffff) <= -1
				...
				if (i_53_ != 1)
				    ...
				    int i_55_ = 0;
				    while ((is_54_.length ^ 0xffffffff)
					   < (i_55_ ^ 0xffffffff)) {
					if ((is_54_[i_55_++] ^ 0xffffffff) != 0
					    && is_54_[i_55_++] != -1
					    && ((is_54_[i_55_++] ^ 0xffffffff)
						!= 0))
					    anInt6934 += 3;
				    }
				}
	    ...
	    if ((anInt6934 ^ 0xffffffff) < -1) {
		aClass348_Sub49_6936 = new ByteBuffer(anInt6934 * 2);
		aClass348_Sub49_Sub1_6953
		    = new FloatBuffer(anInt6934 * 16);
		aClass356_6932
		    = new HashTable(Class33.method340(anInt6934, (byte) 108));
		int i_56_ = 0;
		i_50_ = 0;
		for (int i_57_ = anInt6948;
		     (i_57_ ^ 0xffffffff) >= (anInt6944 ^ 0xffffffff);
		     i_57_++) {
		    if (i_57_ >= 0
			&& (i_57_ ^ 0xffffffff) > (((s) var_s_Sub2).anInt4590
						   ^ 0xffffffff)) {
			int i_58_ = 0;
		...
		anInterface8_6945
		    = (aHa_Sub2_6951.method3733
		       (5123, -49,
			((ByteBuffer) aClass348_Sub49_6936).position,
			((ByteBuffer) aClass348_Sub49_6936).payload,
			false));
		anInterface2_6952
