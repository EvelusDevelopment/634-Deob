...
final class t extends s implements ModelToolkit
{
    long nativeid;
    private Deque aClass262_5149 = new Deque();
    private SafeToolkit anOa5150;
	...
	for (Class348_Sub1 class348_sub1
	     ...
	     class348_sub1 != null;
	     class348_sub1
		 = (Class348_Sub1) aClass262_5149.nextForward((byte) 34))
	...
	aClass262_5149.addToFront(class348_sub1, -20180);
    ...
    t(SafeToolkit var_oa, ya var_ya, int i, int i_50_, int[][] is, int[][] is_51_,
    ...
    private final native void ga(SafeToolkit var_oa, ya var_ya, int i, int i_72_,
