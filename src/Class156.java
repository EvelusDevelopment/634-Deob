...
final class Class156
{
    ...
    private SubNode aClass348_Sub42_2115;
    static int anInt2116;
    static int[] anIntArray2117 = new int[2];
    private Queue aClass107_2118;
    ...
    final SubNode method1240(int i) {
	anInt2114++;
	if (i <= 7)
	    method1240(79);
	SubNode class348_sub42
	    = (((SubNode)
		((Queue) aClass107_2118).parent)
	       .subnodeParent);
	if (class348_sub42
	    == ((Queue) aClass107_2118).parent) {
	...
	do {
		...
		if (Class348_Sub8.anApplet6662 != null) {
			...
			= (DataInputStream) class144.returnObj;
    ...
    final SubNode method1243(byte i) {
	anInt2120++;
	if (i < 44)
	    aStringArray2113 = null;
	SubNode class348_sub42 = aClass348_Sub42_2115;
	if (class348_sub42
	    == ((Queue) aClass107_2118).parent) {
	    aClass348_Sub42_2115 = null;
	    return null;
