...
final class Class348_Sub40_Sub33 extends Class348_Sub40
{
    ...
    static Widget[][] aClass46ArrayArray9427;
	...
	if (((Class322) ((Class348_Sub40) this).aClass322_7033).aBoolean4035) {
		...
		int[][] is_7_
		    = this.method3039((byte) 43, AbstractBuffer.anInt4265, 0);
	...
	if (((Class191) ((Class348_Sub40) this).aClass191_7032).aBoolean2570) {
		...
		int[] is_10_ = this.method3048(AbstractBuffer.anInt4265,
					       i_8_ ^ 0x25c5979e, 0);
	...
	if ((double) f >= -3.141592653589793
		...
		if (!(f <= 0.0F) || !((double) f >= -0.7853981633974483)) {
			...
			if (!((double) f >= 0.7853981633974483)
			    ...
			    AbstractBuffer.anInt4265 = -i + Class286_Sub2.anInt6212;
			}
		    } else {
			Class121.anInt1796
			    = -i + Class348_Sub40_Sub6.anInt9139;
			AbstractBuffer.anInt4265 = -i_12_ + Class286_Sub2.anInt6212;
		    }
		} else {
		    Class121.anInt1796 = i;
		    AbstractBuffer.anInt4265 = Class286_Sub2.anInt6212 - i_12_;
		}
	    } else {
	...
	AbstractBuffer.anInt4265 &= Class299_Sub2.anInt6325;
