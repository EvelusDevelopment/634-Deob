/* AbstractToolkit - Decompiled by JODE
...
abstract class AbstractToolkit
{
    ...
    static OutgoingPacket aClass351_4571;
    ...
    abstract AnimatableToolkit method3625(Model class124, int i, int i_4_, int i_5_,
				int i_6_);
    
    abstract void F(int i, int i_7_);
    
    abstract void draw(int i, int i_8_) throws ToolkitException;
    
    abstract boolean method3627();
    
    abstract void method3628(int i, int i_9_, int i_10_, int i_11_, int i_12_,
			     int i_13_);
    
    abstract RasterToolkit createRasterToolkit(int i, int i_14_, boolean bool);
    ...
    abstract int getAmountPolygons();
    ...
    abstract AbstractRasterizer method3634(Interface3$ interface3,
				   Interface13 interface13);
    
    final void destroy() {
	anInt4573++;
	Class348_Sub40_Sub26.activeToolkits[((AbstractToolkit) this).id] = false;
	method3652();
    }
    
    abstract void method3636(int i, int i_16_, int i_17_, int i_18_, int i_19_,
			     int i_20_, aa var_aa, int i_21_, int i_22_);
    
    abstract ToolkitInfo getToolkitInfo();//c
    
    abstract void method3638(Class101 class101);
    
    abstract int[] na(int i, int i_23_, int i_24_, int i_25_);
    
    abstract int r(int i, int i_26_, int i_27_, int i_28_, int i_29_,
		   int i_30_, int i_31_);
    ...
    static final void method3641(int i, int i_35_, byte i_36_, int i_37_,
				 int i_38_, int i_39_) {
	anInt4575++;
	if (i_36_ != -75)
	    anInt4581 = 73;
	if (i_35_ == i_38_)
	    ...
	    Class239_Sub27.method1839(i_39_, i_35_, i, i_36_ ^ 0x4a, i_37_,
				      i_38_);
    }
    ...
    final void method3645(int i, int i_41_, int i_42_, int i_43_, int i_44_,
			  int i_45_) {
	anInt4563++;
    ...
    abstract s method3648(int i, int i_46_, int[][] is, int[][] is_47_,
			  int i_48_, int i_49_, int i_50_);
    
    final void drawSolidHorizontalLine(byte i, int i_51_, int i_52_, int i_53_, int i_54_) {
	    drawHorizontalLine(i_54_, i_52_, i_51_, i_53_, 1);
    }
    ...
    abstract void drawVerticalLine(int i, int i_55_, int i_56_, int i_57_, int i_58_);
    ...
    abstract int JA(int i, int i_63_, int i_64_, int i_65_, int i_66_,
		    int i_67_);
    ...
    final void method3657(Rectangle[] rectangles, int i, int i_74_)
	throws ToolkitException {
	method3707(rectangles, i, 0, 0);
	anInt4568++;
	if (i_74_ <= 41)
	    ((AbstractToolkit) this).id = 54;
    }
    ...
    final void drawSolidLine(int i, int i_79_, int i_80_, int i_81_,
			  boolean bool) {
	anInt4570++;
	drawVerticalLine(i, i_81_, i_80_, i_79_, 1);
    }
    
    abstract aa method3661(int i, int i_82_, int[] is, int[] is_83_);
    
    final RasterToolkit method3662(int i, int[] is, byte i_84_, int i_85_,
			      int i_86_, int i_87_) {
	anInt4565++;
	if (i_84_ != 94)
	    return null;
	...
	if (class348_sub42_sub3 == null) {
		...
		int i_91_ = -i_90_ + 255;
		int i_92_ = Model.method1097((byte) 95, i_91_, random);
		byte i_93_ = is[i_92_];
		is[i_92_] = is[i_91_];
    ...
    abstract boolean isBloomSupported();
    
    abstract void da(int i, int i_95_, int i_96_, int[] is);
    
    abstract int method3667(int i, int i_97_);
    
    abstract void drawBitmapQuad(int i, int i_98_, int i_99_, int i_100_, int i_101_,
		    int i_102_, byte[] is, int i_103_, int i_104_);
    
    final void method3668(int i, int i_105_, int i_106_, int i_107_,
			  int i_108_, int i_109_) {
	anInt4574++;
	if (i_109_ >= 21)
	    method3628(i_107_, i_105_, i, i_108_, i_106_, 1);
    }
    ...
    abstract void method3674(int i, int i_114_, int i_115_, int i_116_,
			     int i_117_, int i_118_, int i_119_, int i_120_,
			     int i_121_);
    
    abstract void EA(int i, int i_122_, int i_123_, int i_124_);
    
    final void method3675(int i, byte i_125_, int i_126_, int i_127_,
			  int i_128_, int i_129_) {
	if (i_125_ == -125) {
	    drawQuad(i_126_, i_127_, i, i_128_, i_129_, 1);
	    anInt4566++;
	}
    }
    
    abstract void method3676(int i, int i_130_, int i_131_, int i_132_,
			     int i_133_, int i_134_, int i_135_, int i_136_,
    ...
    abstract int OR(int i, int i_142_);
    ...
    final void method3681(RasterToolkit raster, int i) {
	method3687(method3634(raster, method3624(raster.getWidth(), raster.getHeight())));
	anInt4561++;
    }
    
    abstract boolean method3682();
    
    abstract RasterToolkit createRaster(int i, int i_143_, int i_144_, int i_145_,
				 boolean bool);
    ...
    abstract void getDimensions(int[] is);
    
    abstract AbstractFontRasterizer createFontRasterizer(BitmapFont class143, Sprite[] class207s,
				 boolean bool);
    
    abstract void H(int i, int i_146_, int i_147_, int[] is);
    
    abstract void clipDimensions(int i, int i_148_, int i_149_, int i_150_);
    
    abstract void ZA(int i, float f, float f_151_, float f_152_, float f_153_,
		     float f_154_);
    
    abstract void ra(int i, int i_155_, int i_156_, int i_157_);
    
    abstract int getAmountModels();
    
    abstract void C(boolean bool);
    
    abstract void method3687(AbstractRasterizer interface4);
    
    abstract void method3688(int i, int i_158_, int i_159_, int i_160_,
			     int i_161_, int i_162_, int i_163_);
    
    final void method3689(byte i) throws ToolkitException {
	draw(0, 0);
	if (i >= 53)
	    anInt4572++;
    }
    
    abstract Class348_Sub1 method3690(int i, int i_164_, int i_165_,
				      int i_166_, int i_167_, float f);
    
    abstract RasterToolkit method3691(Sprite class207, boolean bool);
	...
	try {
	    ...
	    if (i_171_ == 2)
		return Class306.createSafeToolkit(-6, i_168_, var_d, canvas, i_169_);
	    if (i_171_ == 1)
		return Deque.createDirect3dToolkit(3, i, canvas, var_d);
	    if (i_171_ == 5)
		return Class93.createOpenglToolkit(canvas, var_d, loader, 25542, i);
	    if (i_171_ == 3)
		return Class96.createDirectxToolkit(i, i_170_ ^ 0x4a31, var_d, loader, canvas);
	    throw new IllegalArgumentException("UM");
	} catch (RuntimeException runtimeexception) {
	    throw Class348_Sub17.method2929
		      (runtimeexception,
		       ("ha.TJ(" + i + ',' + i_168_ + ',' + i_169_ + ','
			+ (loader != null ? "{...}" : "null") + ',' + i_170_
			+ ',' + (var_d != null ? "{...}" : "null") + ','
			+ (canvas != null ? "{...}" : "null") + ',' + i_171_
			+ ')'));
	}
    }
    ...
    abstract Class299 method3697(int i, int i_172_, int i_173_, int i_174_,
    ...
    abstract void setDimensions(int i, int i_177_, int i_178_, int i_179_);
    ...
    abstract void removeImageFetcher(Canvas canvas);
    
    abstract za method3702(int i);
    
    abstract void method3703(int i, int i_184_, int i_185_, int i_186_,
			     int i_187_, int i_188_, aa var_aa, int i_189_,
    ...
    abstract void drawHorizontalLine(int i, int i_194_, int i_195_, int i_196_, int i_197_);
    
    abstract void drawQuad(int i, int i_198_, int i_199_, int i_200_, int i_201_,
		     int i_202_);
    
    abstract void drawScreenOverlay(int i);
    
    abstract Class299 method3706(Class299 class299, Class299 class299_203_,
				 float f, Class299 class299_204_);
    
    abstract void method3707(Rectangle[] rectangles, int i, int i_205_,
			     int i_206_) throws ToolkitException;
    
    abstract boolean supportsMultipleCores();
    
    abstract void method3709(int i, int i_207_, int i_208_, int i_209_,
			     int i_210_, int i_211_);
    
    abstract void method3710();
    
    abstract RasterToolkit method3711(int[] is, int i, int i_212_, int i_213_,
				 int i_214_, boolean bool);
    
    AbstractToolkit(d var_d) {
	((AbstractToolkit) this).aD4579 = var_d;
	int i = -1;
	for (int id = 0; id < 8; id++) {
	    if (!Class348_Sub40_Sub26.activeToolkits[id]) {
		Class348_Sub40_Sub26.activeToolkits[id] = true;
		i = id;
		break;
	    }
	}
	...
	((AbstractToolkit) this).id = i;
    }
    
    static {
	aClass351_4571 = new OutgoingPacket(73, -1);
    }
}
