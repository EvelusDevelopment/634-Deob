/* NativeRaster - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

final class NativeRaster extends RasterToolkit
{
    ...
    private NativeToolkit aHa_Sub3_8407;
	...
	int i_9_ = class348_sub49.getDWord();
	...
	if (Class156.method1241(i_93_, i, i_92_ ^ 0x1fe) | (0x10000 & i) != 0
	    || BufferedPacket.method3325(i, i_93_, true))
	    return true;
	if (i_92_ != -385)
	    return false;
    ...
    NativeRaster(NativeToolkit var_ha_Sub3, int i, int i_118_, boolean bool) {
	aBoolean8418 = false;
	anInt8400 = 0;
	anInt8417 = i_118_;
	anInt8411 = i;
    ...
    NativeRaster(NativeToolkit var_ha_Sub3, int i, int i_119_, int[] is, int i_120_,
		  int i_121_) {
	aBoolean8418 = false;
	anInt8400 = 0;
	try {
