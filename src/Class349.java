...
final class Class349
{
    ...
    private int[][][] anIntArrayArrayArray4300;
    static int[][] anIntArrayArray4301 = new int[2][8];
    private int[][][] anIntArrayArrayArray4302;
    static int anInt4303;
    private int[] anIntArray4304 = new int[2];
	...
	if (i != 0) {
		...
		for (int i_2_ = 0;
		     i_2_ < ((Class349) this).anIntArray4299[i_1_]; i_2_++) {
		...
		for (int i_4_ = 0;
		     i_4_ < ((Class349) this).anIntArray4299[i_3_]; i_4_++) {
	...
	float f_7_ = 32.703197F * (float) Math.pow(2.0, (double) f);
	...
	if (((Class349) this).anIntArray4299[i] == 0)
	    return 0;
	float f_11_ = method3449(i, 0, f);
	aFloatArrayArray4306[i][0]
	    = -2.0F * f_11_ * (float) Math.cos((double) method3447(i, 0, f));
	aFloatArrayArray4306[i][1] = f_11_ * f_11_;
	for (int i_12_ = 1; i_12_ < ((Class349) this).anIntArray4299[i];
	     i_12_++) {
	    f_11_ = method3449(i, i_12_, f);
	    float f_13_
		= (-2.0F * f_11_
		   * (float) Math.cos((double) method3447(i, i_12_, f)));
	...
	if (i == 0) {
	    for (int i_16_ = 0;
		 i_16_ < ((Class349) this).anIntArray4299[0] * 2; i_16_++)
		aFloatArrayArray4306[0][i_16_] *= aFloat4305;
	}
	for (int i_17_ = 0; i_17_ < ((Class349) this).anIntArray4299[i] * 2;
	     i_17_++)
	    anIntArrayArray4301[i][i_17_]
		= (int) (aFloatArrayArray4306[i][i_17_] * 65536.0F);
	return ((Class349) this).anIntArray4299[i] * 2;
    }
