...
final class Class342
{
    ...
    int anInt4244;
    int anInt4245;
    static LocationMode aClass364_4246 = new LocationMode("WTI", 5);
	...
	(Class323 class323, Class348_Sub21 class348_sub21, int i, int i_0_,
	 int i_1_, AbstractToolkit var_ha, int i_2_, int i_3_, Class42 class42) {
	try {
	    if (i_0_ == 64) {
		anInt4242++;
		int i_4_ = -5 + i - i_3_ / 2;
		...
		if ((((Class42) class42).anInt604 ^ 0xffffffff) != -1)
		    var_ha.method3668(i_3_ + 10, i_5_,
				      ((Class42) class42).anInt604, i_4_,
				      (i_1_ * class323.method2565() + i_2_
				       - (i_5_ + -1)),
				      92);
		int i_6_ = ((Class42) class42).anInt580;
		if (((Class348_Sub21) class348_sub21).aBoolean6848
		    && ((Class42) class42).anInt567 != -1)
		    i_6_ = ((Class42) class42).anInt567;
	...
	anInt4243++;
	return Class256.method1943(false, ((Class342) this).anInt4245);
    }
	...
	for (int i = Canvas_Sub1.anInt67; i < Class189.anInt2524; i++) {
		...
		for (int i_9_ = 0; i_9_ < Class348_Sub41.anInt7054; i_9_++) {
		    Class357 class357
			= Message.aClass357ArrayArrayArray2029[i][i_8_][i_9_];
		    if (class357 != null) {
			...
			if (class318_sub1_sub1 != null
			    ...
			    Deque.method1992(class318_sub1_sub1, i, i_8_,
						i_9_);
	...
	if (i < 61)
	    return null;
	return new Class342(((Class342) this).anInt4245, i_11_);
    }
    
    Class342(int i, int i_12_) {
	((Class342) this).anInt4245 = i;
	((Class342) this).anInt4244 = i_12_;
    }
    
    static {
	aClass70_4247 = new Class70();
	aClass60_4254 = new Cache(32);
    }
}
