...
final class Class286_Sub4 extends Class286
{
    ...
    static OutgoingPacket aClass351_6244 = new OutgoingPacket(9, 8);
	...
	for (int i_2_ = 0; i_2_ < Class75_Sub1.anInt5652 - 1; i_2_++) {
	    if (i < (AnimationDefinition.anIntArray256[i_2_]
	...
	if (aBoolean6237 && class258_sub2 != null) {
	    float f
		= 2.0F * (-Math.abs(((DirectxToolkit) ((Class286) this).aHa_Sub2_3684)
				    .aFloatArray7825[1])
			  + 1.0F) + 1.0F;
	    ((Class286) this).aHa_Sub2_3684.method3738(-15039, 1);
		...
		(OpenGL.glGetUniformLocationARB(l, "sunColour"),
		 ((DirectxToolkit) ((Class286) this).aHa_Sub2_3684).aFloat7781 * f,
		 ((DirectxToolkit) ((Class286) this).aHa_Sub2_3684).aFloat7816 * f,
		 ((DirectxToolkit) ((Class286) this).aHa_Sub2_3684).aFloat7823 * f,
		 1.0F);
	    OpenGL.glUniform1fARB
		(OpenGL.glGetUniformLocationARB(l, "sunExponent"),
		 64.0F + 928.0F * Math.abs(((DirectxToolkit)
    ...
    Class286_Sub4(DirectxToolkit var_ha_Sub2, Class83 class83) {
	super(var_ha_Sub2);
	aBoolean6233 = false;
	do {
	    try {
	...
	Class348_Sub15 class348_sub15
	    = ((Class348_Sub15)
	       Class27.aClass356_389.get((long) i));
