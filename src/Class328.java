...
class Class328
{
    ...
    static final Class39 method2608(OpenGlToolkit class377, byte[] is, int i,
				    int i_0_) {
	try {
	    anInt4099++;
    ...
    static final ClientScript getClientScript(int i, int i_2_) {
	anInt4101++;
	...
	byte[] is = Class113.indexLoader12.loadArchiveChild(-1860, i_2_, 0);
