...
final class Class348_Sub42_Sub11 extends SubNode
{
    ...
    static OutgoingPacket aClass351_9590 = new OutgoingPacket(83, -1);
    ...
    final void method3221(int i, ByteBuffer class348_sub49) {
	int i_0_ = 81 / ((-39 - i) / 52);
	anInt9583++;
	for (;;) {
	...
	if (((Class348_Sub51) BitmapTable.aClass348_Sub51_3959)
		...
		for (int i_9_ = 0; (i_9_ ^ 0xffffffff) > -3; i_9_++) {
		    ...
		    AnimatableToolkit.anIntArray1127[i_9_] = 1000000;
		    LoadingStage.anIntArray1045[i_9_] = 0;
		}
    ...
    private final void method3227(int i, ByteBuffer class348_sub49,
				  int i_24_) {
	if ((i_24_ ^ 0xffffffff) != -2) {
		...
		for (int i_29_ = 0;
			...
			= class348_sub49.getShort();
		    byte i_30_ = class348_sub49.getByte();
