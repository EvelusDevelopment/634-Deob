...
final class Class288_Sub1 extends Class288
{
    ...
    Class288_Sub1(int i, Class221 class221, Class341 class341, int i_0_,
		  int i_1_, int i_2_) {
    ...
    static final Class288 method2189(ByteBuffer class348_sub49, int i) {
	anInt8576++;
	int i_3_ = class348_sub49.getShort();
	Class221 class221
	    = Class158.method1248(48)[class348_sub49.getUByte()];
	Class341 class341
