...
{
    private IndexLoader aClass45_2498;
    static int anInt2499;
    static int anInt2500;
    private Cache aClass60_2501 = new Cache(64);
	...
	synchronized (aClass45_2498) {
	    is = aClass45_2498.loadArchiveChild(-1860, 35, i_3_);
	}
	class321 = new Class321();
	if (is != null)
	    class321.initialize(-125, new ByteBuffer(is));
	if (i != -12637)
	    aClass60_2501 = null;
    ...
    Class187(GameMode class230, int i, IndexLoader class45) {
	do {
	    try {
