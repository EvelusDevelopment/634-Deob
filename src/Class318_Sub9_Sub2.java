...
class Class318_Sub9_Sub2 extends Class318_Sub9
{
    ...
    static final void method2519(Class318_Sub1 class318_sub1, int i, int i_0_,
	...
	for (int i_8_ = i; i_8_ <= i + 1; i_8_++) {
		...
		for (int i_9_ = i_4_; i_9_ <= i_5_; i_9_++) {
			...
			for (int i_10_ = i_6_; i_10_ <= i_7_; i_10_++) {
			    if (i_10_ >= 0 && i_10_ < Class348_Sub41.anInt7054
				...
				if (class357 != null) {
				    int i_11_
					= (((aa_Sub1.aSArray5191[i_8_]
						 .method3982
					     ((byte) -86, i_10_, i_9_))
					    + (aa_Sub1.aSArray5191[i_8_]
						   .method3982
					       ((byte) -86, i_10_, i_9_ + 1))
					    + (aa_Sub1.aSArray5191[i_8_]
						   .method3982
					       ((byte) -86, i_10_ + 1, i_9_))
					    + (aa_Sub1.aSArray5191[i_8_]
						   .method3982
					       ((byte) -86, i_10_ + 1,
						i_9_ + 1))) / 4
					...
					class318_sub1.method2380
						 ...
						 * (Class348_Sub23_Sub2
						    .anInt9037))));
				    if (class318_sub1_sub4_12_ != null
					&& class318_sub1_sub4_12_
					       .method2388(-100))
					class318_sub1.method2380
					    (Class9.aHa171, i_11_, bool,
					     class318_sub1_sub4_12_,
