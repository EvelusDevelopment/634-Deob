...
final class Class233
{
    ...
    private FloatBuffer aClass348_Sub49_Sub1_3020;
    static int anInt3021;
    static Queue aClass107_3022 = new Queue();
    static int anInt3023;
    private float[] aFloatArray3024 = new float[16];
    ...
    private Class318_Sub9_Sub2[][] aClass318_Sub9_Sub2ArrayArray3030;
    private Class318_Sub9_Sub2[][] aClass318_Sub9_Sub2ArrayArray3031;
    private int[] anIntArray3032;
    private int[] anIntArray3033;
    private int anInt3034;
    private int[] anIntArray3035;
    
    private final void method1649(DirectxToolkit var_ha_Sub2, int i, int i_0_) {
	anInt3019++;
	Class86.aFloat1478 = ((DirectxToolkit) var_ha_Sub2).aFloat7768;
	if (i_0_ != 24484)
    ...
    private final void method1650(DirectxToolkit var_ha_Sub2, byte i) {
	...
	if (Class86.aFloat1478 != ((DirectxToolkit) var_ha_Sub2).aFloat7768)
	    var_ha_Sub2.xa(Class86.aFloat1478);
    }
    
    final void method1651(DirectxToolkit var_ha_Sub2, byte i, int i_1_,
			  Class98 class98) {
	try {
	    anInt3017++;
	    if (((DirectxToolkit) var_ha_Sub2).aClass101_Sub3_7760 != null) {
		if (i_1_ >= 0)
		    method1649(var_ha_Sub2, i_1_, 24484);
		else
		    method1652(false, var_ha_Sub2);
		float f = (((Class101_Sub3)
			    ((DirectxToolkit) var_ha_Sub2).aClass101_Sub3_7760)
			   .aFloat5756);
		float f_2_ = (((Class101_Sub3)
			       ((DirectxToolkit) var_ha_Sub2).aClass101_Sub3_7760)
			      .aFloat5754);
		float f_3_ = (((Class101_Sub3)
			       ((DirectxToolkit) var_ha_Sub2).aClass101_Sub3_7760)
			      .aFloat5784);
		float f_4_ = (((Class101_Sub3)
			       ((DirectxToolkit) var_ha_Sub2).aClass101_Sub3_7760)
			      .aFloat5751);
		try {
		    int i_5_ = 0;
		    ...
		    for (Class318_Sub9 class318_sub9_8_
			 ...
			 class318_sub9_8_ = (((Class318_Sub9) class318_sub9_8_)
					     .aClass318_Sub9_6469)) {
			...
			for (/**/; class318_sub9 != class318_sub9_12_;
				...
				i_13_ = ((Class318_Sub9_Sub2)
					 class318_sub9_sub2).anInt8792;
				bool_14_ = false;
			    }
			...
			if (!bool || (Class86.aFloat1478
				      == ((DirectxToolkit) var_ha_Sub2).aFloat7768)) {
			    if (((DirectxToolkit) var_ha_Sub2).aFloat7768 != 1.0F)
				var_ha_Sub2.xa(1.0F);
			} else
			    var_ha_Sub2.xa(Class86.aFloat1478);
    ...
    private final void method1652(boolean bool, DirectxToolkit var_ha_Sub2) {
	Class86.aFloat1478 = ((DirectxToolkit) var_ha_Sub2).aFloat7768;
	anInt3021++;
    ...
    final void method1654(int i, DirectxToolkit var_ha_Sub2) {
	if (i == 643267468) {
	    anInt3023++;
	    anInterface2_3027
    ...
    private final void method1655(DirectxToolkit var_ha_Sub2, int i, int i_18_) {
	anInt3018++;
	if (i_18_ == 785980556) {
	    ...
	    ((ByteBuffer) aClass348_Sub49_Sub1_3020).position = 0;
	    float f_32_ = -f_20_ + f_23_;
	    if (!((DirectxToolkit) var_ha_Sub2).aBoolean7775) {
		for (int i_33_ = -1 + i; i_33_ >= 0; i_33_--) {
			...
			for (int i_35_ = -1 + i_34_;
			    ...
			    aClass348_Sub49_Sub1_3020.putByte(i_37_);
			    aClass348_Sub49_Sub1_3020.putByte(i_38_);
			    aClass348_Sub49_Sub1_3020.putByte(i_39_);
			    aClass348_Sub49_Sub1_3020.putByte(i_40_);
			...
			if (anIntArray3033[i_33_] > 64) {
				...
				aClass348_Sub49_Sub1_3020.putByte(i_48_);
				aClass348_Sub49_Sub1_3020.putByte(i_49_);
				aClass348_Sub49_Sub1_3020.putByte(i_50_);
				aClass348_Sub49_Sub1_3020.putByte(i_51_);
				aClass348_Sub49_Sub1_3020.method3399(18291,
								     1.0F);
				aClass348_Sub49_Sub1_3020.method3399(18291,
								     0.0F);
		...
		for (int i_56_ = i - 1; i_56_ >= 0; i_56_--) {
			...
			for (int i_58_ = -1 + i_57_;
			    ...
			    aClass348_Sub49_Sub1_3020.putByte(i_60_);
			    aClass348_Sub49_Sub1_3020.putByte(i_61_);
			    aClass348_Sub49_Sub1_3020.putByte(i_62_);
			    aClass348_Sub49_Sub1_3020.putByte(i_63_);
			...
			if ((anIntArray3033[i_56_] ^ 0xffffffff) < -65) {
				...
				aClass348_Sub49_Sub1_3020.method3400
				    (f_77_ + f_26_ * (float) -i_78_,
				     (byte) -79);
				aClass348_Sub49_Sub1_3020.putByte(i_71_);
				aClass348_Sub49_Sub1_3020.putByte(i_72_);
				aClass348_Sub49_Sub1_3020.putByte(i_73_);
				aClass348_Sub49_Sub1_3020.putByte(i_74_);
				aClass348_Sub49_Sub1_3020
	    ...
	    if ((((ByteBuffer) aClass348_Sub49_Sub1_3020).position
		 ^ 0xffffffff)
		!= -1) {
		anInterface2_3027.method11
		    (24,
		     ((ByteBuffer) aClass348_Sub49_Sub1_3020).position,
		     (((ByteBuffer) aClass348_Sub49_Sub1_3020)
		      .payload),
		     -9894);
		var_ha_Sub2.method3794(aClass123_3029, aClass123_3028,
				       i_18_ + -786006967, aClass123_3025,
				       null);
		var_ha_Sub2.method3756((((ByteBuffer)
					 aClass348_Sub49_Sub1_3020).position
					/ 24),
				       7, 0, 120);
	    }
	}
    ...
    Class233() {
	aClass348_Sub49_Sub1_3020 = new FloatBuffer(786336);
