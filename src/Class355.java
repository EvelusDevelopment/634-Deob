...
final class Class355
{
	...
	if ((i ^ 0xffffffff) <= -32769)
	    is = aClass45_4369.loadArchiveChild(-1860, 1, 0x7fff & i);
	else
	    is = aClass45_4368.loadArchiveChild(-1860, 1, i);
	class348_sub42_sub10 = new Class348_Sub42_Sub10();
	((Class348_Sub42_Sub10) class348_sub42_sub10).aClass355_9567 = this;
	if (is != null)
	    class348_sub42_sub10.method3218(new ByteBuffer(is), 0);
	if (i_0_ >= -86)
	    method3473(-12);
	if ((i ^ 0xffffffff) <= -32769)
    ...
    Class355(int i, IndexLoader class45, IndexLoader class45_1_,
	     Interface15 interface15) {
	((Class355) this).anInt4364 = 0;
	aClass60_4362 = new Cache(64);
