...
final class Class348_Sub40_Sub23 extends Class348_Sub40
{
	...
	while_195_:
		...
		while_193_:
			...
			while_191_:
			    ...
			    anInt9323 = class348_sub49.getShort();
			    return;
			} while (false);
			anInt9311 = class348_sub49.getShort();
			return;
		    } while (false);
		    anInt9312 = class348_sub49.getUByte();
		    return;
		} while (false);
		anInt9314 = class348_sub49.getShort();
		return;
	    } while (false);
	    anInt9310 = class348_sub49.getShort();
	} while (false);
    }
	...
	try {
	    ...
	    int i_6_ = ((anInt9310 ^ 0xffffffff) >= -1 ? 4096
			: 4096 - Model.method1097((byte) 117, anInt9310,
						     random));
	    int i_7_ = 88 % ((i - 57) / 55);
		...
		= (anInt9306
		   - ((i_8_ ^ 0xffffffff) < -1
		      ? Model.method1097((byte) 82, i_8_, random) : 0));
    ...
    static final String[] split(char c, String string) {
	anInt9315++;
	int i = Class15.getNumOfChar(4, string, c);
	...
	if (((Class191) ((Class348_Sub40) this).aClass191_7032).aBoolean2570) {
	    ...
	    Random random = new Random((long) anInt9318);
	    for (;;) {
		int i_58_ = i_51_ + Model.method1097((byte) 106,
							i_52_ - i_51_, random);
		int i_59_
		    = (Model.method1097((byte) 117, -i_53_ + i_54_, random)
		       + i_53_);
		...
		if ((Class348_Sub40_Sub6.anInt9139 ^ 0xffffffff)
		    ...
		    i_45_ = i_44_;
		    i_50_ = 0;
		    i_44_ = Model.method1097((byte) 113,
