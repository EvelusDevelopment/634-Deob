...
final class Class151
{
    ...
    static IncomingPacket aClass114_2068 = new IncomingPacket(68, 6);
    byte[] aByteArray2069;
    ...
    static final void method1211(int i, RasterToolkit class105, int i_2_,
				 Widget class46, aa var_aa, int i_3_,
				 int i_4_, int i_5_) {
	try {
	    anInt2064++;
	    if (class105 != null) {
		...
		if (Class348_Sub40_Sub21.anInt9282 != 4)
		    i_6_ = (0x3fff
			    & (int) AbtractArchiveLoader.aFloat3938 - -r_Sub2.anInt10483);
		else
		    i_6_ = 0x3fff & (int) AbtractArchiveLoader.aFloat3938;
		int i_7_ = 10 + Math.max(((Widget) class46).anInt709 / 2,
					 ((Widget) class46).anInt789 / i_4_);
		int i_8_ = i_5_ * i_5_ - -(i_3_ * i_3_);
		if (i_7_ * i_7_ >= i_8_) {
		    int i_9_ = Class70.sineTable[i_6_];
		    int i_10_ = Class70.cosineTable[i_6_];
		    if (Class348_Sub40_Sub21.anInt9282 != 4) {
			i_10_ = 256 * i_10_ / (FloatBuffer.anInt9750
					       - -256);
			i_9_ = i_9_ * 256 / (FloatBuffer.anInt9750
					     - -256);
		    }
