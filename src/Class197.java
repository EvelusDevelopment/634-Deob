...
final class Class197
{
    ...
    final void method1452(ByteBuffer class348_sub49) {
	((Class197) this).anInt2603 = class348_sub49.getUByte();
	((Class197) this).anInt2607 = class348_sub49.getDWord();
	((Class197) this).anInt2606 = class348_sub49.getDWord();
    ...
    final void method1454(ByteBuffer class348_sub49) {
	anInt2604 = class348_sub49.getUByte();
	anIntArray2605 = new int[anInt2604];
	anIntArray2602 = new int[anInt2604];
	for (int i = 0; i < anInt2604; i++) {
	    anIntArray2605[i] = class348_sub49.getShort();
	    anIntArray2602[i] = class348_sub49.getShort();
	}
    }
}
