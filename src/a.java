...
final class a implements ModelToolkit
{
    private i anI5105;
    long nativeid;
    private i anI5106;
    ...
    final boolean method143(AnimatableToolkit class64, int i, int i_4_,
    ...
    final void method144(AnimatableToolkit class64, AnimatableToolkit class64_6_, int i, int i_7_,
    ...
    final void method145(AnimatableToolkit class64, Class101 class101, int[] is, int i) {
    ...
    final boolean method146(AnimatableToolkit class64, int i, int i_15_,
    ...
    final void method149(AnimatableToolkit class64, Class101 class101, int[] is, int i,
			 int i_24_) {
	f(((a) this).nativeid, ((i) (i) class64).nativeid,
	  ((ja) (ja) class101).nativeid, is, i, i_24_);
    }
    
    private final native void na(long l, AbstractToolkit var_ha, int i, int i_25_,
				 int i_26_, int i_27_, int i_28_, int i_29_,
				 int i_30_);
    
    private final native void O(long l, AbstractToolkit var_ha, int[] is, int[] is_31_,
				int[] is_32_, short[] is_33_, int i);
    
    final void method150(AbstractToolkit var_ha, int i, int i_34_, int i_35_, int i_36_,
    ...
    final void method151(AnimatableToolkit class64, int[] is, Class101 class101) {
    ...
    final void method155(AbstractToolkit var_ha, int[] is, int[] is_64_, int[] is_65_,
			 short[] is_66_, int i) {
	O(((a) this).nativeid, var_ha, is, is_64_, is_65_, is_66_, i);
    }
    
    private final native void HA(long l, AbstractToolkit var_ha, int i, int i_67_);
    ...
    a(SafeToolkit var_oa, int i, int i_68_) {
	anOa5115 = var_oa;
