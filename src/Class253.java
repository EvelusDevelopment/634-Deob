...
final class Class253
{
    ...
    final void method1921(byte i, ByteBuffer class348_sub49) {
	if (i != -69)
	    method1923(-117, -120, null);
	anInt3255++;
	for (;;) {
    ...
    static final void method1922(String string, int i, String string_12_,
				 boolean bool) {
	try {
	    if (bool == true) {
		anInt3247++;
    ...
    private final void method1923(int i, int i_13_,
	...
	if (i_13_ == 4) {
		...
		((Class253) this).anInt3245 = class348_sub49.getUByte();
	}
    }
