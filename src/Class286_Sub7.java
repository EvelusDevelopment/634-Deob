...
{
    static IndexLoader indexLoader32_34;
    private Class83 aClass83_6278;
	...
	if (string != null) {
		...
		for (int i = 0;
			...
			for (int i_2_ = i;
			    ...
			    AbstractToolkit.anIntArray4578[i_2_]
				= AbstractToolkit.anIntArray4578[i_2_ - -1];
			...
			BufferedPacket class348_sub47
			    = Class286_Sub3.createBufferedPacket(Class357.aClass351_4394,
						       (Class348_Sub23_Sub2
							.outgoingGameIsaac));
			((BufferedPacket) class348_sub47)
			    .buffer.putByte
	...
	if ((0x1 & i) == 1) {
	    if (!((Class83) aClass83_6278).aBoolean1442) {
		int i_5_
		    = (16
		...
		((Class286) this).aHa_Sub2_3684.method3771
		    ((byte) -95,
		     ((Class83) aClass83_6278).aClass258_Sub3Array1444[i_5_]);
	    } else {
		((Class286) this).aHa_Sub2_3684.method3771
		    ((byte) -83,
		     ((Class83) aClass83_6278).aClass258_Sub1_1440);
		IntergerVarScriptSettingDefinition.aFloatArray2131[2] = 0.0F;
		IntergerVarScriptSettingDefinition.aFloatArray2131[3]
		    = (float) ((((DirectxToolkit) ((Class286) this).aHa_Sub2_3684)
				.anInt7735)
			       % 4000) / 4000.0F;
		IntergerVarScriptSettingDefinition.aFloatArray2131[0] = 0.0F;
		IntergerVarScriptSettingDefinition.aFloatArray2131[1] = 0.0F;
		OpenGL.glTexGenfv(8194, 9473, IntergerVarScriptSettingDefinition.aFloatArray2131, 0);
	    }
	} else if (!((Class83) aClass83_6278).aBoolean1442)
	    ((Class286) this).aHa_Sub2_3684.method3771
		((byte) -110,
		 ((Class83) aClass83_6278).aClass258_Sub3Array1444[0]);
	else {
	    ...
	    IntergerVarScriptSettingDefinition.aFloatArray2131[2] = 0.0F;
	    IntergerVarScriptSettingDefinition.aFloatArray2131[1] = 0.0F;
	    IntergerVarScriptSettingDefinition.aFloatArray2131[3] = 0.0F;
	    OpenGL.glTexGenfv(8194, 9473, IntergerVarScriptSettingDefinition.aFloatArray2131, 0);
	}
	anInt6291++;
    }
	...
	if (((DirectxToolkit) ((Class286) this).aHa_Sub2_3684).anInt7782 > 0) {
	    float f
		= -0.5F / (float) (((DirectxToolkit) ((Class286) this).aHa_Sub2_3684)
				   .anInt7782);
	    ((Class286) this).aHa_Sub2_3684.method3738(-15039, 1);
	    IntergerVarScriptSettingDefinition.aFloatArray2131[3]
		= 0.25F + (((DirectxToolkit) ((Class286) this).aHa_Sub2_3684)
			   .aFloat7792) * f;
	    IntergerVarScriptSettingDefinition.aFloatArray2131[0] = 0.0F;
	    IntergerVarScriptSettingDefinition.aFloatArray2131[2] = f;
	    IntergerVarScriptSettingDefinition.aFloatArray2131[1] = 0.0F;
	    OpenGL.glPushMatrix();
	    OpenGL.glLoadIdentity();
	    OpenGL.glTexGenfv(8192, 9474, IntergerVarScriptSettingDefinition.aFloatArray2131, 0);
	    OpenGL.glPopMatrix();
	    ((Class286) this).aHa_Sub2_3684.method3744
		((float) ((DirectxToolkit) ((Class286) this).aHa_Sub2_3684).anInt7782,
		 770, 0.5F);
	    ((Class286) this).aHa_Sub2_3684.method3771((byte) -99,
						       aClass258_Sub4_6285);
	...
	aClass61_6284 = new Class61(((Class286) this).aHa_Sub2_3684, 2);
	anInt6283++;
	aClass61_6284.method595((byte) 109, 0);
	((Class286) this).aHa_Sub2_3684.method3738(i + 6366, 1);
	((Class286) this).aHa_Sub2_3684.method3729(7681, (byte) 98, 260);
	((Class286) this).aHa_Sub2_3684.method3762(34168, 768, (byte) -87, 0);
    ...
    Class286_Sub7(DirectxToolkit var_ha_Sub2, Class83 class83) {
	super(var_ha_Sub2);
	try {
	    aClass83_6278 = class83;
	    method2167(-21405);
	    aClass258_Sub4_6285
		= new Class258_Sub4(((Class286) this).aHa_Sub2_3684, 6406, 2,
				    new byte[] { 0, -1 }, 6406);
	...
	Class357 class357
	    = Message.aClass357ArrayArrayArray2029[i][i_7_][i_8_];
	if (class357 != null) {
	    Class183
		.method1376(((Class357) class357).aClass318_Sub1_Sub5_4395);
	    Class183
		.method1376(((Class357) class357).aClass318_Sub1_Sub5_4407);
	    if (((Class357) class357).aClass318_Sub1_Sub5_4395 != null)
		((Class357) class357).aClass318_Sub1_Sub5_4395 = null;
	    if (((Class357) class357).aClass318_Sub1_Sub5_4407 != null)
		((Class357) class357).aClass318_Sub1_Sub5_4407 = null;
	}
    }
	...
	anInt6282++;
	if ((((DirectxToolkit) ((Class286) this).aHa_Sub2_3684).anInt7782
	     ^ 0xffffffff)
	    < -1) {
	    ((Class286) this).aHa_Sub2_3684.method3738(-15039, 1);
	    ((Class286) this).aHa_Sub2_3684.method3771((byte) -115, null);
	    ((Class286) this).aHa_Sub2_3684.method3744(0.0F, 770, 1.0F);
	    ((Class286) this).aHa_Sub2_3684.method3738(-15039, 0);
	}
	if (i > -75)
	    aClass258_Sub4_6285 = null;
	((Class286) this).aHa_Sub2_3684.method3729(8448, (byte) 102, 8448);
	OpenGL.glMatrixMode(5890);
	OpenGL.glPopMatrix();
	OpenGL.glMatrixMode(5888);
    }
	...
	((Class286) this).aHa_Sub2_3684.method3729(260, (byte) -94, 8448);
	anInt6279++;
