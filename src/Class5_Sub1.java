...
class Class5_Sub1 extends Class5
{
    ...
    private RasterToolkit aClass105_8338;
    private RasterToolkit aClass105_8339;
    static int anInt8340;
    static int anInt8341;
    private RasterToolkit aClass105_8342;
    private RasterToolkit aClass105_8343;
    static Class221 aClass221_8344;
    static int anInt8345;
    static int anInt8346;
    private RasterToolkit aClass105_8347;
    static int anInt8348;
    static int lobbyUnknown;
    RasterToolkit aClass105_8350;
    static int anInt8351;
    static int anInt8352 = 0;
    
    Class5_Sub1(IndexLoader class45, IndexLoader class45_0_,
		Class369_Sub3 class369_sub3) {
	super(class45, class45_0_, (Class369) class369_sub3);
    }
	...
	if (i != 1084489728)
	    method189((byte) 33);
	return (new int[]
		{ LoadingStage.p11fullArchiveId, AnimationDefinition.p12fullArchiveId, IndexTable.b12fullArchiveId });
    }
    
    public final boolean method8(byte i) {
	anInt8351++;
	if (!super.method8((byte) -125))
	    return false;
	Class369_Sub3 class369_sub3
	...
	((Class5_Sub1) this).aClass105_8350.method972(i_5_, i, i_6_, i_3_);
	anInt8341++;
	if (i_4_ <= 21)
	    method8((byte) 68);
    }
    
    static final boolean method187
	(int i, int i_7_, int i_8_, int i_9_, int i_10_, int i_11_,
	 Class361 class361, int i_12_, int i_13_, int i_14_, int i_15_) {
	anInt8348++;
	int i_16_ = i_14_;
	int i_17_ = i_8_;
	int i_18_ = 64;
	...
	while (i_22_ != i_23_) {
	    ...
	    int i_24_ = -((Class361) class361).anInt4441 + i_17_;
	    i_18_ = -i_20_ + i_16_;
	    i_19_ = i_17_ - i_21_;
	    int i_25_ = i_16_ + -((Class361) class361).anInt4453;
	    i_23_ = 0xfff & 1 + i_23_;
	    int i_26_ = i_12_;
	while_3_:
	    do {
		...
		while_1_:
			...
			do {
			    ...
			    if (class361.method3497(-28388, i, i_10_, 1, i_13_,
						    i_16_, 1, i_17_, i_7_,
						    i_11_)) {
				Class115.anInt1753 = i_17_;
				Class348_Sub40_Sub30.anInt9388 = i_16_;
			...
			if (class361.method3503(i_16_, (byte) 110, i_7_, 1,
						i_13_, i_11_, i_10_, i_17_,
						i)) {
			    Class348_Sub40_Sub30.anInt9388 = i_16_;
			    Class115.anInt1753 = i_17_;
			    return true;
		    ...
		    if (class361.method3495(i, i_17_, 1, i_9_, i_16_, i_7_,
					    i_12_, 91)) {
			Class115.anInt1753 = i_17_;
			Class348_Sub40_Sub30.anInt9388 = i_16_;
			return true;
		...
		if (class361.method3504(i_7_, i_17_, i, i_16_, i_12_, 1, i_9_,
					1)) {
		    Class348_Sub40_Sub30.anInt9388 = i_16_;
		    Class115.anInt1753 = i_17_;
		    return true;
	...
	if (bool) {
		...
		(i, i_28_,
		 i - -((Class369) ((Class5) this).aClass369_4635).anInt4971,
		 (i_28_
	    ...
	    aClass105_8342.method974(i,
				     i_28_ - -(((((Class369) (((Class5) this)
							      .aClass369_4635))
						 .anInt4963)
						+ -i_30_)
					       / 2));
	    aClass105_8339.method974
		((((Class369) ((Class5) this).aClass369_4635).anInt4971
		  + (i + -i_31_)),
		 i_28_ + (((Class369) ((Class5) this).aClass369_4635).anInt4963
			  + -i_32_) / 2);
	    Class348_Sub8.currentToolkit.setDimensions(i, i_28_,
				     (((Class369) (((Class5) this)
						   .aClass369_4635)).anInt4971
				      + i),
				     i_28_ - -aClass105_8343.method980());
	    aClass105_8343.method972(i + i_29_, i_28_,
				     -i_29_ + (((Class369)
						((Class5) this).aClass369_4635)
					       .anInt4971) - i_31_,
				     ((Class369) (((Class5) this)
						  .aClass369_4635)).anInt4963);
	    int i_33_ = aClass105_8338.method980();
	    Class348_Sub8.currentToolkit.setDimensions
		(i,
		 (-i_33_ + i_28_
		  - -((Class369) ((Class5) this).aClass369_4635).anInt4963),
		 ((Class369) ((Class5) this).aClass369_4635).anInt4971 + i,
		 (i_28_
		  + ((Class369) ((Class5) this).aClass369_4635).anInt4963));
	    aClass105_8338.method972
		(i_29_ + i,
		 (-i_33_ + i_28_
		  + ((Class369) ((Class5) this).aClass369_4635).anInt4963),
		 (-i_29_
    ...
    static final HandshakePacket[] getHandshakePackets(byte i) {
	anInt8345++;
	int i_34_ = -7 / ((-67 - i) / 44);
	return (new HandshakePacket[]
		{ Class178.aClass29_2339, Class178.js5initialPacket,
		  Class178.aClass29_2342, Class178.aClass29_2343,
		  Class178.aClass29_2344, Class178.aClass29_2345,
		  Class178.aClass29_2346, Class178.aClass29_2347,
		  Class178.aClass29_2348, Class178.aClass29_2349,
		  Class178.aClass29_2350, Class178.aClass29_2351,
		  Class178.aClass29_2352, Class178.aClass29_2353 });
    }
	...
	int i_39_ = (((Class369) ((Class5) this).aClass369_4635).anInt4971
		     + (i_36_ + -aClass105_8339.method966()));
	int i_40_ = i_35_ - -aClass105_8343.method980();
	int i_41_
	    = (i_35_ + ((Class369) ((Class5) this).aClass369_4635).anInt4963
	       - aClass105_8338.method980());
	int i_42_ = -i_38_ + i_39_;
	int i_43_ = -i_40_ + i_41_;
	int i_44_ = this.method183(124) * i_42_ / 10000;
	int[] is = new int[4];
	Class348_Sub8.currentToolkit.getDimensions(is);
	Class348_Sub8.currentToolkit.setDimensions(i_38_, i_40_, i_44_ + i_38_, i_41_);
	method186(i_40_, i_43_, (byte) 33, i_38_, i_42_);
	Class348_Sub8.currentToolkit.setDimensions(i_44_ + i_38_, i_40_, i_39_, i_41_);
	...
	Class369_Sub3 class369_sub3
	    = (Class369_Sub3) ((Class5) this).aClass369_4635;
	((Class5_Sub1) this).aClass105_8350
	    = Class369_Sub3_Sub1.method3577((((Class369_Sub3) class369_sub3)
					     .anInt8599),
					    (byte) -19,
