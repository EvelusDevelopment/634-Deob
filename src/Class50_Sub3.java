...
final class Class50_Sub3 extends Class50
{
	...
	if (i != -1636518164)
	    anInt5252 = -40;
	Class158.aClass356_4934.removeAll(0);
	anInt5251++;
	Class348_Sub42_Sub9_Sub1.aClass356_10442.removeAll(0);
    }
	...
	try {
	    anInt5238++;
	    if (!Class5_Sub1.aBoolean8335 && FileArchiveTracker.anInt4776 < 500) {
		...
		Class348_Sub42_Sub12 class348_sub42_sub12
		    = new Class348_Sub42_Sub12(string_6_, string, i_8_, i_5_,
					       ...
					       bool, l, bool_1_);
		DirectxToolkit.method3743((byte) 6, class348_sub42_sub12);
	    }
    ...
    static final void method467(int id, int value) {
        anInt5248++;
        WidgetVariable class348_sub42_sub15 = Class318_Sub9_Sub1.method2516(id, (byte) 105, 1);
        class348_sub42_sub15.method3246(-25490);
        ((WidgetVariable) class348_sub42_sub15).intArg = value;
    }
