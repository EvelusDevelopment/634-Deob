...
final class Class348_Sub3 extends Node
{
    ...
    static IncomingPacket currentIncomingPacket = null;
    static int anInt6585;
    static float aFloat6586;
    static int anInt6587;
    static int anInt6588;
    int anInt6589 = 0;
    private NativeToolkit aHa_Sub3_6590;
	...
	if (buffer != null) {
		...
		aHa_Sub3_6590.method3814((((s_Sub3) aS_Sub3_6566).anInt8294
					 ...
					 (byte) 48);
		if (((NativeToolkit) aHa_Sub3_6590).aBoolean8160)
	...
	Class348_Sub40_Sub13.aClass262_9201.removeAll(98);
	anInt6579++;
	...
	if ((((Class348_Sub3) this).anInt6567 ^ 0xffffffff) != 0) {
		...
		= ((AbstractToolkit) aHa_Sub3_6590).aD4579
		      .getTexture(((Class348_Sub3) this).anInt6567, -6662);
	    int i_27_ = ((TextureDefinition) class12).aByte201 & 0xff;
	    if ((i_27_ ^ 0xffffffff) != -1
		&& ((TextureDefinition) class12).aByte213 != 4) {
		int i_28_;
	    ...
	    int i_31_ = 0xff & ((TextureDefinition) class12).aByte216;
	...
	if (i_24_ != 1624)
	    createKeyboardListener(null, (byte) 67);
	if (((NativeToolkit) aHa_Sub3_6590).anInt8178 == 0) {
    ...
    static final AbstractKeyboardListener createKeyboardListener(Component component, byte i) {
	anInt6587++;
	int i_41_ = -16 % ((i - -58) / 63);
	return new KeyboardListener(component);
    }
