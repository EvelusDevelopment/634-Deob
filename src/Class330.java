...
final class Class330
{
    ...
    private NativeToolkit aHa_Sub3_4111;
    byte[] aByteArray4112;
    int anInt4113;
    ...
    static IncomingPacket aClass114_4126 = new IncomingPacket(5, 6);
    ...
    final void method2630(int i, int i_24_, int i_25_, boolean bool,
			  boolean[][] bools, int i_26_) {
	anInt4115++;
	...
	float f = 1.0F / (float) (((NativeToolkit) aHa_Sub3_4111).anInt8125 * i);
	if (bool) {
	    for (int i_27_ = 0;
		...
		for (int i_30_ = 0; anInt4121 > i_30_; i_30_++) {
			...
			for (int i_33_ = i_31_; i_33_ < i_32_; i_33_++) {
				...
				for (int i_34_ = i_28_;
					...
					&& i_24_ >= -i_26_ + i_34_
					&& (bools[i_24_ + (-i_25_ + i_33_)]
					    [-i_26_ + i_34_ + i_24_])) {
					Class101_Sub2 class101_sub2
					    = aHa_Sub3_4111.method3820(false);
					class101_sub2.method932(1.0F, f, f,
								(byte) -65);
					class101_sub2.method891(-i_30_, -i_27_,
								0);
					aHa_Sub3_4111.method3853
					    (i ^ ~0x9f,
					     Class239_Sub18.aClass251_6030);
					aClass97ArrayArray4122[i_30_]
					    [i_27_].method871((byte) 116);
					break while_119_;
				    }
				}
			    }
		...
		for (int i_38_ = 0; i_38_ < anInt4121; i_38_++) {
			...
			if (buffer != null) {
			    Stream stream
				= aHa_Sub3_4111.method3893(buffer, 9179);
			    int i_39_ = 0;
				...
				aHa_Sub3_4111.method3853(i ^ ~0x9f,
							 (Class239_Sub18
							  .aClass251_6030));
				class97.method875(-82, interface5_impl2,
						  i_39_ / 3);
			    }
			}
		    }
    ...
    private final void method2634(int i, int i_62_, int i_63_, int i_64_,
				  int i_65_) {
	anInt4110++;
    ...
    Class330(NativeToolkit var_ha_Sub3, s_Sub3 var_s_Sub3) {
	try {
