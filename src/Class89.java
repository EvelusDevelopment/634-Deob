...
final class Class89
{
    private OpenGlToolkit aClass377_1506;
    ...
    static final void method849(int i, int i_0_, int i_1_, int i_2_, int i_3_,
				int i_4_, int i_5_) {
	anInt1511++;
	if (i_4_ <= 80)
	    method851(-7);
	...
	for (int i_8_ = i_0_; i_8_ < i_6_; i_8_++)
	    Class135_Sub2.method1156(-27, i_2_,
				     AnimationDefinition.anIntArrayArray255[i_8_], i_1_,
				     i_5_);
	int i_9_ = -i + i_2_;
	for (int i_10_ = i_3_; (i_7_ ^ 0xffffffff) > (i_10_ ^ 0xffffffff);
	     i_10_--)
	    Class135_Sub2.method1156(-27, i_2_,
				     AnimationDefinition.anIntArrayArray255[i_10_], i_1_,
				     i_5_);
	int i_11_ = i + i_1_;
	for (int i_12_ = i_6_; (i_12_ ^ 0xffffffff) >= (i_7_ ^ 0xffffffff);
	     i_12_++) {
	    int[] is = AnimationDefinition.anIntArrayArray255[i_12_];
	...
	anInt1509++;
	aClass377_1506.method3966(((Class89) this).aLong1510, 34192);
	super.finalize();
    }
	...
	for (int i_17_ = ((Class318_Sub1_Sub3) class318_sub1_sub3).aShort8743;
		...
		if (class357 != null) {
		    Class148 class148
			= InputstreamWorker.method3620(class318_sub1_sub3, 118);
		    Class148 class148_19_
			= ((Class357) class357).aClass148_4396;
		    if (class148_19_ == null)
			((Class357) class357).aClass148_4396 = class148;
		    else {
			for (/**/;
			     ((Class148) class148_19_).aClass148_2038 != null;
			     class148_19_
				 = ((Class148) class148_19_).aClass148_2038) {
			    /* empty */
			}
			((Class148) class148_19_).aClass148_2038 = class148;
		    }
		    if (bool_13_ && (Class342.anIntArrayArray4253[i_17_][i_18_]
				     & ~0xffffff) != 0) {
			i = Class342.anIntArrayArray4253[i_17_][i_18_];
			i_14_
			    = Class239_Sub1.aShortArrayArray5847[i_17_][i_18_];
			i_15_ = (Class348_Sub1_Sub2.aByteArrayArray8816[i_17_]
				 [i_18_]);
		    }
		    if (!bool
	...
	if (bool_13_ && (i & ~0xffffff) != 0) {
		...
		for (int i_21_ = (((Class318_Sub1_Sub3) class318_sub1_sub3)
			...
			Class239_Sub1.aShortArrayArray5847[i_20_][i_21_]
			    = i_14_;
			Class348_Sub1_Sub2.aByteArrayArray8816[i_20_][i_21_]
			    = i_15_;
		    }
		}
	    }
	...
	if (bool)
	    Class24.aClass318_Sub1_Sub3Array357[Class86.anInt1477++]
		= class318_sub1_sub3;
	else {
		...
		if (class318_sub1_sub3.method2377((byte) 122)) {
			...
			= Class250.aClass318_Sub1Array3226[i_22_];
		    Class250.aClass318_Sub1Array3226[i_22_]
			= class318_sub1_sub3;
		} else {
		    ((Class318_Sub1) class318_sub1_sub3).aClass318_Sub1_6379
	...
	if (bool)
	    ((Class318_Sub1) class318_sub1_sub3).anInt6382 -= i_16_;
	return true;
    }
    ...
    Class89(OpenGlToolkit class377, long l, Class39[] class39s) {
	try {
	    ((Class89) this).aLong1510 = l;
	...
	for (int i = 0; i < 256; i++) {
		...
		if ((i_23_ & 0x1) != 1)
		    ...
		    i_23_ = i_23_ >>> -1253707679 ^ ~0x12477cdf;
	    }
