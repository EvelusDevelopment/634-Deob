...
abstract class Class55
{
    ...
    private HashTable aClass356_1011;
	...
	if (d != 0.0 && !((double) Class62.getCurrentTimeMillis()
	...
	while ((i_8_ ^ 0xffffffff) < -1) {
	    ...
	    Class135_Sub2.method1156(-27, i_25_,
				     AnimationDefinition.anIntArrayArray255[i_23_], i_26_,
				     i);
	    Class135_Sub2.method1156(-27, i_25_,
				     AnimationDefinition.anIntArrayArray255[i_24_], i_26_,
				     i);
	}
    }
	...
	aClass356_1011.putNode((long) i_32_, class348_sub23);
	return class348_sub23;
    }
	...
	aClass356_1011 = new HashTable(8);
    }
