...
{
    static AbstractFontRasterizer aClass324_4456;
	...
	try {
		...
		if (Class295.aBoolean3763 && bool_0_) {
			...
			= class143.method1185(null, i ^ 0x2,
					      ...
					      250, string);
		    int i_3_
			= ((Sprite) Class348_Sub7.aClass207_6643).indexWidth;
		    int i_4_ = i_3_ + 4;
		    i_2_ += 2 * i_4_;
		    i_1_ += 2 * i_4_;
		    ...
		    int i_6_ = (Class239_Sub27.aClass341_6128
				    .method2679(DirectxToolkit.anInt7666, i_2_, 1595)
				+ Class239_Sub3.anInt5871);
		    if (Class59_Sub1.aBoolean5300) {
			i_5_ += s_Sub3.method4008((byte) -124);
			i_6_ += Class16.method260(false);
		    }
		    var_ha.method3691(FileIndexWorker.aClass207_1727, false).method965
			((((Sprite) Class348_Sub40_Sub1.aClass207_9090)
			  .indexWidth) + i_5_,
			 (((Sprite) Class348_Sub40_Sub1.aClass207_9090)
			  .indexHeight) + i_6_,
			 -(2 * (((Sprite) Class348_Sub40_Sub1.aClass207_9090)
				.indexWidth)) + i_1_,
			 -((((Sprite) Class348_Sub40_Sub1.aClass207_9090)
			    .indexHeight)
			   * 2) + i_2_,
			...
			.method974(i_5_, i_6_);
		    Class348_Sub40_Sub1.aClass207_9090.reflectY();
		    var_ha.method3691
			(Class348_Sub40_Sub1.aClass207_9090, true)
			.method974(i_5_ + i_1_ - i_3_, i_6_);
		    Class348_Sub40_Sub1.aClass207_9090.reflectX();
		    var_ha.method3691
			...
			(i_5_,
			 ...
			 -(2 * (((Sprite) Class348_Sub40_Sub1.aClass207_9090)
				.indexHeight)) + i_2_);
		    Class348_Sub7.aClass207_6643.rotateCw90();
		    var_ha.method3691(Class348_Sub7.aClass207_6643, true)
			.method972
			((((Sprite) Class348_Sub40_Sub1.aClass207_9090)
			  .indexWidth) + i_5_,
		    ...
		    int i_10_ = 6 - -i_9_;
		    int i_11_ = i_9_ + 6;
		    var_ha.drawQuad(i_10_ + -i_9_, i_11_ + -i_9_, i_9_ + i_7_ + i_9_,
