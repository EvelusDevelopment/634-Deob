...
final class s_Sub3 extends s
{
    ...
    NativeToolkit aHa_Sub3_8322;
    private float[][] aFloatArrayArray8323;
    Class130 aClass130_8324;
    private HashTable aClass356_8325;
	...
	int i_1_ = (((s) this).anInt4592
		    >> ((NativeToolkit) ((s_Sub3) this).aHa_Sub3_8322).anInt8107);
	...
	anInt8292++;
	int i_10_ = Whirlpool.method831(Class38.anInt513, i_4_,
				      Class132.anInt1910, -118);
	int i_11_
	    = Whirlpool.method831(Class38.anInt513, i, Class132.anInt1910, 72);
	int i_12_ = Whirlpool.method831(Class113.anInt1745, i_8_,
				      Class369.anInt4960, -80);
	int i_13_ = Whirlpool.method831(Class113.anInt1745, i_3_,
				      Class369.anInt4960, -101);
	int i_14_ = Whirlpool.method831(Class38.anInt513, i_4_ + i_6_,
				      Class132.anInt1910, -110);
	int i_15_ = Whirlpool.method831(Class38.anInt513, i + -i_6_,
				      Class132.anInt1910, 28);
	if (i_7_ < -33) {
	    for (int i_16_ = i_10_;
		 (i_14_ ^ 0xffffffff) < (i_16_ ^ 0xffffffff); i_16_++)
		Class135_Sub2.method1156(-27, i_13_,
					 AnimationDefinition.anIntArrayArray255[i_16_],
					 i_12_, i_9_);
	    for (int i_17_ = i_11_; i_17_ > i_15_; i_17_--)
		Class135_Sub2.method1156(-27, i_13_,
					 AnimationDefinition.anIntArrayArray255[i_17_],
					 i_12_, i_9_);
	    int i_18_ = Whirlpool.method831(Class113.anInt1745, i_8_ + i_6_,
					  Class369.anInt4960, 114);
	    int i_19_ = Whirlpool.method831(Class113.anInt1745, -i_6_ + i_3_,
					  Class369.anInt4960, 34);
	    for (int i_20_ = i_14_; i_20_ <= i_15_; i_20_++) {
		int[] is = AnimationDefinition.anIntArrayArray255[i_20_];
	...
	if (aClass330_8307 != null && var_r != null) {
	    int i_36_
		= (i + -(i_33_ * (((NativeToolkit) ((s_Sub3) this).aHa_Sub3_8322)
				  .anInt8133)
			 >> 461407496)
		   >> ((NativeToolkit) ((s_Sub3) this).aHa_Sub3_8322).anInt8107);
	    int i_37_
		= (i_34_ - ((((NativeToolkit) ((s_Sub3) this).aHa_Sub3_8322)
			     .anInt8114) * i_33_
			    >> 689813064)
		   >> ((NativeToolkit) ((s_Sub3) this).aHa_Sub3_8322).anInt8107);
	...
	if (aClass330_8307 != null && var_r != null) {
	    int i_42_
		= (i + -((((NativeToolkit) ((s_Sub3) this).aHa_Sub3_8322).anInt8133
			  * i_39_)
			 >> -1458073752)
		   >> ((NativeToolkit) ((s_Sub3) this).aHa_Sub3_8322).anInt8107);
	    int i_43_
		= (-((((NativeToolkit) ((s_Sub3) this).aHa_Sub3_8322).anInt8114
		      * i_39_)
		     >> -2146527224) + i_40_
		   >> ((NativeToolkit) ((s_Sub3) this).aHa_Sub3_8322).anInt8107);
	...
	if (anInt8329 <= 0)
		...
		= ((NativeToolkit) ((s_Sub3) this).aHa_Sub3_8322).aNativeHeap7891
		      .a(anInt8329 * 4, false);
	    ...
	    if (i_48_ < 1)
		i_48_ = 1;
	    HashTable class356 = new HashTable(i_48_);
		...
		for (int i_51_ = 0; ((((s) this).anInt4590 ^ 0xffffffff)
			...
			for (int i_78_ = 0; i_78_ < is_56_.length; i_78_++) {
				...
				if (((((NativeToolkit) ((s_Sub3) this).aHa_Sub3_8322)
				      .anInt8178)
				     ^ 0xffffffff)
				    == -1)
				...
				if (i_83_ != -1
				    && ((((Node)
					  class348_sub3s_52_[i_78_]).nodeKey
					 ^ 0xffffffffffffffffL)
					> (((Node) (class348_sub3s_47_
							[i_105_])).nodeKey
					   ^ 0xffffffffffffffffL)))
				    class348_sub3s_47_[i_105_]
					= class348_sub3s_52_[i_78_];
		...
		for (int i_115_ = 0; i_115_ < ((s) this).anInt4590; i_115_++) {
			...
			while (is_116_.length > i_118_) {
				...
				if (class348_sub3_124_ == null
				    || ((((Node) class348_sub3_124_)
					 .nodeKey)
					> (((Node) class348_sub3_122_)
					   .nodeKey)))
		...
		ls[i_127_] = ((Node) class348_sub3).nodeKey;
	...
	if (aClass330_8307 == null || var_r == null)
	    return false;
	int i_131_
	    = (-(((NativeToolkit) ((s_Sub3) this).aHa_Sub3_8322).anInt8133 * i_128_
		 >> 798650088) + i
	       >> ((NativeToolkit) ((s_Sub3) this).aHa_Sub3_8322).anInt8107);
	int i_132_
	    = (i_129_ + -((((NativeToolkit) ((s_Sub3) this).aHa_Sub3_8322).anInt8114
			   * i_128_)
			  >> 10128456)
	       >> ((NativeToolkit) ((s_Sub3) this).aHa_Sub3_8322).anInt8107);
    ...
    s_Sub3(NativeToolkit var_ha_Sub3, int i, int i_139_, int i_140_, int i_141_,
	   int[][] is, int[][] is_142_, int i_143_) {
	super(i_140_, i_141_, i_143_, is);
	aClass262_8286 = new Deque();
	do {
	    try {
		...
		aFloat8306--;
		aFloat8305++;
		aClass356_8325 = new HashTable(128);
	...
	if (i_151_ == -1) {
		...
		if (!aClass262_8286.isEnd((byte) 18)) {
		    int i_165_
			= ((NativeToolkit) ((s_Sub3) this).aHa_Sub3_8322).anInt8144;
		    int i_166_
			= ((NativeToolkit) ((s_Sub3) this).aHa_Sub3_8322).anInt8091;
		    ((s_Sub3) this).aHa_Sub3_8322.L
			(0, i_166_,
			 ((NativeToolkit) ((s_Sub3) this).aHa_Sub3_8322).anInt8105);
			...
			((byte) 63, (((NativeToolkit) ((s_Sub3) this).aHa_Sub3_8322)
				     .anInterface18_8147));
		    ...
		    for (Node class348
			     = aClass262_8286.getFirst(i_151_ + 5);
			 class348 != null;
			 class348 = aClass262_8286.nextForward((byte) 106)) {
	...
	try {
	    aClass262_8286.addToFront(new Class348_Sub38((((s_Sub3) this)
							  .aHa_Sub3_8322),
							 this, class348_sub1,
							 is),
				      -20180);
	...
	try {
	    anInt8295++;
	    d var_d = ((AbstractToolkit) ((s_Sub3) this).aHa_Sub3_8322).aD4579;
		...
		if ((((s_Sub3) this).anInt8294 & 0x20) != 0
		    && (i_179_ ^ 0xffffffff) != 0
		    && ((TextureDefinition) var_d.getTexture(i_179_, -6662)).aBoolean209) {
		    i_180_ = 128;
		    i_179_ = -1;
		}
		...
		Node class348;
		for (class348 = aClass356_8325.get(l);
		     class348 != null;
	...
	if (anInt8329 > 0) {
		...
		fs[13] = -(((float) (2 * i_212_)
			   ...
			   / (float) (((NativeToolkit) ((s_Sub3) this).aHa_Sub3_8322)
				      .anInt7962)) + 1.0F;
		fs[11] = 0.0F;
		fs[0] = ((float) i_213_
			 / ((float) (((NativeToolkit) ((s_Sub3) this).aHa_Sub3_8322)
