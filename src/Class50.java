...
abstract class Class50
{
    ...
    static final Class171 method459(int i, DirectxToolkit var_ha_Sub2, String string,
				    boolean bool) {
	try {
	    anInt861++;
	    ...
	    OpenGL.glGetIntegerv(34379, GraphicsFetcher.anIntArray9069, 0);
	    if ((GraphicsFetcher.anIntArray9069[0] ^ 0xffffffff) != 0) {
