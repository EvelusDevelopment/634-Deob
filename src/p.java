...
final class p extends Node implements ModelToolkit
{
    long nativeid;
    ...
    private final native void sa(SafeToolkit var_oa, Canvas canvas, int i, int i_0_);
	...
	if (!aBoolean5144) {
	    aLong5146 = Class62.getCurrentTimeMillis();
	    aBoolean5144 = true;
	} else if (Class62.getCurrentTimeMillis() - aLong5146 < 30000L)
    ...
    p(SafeToolkit var_oa, Canvas canvas, int i, int i_11_) {
