...
final class Class323
{
    ...
    private RasterToolkit[] aClass105Array4042;
    private static int[] anIntArray4043 = new int[256];
    private int[] anIntArray4044 = new int[4];
    
    private final void method2559(AbstractToolkit var_ha, Font font,
	...
	Image image = Class305.canvas.createImage(i_0_, i_3_);
    ...
    private final void method2561(AbstractToolkit var_ha, String string, int[] is, int i,
    ...
    final void method2563(AbstractToolkit var_ha, String string, int i, int i_14_,
			  int i_15_, boolean bool) {
	int i_16_ = method2564(string) / 2;
	var_ha.getDimensions(anIntArray4044);
