...
final class Class302
{
	...
	Class103.method950(i_0_, 0,
			   Class65.lobbyWorlds.length + -1, bool,
	...
	try {
		...
		if (Class348_Sub40_Sub21.anInt9282 != 1
			...
			StringVarScriptSettingLoader.method814((byte) 125, l);
		} else
		    Canvas_Sub1.method119(-1, l);
	    }
	    BufferedPacket.method3324(Class348_Sub8.currentToolkit, (byte) 83,
	    ...
	    Class348_Sub42_Sub20.method3281((byte) 46, Class348_Sub8.currentToolkit);
	    int i_4_ = FileIndexWorker.method1053(3112);
	    if (i_4_ == -1)
		i_4_ = Class362.anInt4458;
	    if (i_4_ == -1)
		i_4_ = OndemandFileRequest.anInt10447;
	    Class33.method338(0, i_4_);
	    if (i == -43) {
		int i_5_ = (Class132.localPlayer
				.method2436((byte) 103)
			    << 1788292200);
		Class335.method2655
		    (98,
