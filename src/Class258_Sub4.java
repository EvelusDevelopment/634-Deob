...
{
    static AbstractMouseListener mouseMovementListener;
    ...
    Class258_Sub4(DirectxToolkit var_ha_Sub2, int i, int i_0_, byte[] is, int i_1_) {
	super(var_ha_Sub2, 3552, i, i_0_, false);
	try {
	    anInt8556 = i_0_;
	    ((Class258) this).aHa_Sub2_4851.method3771((byte) -94, this);
	    OpenGL.glPixelStorei(3317, 1);
	    OpenGL.glTexImage1Dub(((Class258) this).anInt4849, 0,
				  ((Class258) this).anInt4858, anInt8556, 0,
				  i_1_, 5121, is, 0);
	...
	((Class258) this).aHa_Sub2_4851.method3771((byte) -114, this);
	int i_2_ = 59 / ((-49 - i) / 40);
	anInt8555++;
	...
	anInt8559++;
	int i_4_ = -43 / ((-65 - i) / 55);
	long l = (long) (i_3_ | (bool ? -2147483648 : 0));
