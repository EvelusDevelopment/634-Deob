...
final class Class135_Sub2 extends Class135 implements Interface8
{
    ...
    static ConnectionMode worldConnectionNode;
    static int anInt4840;
    static int anInt4841;
    static int anInt4842;
    static IndexLoader skinIndexLoader;
	...
	if (i_7_ < -77) {
		...
		ByteBuffer class348_sub49
		    = (new ByteBuffer
		       (Class98.method878((LobbyWorld.method1039
					   (Class348_Sub23_Sub3.sskeyStr,
					    true)),
					  -126)));
		l = class348_sub49.getLong();
		Class348_Sub33.aLong6966
		    = class348_sub49.getLong();
	    } else {
    ...
    Class135_Sub2(DirectxToolkit var_ha_Sub2, int i, byte[] is, int i_8_,
		  boolean bool) {
