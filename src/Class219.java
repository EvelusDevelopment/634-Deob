...
final class Class219
{
    ...
    IndexLoader aClass45_2873;
    static int anInt2874;
    private Cache aClass60_2875 = new Cache(64);
	...
	if (((Class318_Sub1_Sub3_Sub3) class318_sub1_sub3_sub3).anInt10319
		...
		if ((((Class318_Sub1_Sub3_Sub3) class318_sub1_sub3_sub3)
		     .anInt10322) > 0
		    && (((AnimationDefinition) class17).anInt262 ^ 0xffffffff) == -1) {
		    Class235.anInt3062 = -1;
		    Class127_Sub1.anInt8387 = 0;
		    ((Class318_Sub1_Sub3_Sub3) class318_sub1_sub3_sub3)
			.anInt10326++;
		...
		if ((((Class318_Sub1_Sub3_Sub3) class318_sub1_sub3_sub3)
		     .anInt10322) <= 0
		    && (((AnimationDefinition) class17).anInt245 ^ 0xffffffff) == -1) {
		    Class127_Sub1.anInt8387 = 0;
		    Class235.anInt3062 = -1;
		    ((Class318_Sub1_Sub3_Sub3) class318_sub1_sub3_sub3)
			.anInt10326++;
	    ...
	    if ((((Class318_Sub1_Sub3_Sub3) class318_sub1_sub3_sub3).anInt10269
		 ^ 0xffffffff) != 0
		&& (((Class318_Sub1_Sub3_Sub3) class318_sub1_sub3_sub3)
		    .anInt10225) <= Class367_Sub11.logicCycle) {
		...
		if (class318_sub1_sub3_sub3
		    instanceof Npc)
		    bool_8_ = ((NpcDefinition) (((Npc)
					   (Npc)
					   class318_sub1_sub3_sub3)
					  .definition)).aBoolean1331;
		if (bool_8_) {
		    int i_9_
			= ((((Class318_Sub1_Sub3_Sub3) class318_sub1_sub3_sub3)
			    .anInt10282)
	...
	synchronized (aClass45_2866) {
	    is = aClass45_2866.loadArchiveChild(-1860, i, i_15_);
	}
	class31 = new Class31();
	((Class31) class31).aClass219_438 = this;
	if (is != null)
	    class31.method332(i ^ ~0x55, new ByteBuffer(is));
	synchronized (aClass60_2875) {
	...
	synchronized (aClass60_2875) {
	    aClass60_2875.removeAll(i);
	}
	anInt2865++;
	synchronized (((Class219) this).aClass60_2862) {
	    ((Class219) this).aClass60_2862.removeAll(0);
	}
    }
    ...
    Class219(GameMode class230, int i, IndexLoader class45, IndexLoader class45_17_) {
	try {
