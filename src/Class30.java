...
final class Class30
{
    ...
    static final void setNativeLibraryLoader(IndexLoader class45, Signlink signlink, byte i) {
	try {
	    Class348_Sub41.aString7048 = "";
	    Class59_Sub1.nativeLibSignlink = signlink;
	    anInt410++;
	    Class167.nativeLibIndexLoader = class45;
	    ...
	    if (i != 95)
		anIntArray407 = null;
	    if (!((Signlink) Class59_Sub1.nativeLibSignlink).aBoolean3794) {
